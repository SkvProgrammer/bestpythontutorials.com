...
<html lang="en-Us">
    <head>
        <title>Lambda in Python | Anonymous Function in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Lambda in Python | Anonymous Function in Python"/> 
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="lambda.php" target="_self">lambda function</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="lambda.php" target="_self" style="color:white;">lambda function</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Lambda Function in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/lambda.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/lambda.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
  ...
  <p style="text-align:justify;" class="mt-4">Lambda Function is a Small Anonymous Function which takes a number of arguments but returns only one expression.</p>
   <div class="mb-3 mt-3">
...
<div class="container-fluid p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
...
<br>
  ...
  document.write('<scr' + 'ipt type="text/javascript" src="http' + (location.protocol === 'https:' ? 's' : '') + '://partitiondetergenttumor.com/ccab6f0b37ebcf46ae2cc8c860e3836a/invoke.js"></scr' + 'ipt>');
        ...
        <h4 style="text-align:justify;color:#a54eee;" class="mt-5">Why do We need to use Lambda function?</h4>
        
        <p style="text-align:justify;">Whenever you need to use an anonymous function for a short period of Time you can the <code>Lambda</code> function.We generally use it as an argument to a higher-order function (a function that takes in other functions as arguments). Lambda functions are used along with built-in functions like <a href="map.php" style="color:grey;text-decoration:none;">filter() , map() <img src="django/link.png" style="height:10px;"></a> etc.</p>
...
print(cube(2)) 
        ...
        <ul style="text-align:justify;font-size:20px;" class="mt-5">
