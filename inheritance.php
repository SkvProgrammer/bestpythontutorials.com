...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Inheritance in python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,inheritance in python,child class,parent class">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="inheritance.php" target="_self">Inheritance</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="inheritance.php" target="_self" style="color:white;">Inheritance</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Inheritance in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/inheritance.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/inheritance.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
   ...
   <h5 style="text-align:justify;" class="mt-4"><code>Inheritance</code> - Inheritance is the process of inheriting methods and properties from one class two another.</h5><br>
        <p style="text-align:justify;">
          The class from which the methods and properties are inherited is called <b>Parent or Base Class</b> and the class which <i>inherits</i> the methods and properties is called <b>Child or Base</b> Class. 
        </p>
 <div class="mb-3 mt-3">
 ...
 <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
                 <keyword>class</keyword> Parent_Class:<br>
                    <xvc style="margin-left:30px;">statement(s)</xvc><br>
                    <keyword>class</keyword> Child_Class(Parent_Class):<br>
                    <xvc style="margin-left:30px;">statement(s)</xvc>
             </div>
