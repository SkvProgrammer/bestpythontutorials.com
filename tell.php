...
<html lang="en-Us">
    <head>
        <title>Tell() and Seek() method in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="tell() and seek() method in Python"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,tell() and seek() method in Python">
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">tell() and seek() in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/tell.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/tell.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align::justify;" class="mt-4"><code>tell()</code> method returns the current position of the file read/write pointer within the file</p>
...
print(content)
print("Current Position:",file.tell())</textarea>
...
<div class="container mt-3" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
I am a self taught programmer
<br><br>
Current Position: 31
</div>
<h3 class="text-left mt-4" style="color:#a54eee;">seek() method</h3>
<p style="text-align:justify;">
  Python file method seek() sets the file's current position at the offset. The whence argument is optional and defaults to 0, which means absolute file positioning, other values are 1 which means seek relative to the current position and 2 means seek relative to the file's end.</p>
<p style="text-align:justify;">
There is no return value. Note that if the file is opened for appending using either 'a' or 'a+', any seek() operations will be undone at the next write.</p>
<p style="text-align:justify;">
...
<h3 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h3>
<div class="container mt-3" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
File Name: demo.txt<br>
Reading Line: I am a self taught programmer
<br><br>
Reading Line: I am a self taught programmer
