...
<html lang="en-Us">
    <head>
        <title>Terms and Conditions - BestPythonTutorials.com</title>
        <meta charset="utf-8">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:30px;">ABOUT US</h4></li><br>
     <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="termsandconditions.php"  target="_self">Terms and Conditions</a></li>
   <li><a href="privacypolicy.php"  target="_self">Privacy Policy</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="" style="border:none;color:white;"><h1 id="tag1">ABOUT</h1></a>
    <a href="termsandconditions.php"  target="_self" style="color:white;">Terms and Conditions</a>
    <a href="privacypolicy.php"  target="_self">Privacy Policy</a>
  ...
  <section class="container-fluid text-center" id="content" style="width:79%;background-color:white;font-family: 'Baloo Thambi 2', cursive;font-size:18px;position:absolute;top:60px;right:0px;padding:0px;overflow:hidden!important;"> 
    <!----------------------------ADS------------------->
...
<h2 style="text-align:justify;color:#a54eee;">Terms and Conditions</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/termsandconditions.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/termsandconditions.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p>Welcome to bestpythontutorials.com!</p>

<p>These terms and conditions outline the rules and regulations for the use of BPT's Website, located at https://www.bestpythontutorials.com.</p>
...
<p>We employ the use of cookies. By accessing bestpythontutorials.com, you agreed to use cookies in agreement with the BPT's Privacy Policy.</p>

<p>Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>

<h3><strong>License</strong></h3>

<p>Unless otherwise stated, BPT and/or its licensors own the intellectual property rights for all material on bestpythontutorials.com. All intellectual property rights are reserved. You may access this from bestpythontutorials.com for your own personal use subjected to restrictions set in these terms and conditions.</p>

<p>You must not:</p>
<ul>
    <li>Republish material from bestpythontutorials.com</li>
    <li>Sell, rent or sub-license material from bestpythontutorials.com</li>
    <li>Reproduce, duplicate or copy material from bestpythontutorials.com</li>
    <li>Redistribute content from bestpythontutorials.com</li>
</ul>

<p>This Agreement shall begin on the date hereof.</p>

<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. BPT does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of BPT,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, BPT shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>

<p>BPT reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
...
<p>You hereby grant BPT a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
...
<p>No use of BPT's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
...
function next(){
  window.open("privacypolicy.php","_self");
}
function prev(){
