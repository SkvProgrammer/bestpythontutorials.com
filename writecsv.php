...
<html lang="en-Us">
    <head>
        <title>Writing into a CSV File in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Writing into a CSV File in File - CSV Module in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="writecsv.php" target="_self">Write CSV file</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="writecsv.php" target="_self" style="color:white;">Write CSV file</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Writing into a CSV file</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/writecsv.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/writecsv.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
   ...
   <p style="text-align:justify;" class="mt-4">CSV stands for <b>'Comma Seperated Value'</b>.This format is the most common import and export format for spreadsheets and databases.</b></p>
        ...
        <h3 style="text-align:left;color:#a54eee;">Important Functions of csv Module</h3>
        ...
        <h2 style="text-align:justify;color:#a54eee;" class="mt-4">Writing into a CSV File</h2>
...
<div style="text-align:justify;">
 ...
 writer.writeheader()
 writer.writerow({'name': 'Hari', 'age': 27,'nickname':'hr'}) writer.writerow({'name': 'Ramesh', 'age': 29,'nickname':'Ramu'})  </textarea>
...
function next(){
  window.open("readexcel.php","_self");
}
function prev(){
  window.open("readcsv.php","_self");
}
