...
<html lang="en-Us">
    <head>
        <title>Generators Vs List in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Generators Vs List in Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,programming tutorial,generators vs list,generators vs list in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="generatorsvslist.php" target="_self">Generators vs List</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="generatorsvslist.php" target="_self" style="color:white;">Generators vs List</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Generators Vs List in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/generatorsvslist.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/generatorsvslist.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">This Chapter is actually made to difference between the <b>Generator Expressions</b> and <b>List Comprehension</b>.But First of all let's compare the <b>Generators</b> and <b>List</b>.Generators and Lists are having a large difference.Generators are actually related to <b>Functions</b> whereas <b>List</b> are having no direct connections with Methods.Now Let's Compare the <b>Generator Expressions</b> and <b>List Comprehension</b>.</p>
          <script type="text/javascript">
  atOptions = {
...
<h4 class="text-left mt-4" style="color:#a54eee;">List Comprehensions</h4>
<p style="text-align:justify;">List Comprehensions are an elegant way for creating a List.It seamlessly decreases the lines of code.In many situations List Comprehensions helps to solve the problem with a great ease.To learn List Comprehension.Check Out Our <a href="listcomprehension.php" style="color:grey;text-decoration:none;">List Comprehension Tutorial <img src="django/link.png" style="height:10px;"></a>.</p>


      <h3 class="text-center mt-4" style="color:#a54eee;">Whereas</h3>

<h4 class="text-left mt-4" style="color:#a54eee;">Generator Expressions</h4>
<p style="text-align:justify;">Generator Expressions are somewhat similar to list comprehensions, but Generator Expression doesn’t construct list object. Instead of creating a list and keeping the whole sequence in the memory, the generator generates the next element in demand.
...
The Generator Expression allows us to create a generator without the yield keyword.</p>
...
y = getsizeof(gen_exp) 
print("Size of Generator Expression = ", y) 
...
function prev(){
  window.open("generators.php","_self");
}
