...
<html lang="en-Us">
    <head>
        <title>Buffering Protocol in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Buffering Protocol in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,buffering protocol in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="buffering.php" target="_self">Python Buffering Protocol</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="buffering.php" target="_self" style="color:white;">Python Buffering Protocol</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Buffering Protocol in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/buffering.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/buffering.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Buffer Protocol in Python Provides us a way to access the internal data of an Object.Certain objects available in Python wrap access to an underlying memory array or buffer. Such objects include the built-in <code>bytes</code> and <code>bytearray</code>, and some extension types like <code>array.array</code>.</p>
 <div class="mb-3 mt-3">
...
Python provides such a facility at the C level in the form of the buffer protocol. This protocol has two sides:</p>
<ul style="text-align:justify;">
<li class="mt-3">on the producer side, a type can export a “buffer interface” which allows objects of that type to expose information about their underlying buffer. This interface is described in the section Buffer Object Structures;
</li>
<li>on the consumer side, several means are available to obtain a pointer to the raw underlying data of an object (for example a method parameter).
</li>
</ul>
<p style="text-align: justify;">So, to expose the same protocol to normal Python code base, memory views are present.</p>
<p style="text-align:justify;">The <code>memoryview()</code> function allows direct read and write access to an object’s byte-oriented data without needing to copy it first. That can yield large performance gains when operating on large objects since it doesn’t create a copy when slicing.</p>

<h3 style="text-align:left;color:#a54eee;" class="mb-0 mt-4">SYNTAX</h3>
<div class="container text-left mb-5" style="border:3px solid #f2f2f2;">
  <comment>memoryview</comment>(object)

</div>
<h3 style="text-align:left;color:#a54eee;" class="mt-3 mb-0">PARAMETERS</h3>
<div style="overflow:auto;">
  <table>
    ...
    <tr>
      <td>obj</td>
      <td>object whose internal data is to be exposed.</td>
    </tr>
  </table>
</div>
...
print('Before updating:', byte_array) 

memory_view = memoryview(byte_array)  
memory_view[2]= 104
print('After updating:', byte_array)
...
<h3 class="mt-4" style="text-align:left;color:#a54eee;">EXPLANATION</h3>
<p style="text-align:justify;">
 Here,We updated the memory view’s 2nd index to ASCII value 104 (h). In this memory view object <code>memory_view</code> references the same buffer or memory and by updating the index in <code>memory_view</code>,it also updates <code>byte_array</code>.</p>
<h3 class="mt-4" style="text-align:left;color:#a54eee;">Importance of Buffer Protocol</h3>
<p style="text-align:justify;">By using buffer protocol we can work on large data like we want to work on binary data of an image. Buffer protocol, can create another object access to modify the large data without copying it. This makes the program use less memory and increases the execution speed.</p>
...
function next(){
  window.open("linguistics.php","_self"); 
}
function prev(){
  window.open("designpatterns.php","_self");
}
