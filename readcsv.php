...
<html lang="en-Us">
    <head>
        <title>Read a CSV File in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Reading a CSV file in Python - csv module in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="readcsv.php" target="_self">Read CSV file</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="readcsv.php" target="_self" style="color:white;">Read CSV file</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Reading a CSV file in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/readcsv.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/readcsv.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
        ...
        <p style="text-align:justify;" class="mt-4">CSV stands for <b>'Comma Seperated Value'</b>.This format is the most common import and export format for spreadsheets and databases.</b></p>

        <h3 style="text-align:left;color:#a54eee;" class="mt-4">Important Functions of csv Module</h3>
        
        <ul style="text-align:justify;font-size:20px;" class="mb-3">
          <li><strong>csv.reader():</strong>This function is used to read a <i>csvfile</i>.</li>
          <li><strong>csv.writer():</strong>This function is used to write into a <i>csvfile</i>.</li>
          <li><strong>csv.register_dialect():</strong> It associates dialect with a name. The name must be a string or a Unicode object</li>
          <li><strong>csv.unregister_dialect():</strong>Delete the dialect associated with name from the dialect registry. An Error is raised if name is not a registered dialect name</li>
          <li><strong>csv.get_dialect(name):</strong>Return the dialect associated with name. An Error is raised if name is not a registered dialect name. This function returns an immutable Dialect</li>
          <li><strong>csv.list_dialects():</strong>Return the names of all registered dialects.</li>
          <li><strong>csv.field_size_limit():</strong>Returns the current maximum field size allowed by the parser. If new_limit is given, this becomes the new limit.</li>
        </ul>
        <h2 style="text-align:justify;color:#a54eee;" class="mt-4">Reading a CSV File</h2>
...
import csv
with open('main.txt') as CsvFile:
      reader = csv.reader(CsvFile, delimiter=',')
      line_count = 0
      for row in reader:
               if line_count == 0:
               print(f'Column names are {", ".join(row)}')
               line_count += 1 </textarea>
...
<p style="text-align:justify;" class="mt-4"><STRONG>Note:</STRONG>You can add the name of the csv file in the open function to read it.</p>
</div>
...
function next(){
  window.open("writecsv.php","_self");
}
function prev(){
