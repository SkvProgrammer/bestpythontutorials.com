...
<html lang="en-Us">
    <head>
        <title>Exploring HTTPS in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Exploring HTTPS in Python - HTTPS in Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,exploring https in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="exploringhttps.php" target="_self">Exploring HTTPS</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="exploringhttps.php" target="_self" style="color:white;">Exploring HTTPS</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">HTTPS in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/exploringhttps.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/exploringhttps.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In this Chapter we are going to learn about the <b>HTTP</b> and <b>HTTPS</b> Protocol.You might have visited so many sites in the web.You might have noticed that in the urls there's written something called <b>https://</b> or <b>http://</b>.They are actually security protocols for the web.They are very useful in aspects of web development.</p>



<img src="https.png" class="img-fluid" alt="HTTPS">


<h4 class="text-left mt-4" style="color:#a54eee;">What is HTTP?</h4>
<p style="text-align:justify;">This acronym stands for HyperText Transfer Protocol, which underpins most of the communications that go on when you’re surfing your favorite websites. More specifically, HTTP is how a user agent, like your web browser, communicates with a web server, like bestpythontutorials.com. Here’s a simplified diagram of HTTP communications:</p>
 <div class="mb-3 mt-3">
...
<h4 class="text-left mt-4" style="color:#a54eee;">What is HTTPS?</h4>
<p style="text-align:justify;">Now that you understand a bit more about HTTP, what is HTTPS? The good news is, you already know this! HTTPS stands for HyperText Transfer Protocol Secure. Fundamentally, HTTPS is the same protocol as HTTP but with the added implication that the communications are secure.</p>


 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
   <h4 class="text-left mt-4" style="color:#a54eee;">Importance of HTTPS?</h4>    
<p style="text-align:justify;">Secure communications are critical in providing a safe online environment. As more of the world moves online, including banks and healthcare sites, it’s becoming more and more important for developers to create Python HTTPS applications. Again, HTTPS is just HTTP over TLS or SSL. TLS is designed to provide privacy from eavesdroppers. It can also provide authentication of both the client and the server.</p>
       
<h5 class="text-left mt-4">Check Out Our  <a href="django/home_django.php" style="color:grey;text-decoration:none;">Django <img src="django/link.png" style="height:10px;"></a> and <a href="flask/home_flask.php" style="color:grey;text-decoration:none;">Flask Tutorial <img src="django/link.png" style="height:10px;"></a></h5>
