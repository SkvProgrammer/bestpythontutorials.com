...
<html lang="en-Us">
    <head>
        <title>Logging in Python - Log Messages in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Log Messages in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,log messages in Python,logging module in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="logging.php" target="_self">Logging in Python</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="logging.php" target="_self" style="color:white;">Logging in Python</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Logging in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/logging.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/logging.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<h3 class="mt-4 text-left" style="color:#a54eee;">Logging Module</h3>
<p>Python provides a module called <code>logging</code> which is ready-to-use for beginner as well ae enterprise. It is used by most of the third-party Python libraries, so you can integrate your log messages with the ones from those libraries to produce a homogeneous log for your application.</p>
<h3 class="mt-4 text-left" style="color:#a54eee;">Levels of Log Message</h3>
<ul style="text-align:justify;font-size:20px;">
  <li><b>DEBUG</b>:These are used to give Detailed information, typically of interest only when diagnosing problems</li>
<li class="mt-2"><b>INFO</b>:This Confirms that all the things are working as expected.</li>
<li class="mt-2"><b>WARNING</b>:Shows something unexpected is happening in the program.</li>
<li class="mt-2"><b>ERROR</b>:Indicates Serious Problems,which will affect other functions.</li>
<li class="mt-2"><b>CRITICAL</b>:Indicates Serious Error which can make the application unable to run.</li>
</ul>
<p style="text-align:justify;" class="mt-4">Developers can also make their own log message but in that case they must keep in mind the numeric values for different log message.</p>
...
<h3 class="text-left mt-5" style="color:#a54eee;">Methods of logging Module</h3>
<ul style="text-align:justify;font-size:20px;">
  <p>
    <li><b>Logger.info(msg)</b> : This will log a message with level INFO on this logger.</li>
<li><b>Logger.warning(msg)</b> : This will log a message with level WARNING on this logger.
<li><b>Logger.error(msg)</b> : This will log a message with level ERROR on this logger.
<li><b>Logger.critical(msg)</b> : This will log a message with level CRITICAL on this logger.
<li><b>Logger.log(lvl,msg)</b> : This will Logs a message with integer level lvl on this logger.
<li><b>Logger.exception(msg)</b> : This will log a message with level ERROR on this logger.
<li><b>Logger.setLevel(lvl)</b> : This function sets the threshold of this logger to lvl. This means that all the messages below this level will be ignored.
<li><b>Logger.addFilter(filt)</b> : This adds a specific filter filt to the to this logger.
<li><b>Logger.removeFilter(filt)</b> : This removes a specific filter filt to the to this logger.
<li><b>Logger.filter(record)</b> : This method applies the logger’s filter to the record provided and returns True if record is to be processed. Else, it will return False.
<li><b>Logger.addHandler(hdlr)</b> : This adds a specific handler hdlr to the to this logger.
<li><b>Logger.removeHandler(hdlr)</b> : This removes a specific handler hdlr to the to this logger.
<li><b>Logger.hasHandlers()</b> : This checks if the logger has any handler configured or not.
  </p>
</ul>
 <br>
           <script type="text/javascript">
...
<h3 class="text-left mt-5" style="color:#a54eee;">EXAMPLE</h3>
<p style="text-align:justify;">Now we will see the use of log messages with a simple python program.</p>
...
logger.critical("Complete Damage..")</textarea>
...
<h3 class="text-left mt-5" style="color:#a54eee;">Output of the Above Code</h3>
