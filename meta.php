...
<html lang="en-Us">
    <head>
        <title>Meta classes in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Meta Classes in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,meta classes in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <!--new-->
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="meta.php" target="_self">Meta Classes</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <!--new-->
    <a href="meta.php" target="_self" style="color:white;">Meta Classes</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Meta Classes in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/meta.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/meta.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">A <b>metaclass</b> is a class whose instances are classes. Like an ordinary class which defines the behavior of the instances of the class, a metaclass defines the behavior of other classes and their instances.
<br>
Metaclasses are not supported by every object oriented programming language. Those programming language, which support metaclasses, considerably vary in way they implement them. Python is supporting them and hence we are learning it.A Class is itself an instance of metaclass.To Learn Metaclasses you should have the basic knowledge of <a href="classes.php">Python Classes</a>.</p>
...
<h3 style="text-align:left;color:#a54eee;" class="mt-4">Creating Custom Metaclasses</h3>
<p style="text-align:justify;">In Python we can customize a metaclass using the <code>metaclass</code> attribute.This can also be done by inheriting a class that has already passed in this keyword.
</p>
...
class MyOrdinaryClass(metaclass=MyMetaClass):
    pass

class MySubclass(MyOrdinaryClass):
    pass
"""Printing the type of class"""
print(type(MyMetaClass))
print(type(MyOrdinaryClass))
...
<p class="mt-4" style="text-align:justify;">The type of MyMetaClass is <code>&lt;class 'type'&gt;</code> and of the MyOrdinaryClass and MySubclass is <code>&lt;class '__main__.MyMetaClass'&gt;</code>
  ...
  <h3 style="text-align:justify;color:#a54eee;" class="mt-4">__new__ and __init__
</h3>
...
<p style="text-align:justify;"><code>__new__</code> is used when one wants to define dict or bases tuples before the class is created. The return value of <code> __new__</code> is usually an instance of cls. <code>__new__</code> allows subclasses of immutable types to customize instance creation. It can be overridden in custom metaclasses to customize class creation. <code>__init__</code> is usually called after the object has been created so as to initialize it.
...
<h3 style="text-align:justify;color:#a54eee;" class="mt-4">Singleton using Python</h3>
