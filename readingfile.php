...
<html lang="en-Us">
    <head>
        <title>Reading a File in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Reading a File in Python"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,reading a file in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">PATTERNS</h4></li><br>
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">FILE HANDLING</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="readingfile.php" target="_self">Reading a file</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="readingfile.php" target="_self" style="color:white;">Reading a file</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Reading a file in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/readingfile.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/readingfile.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In previous chapters we have seen how to open a file using 3 different methods.Now we will see how to read a file in python using the <code>read()</code> and <code>readline()</code>.</p>
<p style="text-align:justify;" class="mt-4">For this chapter assume that we will be using a <kbd>demo.txt</kbd> file,whose content is below:</p>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:3px solid lightgrey;">
  I am a self taught programmer<br>
  I love to code<br>
  Python is an awesome programming language<br>
  BestPythonTutorials.com is great place to learn coding
</div>
<br>
           <script type="text/javascript">
  atOptions = {
 ...
 <h3 class="text-left mt-5" style="color:#a54eee;">Reading a single line</h3>
...
<h3 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h3>
<div class="container" style="background-color:#f2f2f2;border:3px solid lightgrey;text-align:justify;">
...
<h3 class="text-left mt-5" style="color:#a54eee;">Reading the Whole file or specific number of lines of a file</h3>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
 <textarea id="editor2" name="initScript" style="height:20vh!important;text-align:justify;overflow:hidden;-webkit-border-radius: 5px;
    -moz-border-radius: 5px;border-radius: 5px;z-index:0;" readOnly = 'nocursor'>
file = open("demo.txt","rt")
print(file.read())#reading the whole text
print(file.read(2))#reading first two lines of a file</textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
I love to code<br>
Python is an awesome programming language<br>
BestPythonTutorials.com is great place to learn coding<br><br>
...
<h3 class="text-left mt-5" style="color:#a54eee;">Reading a file by looping</h3>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<a download="demo.txt" href="demo.txt" style="color:white;background-color:orangered;text-decoration:none;border-radius:5px;padding-left:4px;padding-right:4px;">Download Demo.txt File</a>
...
function next(){
  window.open("writingfile.php","_self"); 
}
function prev(){
  window.open("openingfile.php","_self");
}
