...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="../codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Admin Interface in django"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,admin interface in django">
  ...
  <!--vertical menu-->
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">DJANGO TUTORIAL</h4></li><br>
     <li><a href="home_django.php"  target="_self">Django Home</a></li>
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="admin_interface_django.php"  target="_self">Admin Interface</a></li>
...
<a href="" style="border:none;color:white;"><h1 id="tag1">DJANGO TUTORIAL</h1></a>
  <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="admin_interface_django.php"  target="_self" style="color:white;">Admin Interface</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Admin Interface in Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/admin_interface_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/django/admin_interface_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Django is an Awesome Web Framework.There are some features which only and only django supports i.e. the admin interface which is great for backend stuffs.</p>
<p style="text-align:justify;">Django's admin UI is great for working as it generates awesome UI for all Applications.Django's admin is based on <b>django.contrib</b> module.</p>

<p style="text-align:justify;"> To have it working you need to make sure some modules are imported in the <b>INSTALLED_APPS</b> and <b>MIDDLEWARE_CLASSES</b> tuples of the myproject1/settings.py file.</p>

<h3 class="text-left mt-4" style="color:#a54eee;">Structure of INSTALLED_APPS</h3>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
  INSTALLED_APPS = (<br>
   <str>'django.contrib.admin',<br>
...
<h3 class="text-left mt-4" style="color:#a54eee;">Structure of MIDDLEWARE_CLASSES</h3>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
MIDDLEWARE_CLASSES = (<br>
   <Str>'django.contrib.sessions.middleware.SessionMiddleware',<br>
   'django.middleware.common.CommonMiddleware',<br>
   'django.middleware.csrf.CsrfViewMiddleware',<br>
   'django.contrib.auth.middleware.AuthenticationMiddleware',<br>   'django.contrib.messages.middleware.MessageMiddleware',<br>
   'django.middleware.clickjacking.XFrameOptionsMiddleware',<br></Str>
)
</div>

<p style="text-align:justify;" class="mt-3 mb-0">In Order to access the Admin Page you first need to instantiate the Databases.</p>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
python manage.py migrate
</div>
<p style="text-align:justify;" class="mt-3 mb-0">Create a Superuser to access the Admin Page.</p>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
python manage.py createsuperuser
</div>
<p style="text-align:justify;" class="mt-3 mb-0">Now run the server to access the Admin Page</p>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
python manage.py runserver
</div>

<h3 class="text-left mt-4" style="color:#a54eee;">Django Admin Interface</h3>
<p class="text-left"><b>User Authentication Page</b>:In Order to go to this page map the url as <b>127.0.0.1:8000/admin</b> and the below page will appear add the username and password generated as super user.</p>
<img src="django_admin1.png" class="img-fluid">
<p style="text-align:justify;">After filling the form we will be redirected to the below admin page.</p>
<img src="django_admin2.jpg" class="img-fluid">
...
function prev(){
  window.open("creating_project_django.php","_self");
}
