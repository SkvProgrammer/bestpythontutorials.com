...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Ajax in Django">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="ajax_django.php"  target="_self">Django AJAX</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="ajax_django.php"  target="_self" style="color:white;">Django AJAX</a>
...
<h2 class="text-left" style="color:#a54eee;">Ajax in Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/ajax_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/ajax_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------Google Translate API ends----------------->
  ...
  <p style="text-align:justify;" class="mt-4">Your settings.py file must contain the following in the listed variables.</p>
  
  <div class="text-left mt-1 mb-0">
    <p style="text-align:justify;" class="mb-1">settings.py</p>
  ...
  DAJAXICE_MEDIA_PREFIX = 'dajaxice'</textarea>
  ...
  <p style="text-align:justify;">Now go to the <b>myapp/url.py</b> file and make sure you have the following to set dajax URLs and to load <b>dajax</b> statics js files −</p>
  <div class="text-left mt-1 mb-0">
    <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
  ...
  urlpatterns += staticfiles_urlpatterns()</textarea>
                <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
                <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
               </button>
               -->
  ...
  <p style="text-align:justify;" class="mt-3">Now let us create a simple form using the <b>Models</b>.</p>
  <div class="text-left mt-1 mb-0">
    <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
   <textarea id="editor3" name="initScript" style="height:20vh!important;text-align:justify;overflow:hidden;-webkit-border-radius: 5px;
      -moz-border-radius: 5px;border-radius: 5px;z-index:0;" readOnly = 'nocursor'>
  class ModalFormone(forms.Form):
     name = forms.CharField(max_length = 100)
     phonenumber = forms.CharField(max_length = 10)
     email = forms.CharField(max_length = 100)</textarea>
                <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
                <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
               </button>
               -->
  ...
  <p style="text-align:justify;" class="mt-3">Then we need an <b>ajax.py</b> file in our application: <b>myapp/ajax.py</b>. That's where is our logic, that's where we put the function that will be saving our form then return the popup −</p>
  <div class="text-left mt-1 mb-0">
    <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
  ...
  from myapp.form import ModalFormone
  ...
  def send_form(request, form):
     dajax = Dajax()
     form = ModalFormone(deserialize_form(form))
     
     if form.is_valid():
        dajax.remove_css_class('#my_form_one input', 'error')
        fr = ModalFromone()
        fr.name = form.cleaned_data.get('name')
        fr.phonenumber = form.cleaned_data.get('phonenumber')
        fr.save()
        
        dajax.alert("Form Entry %s was successfully saved." % 
  ...
  <p style="text-align:justify;" class="mt-3">Now let's create the <b>modalformone.html</b> template, which has our form −</p>
  ...
  <html>
     ...
     <body>
        ...
        <form action = "" method = "post" id = "my_form_one" accept-charset = "utf-8">
           {{ form.as_p }}
  ...
  <p style="text-align:justify;" class="mt-3">Now let us create the views.</p>
  ...
  def modalform(request):
     form = ModalFormone()
     return render(request, 'modalformone.html', locals())</textarea>
                <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
                <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
               </button>
               -->
  ...
  <p style="text-align:justify;" class="mt-3">Add the corresponding URL in myapp/urls.py −
  </p>
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
  url(r'^modalformone/', 'modalformone', name = 'modalformone'),
  </div>
  ...
  <p style="text-align:justify;" class="mt-1">Now we will try to load the Static Files.</p>
  ...
  <script src = "{% static '/static/dajax/jquery.dajax.core.js' %}"></script></textarea>
                <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
                <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
               </button>
               -->
  ...
  <p style="text-align:justify;" class="mt-3">Now let us create the javascript function for carrying out the AJAX Functionality.</p>
  <div class="text-left mt-1 mb-0">
    <form action="" method="post" target="_blank">
  ...
  <script>
  function send_form(){
        Dajaxice.myapp.send_form(Dajax.process,{'form':$('#my_form_one').serialize(true)});
     }
  </script></textarea>
                <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
                <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
  ...
  <p style="text-align:justify;" class="mt-3"> Note that you need the “jquery-1.11.3.min.js” in your static files directory, and also the jquery.dajax.core.js. To make sure all dajax static files are served under your static directory, run −
  </p>
  <div class="container p-2 mb-1" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
  python manage.py collectstatic
  </div>
  <div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
  <p style="text-align:justify;" class="mt-4"><b>Note</b> − Sometimes the jquery.dajax.core.js can be missing, if that happens, just download the source and take that file and put it under your static folder.
  </p>
  </div>
  
  
  <h5 class="text-left mt-3">The App is created,Run the App and Have Fun With AJAX.</h5>
