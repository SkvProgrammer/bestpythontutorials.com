...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Exceptions in Django - Exception Handling in Django">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="exceptions_django.php"  target="_self">Django Exceptions</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="exceptions_django.php"  target="_self" style="color:white;">Django Exceptions</a>
...
<h2 class="text-left" style="color:#a54eee;">Exception - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/exceptions_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/exceptions_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">An exception is an abnormal event or situation that leads to the failure of the program. To deal with this situation, Django uses its own exception classes and supports all core Python exceptions as well. Django core exceptions classes are defined in django.</p>

<h3 class="text-left mt-4">Django Exception Classes</h3>
...
<tr>
  ...
  <td>The base class for DoesNotExist exceptions.</td>
</tr>
<tr>
  <td>EmptyResultSet</td>
  <td>If a query does not return any result, this exception is raised.</td>
</tr>
<tr>
  <td>FieldDoesNotExist</td>
  <td>It raises when the requested field does not exist.</td>
</tr>
<tr>
  <td>MultipleObjectsReturned</td>
  <td>This exception is raised by a query if only one object is expected, but multiple objects are returned.</td>
</tr>
<tr>
  <td>SuspiciousOperation</td>
  <td>This exception is raised when a user has performed an operation that should be considered suspicious from a security perspective.</td>
</tr>
<tr>
  <td>PermissionDenied</td>
  <td>It is raised when a user does not have permission to perform the action requested.</td>
</tr>
<tr>
  <td>ViewDoesNotExist</td>
  <td>It is raised by django.urls when a requested view does not exist.</td>
</tr>
<tr>
  <td>MiddlewareNotUsed</td>
  <td>It is raised when a middleware is not used in the server configuration.</td>
</tr>
<tr>
  <td>ImproperlyConfigured</td>
  <td>The ImproperlyConfigured exception is raised when Django is somehow improperly configured.</td>
</tr>
<tr>
  <td>FieldError</td>
  <td>It is raised when there is a problem with a model field.</td>
</tr>
<tr>
  <td>ValidationError</td>
  <td>It is raised when data validation fails form or model field validation.</td>
</tr>
</tbody></table>
</div>
<h3 class="text-left mt-4">Django Database Exceptions</h3>
<div style="overflow:scroll;">
  <table class="alt">
<tbody><tr>
  <th>Exception</th>
...
<tr>
  <td>DatabaseError</td>
  <td>It occurs when the database is not available.</td>
</tr>
<tr>
  <td>IntegrityError</td>
  <td>It occurs when an insertion query executes.</td>
</tr>
<tr>
  <td>DataError</td>
  <td>It raises when data related issues come into the database.</td>
</tr>
<tr>
  <td>InterfaceError</td>
  <td>It raises when the interface is not correct.</td>
</tr>
<tr>
  <td>Error</td>
  <td>It raises normal exception.</td>
</tr>
<tr>
  <td>ProgrammingError</td>
  <td>It raises when code is wrong.</td>
</tr>
<tr>
  <td>OperationalError</td>
  <td>It raises when data operations are incorrect.</td>
</tr>
<tr>
  <td>NotSupportedError</td>
  <td>It raises when a particular object is not supported.</td>
</tr>
</tbody></table>
</div>

<h3 class="text-left mt-4">Django URL Resolver Exceptions</h3>
<div style="overflow:scroll;">
  <table class="alt">
<tbody><tr>
  <th>Exception</th>
...
<tr>
  <td>Resolver404</td>
  <td>This exception raised when the path passed to resolve() function does not map to a view.</td>
</tr>
<tr>
  <td>NoReverseMatch</td>
  <td>It is raised when a matching URL in your URLconf cannot be identified based on the parameters supplied.</td>
</tr>
</tbody></table>
</div>

<p style="text-align:justify;" class="mt-4">There are more exceptions such as Http Exception and Transaction Exceptions.You can see the <a href="" style="text-decoration:none;color:grey;">Official Documentation <img src="link.png" style="height:10px;"></a></p>
...
function next(){
  window.open("database_connectivity_django.php","_self");
}
function prev(){
