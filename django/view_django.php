...
<html lang="en-Us">
    <head>
        <title>Views in Django | View Function in Django</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="../codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="views in django"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,views in django">
  ...
  <!--vertical menu-->
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">DJANGO TUTORIAL</h4></li><br>
     <li><a href="home_django.php"  target="_self">Django Home</a></li>
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="view_django.php"  target="_self">Django View</a></li>
...
<a href="" style="border:none;color:white;"><h1 id="tag1">DJANGO TUTORIAL</h1></a>
  <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="view_django.php"  target="_self" style="color:white;">Django View</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Views in Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/view_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/django/view_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In the introductory chapter of MVT we have discussed a bit about Views.Now,In this chapter we are going to have a deep discussion on Views and how we can create views in Django.</p>
<h4 class="text-left mt-4" style=" color:#a54eee;">According to Official Documentation of Django:</h4>
<p style="text-align:justify;">A <b>view function</b>, or <b>view</b> for short, is a Python function that takes a Web request and returns a Web response. This response can be the HTML contents of a Web page, or a redirect, or a 404 error, or an XML document, or an image . . . or anything, really. The view itself contains whatever arbitrary logic is necessary to return that response. This code can live anywhere you want, as long as it’s on your Python path. There’s no other requirement–no “magic,” so to speak. For the sake of putting the code somewhere, the convention is to put views in a file called views.py, placed in your project or application directory.
</p>

<p style="text-align:justify;">Now We will try to create a simple view in Django which will display the Local Time.</p>
<div class="text-left mt-1">
    <h3 class="text-left mt-2" style=" color:#a54eee;">A Simple View</h3>
...
def current_datetime(request):
    ...
    return HttpResponse(html)</textarea>
...
<p style="text-align:justify;">I have used a lot of new terms or keywords in the above program and I think you need to gain some knowledge about these.Now we will try to understand the code.
</p>
<ul style="text-align:justify;list-style:square;">
<li>First, we imported the class <b>HttpResponse</b> from the <b>django.http</b> module, along with Python’s datetime module.
</li>
<li class="mt-2">Next, we define a function called current_datetime. This is the view function. Each view function takes an HttpRequest object as its first parameter, which is typically named request.
</li>
<li class="mt-2">
Note that the name of the view function doesn’t matter,it doesn’t have to be named in a certain way in order that Django should recognize it. We’re calling it <b>current_datetime</b> here, because that name clearly indicates what it does.
</li>
<li class="mt-2">
...
<p style="text-align:justify;">Now you need to map the url in order to get the output.You will be using the <b>urls.py</b> of the main project folder.In this example we will have to map the url but if you don't know what is URL Mapping.Don't Worry We have made another chapter for it.Click here to view but I will suggest you to go through all chapter and don't jump from one chapter to another and skipping some chapters in between.</p>

<div class="text-left mt-1">
    <h3 class="text-left mt-2" style=" color:#a54eee;">URL Mapping</h3>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<h3 class="text-left mt-4" style=" color:#a54eee;">EXPLANATION</h3>
<p style="text-align:justify;">In line 1 , We have imported the required libraries.In line 4 , We have imported our views which I have created in the <b>models.py</b> file and that was named <b>current_datetime</b>.In the List of urlpattern,we have a function named path now this function takes two parameters , the address or url and the view name.In this case it is <b>' '</b> which means these view will be the home page of our website.</p>

<h3 class="text-left mt-4" style=" color:#a54eee;">Handling Errors</h3>
<p style="text-align:justify;">Django provides help for returning HTTP error codes. There are subclasses of HttpResponse for a number of common HTTP status codes other than 200 (which means “OK”). You can find the full list of available subclasses in the request/response documentation. Return an instance of one of those subclasses instead of a normal HttpResponse in order to signify an error. For example:</p>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
def myview(request):
    if foo:
        ...
        return HttpResponse('<h1>Page was found</h1>')</textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<p style="text-align:justify;" class="mt-2">There isn’t a specialized subclass for every possible HTTP response code, since many of them aren’t going to be that common. However, as documented in the HttpResponse documentation, you can also pass the HTTP status code into the constructor for HttpResponse to create a return class for any status code you like.</p>
<p style="text-align:justify;">To Read more about views , <a href="" style="text-decoration:none;color:grey;">Click Here <img src="link.png" style="height:10px;width:10px;"></a></p> 
<!-------------------------------CONTENT----------------------------->
</div>
...
function next(){
  window.open("template_django.php","_self"); 
}
function prev(){
  window.open("model_django.php","_self");
}
