...
<html lang="en-Us">
    <head> 
        <title>Generic Views - Django</title>
        <meta charset="utf-8">
...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Creating Generic Views in Django - Generic Views in Django">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="generic_views_django.php"  target="_self">Generic Views</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="generic_views_django.php"  target="_self" style="color:white;">Generic Views</a>
...
<h2 class="text-left" style="color:#a54eee;">Generic Views - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/generic_views_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/generic_views_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In this chapter we are going to learn about the Generic Views in Django.In the previous chapters we have focused on MVT and now in this chapter we will be looking forward to learn the concept of Generic Views.</p>

<p style="text-align:justify;">In many situation writing views is a very tough task especially when working on a large app.Now Django solved this problem by introducing <b>Generic Views</b> which are classes not Function and thatswhy often called <b>class-based views.Django offers a set of classes for generic views in django.views.generic, and every generic view is one of those classes or a class that inherits from one of them.</b></p>

<h3 class="text-left mt-4">Genric Classes List</h3>
...
<p style="text-align:justify;">You don't need to remember all the classes but you may have to use many of the in different scenarios.Now we will see an example where we  will run a static page in the server by what we normally do and in the next method we will see how to run a static page using class-based views or generic views.</p>

<h3 class="text-left mt-4">EXAMPLE</h3>
<P style="text-align:justify;" class="
mb-0">Here we have a static page called index.html</P>
...
<p style="text-align:justify;">Now we will try to learn this static page by the normal technique or you can say what we will be normally doing.To do this we have to modify the <b>views.py</b> and <b>urls.py</b> file.</p>
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0">views.py</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
def static(request):
   return render(request, 'index.html', {})</textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0">urls.py</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
urlpatterns = patterns("yourapp.views", url(r'^static/', 'static', name = 'static'),)</textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<p style="text-align:justify;" class="mt-3">But we have done a lot for getting a simple output.Now what should we do.We can also do the same in very less steps.After using generic views , views.py file looks like:</p>
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0">views.py</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p style="text-align:justify;">So in this way you can use generic classes.</p>
...
function prev(){
  window.open("creating_views_django.php","_self");
}
