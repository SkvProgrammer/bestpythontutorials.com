...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="../codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="MVT in django"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,MVT in Django,model view tempate in django">
  ...
  <!--vertical menu-->
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">DJANGO TUTORIAL</h4></li><br>
     <li><a href="home_django.php"  target="_self">Django Home</a></li>
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="mvt_django.php"  target="_self">Django MVT</a></li>
...
<a href="" style="border:none;color:white;"><h1 id="tag1">DJANGO TUTORIAL</h1></a>
  <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="mvt_django.php"  target="_self" style="color:white;">Django MVT</a>
...
<p style="text-align:justify;" class="mt-4">Django is based on <b>MVT (Model-View-Template)</b> architecture. MVT is a software design pattern for developing a web application.Although Django follows MVC pattern but maintains its own conventions. So, control is handled by the framework itself.

There is no separate controller and complete application is based on Model View and Template. That?s why it is called MVT application.</p>
<p style="text-align:justify;">It has three main components Model,View and Controller.Let's dive into some more details of these components.</p>
<p style="text-align:justify;">See the following graph that shows the MVT based control flow.</p>
<img src="mvt2.png" class="img-fluid mt-3 mb-3">

<p style="text-align:justify;">Django MVT based control flow
</p>
<p style="text-align:justify;">Here, a user requests for a resource to the Django, Django works as a controller and check to the available resource in URL.
</p>
...
<h3 class="text-left mt-4" style="color:#a54eee;">Model</h3>
<p style="text-align:justify;">Models are responsible for managing data or you can it is used to handle databases.It is the logical data structure behind the entire application and is represented by a database (generally relational databases such as MySql, Postgres)</p>
<h3 class="text-left mt-4" style="color:#a54eee;">Views</h3>
<p style="text-align:justify;">Views are actually the User Interface i.e. what we see in our web pages.It is represented by HTML/CSS/Javascript and Jinja files.UI is what you see in your browser when you render a website.</p>
<h3 class="text-left mt-4" style="color:#a54eee;">Templates</h3>
<p style="text-align:justify;">The Template is a presentation layer which handles User Interface part completely.It consists of static parts of the desired HTML output as well as some special syntax describing how dynamic content will be inserted</p>
