...
<html lang="en-Us">
    <head>
        <title>Templates in Django</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="../codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="templates in django"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,templates in django">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
       <img src="djangobannertwo.png" class="ml-auto mr-auto img-fluid mt-3 mb-3 text-center" style="width:100%;height:190px;">
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">DJANGO TUTORIAL</h4></li><br>
     <li><a href="home_django.php"  target="_self">Django Home</a></li>
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="template_django.php"  target="_self">Django Template</a></li>
      <li><a href="url_mapping_django.php"  target="_self">URL Mapping</a></li>
      <li><a href="apache_setup_django.php"  target="_self">Apache Setup</a></li>
      ...
      <li><a href="migrations_django.php">Migrations</a></li>
    </ul>
...
<a href="" style="border:none;color:white;"><h1 id="tag1">DJANGO TUTORIAL</h1></a>
  <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="template_django.php"  target="_self" style="color:white;">Django Template</a>
      <a href="url_mapping_django.php"  target="_self">URL Mapping</a>
      <a href="apache_setup_django.php"  target="_self">Apache Setup</a>
      ...
      <a href="migrations_django.php">Migrations</a>
  </div>
</div>
</div>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Templates in Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/template_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/django/template_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<a style="background-color:orangered;color:white;border-radius:1px;padding:1px;font-size:15px;" class="col-lg-3 col-sm-3 col-md-3 mb-1" id="facebookshare" onclick="languagedisplay()">   <i class="fa fa-language"></i>Language </a></button>
...
<p style="text-align:justify;" class="mt-4">Django provides a convenient way to generate dynamic HTML pages by using its template system.</p>
<p style="text-align:justify;">
A template consists of static parts of the desired HTML output as well as some special syntax describing how dynamic content will be inserted.</p>
...
<h3 class="text-left mt-4" style="color:#a54eee;">Why we need to use Templates?</h3>
<p style="text-align:justify;">HTML is a markup language and hence we can't write Python code in it.So Django provides a Django Templeate engine which support Django Template language and due to this we can use Python code in an <code>.html</code> file.</p>
<p style="text-align:justify;">Django Template Engine is used to separate the design from the python code and allows us to build dynamic web pages.</p>

<h3 class="text-left mt-4" style="color:#a54eee;">Configuration</h3>
<p style="text-align:justify;">Templates engines are configured with the TEMPLATES setting. It’s a list of configurations, one for each engine. The default value is empty. The <b>settings.py</b> generated by the <code>startproject</code> command defines a more useful value:</p>
...
TEMPLATES = [  
    {  
        ...
        'DIRS': [os.path.join(BASE_DIR,'templates')],#template directory location  
        'APP_DIRS': True,  
        'OPTIONS': {  
            'context_processors': [  
...
<p style="text-align:justify;">BACKEND is a dotted Python path to a template engine class implementing Django’s template backend API. The built-in backends are <b>django.template.backends.django.DjangoTemplates</b> and <b>django.template.backends.jinja2.Jinja2</b>.
</p>
<p style="text-align:justify;">
...
<p style="text-align:justify;">OPTIONS contains backend-specific settings.</p>


<h3 class="text-left mt-4" style="color:#a54eee;">EXAMPLE</h3>
<p style="text-align:justify;">First of all in the project folder create a folder called <b>templates</b> where you will have to put all your <code>.html</code> files i.e the templates.Now the second step is to create a file called <code>index.html</code>,index named files are regarded as the home page file.Now write some HTML code in it.</p>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<body>  
<h1>Welcome to BestPythonTutorials.com</h1>  
</body>  
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<h3 class="text-left mt-4" style="color:#a54eee;">Loading the Template</h3>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
def index(request):  
   ...
   return HttpResponse(template.render()) </textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<p style="text-align:justify;" class="mt-2 mb-0">Don't forget to map the URL:</p>
<div class="container" style="background-color:#f2f2f2;text-align:justify;border:2px solid lightgrey;">
  urlpatterns = [<br>
     path('',views.index)<br>
  ]
</div>
<h3 class="text-left mt-4" style="color:#a54eee;">Registering the App</h3>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<h3 class="text-left mt-4" style="color:#a54eee;">Running the Server</h3>
<div class="container" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
  python manage.py runserver
</div>

<h3 class="text-left mt-4" style="color:#a54eee;">Django Template Language</h3>
<p style="text-align:justify;">Django Template Language is not exactly similar to python.It has some difference.A template is rendered with a context which is used to get value at a web page.</p>
<p style="text-align:justify;">In Django Template Language we put the code inside double curly brackets {{ }}.</p>

<h3 class="text-left mt-4" style="color:#a54eee;">EXAMPLE</h3>
<div class="text-left mt-1">
  <h5 style="text-align:left;">views.py</h5>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
def index(request):  
    ...
    return HttpResponse(template.render(name)) </textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<h5 style="text-align:justify;color:#a54eee;" class="mt-3 mb-1">Modifying the <b>index.html</b> file</h5>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<img src="output_variables.png" class="img-fluid" style="border:1px solid black;">

<h3 class="text-left mt-4" style="color:#a54eee;">More About Template Language</h3>
<p style="text-align:justify;">In a template, Tags provide arbitrary logic in the rendering process. For example, a tag can output content, serve as a control structure e.g. an "if" statement or a "for" loop, grab content from a database etc.
</p>
<p style="text-align:justify;">
Tags are surrounded by {% %} braces. For example.</p>
<div class="container" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
  {% csrf_token %}<br><br> 
  
{% if user.is_authenticated %}<br>  
    <xf style="margin-left:20px;">Hello {{ user.username }} , you are logged in</xf>  <br>
{% endif %} <br>
</div>
<!-------------------------------CONTENT----------------------------->
</div>
...
<!-----------------------------------MODAL ENDS------------------------->
      ...
      <footer style="height:auto;background-image:linear-gradient(75deg,#a54eee,#4537d1);font-family: 'Roboto', sans-serif!important;" class="text-center container-fluid pt-5" id="foot"> 
             ...
             <ul style="list-style:none;color:white;" id="footlink" class="mt-5 col-lg-6 col-md-12 col-sm-12">
               ...
               <li><a href="mailto:contact@bestpythontutorials.com"> Write articles for us</a></li>
               ...
               <li><a href="../mysql/home_mysql.php">Share our Tutorials</a></li>
               <li><a href="../home_mongodb">Finally Keep Visiting our site</a></li>  
...
function prev(){
  window.open("view_django.php","_self");
}
