...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="../codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Introduction to Django - Django Tutorials - Learn Django"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,introduction to django">
  ...
  <!--vertical menu-->
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">DJANGO TUTORIAL</h4></li><br>
     <li><a href="home_django.php"  target="_self">Django Home</a></li>
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="intro_django.php"  target="_self">Introduction</a></li>
...
<a href="" style="border:none;color:white;"><h1 id="tag1">DJANGO TUTORIAL</h1></a>
  <a href="home_django.php"  target="_self">Django Home</a>
      <a href="intro_django.php"  target="_self" style="color:white;">Introduction</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Introduction to Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/intro_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/django/intro_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<ul style="text-align:justify;">
  <li>Django is an versatile and scalable Web Framework.</li>
  <li>Django Provides an in-built admin interface which is really awesome.</li>
  <li>Django supports Rapid Development. </li>
  <li>It has thousands of additional packages available.</li>
  <li>Django is an open source web application framework. It is publicly available without cost.</li>
</ul>
<h3 class="text-left mt-4" style="color:#a54eee;">Where Django is used?</h3>
<p style="text-align:justify;">Django is used in many popular sites like as: Disqus, Instagram, Knight Foundation, MacArthur Foundation, Mozilla, National Geographic etc. There are more than 5k online sites based on the Django framework. ( Source )</p>

<p style="text-align:justify;">In the next chapter we will learn about Virtual Environment and installing django in our Computer.</p>
...
function prev(){
  window.open("home_django.php","_self");
}
