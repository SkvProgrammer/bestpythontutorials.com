...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="../codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Models in django"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,models in django">
  ...
  <!--vertical menu-->
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">DJANGO TUTORIAL</h4></li><br>
     <li><a href="home_django.php"  target="_self">Django Home</a></li>
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="model_django.php"  target="_self">Django Model</a></li>
...
<a href="" style="border:none;color:white;"><h1 id="tag1">DJANGO TUTORIAL</h1></a>
  <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="model_django.php"  target="_self" style="color:white;">Django Model</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Models in Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/model_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/django/model_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In the previous chapter we have learned about MVT structure and had some brief introduction to Models , Views and Controllers in Django.Now in this chapter we will go more deep into the Models and see how we can create models in django.</p>
<p style="text-align:justify;">Models are nothing but widgets like textfield , password field , Checkbox and a lot.Django Model is a subclass of <b>django.db.models.Model</b> and each field of the model class represents a database field (column).
</p>
        <script type="text/javascript">
  atOptions = {
...
<p style="text-align:justify;">Models are defined in the <b>models.py</b> file in the app of your project folder.</p>
 <div class="text-left mt-1">
    <h3 class="text-left mt-2" style="text-align:left;color:#a54eee;">Creating a Model</h3>
...
class Student(models.Model):  
    ...
    roll_no = models.CharField(max_length=2)  </textarea>
...
<p style="text-align:justify;" class="mt-2">The above model will create the following code in the databases engine.By default it is SQLite but again you can use any database from MySQL to Oracle.</p>
 <div class="text-left mt-1">
    <h3 class="text-left mt-2" style="text-align:left;color:#a54eee;">Database</h3>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<h3 class="text-left mt-4" style="text-align:left;color:#a54eee;">How to Register Models</h3>
<p style="text-align:justify;">After creating models you have to register them in the <b>INSTALLED_APP</b> tuple of <b>settings.py</b></p>
 <div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
INSTALLED_APPS = (  
    #apps  
    'app_name',#model is inside this app  
    #apps 
) </textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<h3 class="text-left mt-4" style="color:#a54eee;">Django Model Fields
</h3>
<p style="text-align: justify;">The fields defined inside the Model class are the columns name of the mapped table. The fields name should not be python reserve words like clean, save or delete etc.
</p>
<p style="text-align:justify;">
...
<tr>
  ...
  <td>It is a 64-bit integer, much like an AutoField except that it is guaranteed to fit numbers from 1 to 9223372036854775807.</td>
</tr>
<tr>
    <td>BigIntegerField</td>
    <td>class BigIntegerField(**options)</td>
  <td>It is a 64-bit integer, much like an IntegerField except that it is guaranteed to fit numbers from -9223372036854775808 to 9223372036854775807.</td>
</tr>
<tr>
    <td>BinaryField</td>
...
<tr>
    <td>DateTimeField</td>
    <td>class DateTimeField(auto_now=False, auto_now_add=False, **options)</td>
  <td>It is used for date and time, represented in Python by a datetime.datetime instance.</td>
</tr>
<tr>
    <td>DecimalField</td>
    <td>class DecimalField(max_digits=None, decimal_places=None, **options)</td>
  <td>It is a fixed-precision decimal number, represented in Python by a Decimal instance.</td>
</tr>
<tr>
    <td>DurationField</td>
...
<tr>
    <td>ImageField</td>
    <td>class ImageField(upload_to=None, height_field=None, width_field=None, max_length=100, **options)</td>
  <td>It inherits all attributes and methods from FileField, but also validates that the uploaded object is a valid image.</td>
</tr>
<tr>
    <td>IntegerField</td>
    <td>class IntegerField(**options)</td>
  <td>It is an integer field. Values from -2147483648 to 2147483647 are safe in all databases supported by Django.</td>
</tr>
<tr>
...
<tr>
  ...
  <td>Like an IntegerField, but must be either positive or zero (0). Values from 0 to 2147483647 are safe in all databases supported by Django.</td>
</tr>
<tr>
    <td>SmallIntegerField</td>
    <td>class SmallIntegerField(**options)</td>
  <td>It is like an IntegerField, but only allows values under a certain (database-dependent) point.</td>
</tr>
<tr>
    <td>TextField</td>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Field Options
</h4>
<p style="text-align:justify;">
Each field requires some arguments that are used to set column attributes. For example, CharField requires <code>mac_length</code> to specify varchar database.
</p>
<p style="text-align:justify;">
...
<tr>
    <td>Choices</td>
    <td>An iterable (e.g., a list or tuple) of 2-tuples to use as choices for this field.</td>
</tr>
<tr>
    <td>Default</td>
...
function prev(){
  window.open("mvt_django.php","_self");
}
