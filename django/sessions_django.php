...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Sessions in Django - Django Sessions">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="sessions_django.php"  target="_self">Django Sessions</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="sessions_django.php"  target="_self" style="color:white;">Django Sessions</a>
...
<h2 class="text-left" style="color:#a54eee;">Sessions - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/sessions_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/sessions_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">If you fluently browse the internet,you might have visited a lot sites in the web.So do they represent some most common things.Yes mostly all of them have User Authentication System i.e. the famous Login and Logout System.This system is generally based on Sessions in different programming languages or frameworks.In this chapter we will see a simple example of how sessions work in Django and how to implement them.</p>
<p style="text-align:justify;">Django provides built-in support for cookie handling cookies are nothing but data which is stored in our computer while we open a site and it helps the site to remember the user.In order to do this you first need to modify the <B>INSTALLED_APPS</B> and <b>MIDDLEWARE_CLASSES</b>.</p>

<p style="text-align:justify;" class="mb-0">Your <B>MIDDLEWARE_CLASSES</B> should contain this:</p>
<div class="container" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
  'django.contrib.sessions.middleware.SessionMiddleware'
</div>

<p style="text-align:justify;" class="mb-0 mt-3">Your <b>INSTALLED_APPS</b> should contain this:</p>
<div class="container" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
  'django.contrib.sessions'
</div>
<p style="text-align:justify;" class="mt-3">By default, Django saves session information in database (django_session table or collection), but you can configure the engine to store information using other ways like: in <b>file</b> or in <b>cache</b>.

<p style="text-align:justify;">In order to grab this concept of sessions we will be designing a simple login form and will print the name of user when logged in and if logged out it will print the logged out message.</p>
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0 text-center">Basic Login System Design</p>
...
def login(request):
   ...
   return render(request, 'loggedin.html', {"username" : username}</textarea>
...
<p style="text-align:justify;">Now let us create UserFormView view for the login form, where we won’t display the <i>form</i> if the cookies is set −
</p>
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0 text-center">The View's Part</p>
  <form action="" method="post" target="_blank">
...
def UserFormView(request):
   if request.session.has_key('username'):
      ...
      return render(request, 'login.html', {})</textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<p style="text-align:justify;">Now the last step is to map the URL in the <b>urls.py</b> file</p>
...
urlpatterns = patterns('yourapp.views',
   url(r'^connection/','UserFormView', name = 'loginform'),
   url(r'^login/', 'login', name = 'login'))</textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<p style="text-align:justify;">We have successfully made the Login system but we haven't added the Logout Functionality to add the Logout Functionality add the below code.</p>
<div class="text-left mt-0 mb-1">
  <form action="" method="post" target="_blank">
...
def logout(request):
   try:
      ...
      pass
   return HttpResponse("<strong>You are logged out.</strong>")</textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<p style="text-align:justify;">Don't forget to map the url.</p>
...
function next(){
  window.open("ajax_django.php","_self");
}
function prev(){
