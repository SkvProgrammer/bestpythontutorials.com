...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Migrations in Django - Migrate Databases in Django">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="migrations_django.php" target="_self">Migrations</a></li>
...
<h2 class="text-left" style="color:#a54eee;">Migrations - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/migrations_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/migrations_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Migrations is way of applying all the changes made in the models into the Database Schema.Migrating generates the migration file which creates table in the database and maps models into the database.</p>
<p style="text-align:justify;">There are some commands available to migrate the models , You can easily learn them:</p>
<ul style="text-align:justify;">
<li><b>makemigrations</b> : It is used to create a migration file that contains code for the tabled schema of a model.
<li><b>migrate</b> : It creates table according to the schema defined in the migration file.
<li><b>sqlmigrate</b> : It is used to show a raw SQL query of the applied migration.
<li><b>showmigrations</b> : It lists out all the migrations and their status.
</ul>
