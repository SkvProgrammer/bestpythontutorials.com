...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Bootstrap in Django - RWD Django">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="bootstrap_django.php"  target="_self">Django Bootstrap</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="bootstrap_django.php"  target="_self" style="color:white;">Django Bootstrap</a>
...
<h2 class="text-left" style="color:#a54eee;">Bootstrap - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/bootstrap_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/bootstrap_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Bootstrap is a Frontend Framework for Creating UI of Websites.It is one of the most popular Framwork based on HTML , CSS and JavaScript.We have made awesome tutorial for Bootstrap.<a href="../bootstrap/home_bootstrap.php" style="color:grey;text-decoration:none;">Click here to View <img src="link.png" class="img-fluid" style="height:10px;"></a> </p>

<p style="text-align:justify;">Now in order to use bootstrap in your Django Application you first need to install or download Bootstrap i.e. you have to host Bootstrap.<a href="https://getbootstrap.com/" style="text-decoration:none;color:grey;">Click here to Download <img src="link.png" style="height:10px;"></a></p>
<p style="text-align:justify;">Now after downloading and extracting you will get two folder as show in the screenshot below.This are files you need.</p>
<img src="file_explorer.png" class="img-fluid">

<p style="text-align:justify;">As you know that the stylesheets i.e. the css and bootstrap files are static file which should be stored in the <b>static</b> folder of your project created in Django.It will be like <b>Project Folder - Static - CSS - All Bootstrap files of Js and CSS folder as shown in the image.</b></p>
<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4">You need to put the files not the directory you got after extraction of bootstrap download.</p>
</div>

<p style="text-align:justify;" class="mt-3">Now the next step is obviously creating a project,app and loading the template.We will be directly jumping into the loading template topic.</p>

<h3 class="text-left mt-4">Loading Template</h3>
<p style="text-align:justify;">Now we will be loading the template i.e. the HTML file where you will make the design.In this example we will be designing simple buttons as it's easy to distinguish between normal buttons and the button created using bootstrap classes.</p>
...
<body>    
  ...
  <button type="submit" class="btn btn-primary">Submit 3</button>   
</body>  
</html></textarea>
...
<p style="text-align:justify;" class="mt-3">In order to see the difference we will first make the template without bootstrap classes and the second we will make using bootstrap classes.</p>
<h3 class="text-left mt-3">Output of the above code</h3>
<img src="output_buttons2.jpg" class="img-fluid mb-3" style="border:1px solid black;">
<div class="text-left mt-1 mb-0">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p style="text-align:justify;">Now we will make the above program using bootstrap and we can clearly see the difference.</p>
<h3 class="text-left mt-3">Output of the above code</h3>
<img src="output_buttons3.png" class="img-fluid mb-3" style="border:1px solid black;">
...
function next(){
  window.open("exceptions_django.php","_self");
}
function prev(){
  window.open("hashing_django.php","_self");
}
