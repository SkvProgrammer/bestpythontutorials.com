...
<html lang="en-Us">
    <head> 
        <title>Creating Views - Django</title>
        <meta charset="utf-8">
...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Creating Views in Django - Views in Django">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="creating_views_django.php"  target="_self">Creating Views</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="creating_views_django.php"  target="_self" style="color:white;">Creating Views</a>
...
<h2 class="text-left" style="color:#a54eee;">Creating Views - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/creating_views_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/creating_views_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In the Previous Chapters We have learned about the MVT Pattern and have discussed the three component in depth.But till now we haven't created any large view.So,In this chapter we are going to create some awesome views.</p>

<p style="text-align:justify;">In this chapter we are actually going to build some useful views which will help you to grab the concept of views in Django.What are views - We have already discussed and I don't think I need to again cover it.</p>
...
def weather(request):
   text = """<h1>Today's Weather will be great</h1>"""
   return HttpResponse(text)</textarea>
...
<h3 class="text-left mt-4">EXPLANATION</h3>
<p style="text-align:justify;">This view is not great but tells us about the weather forecast.Now What this program depict.In this program we have used HttpResponse which is nothing but renders html output in the browser.So this chapter is over.This was just to make you comfortable with the views in the MVT.</p>
