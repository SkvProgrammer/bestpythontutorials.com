...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Forms in Django - Django Form Handling">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="forms_django.php"  target="_self">Django Forms</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="forms_django.php"  target="_self" style="color:white;">Django Forms</a>
...
<h2 class="text-left" style="color:#a54eee;">Forms - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/forms_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/forms_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<div class="text-left mt-1 mb-1">
  <p style="text-align:justify;" class="mb-1">Now we will make a simple form using Django.</p>
...
class StudentForm(forms.Form):  
    ...
    age  = forms.CharField(label="Enter your age:", max_length = 2)  </textarea>
  ...
  <div class="container-fluid mt-4 pt-2 pb-2" style="background-color:#ffffcc;">
<p style="text-align:justify;" class="mt-4">The above code will generate an HTML form when rendered in any browser.Remember that you can't create buttons using django's form API so you have to include buttons in your template itself.</p>
</div>

<h3 class="text-left mt-4">Buidling a Simple Form</h3>
<div class="text-left mt-1 mb-1">
  <p style="text-align:justify;" class="mb-1">Now we will make a simple form using Django.</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p style="text-align:justify;" class="mt-3">Setting up <b>index.html</b> and <b>urls.py</b> file.</p>

<p class="text-center mb-0">index.html</p>
...
<p class="text-center mb-0 mt-4">urls.py</p>
<div class="text-left mt-0 mb-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p style="text-align:justify;" class="mt-4">Now run the server to see the output of the above program.</p>
<img src="output_forms.jpg" class="img-fluid" style="border:1px solid black;">
<p style="text-align:justify;" class="mt-4">There are other output options though for the &lt;label&gt;/&lt;input&gt; pairs:

<ul style="text-align:justify;list-style:square;" class="mt-4">
<li>{{ form.as_table }} will render them as table cells wrapped in &lt;tr&gt; tags
<li>{{ form.as_p }} will render them wrapped in &lt;p&gt; tags
<li>{{ form.as_ul }} will render them wrapped in &lt;li&gt; tags
</ul>
</p>
...
function next(){
  window.open("form_validation_django.php","_self");
}
function prev(){
