...
<html lang="en-Us">
    <head>
        <title>Environment Setup in Django</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="../codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Environment Setup in Django - BestPythonTutorials.com"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,environment setup in django">
  ...
  <!--vertical menu-->
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">DJANGO TUTORIAL</h4></li><br>
     <li><a href="home_django.php"  target="_self">Django Home</a></li>
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="environment_setup_django.php"  target="_self">Environment Setup</a></li>
...
<a href="" style="border:none;color:white;"><h1 id="tag1">DJANGO TUTORIAL</h1></a>
  <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="environment_setup_django.php"  target="_self" style="color:white;">Environment Setup</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Environment Setup in Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/environment_setup_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/django/environment_setup_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In Previous Chapter you have seen how to install virtual environment in Python.Now in this chapter you will see how to install django using Python's Pip package manager inside an virtual environment called <b>test</b>.</p>
<h3 class="text-left mt-4" style="color:#a54eee;">Installing Django</h3>
<p style="text-align:justify;" class="mb-0">Activating Virtual Environment</p>
<div class="container text-left p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;">workon test</div>
<p style="text-align:justify;" class="mb-0 mt-4">command to install django</p>
<div class="container text-left p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;">pip install django</div>
<p style="text-align:justify;" class="mb-0 mt-4">command to install django specific version</p>
<div class="container text-left p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;">pip install django == 2.0.2</div>

<h3 class="text-left mt-4" style="color:#a54eee;">Verify Installation</h3>
<div class="container text-left p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;"> >>> import django<br>
>>> print(django.__version__)<br>
2.0.2<br>
>>>
</div>
<p style="text-align:justify;" class="mt-4">In the next chapter we will how to create a project in django.</p>
...
function prev(){
  window.open("virtual_env_django.php","_self");
}
