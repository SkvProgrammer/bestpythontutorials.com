...
<html lang="en-Us">
    <head> 
        <title>CRUD App and Operations - Django</title>
        <meta charset="utf-8">
...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="CRUD in Django - Database CRUD Applications">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="crud_django.php"  target="_self">Django CRUD</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="crud_django.php"  target="_self" style="color:white;">Django CRUD</a>
...
<h2 class="text-left" style="color:#a54eee;">CRUD Django - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/crud_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/crud_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">CRUD stands for Create Read Update Delete.In computer programming, create, read, update, and delete are the four basic functions of persistent storage.Now in simple language it is nothing but some operation of Database.</p>


<!------------------------------ADs------------------------------>
<div class="container mb-3 mt-3 text-center" style="height:20vh;width:100%;"></div>
<!-------------------------------ADS------------------------------>



<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4">Please note that may people used to say that CRUD is Create Retrieve Update Delete but Don't confuse Retrieve and Read mean the same.</p>
</div>


<h3 class="text-left mt-4">Setting up an App for CRUD Applications</h3>
<p style="text-align:justify;">For this chapter you will some Database Management System.So I recommend you to use <a href="https://www.apachefriends.org/download.html" style="text-decoration:none;color:grey;" target="_blank">XAMPP<img src="link.png" class="img-fluid" style="height:10px;"></a>,Which I think is easy to use.It provides MySQL Database and PhpMyAdmin for Admin stuffs of Databases such as creating database and tables.</p>

<h4 class="text-left mt-4">Creating a Project and an App</h4>
<p style="text-align:justify;">Now we will create a simple project and an app which contains a form to take the inputs from the user and perform CRUD Applications.</p>
...
<p style="text-align:justify;" class="mt-2 mb-0">Now we will create an app in the crud_app project for CRUD Applications</p>
 <div class="container" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
python manage.py startapp crud_demo
</div>

<p style="text-align:justify;" class="mt-4">If your are with us from the beginning then the folder structure will be easy to grab for you So I am not going to cover it again.It's on you  like an homework.</p>
<p style="text-align:justify;">Now can you guess the next step , the next step is setting up the database in the <b>settings.py</b> file in <i>our project folder</i> and modify the set named <b>DATABASES</b></p>

<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0 text-center">settings.py</p>
...
<p style="text-align:justify;">You can see that we are using the MySQL Database and I recommend you to use the same but it's totally on you that what you want to use.</p>

<p style="text-align:justify;">Till now we have done few thing So our next step will be modifying or creating the views,models and templates.</p>
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0 text-center">models.py</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p style="text-align:justify;" class="mt-4">Now we will create the form which we will be using to take the inputs.</p>
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0 text-center">forms.py</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p style="text-align:justify;" class="mt-4">Now we will modify the <b>views.py</b> file</p>
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0 text-center">views.py</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
def destroy(request, id):  
    student = student.objects.get(id=id)  
    student.delete()  
    return redirect("/display") </textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<h3 style="text-align:justify;" class="mt-4">URL Mapping</h3>
<p style="text-align:justify;">Now we will try to map the url for running the above app in the server</p>
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0 text-center">urls.py</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p style="text-align:justify;" class="mt-3">Now the last steps are organizing the templates and finally running the server to get the output.So we will have to design 3 html pages - index.html , edit.html , and display.html</p>
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0 text-center">index.html</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0 text-center">display.html</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
{% for student in students %}  
    <tr>  
        ...
        <td>  
            <a href="/edit/{{ employee.roll_no }}"><span class="glyphicon glyphicon-pencil" >Edit</span></a>  
            <a href="/delete/{{ employee.roll_no }}">Delete</a>  
        </td>  
    </tr>  
{% endfor %}  
    </tbody>  
...
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0 text-center">edit.html</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<body>  
<form method="POST" class="post-form" action="/update/{{employee.roll_no}}">  
        {% csrf_token %}  
    <div class="container">  
<br>  
    <div class="form-group row">  
  ...
  <div class="form-group row">  
    ...
    <div class="col-sm-4">  
        <input type="text" name="ename" id="name" required maxlength="100" value="{{ student.name }}" />  
    </div>  
  </div>  
    <div class="form-group row">  
    <label class="col-sm-2 col-form-label">Roll Number:</label>  
    <div class="col-sm-4">  
        <input type="email" name="roll" id="roll" required maxlength="254" value="{{ student.roll }}" />  
    </div>  
  </div>  
    <div class="form-group row">  
    <label class="col-sm-1 col-form-label"></label>  
    <div class="col-sm-4">  
    <button type="submit" class="btn newcolorbtn">Update</button>  
    </div>  
  </div>  
    </div>  
</form>  
...
<p style="text-align:justify;" class="mt-4">Now register your app in the INSTALLED_APPS Tuple of <b>settings.py</b> file.Then Migrate and run the server to see the output</p>
<div class="text-left mt-0 mb-1">
  <p style="text-align:left;" class="mt-0 mb-0 text-center">settings.py</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
mt-4">Now we will migrate the database.</P>
<div class="container" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
...
<p style="text-align:justify;" class="mt-3">We have completed the app development now enjoy and experiment.</p>
...
function next(){
  window.open("sessions_django.php","_self");
}
function prev(){
  window.open("response_request_django.php","_self");
}
