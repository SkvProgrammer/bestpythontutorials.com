...
<html lang="en-Us">
    <head> 
        <title>Database Connectivity - Django</title>
        <meta charset="utf-8">
...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Database Connectivity in Django - Databases in Django">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="database_connectivity_django.php"  target="_self">Database Connectivity</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="database_connectivity_django.php"  target="_self" style="color:white;">Database Connectivity</a>
...
<h2 class="text-left" style="color:#a54eee;">Database Connectivity - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/database_conectivity_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/database_conectivity_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Django officially supports the following databases but with the use of third parties you can integrate a number of Databases.</p>
...
<p style="text-align:justify;">Django by default uses <b>SQLite</b> as it's database but in this chapter we are going to use the MySQL Database.To use it we need to make some changes in the <b>DATABASES</b> list in the <b>settings.py</b> file as shown below:</p>
...
<p style="text-align:justify;" class="mt-3">Now we need to migrate the Database.</p>
<div class="container" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">python manage.py migrate</div>


<h3 class="text-left mt-4">EXAMPLE</h3>
<p style="text-align:justify;" class="mb-1">Now we will see an Example of using MySQL database in Django.</p>

<h4 class="text-left mt-2">Migrating Models</h4>
...
<p style="text-align:justify;" class="mt-4">Now migrate the database and see the migration file created in the migrations folder,It will look like the below file</p>
<div class="text-left mt-1 mb-0">
...
<p style="text-align:justify;">Now we have established a connection with a table called <b>student</b> to our Django's Web Application.</p>
...
function next(){
  window.open("migrations_django.php","_self");
}
function prev(){
