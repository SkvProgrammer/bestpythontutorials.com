...
<html lang="en-Us"> 
    <head>
        <title>Django Tutorials - BestPythonTutorials.com</title>
        <meta charset="utf-8">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">DJANGO TUTORIAL</h4></li><br>
     <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="home_django.php"  target="_self">Django Home</a></li>
...
<a href="" style="border:none;color:white;"><h1 id="tag1">DJANGO TUTORIAL</h1></a>
  <a href="home_django.php"  target="_self" style="color:white;">Django Home</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Django Tutorials</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/home_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/django/home_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<h2 style="text-align:center;color:#a6a6a6;" class="mt-4">PRE-REQUISITES</h2>
<p style="text-align:justify;">The only prerequisites of this course is having the basic knowledge of <a href="../home.php" style="color:grey;text-decoration:none;">Python Programming Language <img src="link.png" style="height:10px;"></a> and some OOPs Concept in Python.But if you don't know how to start then check out our <a href="../home.php" style="color:grey;text-decoration:none;">Python Tutorial Series <img src="link.png" style="height:10px;"></a>.</p>
<h2 style="text-align:center;color:#a6a6a6;" class="mt-4">AUDIENCE</h2>
<p style="text-align:justify;">This course is made for beginners as well as working professionals to learn Django from starting to end with very easy to understand language used.Django is a good web framework for developing Powerful Web Application.</p>
