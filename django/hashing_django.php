...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Hashing in Django - Django Hashing">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="hashing_django.php"  target="_self">Django Hashing</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="hashing_django.php"  target="_self" style="color:white;">Django Hashing</a>
...
<h2 class="text-left" style="color:#a54eee;">Hashing - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/hashing_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/hashing_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4"><b>Hashing</b> is the process of converting a string into encrypted form.It is used to make passwords more secure.Django's make_password (source code) function converts a plain-text password into a hash that is appropriate for storing in a persistent database. You definitely do not want to try to roll your own encryption and hashing functions for storing passwords when this function already exists.</p>

<h3 style="text-align:justify;" class="mt-4">Password Management</h3>
<p style="text-align:justify;">Password management is something that should generally not be reinvented unnecessarily, and Django endeavors to provide a secure and flexible set of tools for managing user passwords. This document describes how Django stores passwords, how the storage hashing can be configured, and some utilities to work with hashed passwords.</p>

<h3 style="text-align:justify;" class="mt-4">Hashing Alogorithms</h3>
<p style="text-align:justify;">Django provides us some useful Hashing Algorithms to hash passwords some of them are:By default, Django uses the PBKDF2 algorithm with a SHA256 hash, a password stretching mechanism recommended by NIST. This should be sufficient for most users: it's quite secure, requiring massive amounts of computing time to break.</p>
<p style="text-align:justify;">We can also use algorithms like bcrypt and Argon2 for hashing passwords in Django.There are many more algorithms such as:</p>
...
class MyPBKDF2PasswordHasher(PBKDF2PasswordHasher):
    ...
    """
    iterations = PBKDF2PasswordHasher.iterations * 100</textarea>
...
<p style="text-align:justify;" class="mt-3">You have to save this file in your main project folder such as <b>myproject/hashing.py</b></p>

<div class="text-left mt-1 mb-0">
  <p style="text-align:justify;" class="mb-1">2.Add your new hasher as the first entry in PASSWORD_HASHERS:</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p style="text-align:justify;" class="mt-3">That’s it – now your Django install will use more iterations when it stores passwords using PBKDF2.</p>
<h3 class="text-left mt-4">Argon2</h3>
<p style="text-align:justify;">Argon2 has three attributes that can be customized:
</p>
<ul style="text-align:justify;list-style:square;">
<li>time_cost controls the number of iterations within the hash.
<li>memory_cost controls the size of memory that must be used during the computation of the hash.
<li>parallelism controls how many CPUs the computation of the hash can be parallelized on.
</ul>
<p style="text-align:justify;">The default values of these attributes are probably fine for you. If you determine that the password hash is too fast or too slow, you can tweak it as follows:
</p>
<ul style="text-align:justify;list-style:square;">
<li>Choose parallelism to be the number of threads you can spare computing the hash.
<li>Choose memory_cost to be the KiB of memory you can spare.
<li>Adjust time_cost and measure the time hashing a password takes. Pick a time_cost that takes an acceptable time for you. If time_cost set to 1 is unacceptably slow, lower memory_cost.
</ul>
...
function next(){
  window.open("bootstrap_django.php","_self");
}
function prev(){
  window.open("comments_django.php","_self");
}
