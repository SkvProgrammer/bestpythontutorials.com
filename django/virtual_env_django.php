...
<html lang="en-Us">
    <head>
        <title>Virtual Environment in Django</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="../codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Virtual Environment in Django - BestPythonTutorials.com"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,virtual environment in django">
  ...
  <!--vertical menu-->
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">DJANGO TUTORIAL</h4></li><br>
     <li><a href="home_django.php"  target="_self">Django Home</a></li>
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="virtual_env_django.php"  target="_self">Virtual Environment</a></li> 
...
<a href="" style="border:none;color:white;"><h1 id="tag1">DJANGO TUTORIAL</h1></a>
  <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="virtual_env_django.php"  target="_self" style="color:white;">Virtual Environment</a> 
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Virtual Environment in Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/virtual_env_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/django/virtual_env_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In Python while using third party modules we often need to install them as they don't come with the official package which is actually not good and we should keep the packages in a good manner and for that we have to use <b>Virtual Environments.</b></p>
...
<p style="text-align:justify;" class="mt-4">In the next chapter we will see how to install django inside virtual environment.</p>
...
function prev(){
  window.open("intro_django.php","_self");
}
