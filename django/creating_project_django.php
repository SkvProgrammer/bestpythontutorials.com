...
<html lang="en-Us">
    <head>
        <title>Creating a Project in Django</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="../codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Creating a Project in django"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,creating a project in django">
  ...
  <!--vertical menu-->
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">DJANGO TUTORIAL</h4></li><br>
     <li><a href="home_django.php"  target="_self">Django Home</a></li>
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="creating_project_django.php"  target="_self">Creating Project</a></li>
...
<a href="" style="border:none;color:white;"><h1 id="tag1">DJANGO TUTORIAL</h1></a>
  <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="creating_project_django.php"  target="_self" style="color:white;">Creating Project</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Creating a Project in Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/creating_project_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/django/creating_project_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In this Chapter we will learn that what is a <b>Project in Django</b> and how to create a project in Django.Django is a great Framework as It do many tasks itself.</p>
<p style="text-align:justify;">Projects are sum of applications and applications are piece of code relying on the MVT Pattern.For Example,Suppose you have made a website using django then the website is your <b>Project</b> and sections like forum , contact page or report error pages are the examples of Applications.</p>

<h4 style="text-align:justify;" class="mt-4">Now we will see how to create a project in django.</h4>
<p style="text-align:justify;" class="mb-1">For window or linux the command is same for installing Django.</p>
...
<p style="text-align:justify;" class="mt-4 mb-1">By running the above command a folder named <b>myproject1</b> will be created and the folder structure pf myproject1 will be like:</p>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
  myproject1/<br>
   <xC style="margin-left:10px;">manage.py</xC><br>
   <xC style="margin-left:10px;">myproject1</xC>/<br>
      <xC style="margin-left:30px;">__init__.py</xC><br>
      <xC style="margin-left:30px;">settings.py</xC><br>
      <xC style="margin-left:30px;">urls.py</xC><br>
      <xC style="margin-left:30px;">wsgi.py</xC>
</div>

<h3 class="text-left mt-4">Structure of the Folder</h3>
<p style="text-align:justify;">It's very important that you should know about these files inside the project folder.
<ul style="text-align:justify;list-style:square;">
  <li><b>manage.py</b> − This file is kind of your project local django-admin for interacting with your project via command line (start the development server).</li>
  <li><b>__init__.py</b> − This folder should be treated as package folder.</li>
  <li><b>settings.py</b> − This file is used to manage Settings for the project.</li>
  <li><b>urls.py</b> − This helps in URL Mapping of the Project.</li>
  <li><b>wsgi.py</b> − If you need to deploy your project over WSGI.</li>
</ul>
</p>

<h3 class="text-left mt-4">Important Point</h3>
<p style="text-align:justify;">In the <b>settings.py</b> file you will have an option of <b>DEBUG</b> whose value will be <b>True</b> by default.Please note that the value of DEBUG must not be True in a live project.</p>
...
function next(){
  window.open("admin_interface_django.php","_self"); 
}
function prev(){
  window.open("environment_setup_django.php","_self");
}
