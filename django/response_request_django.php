...
<html lang="en-Us">
    <head> 
        <title>Request and Response Objects - Django</title>
        <meta charset="utf-8">
...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Response and Request Methods in Django - HttpResponse and HttpRequest in Django">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
       <img src="djangobannertwo.png" class="ml-auto mr-auto img-fluid mt-3 mb-3 text-center" style="width:100%;height:190px;">    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">DJANGO TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="response_request_django.php"  target="_self">Response and Request</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="response_request_django.php"  target="_self" style="color:white;">Response and Request</a>
...
<h2 class="text-left" style="color:#a54eee;">Response and Request Object - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/response_request_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/response_request_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In an Web Application there are two major events that takes place i.e. Request and Response.The user requests for some data and the data comes in the form of response.</p>
<p style="text-align:justify;">When a client requests for a resource, a HttpRequest object is created and correspond view function is called that returns HttpResponse object.</p>
<p style="text-align:justify;">Django's <b>django.http</b> module provides two provides different methods and classes such as HttpResponse and HttpRequest.Both of this classes have their own methods and attributes.In this chapter we are going to cover them.</p>

<h3 class="text-left mt-4">HttpResponse</h3>
<h5 class="text-center">HttpResponse Methods</h5>
...
<tr>
  <td>HttpResponse.__init__<em>(content='', content_type=None, status=200, reason=None, charset=None)</em></td>
  <td>It is used to instantiate an HttpResponse object with the given page content and content type.</td>
</tr>
<tr>
  <td>HttpResponse.__setitem__<em>(header, value)</em></td>
  <td>It is used to set the given header name to the given value.</td>
</tr>
<tr>
  <td>HttpResponse.__delitem__<em>(header)</em></td>
  <td>It deletes the header with the given name.</td>
</tr>
<tr>
  <td>HttpResponse.__getitem__<em>(header)</em></td>
  <td>It returns the value for the given header name.</td>
</tr>
<tr>
  <td>HttpResponse.has_header<em>(header)</em></td>
  <td>It returns either True or False based on a case-insensitive check for a header with the provided name.</td>
</tr>
<tr>
  <td>HttpResponse.setdefault<em>(header, value)</em></td>
  <td>It is used to set default header.</td>
</tr>
<tr>
  <td>HttpResponse.write<em>(content)</em></td>
  <td>It is used to create response object of file-like object.</td>
</tr>
<tr>
  <td>HttpResponse.flush()</td>
  <td>It is used to flush the response object.</td>
</tr>
<tr>
  <td>HttpResponse.tell()</td>
  <td>This method makes an HttpResponse instance a file-like object.</td>
</tr>
<tr>
  <td>HttpResponse.getvalue()</td>
  <td>It is used to get the value of HttpResponse.content.</td>
</tr>
<tr>
  <td>HttpResponse.readable()</td>
  <td>This method is used to create stream-like object of HttpResponse class. </td>
</tr>
<tr>
  <td>HttpResponse.seekable()</td>
  <td>It is used to make response object seekable.</td>
</tr>
</tbody></table>
</div>

<h5 class="text-center mt-4">HttpResponse Attributes</h5>
...
<tr>
  <td>HttpResponse.content</td>
  <td>A bytestring representing the content, encoded from a string if necessary.</td>
</tr>
<tr>
  <td>HttpResponse.charset</td>
  <td>It is a string denoting the charset in which the response will be encoded.</td>
</tr>
<tr>
  <td>HttpResponse.status_code</td>
  <td>It is an <strong>HTTP status code</strong> for the response.</td>
</tr>
<tr>
  <td>HttpResponse.reason_phrase</td>
  <td>The HTTP reason phrase for the response.</td>
</tr>
<tr>
  <td>HttpResponse.streaming</td>
  <td>It is false by default.</td>
</tr>
<tr>
  <td>HttpResponse.closed</td>
  <td>It is True if the response has been closed.</td>
</tr>
</tbody></table>
</div>

<h3 class="text-left mt-4">HttpRequest</h3>
<h5 class="text-center">HttpRequest Methods</h5>
<div style="overflow:scroll;">
<table class="alt">
<tbody><tr>
  <th>Attribute</th>
...
<tr>
  <td>HttpRequest.get_host()</td>
  <td>It returns the original host of the request.</td>
</tr>
<tr>
  <td>HttpRequest.get_port()</td>
  <td>It returns the originating port of the request.</td>
</tr>
<tr>
  <td>HttpRequest.get_full_path()</td>
  <td>It returns the path, plus an appended query string, if applicable.</td>
</tr>
<tr>
  <td>HttpRequest.build_absolute_uri <em>(location)</em></td>
  <td>It returns the absolute URI form of location.</td>
</tr>
<tr>
  <td>HttpRequest.get_signed_cookie <em>(key, default=RAISE_ERROR, salt='', max_age=None)</em></td>
  <td>It returns a cookie value for a signed cookie, or raises a django.core.signing.BadSignature exception if the signature is no longer valid.</td>
</tr>
<tr>
  <td>HttpRequest.is_secure()</td>
  <td>It returns True if the request is secure; that is, if it was made with HTTPS.</td>
</tr>
<tr>
  <td>HttpRequest.is_ajax()</td>
  <td>It returns True if the request was made via an XMLHttpRequest.</td>
</tr>
</tbody></table>
</div>

<h5 class="text-center mt-4">HttpRequest Attributes</h5>
<div style="overflow:scroll;">
  <table class="alt">
<tbody><tr>
  <th>Attribute</th>
...
<tr>
  <td>HttpRequest.scheme</td>
  <td>A string representing the scheme of the request (HTTP or HTTPs usually).</td>
</tr>
<tr>
  <td>HttpRequest.body</td>
  <td>It returns the raw HTTP request body as a byte string.</td>
</tr>
<tr>
  <td>HttpRequest.path</td>
  <td>It returns the full path to the requested page does not include the scheme or domain.</td>
</tr>
<tr>
  <td>HttpRequest.path_info</td>
  <td>It shows path info portion of the path.</td>
</tr>
<tr>
  <td>HttpRequest.method</td>
  <td>It shows the HTTP method used in the request.</td>
</tr>
<tr>
  <td>HttpRequest.encoding</td>
  <td>It shows the current encoding used to decode form submission data.</td>
</tr>
<tr>
  <td>HttpRequest.content_type</td>
  <td>It shows the MIME type of the request, parsed from the CONTENT_TYPE header.</td>
</tr>
<tr>
  <td>HttpRequest.content_params</td>
  <td>It returns a dictionary of key/value parameters included in the CONTENT_TYPE header.</td>
</tr>
<tr>
  <td>HttpRequest.GET</td>
  <td>It returns a dictionary-like object containing all given HTTP GET parameters.</td>
</tr>
<tr>
  <td>HttpRequest.POST</td>
  <td>It is a dictionary-like object containing all given HTTP POST parameters.</td>
</tr>
<tr>
  <td>HttpRequest.COOKIES</td>
  <td>It returns all cookies available.</td>
</tr>
<tr>
  <td>HttpRequest.FILES</td>
  <td>It contains all uploaded files.</td>
</tr>
<tr>
  <td>HttpRequest.META</td>
  <td>It shows all available Http headers.</td>
</tr>
<tr>
  <td>HttpRequest.resolver_match</td>
  <td>It contains an instance of ResolverMatch representing the resolved URL. </td>
</tr>
</tbody></table>
...
function next(){
  window.open("crud_django.php","_self");
}
function prev(){
  window.open("file_upload_django.php","_self");
}
