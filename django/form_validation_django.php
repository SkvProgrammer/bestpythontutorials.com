...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Form Validation in Django - Django Form Validation">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="form_validation_django.php"  target="_self">Form Validation</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="form_validation_django.php"  target="_self" style="color:white;">Form Validation</a>
...
<h2 class="text-left" style="color:#a54eee;">Form Validation - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/form_validation_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/form_validation_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Django provides built-in methods to validate form data.We can only validate the form data if we have used the CSRF token.Now what is this CSRF token?</p>
<p style="text-align:justify;"> A <b>CSRF(Cross-Site Request Forgery)</b> token is a unique, secret, unpredictable value that is generated by the server-side application and transmitted to the client in such a way that it is included in a subsequent HTTP request made by the client.
</p>
<p style="text-align:justify;">Now In this chapter we will be creating a simple form and will try to validate it using methods like <b>is_valid()</b>.The <b>is_valid()</b> method returns True if data is valid and place all data into a cleaned_data attribute.</p>

<h3 class="text-left mt-4">Django Validation Example</h3>
<p style="text-align:justify;">We will be learning form validation by creating a simple form and will warn the user if the data is not filled in the input boxes or checkboxes.I think you know what is the next step, yes the next step is creating some model fields.</p>
<div class="text-left mt-1 mb-1">
  <p style="text-align:justify;" class="mb-1">models.py</p>
...
class Info(models.Model):  
    ...
    class Meta:  
        db_table = "project_table1" </textarea>
...
<h3 class="text-left mt-4">Instantiating the form</h3>
<div class="text-left mt-1 mb-1">
  <p style="text-align:justify;" class="mb-1">forms.py</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
from yourapp.models import Info  
...
<div class="text-left mt-1 mb-1">
  <p style="text-align:justify;" class="mb-1">views.py</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
def info(request):  
    if request.method == "POST":  
        ...
        form = InfoForm()  
    return render(request,'index.html',{'form':form})  </textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<div class="text-left mt-1 mb-0">
  <p style="text-align:justify;" class="mb-1">index.html</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p style="text-align:justify;" class="mt-4">We have completed the validation of the form and if you follow each steps written above you can easily make this program and can make more changes and do experiments.</p>
