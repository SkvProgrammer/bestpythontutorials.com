...
<html lang="en-Us">
    <head> 
        <title>Static File Handling - Django</title>
        <meta charset="utf-8">
...
<script async src="https://cse.google.com/cse.js?cx=016236012273495808262:cabujlbzuwi"></script>
        ...
        <meta name="description" content="Static File Handling in Django">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
      ...
      <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="static_file_handling_django.php"  target="_self">Static File Handling</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="home_django.php"  target="_self">Django Home</a>
      ...
      <a href="static_file_handling_django.php"  target="_self" style="color:white;">Static File Handling</a>
...
<h2 class="text-left" style="color:#a54eee;">Static File Handling - Django</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/django/static_file_handling_django.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/django/static_file_handling_django.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In an Web Application , Images,css file and javascript files are called <b>Static Files</b>.The <b>django.contrib.staticfiles</b> module helps to manage static files in Django.</p>

<h3 class="text-left mt-4">Configuration</h3>
<div class="text-left mt-1 mb-1">
  <p style="text-align:justify;" class="mb-1">Include <b>django.contrib.staticfiles</b> in the INSTALLED_APPS of the <b>settings.py</b> file.</p>
...
<p style="text-align:justify;" class="mt-3 mb-1">Add the location of static folder in the <b>STATIC_URL</b></p>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
  STATIC_URL = '/static/'
</div>
<p style="text-align:justify;" class="mt-4">Your project will probably also have static assets that aren’t tied to a particular app. In addition to using a static/ directory inside your apps, you can define a list of directories (STATICFILES_DIRS) in your settings file where Django will also look for static files.</p>

<p style="text-align:justify;" class="mt-3">Now keep all the images , css files and javascript files in the static folder created(You have to manually create the static folder).The next step will be loading the static</p>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
  STATICFILES_DIRS = [<br>
...
<h2 class="text-left mt-5 mb-3">Django Static Examples</h2>
<h4 class="text-center mb-0">EXAMPLE 1(Images)</h4>
<div class="text-left mt-0">
  <p class="text-left mb-0">index.html</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<body>  
<img src="{% static '/bg.jpeg' %}" alt="image" height="100px" width="100px"/>  
</body>  
</html> </textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<div class="text-left mt-1">
  <p class="text-left mb-0">views.py</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<div class="text-left mt-1">
  <p class="text-left mb-0">urls.py</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<img src="../smile.svg" class="img-fluid" style="border:1px solid black;height:500px;width:100%;">



<!---EXAMPLE 2-------->
<h4 class="text-center mb-0 mt-4">EXAMPLE 2(Javascript File)</h4>
<div class="text-left mt-0">
  <p class="text-left mb-0">index.html</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<div class="text-left mt-1">
 ...
 <textarea id="editor6" name="initScript" style="height:20vh!important;text-align:justify;overflow:hidden;-webkit-border-radius: 5px;
    -moz-border-radius: 5px;border-radius: 5px;z-index:0;" readOnly = 'nocursor'>
alert("Hello, Welcome to BPT");  </textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
function next(){
  window.open("forms_django.php","_self");
}
function prev(){
