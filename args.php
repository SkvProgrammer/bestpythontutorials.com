...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="*args and **kwargs in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,  args and kwargs in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="args.php" target="_self">*args,**kwargs</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="args.php" target="_self" style="color:white;">*args,**kwargs</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">args and kwargs in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/args.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/args.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align: justify;" class="mt-4">To start this chapter you should have the knowledge of <a href="functions.php" style="color:grey;text-decoration:none;">Functions <img src="django/link.png" style="height:10px;"></a>.In our Function chapter in the last example we have stated that the function has a definite number of arguments and if while calling the function if the number of arguments are unequal then the program will generate an Error.So the <b>*args</b> and <b>**kwargs</b> are the solution for this problem.</p>
...
data("Satyam")#only one argument
data("Satyam Kumar")#two arguments
data("Satyam Kumar Verman")#three arguments
...
# Driver code 
Func(first_name ='Satyam', mid_name ='Kumar', last_name='Verman')  
Func(first_name ='Satyam', mid_name ='Kumar')
Func(first_name ='Satyam')   
...
<p style="text-align:justify;" class="mt-4"><b>Note:</b>*args and **kwargs are just popularized,you can use any name such <b>*iamargs</b> or <b>**iamkwargs</b>.</p>
</div>       
