...
<html lang="en-Us">
    <head>
        <title>Contact us - BestPythonTutorials.com</title>
        <meta charset="utf-8">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="privacypolicy.php"  target="_self">Privacy Policy</a></li>
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="contactus.php"  target="_self">Contact Us</a></li>
    </ul>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="contactus.php"  target="_self" style="color:white;">Contact Us</a>
  </div>
</div>
</div>
...
<h2 style="text-align:justify;color:#a54eee;">Contact Us</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/contactus.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/contactus.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<h5 style="text-align:justify;" class="mt-4"><b>Address</b> : Anonymous</h5>
<h5 style="text-align:justify;" class="mt-2 mb-5"><b>Note</b> : For Freelance Projects you can use the form below.</h5>


<div class="container mt-4" id="main" style="text-align:justify;">
  <form action="https://formspree.io/xknqvyze" method="POST">
    <label for="fname">Name</label>
    <input type="text" id="name" name="name" placeholder="Type Your Name.." required autocomplete="off" style="background-color:white;color:black;border:1px solid lightgrey;">

    <label for="_replyto">Email</label>
    <input type="text" id="email" name="_replyto" placeholder="Type Your Email.." required autocomplete="off" style="background-color:white;color:black;border:1px solid lightgrey;">
     <label for="phonenumber">Phone Number</label>
    <input type="text" id="phonenumber" name="phonenumber" placeholder="Type Your Phone Number.." required autocomplete="off" style="background-color:white;color:black;border:1px solid lightgrey;">
 <label for="subject">Subject</label>
    <input type="text" id="subject" name="subject" placeholder="Type Your Subject.." required autocomplete="off" style="background-color:white;color:black;border:1px solid lightgrey;">
    <label for="message">Message</label>
    <textarea id="message" name="message" placeholder="Type Your Message.." required autocomplete="off" style="background-color:white;color:black;border:1px solid lightgrey;width:100%;border-radius:5px;height:200px;"></textarea>

  
    <button class="btn btn-success text-center ml-auto mr-auto">Submit</button>
  </form>
</div>
