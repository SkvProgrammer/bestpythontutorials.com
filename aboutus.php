...
<html lang="en-Us">
    <head>
        <title>About us - BestPythonTutorials.com</title>
        <meta charset="utf-8">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="privacypolicy.php"  target="_self">Privacy Policy</a></li>
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="aboutus.html"  target="_self">About Us</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="aboutus.html"  target="_self" style="color:white;">About Us</a>
...
<h2 style="text-align:justify;color:#a54eee;">About Us</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/aboutus.html" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/aboutus.html" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-3"><b>BestPythonTutorials.<com style="color:rgb(101, 231, 101);">com</com></b> is focused to provide high-quality programming tutorials in the simplest way. Currently, we are providing tutorials on Python programming language and some of its awesome frameworks such as Django, flask, and some data science tools such as NumPy, Pandas, and Matplotlib.In the future, we will be launching tutorials on Data Science, Ethical Hacking, and Game Development. We are committed to providing awesome tutorials to everyone.
</p>
<p style="text-align:justify;">We welcome your suggestions and feedbacks. If you have any suggestions you can send them using the form below and if you find any errors in these tutorials you can report them and we will solve them within few days, you can also write articles for us.
</p>
  <p style="text-align:justify;">
    This site is created by Satyam Kumar Verman, who is a self-taught programmer and blogger. He writes his technical blogs at <a href="https://devtipsntricks.com">DevTipsNTricks.com</a> Below we have a brief intro of Satyam Kumar Verman.
  </p>
  <div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12"><img src="skv.jpg" style="height:90%;width:40%;border-radius:50px;"></div>
