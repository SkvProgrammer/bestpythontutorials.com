...
<html lang="en-Us">
    <head>
        ...
        <meta name="description" content="Operators in Python - Python Operators"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="operators.php" target="_self">Operators</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="operators.php" target="_self" style="color:white;">Operators</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;">Operators in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/operators.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/operators.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
 ...
 <p style="text-align:left;" class="mt-4">Operators are simply the tools for performing mathematical calculations for different variables and values... </p>

        <p>Python has <b>Seven</b> different group of operators :- </p>
        <ul style="text-align:left;font-size:20px;">
          <li onclick="window.open('#arithmetic','_self');">Arithmetic Operators</li>
          <li onclick="window.open('#logical','_self');">Logical Operators</li>
          <li onclick="window.open('#comparison','_self');">Comparison Operators</li>
          <li onclick="window.open('#bitwise','_self');">Bitwise Operators</li>
          <li onclick="window.open('#identity','_self');">Identity Operators</li>
          <li onclick="window.open('#membership','_self');">Membership Operators</li>
          <li onclick="window.open('#assignment','_self');">Assignment Operators</li>
        </ul>
<h2 style="text-align:left;color:#a54eee;" id="arithmetic">Arithmetic Operators</h2>
<p style="text-align:justify;">Arithmetic Operators perform mathematical calculations with integers...</p>
<div style="overflow-x:auto;">
  <table>
    ...
    <tr>
      ...
      <td>*</td>
      <td>a*b</td>
      <td>Give the product of the values</td>
    </tr>
    <tr>
      <td>Floor Division</td>
      <td>//</td>
      <td>a//b</td>
      <td>Give the Quotient in round form i.e values after decimal are removed</td>
    </tr>
    <tr>
      <td>Modulus</td>
      <td>%</td>
      ...
      <td>**</td>
      <td>a**b</td>
      <td>It returns the value a to power of b</td>
      
    </tr>
  </table>
</div>
<h2 style="text-align:left;color:#a54eee;" class="mt-5" id="logical">Logical Operators</h2>
<p style="text-align:justify;">Logical Operators combines conditional statements...</p>
...
<div style="overflow-x:auto;">
  <table>
    ...
    <tr>
      <td>and</td>
      <td>It returns True if both statements are correct </td>
      <td>5 > 2 and 6 > 4</td>  
      <td>True</td> 
    </tr>
    <tr>
      <td>or</td>
      <td>It return True if any one condition is correct</td>
      <td>5 > 6 or 6 > 5</td>
      <td>True</td>
    ...
    <tr>
      <td>not</td>
      <td>It returns False if condition is correct</td>
      <td>not(5 > 2 and 6 > 3)</td>
      <td>False</td>
...
<h2 style="text-align:left;color:#a54eee;" class="mt-5" id="comparison">Comparison Operators</h2>
<p style="text-align:justify;">Comaprison Operators are used to compare two values...</p>
...
<div style="overflow-x:auto;">
  <table>
    ...
    <tr>
      ...
      <td>==</td>
      <td>6 == 6</td>
      <td>Returns True if values are equal</td>
    ...
    <tr>
      ...
      <td>!=</td>
      <td>6 != 5</td>
      <td>Returns True if value are not equal</td>      
    </tr>
    <tr>
      <td>Greater than</td>
      <td> > </td>
      <td>6 > 3</td>
      <td>Returns True if chosen value is greater</td>
    ...
    <tr>
      ...
      <td><</td>
      <td>5 < 6</td>
      <td>Return True if chosen value is less</td>
    </tr>
    <tr>
      <td>Greater than or Equal to</td>
      <td>>=</td>
      <td>6 >= 5</td>
      <td>Returns True if the value is greater or Equal to other value</td>
    </tr>
    <tr>
      <td>Smaller than or Equal to</td>
      <td><=</td>
      <td>5 <= 6</td>
      <td>Returns True if the value is smaller or equal to other values</td>
      
    </tr>
     
  </table>
</div>
<h2 style="text-align:left;color:#a54eee;" class="mt-5" id="bitwise">Bitwise Operators</h2>
<p style="text-align:justify;">Bitwise Operators are used to compare two  binary values...</p>
...
<div style="overflow-x:auto;">
  <table>
    ...
    <tr>
      ...
      <td>&</td>
      <td>12&21</td>
      <td>Sets each bit to 1 if both bits are 1
</td>
<td>4</td>
...
<h2 style="text-align:left;color:#a54eee;" class="mt-5" id="identity">Identity Operators</h2>
<p style="text-align:justify;">Identity Operators are used to compare two  objects...</p>
...
<div style="overflow-x:auto;">
  <table>
    ...
    <tr>
      <td>is</td>
      <td>a is b</td>
      <td>Returns True if a and b are same objects
</td>
    ...
    <tr>
      <td>is not</td>
      <td>a is not b</td>
      <td>Return True if a and b are not the same object</td>   
...
<h2 style="text-align:left;color:#a54eee;" class="mt-5" id="membership">Membership Operators</h2>
<p style="text-align:justify;">Membership Operators are used to check if a sequence is available in an object or not...</p>
<div style="overflow-x:auto;">
  <table>
    <tr>
...
<h2 style="text-align:left;color:#a54eee;" class="mt-5" id="assignment">Assignment Operators</h2>
<p style="text-align:justify;">Assignment Operators are shorthand statements to modify the values of the variable...</p>
<div style="overflow-x:auto;">
  <table>
    <tr>
      <th>Operator</th>
...
function next(){
  window.open("calculations.php","_self");
}
function prev(){
