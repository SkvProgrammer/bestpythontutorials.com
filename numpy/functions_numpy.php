...
<html lang="en-Us">
    <head>
        <title>Functions in NumPy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="NumPy Functions - List of NumPy Functions - Universal Functions in NumPy - ufunc in numpy - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="functions_numpy.php" target="_self">Numpy Functions</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="functions_numpy.php" target="_self" style="color:white;">Numpy Functions</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Functions - Numpy</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/functions_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/functions_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">NumPy provides a lot of functions such as Mathematical Functions , String Functions and Universal Function.As you know we have already discussed the Mathematical and String Functions.So now we are going to discuss universal functions in NumPy.</p>
<h4 class="text-left mt-4" style="color:#a54eee;">Check Out Our Function Tutorials:</h4>
<ol style="text-align:justify;list-style: square;">
  <li><p><a href="./mathematical_functions_numpy.php" style="color:grey;text-decoration:none;">Mathematical Functions <img src="../django/link.png" alt="link" style="height:10px;"></a></p></li>
  <li><p><a href="./string_functions_numpy.php" style="color:grey;text-decoration:none;">String Functions <img src="../django/link.png" alt="link" style="height:10px;"></a></p></li>
  <li><p><a href="./string_functions_numpy.php" style="color:grey;text-decoration:none;">Universal Functions(ufunc)</a></p></li>
</ol>

<h4 class="text-left mt-4" style="color:#a54eee;">Universal Functions(ufunc)</h4>
<p style="text-align:justify;">Universal functions in Numpy are simple mathematical functions. It is just a term that we gave to mathematical functions in the Numpy library. Numpy provides various universal functions that cover a wide variety of operations</p>

<h4 class="text-left mt-4" style="color:#a54eee;">Why use Universal Functions?</h4>
<p style="text-align:justify;"><code>ufuncs</code> are used to implement <i>vectorization</i> in NumPy which is way faster than iterating over elements.Now what is vectorization? - Converting iterative statements into a vector based operation is called vectorization.It is faster as modern CPUs are optimized for such operations.
</p>
...
function next(){
  window.open("copies_views_numpy.php","_self");
}
function prev(){
  window.open("matrix_operations_numpy.php","_self");
}
