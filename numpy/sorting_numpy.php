...
<html lang="en-Us">
    <head>
        <title>Sorting Arrays in NumPy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Sorting Arrays in NumPy - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="sorting_numpy.php" target="_self">Sorting</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="sorting_numpy.php" target="_self" style="color:white;">Sorting</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Sorting - Numpy</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/sorting_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/sorting_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4"><b>Sorting</b> means arranging the elements of an array on a particular sequence or order(generally ascending or descending order).NumPy provides the <b>numpy.sort()</b> method for sorting arrays.</p>

<p style="text-align:justify;">Here,Ordered or Particular sequence is any sequence that has an order corresponding to elements, like numeric or alphabetical, ascending or descending.
</p>
...
<p style="text-align:justify;" class="mt-4"><b>Note:</b>This method returns a copy of the array, leaving the original array unchanged.</p>
</div>
...
array2 = np.array([["alpha","beta","gamma"]])
print(np.sort(array1))
...
import numpy as np
array1 = np.array([[2,3,10,1,3],[8,3,5,9,3]])
print(np.sort(array1,axis = 0))#rows
print(np.sort(array1,axis = 1))#columns
</code>
  </div>
