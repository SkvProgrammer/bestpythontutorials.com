...
<html lang="en-Us">
    <head>
        <title>String Functions  in Numpy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="String Functions in NumPy - NumPy contains the following functions for the operations on the arrays of dtype string. - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li><a href="array_creation_routines_numpy.php" target="_self">Array Creation</a></li>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="string_functions_numpy.php" target="_self">String Functions</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="array_creation_routines_numpy.php" target="_self">Array Creation</a>
      ...
      <a href="string_functions_numpy.php" target="_self" style="color:white;">String Functions</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">String Functions - Numpy</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/mathematical_functions_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/mathematical_functions_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">NumPy provides a lots of functions for dtype string:</p>
...
<tr>
  <td>1</td>
  <td>add()</td>
  <td>It is used to concatenate the corresponding array elements (strings). </td>
</tr>
<tr>
  <td>2</td>
  <td>multiply()</td>
  <td>It returns the multiple copies of the specified string, i.e., if a string 'hello' is multiplied by 3 then, a string 'hello hello' is returned.</td>
</tr>
<tr>
  <td>3</td>
  <td>center()</td>
  <td>It returns the copy of the string where the original string is centered with the left and right padding filled with the specified number of fill characters.</td>
</tr>
<tr>
  <td>4</td>
  <td>capitalize()</td>
  <td>It returns a copy of the original string in which the first letter of the original string is converted to the Upper Case.</td>
</tr>
<tr>
  <td>5</td>
  <td>title()</td>
  <td>It returns the title cased version of the string, i.e., the first letter of each word of the string is converted into the upper case.</td>
</tr>
<tr>
  <td>6</td>
  <td>lower()</td>
  <td>It returns a copy of the string in which all the letters are converted into the lower case. </td>
</tr>
<tr>
  <td>7</td>
  <td>upper()</td>
  <td>It returns a copy of the string in which all the letters are converted into the upper case. </td>
</tr>
<tr>
  <td>9</td>
  <td>split()</td>
  <td>It returns a list of words in the string. </td>
</tr>
<tr>
  <td>9</td>
  <td>splitlines()</td>
  <td>It returns the list of lines in the string, breaking at line boundaries. </td>
</tr>
<tr>
  <td>10</td>
  <td>strip()</td>
  <td>Returns a copy of the string with the leading and trailing white spaces removed. </td>
</tr>
<tr>
  <td>11</td>
  <td>join()</td>
  <td>It returns a string which is the concatenation of all the strings specified in the given sequence. </td>
</tr>
<tr>
  <td>12</td>
  <td>replace()</td>
  <td>It returns a copy of the string by replacing all occurrences of a particular substring with the specified one. </td>
</tr> 
<tr>
  <td>13</td>
  <td>decode()</td>
  <td>It is used to decode the specified string element-wise using the specified codec.</td>
</tr>
<tr>
  <td>14</td>
  <td>encode()</td>
  <td>It is used to encode the decoded string element-wise.</td>
</tr>
</tbody></table>
</div>
...
<p style="text-align:justify;" class="mt-4">Now we have covered some important methods of numpy.We have left some examples for your own practice and My suggestion is to go through the examples and practice more and more.</p>
...
function next(){
  window.open("bitwise_operators_numpy.php","_self");
}
function prev(){
  window.open("mathematical_functions_numpy.php","_self");
}
