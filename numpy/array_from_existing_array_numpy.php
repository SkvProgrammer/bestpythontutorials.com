...
<html lang="en-Us">
    <head>
        <title>Array From Existing Array in Numpy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Array From Existing Array in NumPy - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="array_from_existing_array_numpy.php" target="_self">Array From existing Array</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="array_from_existing_array_numpy.php" target="_self" style="color:white;">Array From existing Array</a>
...
<!--search ends-->
    <h3 style="text-align:left;color:#a54eee;">Array From Existing Array or Data</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/array_from_existing_array_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/array_from_existing_array_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
tuple1 = (1,2,3)
a = np.asarray(tuple1,dtype="float") 
print(a)
</code>
  </div>
...
<h5 class="text-left mt-4" style="color:#a54eee;">PARAMETERS</h4>
<DIV style="overflow:scroll;">
  <table class="table table-bordered">
<tbody><tr>
<th style="text-align:center;">Sr.No.</th>
...
x = np.fromiter(iter1, dtype = float) 
print(x)
</code>
  </div>
...
<h4 class="text-left mt-4" style="color:#a54eee;">numpy.frombuffer()</h4>
<p style="text-align: justify;">This function interprets a buffer as one-dimensional array. Any object that exposes the buffer interface is used as parameter to return an ndarray.</p>

<h5 class="text-left mt-4" style="color:#a54eee;">SYNTAX</h4>
<div class="container p-1" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">numpy.frombuffer(buffer, dtype = float, count = -1, offset = 0)</div>
<h5 class="text-left mt-4" style="color:#a54eee;">PARAMETERS</h4>
<DIV style="overflow:scroll;">
  <table class="table table-bordered">
<tbody><tr>
...
function next(){
  window.open("iterating_over_array_numpy.php","_self");
}
function prev(){
  window.open("array_attributes_numpy.php","_self");
}
