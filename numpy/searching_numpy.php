...
<html lang="en-Us">
    <head>
        <title>Searching Elements in an Array in NumPy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Searching in NumPy - Searching Arrays in NumPy - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="searching_numpy.php" target="_self">Searching</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="searching_numpy.php" target="_self" style="color:white;">Searching</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Searching - Numpy</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/searching_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/searching_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
x = np.where(array1 == 10)#search for value 10 in the array
print(x)
</code>
  </div>
...
import numpy as np
array1 = np.array([2,3,10,1,3])
x = np.where(array1%2 == 0)#search for even numbers
print(x)
</code>
  </div>

<p style="text-align:justify;" class="mt-3">The output of the above code is a tuple <code>(array([0, 2], dtype=int32),)</code> which indicates that there is even number at position 0 and 2.</p>
...
#searchsorted array assumes that the array is sorted always
array1 = np.array([1, 2, 3, 4])

x = np.searchsorted(array1, 3)
...
y = np.searchsorted(array1, 1 ,side="right")
