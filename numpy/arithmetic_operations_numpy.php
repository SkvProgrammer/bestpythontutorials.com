...
<html lang="en-Us">
    <head>
        <title>Arithmetic Operations in NumPy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Arithmetic Operations in NumPy - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="arithmetic_operations_numpy.php" target="_self">Arithmetic Operations</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="arithmetic_operations_numpy.php" target="_self" style="color:white;">Arithmetic Operations</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Arithmetic Operations - Numpy</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/arithmetic_operations_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/arithmetic_operations_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">NumPy provides a large number of Arithmetic Operations which is a great thing for Data Analysis.NumPy is a really great tool for analysing data along with <a href="../pandas/home_pandas.php" style="color:grey;text-decoration:none;">Pandas <img src="../django/link.png" style="height:10px;"></a> for Data Manipulation and <a href="../matplotlib/home_matplotlib.php" style="color:grey;text-decoration:none;">Matplotlib <img src="../django/link.png" style="height:10px;"></a> for Data Visualization.</p>
<p style="text-align:justify;">NumPy provides Arithmetic Operations such as add() , subtract() , multiply() , divide() , reciprocal() , mod() , remainder() etc.</p>
...
<div style="overflow:scroll;">
  ...
  <tbody>
    <tr>
      <td>add()</td>
      <td>This method adds the elements.</td>
    </tr>
    <tr>
      <td>subtract()</td>
      <td>This method subtracts the elements.</td>
    </tr>
    <tr>
      <td>divide()</td>
      <td>This method divides the elements.</td>
    </tr>
    <tr>
      <td>multiply()</td>
      <td>This method gives the product of elements.</td>
    </tr>
    <tr>
      <td>reciprocal()</td>
      <td>This method returns the reciprocal of the elements.</td>
    </tr>
    <tr>
      <td>mod()</td>
      <td>This function returns the remainder after division of elements.</td>
    </tr>
    <tr>
      <td>power()</td>
      <td>This method returns the exponential of the element.</td>
    </tr>
    <tr>
      <td>remainder()</td>
      <td>This returns the remainder after division.</td>
    </tr>
  </tbody>
  </table>
</div>
...
#subtract
print("The difference is:",np.subtract(a,b))
#divide
print("The quotient is:",np.divide(a,b))
#multiply
print("The product is:",np.multiply(a,b))
#reciprocal
print("The reciprocal is:",np.reciprocal(a,b))
#mod
print("The remainder is:",np.mod(a,b))
#power
print("The exponential form is:",np.power(2,2))
</code>
  </div>
<h4 class="text-left mt-4" style="color:#a54eee;">Arithmetic Operations on Complex Numbers</h4>
<p style="text-align:justify;">NumPy also supports methods for performing Arithmetic Operations on Complex Numbers...</p>

<ul style="text-align:justify;list-style:square;">
<li>numpy.real() − It returns the real part of the complex data type argument.

<li>numpy.imag() − It returns the imaginary part of the complex data type argument.

<li>numpy.conj() − It returns the complex conjugate, which is obtained by changing the sign of the imaginary part.
...
function next(){
  window.open("statistical_functions_numpy.php","_self");
}
function prev(){
  window.open("broadcasting_numpy.php","_self");
}
