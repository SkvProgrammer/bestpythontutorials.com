...
<html lang="en-Us">
    <head>
        <title>Iterating Over an Array in Numpy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Iterating Over an Array in NUMPY - Looping through an Array in NUMPY - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="iterating_over_array_numpy.php" target="_self">Iterating over an Array</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="iterating_over_array_numpy.php" target="_self" style="color:white;">Iterating over an Array</a>
...
<!--search ends-->
    <h3 style="text-align:left;color:#a54eee;">Iterating Over an Array</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/iterating_over_array_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/iterating_over_array_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
print('Looped array is:')
for x in np.nditer(a):
   print(x)
</code>
  </div>

<h4 class="text-left mt-5" style="color:#a54eee;">Iterating Array With Different Data Types</h4>
<p style="text-align:justify;">We can use <code>op_dtypes</code> argument and pass it the expected datatype to change the datatype of elements while iterating.
</p>
...
<h4 class="mt-5 text-left" style="color:#a54eee;">Enumerated Iteration Using <code>ndenumerate()</code></h4>
<p style="text-align:justify;">Enumeration means haveing the sequence number of something one by one.
</p>
<p style="text-align:justify;">
...
for enum_id, x in np.ndenumerate(array1):
  print(enum_id, x)
</code>
  </div>
...
function prev(){
  window.open("array_from_existing_array_numpy.php","_self");
}
