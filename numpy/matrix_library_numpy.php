...
<html lang="en-Us">
    <head>
        <title>Matrix Library in NumPy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Matrix Library in NumPy - Matrices in NumPy - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="matrix_library_numpy.php" target="_self">Matrix Library</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="matrix_library_numpy.php" target="_self" style="color:white;">Matrix Library</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Matrix Library - Numpy</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/matrix_library_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/matrix_library_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Matrix in a container for storing multiple values.In NumPy , We are provided with a model called <b>numpy.matlib</b> which is used to perform operations or implement Matrices.</p>

<h4 class="text-left mt-4" style="color:#a54eee;">numpy.matlib.empty()</h4>
<p style="text-align:justify;">This method returns an uninitialized matrix of random values.The Syntax is given below:</p>
<div class="container p-1" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">numpy.matlib.empty(shape, dtype, order) </div>
...
<div style="overflow:scroll;">
  <table>
    ...
    <tr>
      <td>shape</td>
      <td>It is the tuple defining the shape of the matrix</td>
    </tr>
    <tr>
      <td>dtype</td>
      <td>This is used to set the data type of the array.</td>
    </tr>
    <tr>
      <td>order</td>
      <td>It is the insertion order of the matrix i.e C or F</td>
    </tr>
  </table>
</div>
...
array1 = np.matlib.empty((2,3),dtype="int",order="C")
print(array1)
</code>
  </div>
...
array1 = np.matlib.zeros((2,3),dtype="int",order="C")
print(array1)
</code>
  </div>
...
array1 = np.matlib.ones((2,3),dtype="int",order="C")
print(array1)
</code>
  </div>

<h4 class="text-left mt-4" style="color:#a54eee;">numpy.matlib.eye()</h4>
<p style="text-align:justify;">This function returns a matrix with the diagonal elements initialized to 1 and zero elsewhere. The syntax to use this function is given below.</p>
<h4 class="text-left mt-3">SYNTAX</h4>
<div class="container p-1 mb-5" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">numpy.matlib.eye(n, m, k, dtype)   </div>

<h4 class="text-left mt-4" style="color:#a54eee;">PARAMETERS</h4>
<div style="overflow:scroll;" class="mb-5">
  <table>
    <tr>
      <th>Parameter</th>
      <th>Description</th>
    ...
    <tr>
      <td>n</td>
      <td>It represents the number of rows in the resulting matrix.</td>
    </tr>
    <tr>
      <td>m</td>
      <td> It represents the number of columns, defaults to n.</td>
    </tr>
    <tr>
      <td>k</td>
      <td> It is the index of diagonal.</td>
    </tr>
    <tr>
      <td>dtype</td>
      <td>It is the data type of the output</td>
    </tr>
  </table>
</div>
...
array1 = np.matlib.eye(n = 2, M = 2, k = 2, dtype = "int")
print(array1)
</code>
  </div>
...
<h4 style="text-align:justify;color:#a54eee;" class="mt-5">numpy.matlib.identity()</h4> 
...
import numpy as np
import numpy.matlib
array1 = numpy.matlib.identity(3, dtype = int)
print(array1)
</code>
  </div>
...
<p style="text-align:justify;" class="mt-4"><b>Note:</b>According to the official website of Numpy i.e. the numpy.org they now don't recommend to use these classes.</p>
</div>
...
function next(){
  window.open("linear_algebra_numpy.php","_self");
}
function prev(){
  window.open("searching_numpy.php","_self");
}
