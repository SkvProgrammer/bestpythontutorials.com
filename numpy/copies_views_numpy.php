...
<html lang="en-Us">
    <head>
        <title>Copies and Views in NumPy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Copies and Views in NumPy  - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="copies_views_numpy.php" target="_self">Copies and Views</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="copies_views_numpy.php" target="_self" style="color:white;">Copies and Views</a>
  </div>
</div>
</div>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Copies and Views - Numpy</h3>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">The copy of an input array is physically stored at some other location and the content stored at that particular location is returned which is the copy of the input array whereas the different view of the same memory location is returned in the case of view.</p>

<h3 style="text-align:center;">OR</h3>
<p style="text-align:justify;">The major difference between a copy and a view of an array is that the copy is a new array whereas the view is just the view of the original array.
</p>
...
function prev(){
  window.open("functions_numpy_numpy.php","_self");
}
