...
<html lang="en-Us"> 
    <head>
        <title>Introduction to Numpy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="NumPy is a python library used for working with arrays. It also has functions for working in domain of linear algebra, fourier transform, and matrices. NumPy was created in 2005 by Travis Oliphant. It is an open source project and you can use it freely. - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="intro_numpy.php" target="_self">Introduction</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="intro_numpy.php" target="_self" style="color:white;">Introduction</a>
...
<!--search ends-->
    <h2 style="text-align:left;color:#a54eee;">Introduction to Numpy</h2>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/intro_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/intro_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p class="mt-4" style="text-align:justify;">Numpy is a Python-Based Framework for Array Processing.It stands for Numerical Python.It provides adhoc classes to deal with numerical data in the form of spreadsheet or csv.</p>
<p style="text-align:justify;">NumPy is a python library used for working with arrays. It also has functions for working in domain of linear algebra, fourier transform, and matrices. NumPy was created in 2005 by Travis Oliphant. It is an open source project and you can use it freely.</p>


<h3 class="text-left mt-4" style="color:#a54eee;">Features of Numpy</h3>
<ul style="text-align:justify;list-style:square;">
<li><p style="text-align:justify;">A powerful N-dimensional array object.</p>
<li><p style="text-align:justify;">Sophisticated broadcasting functions.</p>
<li><p style="text-align:justify;">Tools for integrating C/C++ and Fortran code.</p>
<li><p style="text-align:justify;">Useful linear algebra, Fourier transform, and random number capabilities.
</p>
</ul>

<h3 class="text-left mt-4" style="color:#a54eee;">Why use Numpy?</h3>
<p style="text-align:justify;">We use numpy as numpy arrays are 50 times faster than Python's traditional List but again the question arises why the numpy arrays are faster - The answer is that NumPy arrays are stored at one continuous place in memory unlike lists, so processes can access and manipulate them very efficiently.
This behavior is called locality of reference in computer science.

This is the main reason why NumPy is faster than lists. Also it is optimized to work with latest CPU architectures.Numpy is also widely use in the field of <b>Data Science.</b></p>

<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4">Data Science is the field where we deal with complex data and make predictions by analyzing data.</p>
</div>
...
<div id="id01" class="modal text-center ml-auto mr-auto" style="box-shadow:none;border:none;outline: none;">
...
function prev(){
  window.open("home_numpy.php","_self");
}
