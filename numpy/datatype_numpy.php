...
<html lang="en-Us">
    <head>
        <title>Data Types in Numpy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Data Types in Numpy - Data Structures in NumPy - BestPythonTutorials.com" />
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
       <img src="numpybanner.png" class="ml-auto mr-auto img-fluid mt-3 mb-3 text-center" style="width:100%;height:190px;">
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      <li><a href="home_numpy.php"  target="_self">Numpy Home</a></li>
      <li><a href="intro_numpy.php" target="_self">Introduction</a></li>
      <li><a href="ndarray_numpy.php" target="_self">NdArray</a></li>
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="datatype_numpy.php" target="_self">Data Types</a></li>
      <li><a href="array_creation_routines_numpy.php" target="_self">Array Creation Routines</a></li>
      <li><a href="array_attributes_numpy.php" target="_self">Array Attributes</a></li>
      <li><a href="array_from_existing_array_numpy.php" target="_self">Array From existing Array</a></li>
      <li><a href="iterating_over_array_numpy.php" target="_self">Iterating over an Array</a></li>
      <li><a href="mathematical_functions_numpy.php" target="_self">Mathematical Functions</a></li>
      <li><a href="string_functions_numpy.php" target="_self">String Functions</a></li>
      <li><a href="bitwise_operators_numpy.php" target="_self">Bitwise Operators</a></li>
      <li><a href="indexing_and_slicing_numpy.php" target="_self">Indexing and Slicing</a></li>
      <li><a href="broadcasting_numpy.php" target="_self">Broadcasting</a></li>
      <li><a href="arithmetic_operations_numpy.php" target="_self">Arithmetic Operations</a></li>
      <li><a href="statistical_functions_numpy.php" target="_self">Statistical Functions</a></li>
      <li><a href="sorting_numpy.php" target="_self">Sorting</a></li>
      <li><a href="searching_numpy.php" target="_self">Searching</a></li>
      <li><a href="matrix_library_numpy.php" target="_self">Matrix Library</a></li>
      <li><a href="linear_algebra_numpy.php" target="_self">Linear Algebra</a></li>
      <li><a href="matrix_operations_numpy.php" target="_self">Matrix Operations</a></li>
      <li><a href="functions_numpy.php" target="_self">Numpy Functions</a></li>
      <li><a href="copies_views_numpy.php" target="_self">Copies and Views</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
          <a href="home_numpy.php"  target="_self">Numpy Home</a>
      <a href="intro_numpy.php" target="_self">Introduction</a>
      <a href="ndarray_numpy.php" target="_self">NdArray</a>
      <a href="datatype_numpy.php" target="_self" style="color:white;">Data Types</a>
      <a href="array_creation_routines_numpy.php" target="_self">Array Creation Routines</a>
      <a href="array_attributes_numpy.php" target="_self">Array Attributes</a>
      <a href="array_from_existing_array_numpy.php" target="_self">Array From existing Array</a>
      <a href="iterating_over_array_numpy.php" target="_self">Iterating over an Array</a>
      <a href="mathematical_functions_numpy.php" target="_self">Mathematical Functions</a>
      <a href="string_functions_numpy.php" target="_self">String Functions</a>
      <a href="bitwise_operators_numpy.php" target="_self">Bitwise Operators</a>
      <a href="indexing_and_slicing_numpy.php" target="_self">Indexing and Slicing</a>
      <a href="broadcasting_numpy.php" target="_self">Broadcasting</a>
      <a href="arithmetic_operations_numpy.php" target="_self">Arithmetic Operations</a>
      <a href="statistical_functions_numpy.php" target="_self">Statistical Functions</a>
      <a href="sorting_numpy.php" target="_self">Sorting</a>
      <a href="searching_numpy.php" target="_self">Searching</a>
      <a href="matrix_library_numpy.php" target="_self">Matrix Library</a>
      <a href="linear_algebra_numpy.php" target="_self">Linear Algebra</a>
      <a href="matrix_operations_numpy.php" target="_self">Matrix Operations</a>
      <a href="functions_numpy.php" target="_self">Numpy Functions</a>
      <a href="copies_views_numpy.php" target="_self">Copies and Views</a>
  </div>
</div>
</div>
...
<!--search ends-->
    <h2 style="text-align:left;color:#a54eee;">Data Types - NumPy</h2>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/datatype_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/datatype_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Python supports basic data types such as string , numbers and booleans whereas numpy support a very wide range of Data Types which is good for Data Analysis.A complete table is given below:</p>
...
<tr>
  <td>1</td>
  <td>bool_</td>
  <td>It represents the boolean value indicating true or false. It is stored as a byte.</td>
</tr> 
<tr>
  <td>2</td>
  <td>int_</td>
  <td>It is the default type of integer. It is identical to long type in C that contains 64 bit or 32-bit integer. </td>
</tr>
<tr>
  <td>3</td>
  <td>intc</td>
  <td>It is similar to the C integer (c int) as it represents 32 or 64-bit int. </td>
</tr>
<tr>
  <td>4</td>
  <td>intp</td>
  <td>It represents the integers which are used for indexing.</td>
</tr>
<tr>
  <td>5</td>
  <td>int8</td>
  <td>It is the 8-bit integer identical to a byte. The range of the value is -128 to 127. </td>
</tr>
<tr>
  <td>6</td>
  <td>int16</td>
  <td>It is the 2-byte (16-bit) integer. The range is -32768 to 32767. </td>
</tr>
<tr>
  <td>7</td>
  <td>int32</td>
  <td>It is the 4-byte (32-bit) integer. The range is -2147483648 to 2147483647. </td>
</tr>
<tr>
  <td>8</td>
  <td>int64</td>
  <td>It is the 8-byte (64-bit) integer. The range is -9223372036854775808 to 9223372036854775807. </td>
</tr>
<tr>
  <td>9</td>
  <td>uint8</td>
  <td>It is the 1-byte (8-bit) unsigned integer. </td>
</tr>
<tr>
  <td>10</td>
  <td>uint16</td>
  <td>It is the 2-byte (16-bit) unsigned integer.</td>
</tr> 
<tr>
  <td>11</td>
  <td>uint32</td>
  <td>It is the 4-byte (32-bit) unsigned integer. </td>
</tr>
<tr>
  <td>12</td>
  <td>uint64</td>
  <td>It is the 8 bytes (64-bit) unsigned integer.</td>
</tr> 
<tr>
  <td>13</td>
  <td>float_</td>
  <td>It is identical to float64. </td>
</tr> 
<tr>
  <td>14</td>
  <td>float16</td>
  <td>It is the half-precision float. 5 bits are reserved for the exponent. 10 bits are reserved for mantissa, and 1 bit is reserved for the sign.</td>
</tr>
<tr>
  <td>15</td>
  <td>float32</td>
  <td>It is a single precision float. 8 bits are reserved for the exponent, 23 bits are reserved for mantissa, and 1 bit is reserved for the sign. </td>
</tr>
<tr>
  <td>16</td>
  <td>float64</td>
  <td>It is the double precision float. 11 bits are reserved for the exponent, 52 bits are reserved for mantissa, 1 bit is used for the sign. </td>
</tr>
<tr>
  <td>17</td>
  <td>complex_</td>
  <td>It is identical to complex128. </td>
</tr>
<tr>
  <td>18</td>
  <td>complex64</td>
  <td>It is used to represent the complex number where real and imaginary part shares 32 bits each.</td>
</tr> 
<tr>
  <td>19</td>
  <td>complex128</td>
  <td>It is used to represent the complex number where real and imaginary part shares 64 bits each. </td>
</tr>
</tbody></table>
</div>

<h3 class="text-left mt-4" style="color:#a54eee">Data Type Object(dtype)</h3>
<p style="text-align:justify;">A data type object describes interpretation of fixed block of memory corresponding to an array, depending on the following aspects −
</p>
<ul style="text-align:justify;list-style:square;">
<li>Type of data (integer, float or Python object)

<li>Size of data

<li>Byte order (little-endian or big-endian)

<li>In case of structured type, the names of fields, data type of each field and part of the memory block taken by each field.

<li>If data type is a subarray, its shape and data type
</ul>
<p style="text-align:justify;">The byte order is decided by prefixing '<' or '>' to data type. '<' means that encoding is little-endian (least significant is stored in smallest address). '>' means that encoding is big-endian (most significant byte is stored in smallest address).
</p>
...
<ul style="text-align:justify;list-style:square;">
<li>Object − To be converted to data type object

<li>Align − If true, adds padding to the field to make it similar to C-struct

<li>Copy − Makes a new copy of dtype object. If false, the result is reference to builtin data type object
</ul>
...
function next(){
  window.open("array_creation_routines_numpy.php","_self");
}
function prev(){
  window.open("ndarray_numpy.php","_self");
}
