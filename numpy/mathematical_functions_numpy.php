...
<html lang="en-Us">
    <head>
        <title>Mathematical Functions  in Numpy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="mathematical_functions_numpy.php" target="_self">Mathematical Functions</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="mathematical_functions_numpy.php" target="_self" style="color:white;">Mathematical Functions</a>
...
<!--search ends-->
    <h3 style="text-align:left;color:#a54eee;">Mathematical Functions in Numpy</h3>
