...
<html lang="en-Us">
    <head>
        <title>Bitwise Operators in NumPy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Bitwise Operators in NumPy - NumPy Bitwise Operators - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="bitwise_operators_numpy.php" target="_self">Bitwise Operators</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="bitwise_operators_numpy.php" target="_self" style="color:white;">Bitwise Operators</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Bitwise Operators - Numpy</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/bitwise_operators_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/bitwise_operators_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
  <p style="text-align:justify;" class="mt-4">NumPy provides a wide range of Binary or Bitwise Operators which are an essential part of the Scientific Calculations.</p>
<div style="overflow:scroll;" class="mt-4">
...
<p style="text-align:justify;" class="mt-4">Now the main thing is how these operators works - you may have noticed that it has included <code>and</code> keyword which is a comparison operator now there's another term i.e. bitwise now we can think bitwise as 'binary wise' i.e. binary form.So the conclusion is that the binary form of numbers is compared but again the question arises how the compiler compares the 0s and 1s.It is compared by the below logic displayed in the table.To explain this we have taken an example of 12 and 15 and the binary form of 12 and 15 are 1100 and 1111 respectively.So they compared like this of both the opposite bits are same the new bit will be 1 and otherwise it will be 0.  </p>
...
function next(){
  window.open("indexing_and_slicing_numpy.php","_self");
}
function prev(){
  window.open("string_functions_numpy.php","_self");
}
