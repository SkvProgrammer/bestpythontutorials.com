...
<html lang="en-Us">
    <head>
        <title>Linear Algebra in NumPy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Linear Algebra NumPy - Using Linear Algebra in NumPy - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="linear_algebra_numpy.php" target="_self">Linear Algebra</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="linear_algebra_numpy.php" target="_self" style="color:white;">Linear Algebra</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Linear Algebra - Numpy</h3>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Linear algebra is a branch of mathematics concerned with vector spaces and the mappings between those spaces. NumPy has a package called <b>linalg</b>. This page is meant only to familiarize you with the NumPy’s linear algebra functions for those who are interested</p>

<p style="text-align:justify;">Now the linear algebra module <b>linalg</b> supports various methods for applying linear algebra on numpy arrays.</p>
<ol style="text-align:justify;list-style:square;">
<li>rank, determinant, trace, etc. of an array.
<li>eigen values of matrices
<li>matrix and vector products, matrix exponentiation
<li>solve linear or tensor equations and much more!  
</ol>
...
<h4 class="text-left mt-5 mb-4" style="color:#a54eee;">Matrix eigenvalues Functions</h4>
<div style="overflow:scroll;" class="mb-3">
...
<h4 class="text-left mt-5" style="color:#a54eee;">Matrix and Vector Products</h4>
<p style="text-align:justify;">Now we will see the use of many matrix functions for finding product.</p>
<div style="overflow:scroll;">
  <table class="numpy-table">
<tbody><tr>
<th>Function</th>
...
<tr>
<td><strong>linalg.multi_dot()</strong></td>
...
<tr>
<td><strong>linalg.matrix_power()</strong></td>
...
product = np.dot(5, 4)
print("Dot Product of scalar values is : ", product)
 
vector_a = 4 + 4j
vector_b = 4 + 7j
 
product = np.dot(vector_a, vector_b)
print("Dot Product of vectors is : ", product)
...
plt.show()
  ...
  <h4 class="text-left mt-5">Output of the above code</h4>
<img src="basicplot.png" class="img-fluid">
...
function prev(){
  window.open("matrix_library_numpy.php","_self");
}
