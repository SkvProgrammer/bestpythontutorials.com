...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="../codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Flask Tutorials - BestPythonTutorials.com"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,django tutorials">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
       ...
       <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="home_numpy.php"  target="_self">Numpy Home</a></li>
       <li><a href="intro_numpy.php" target="_self">Introduction</a></li>
       <li><a href="ndarray_numpy.php" target="_self">NdArray</a></li>
       <li><a href="datatype_numpy.php" target="_self">Data Types</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="home_numpy.php"  target="_self" style="color:white;">Numpy Home</a>
<a href="intro_numpy.php" target="_self">Introduction</a>
<a href="ndarray_numpy.php" target="_self">NdArray</a>
<a href="datatype_numpy.php" target="_self">Data Types</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">NumPy Tutorial</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">



<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/home_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" > <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/numpy/home_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;">This tutorial series is designed for beginners as well as working professionals.Numpy is a great framework for working with numerical data.We have tried our best to provide you best content.</p>
<h3 class="text-center mt-4" style="color:#a6a6a6;">PREREQUISITES</h3>
<p style="text-align:justify;">Since Numpy is a Python based scientific framework the knowledge of Python Programming is must for this tutorial series.Check Out Our <a href="../home.php" style="color:grey;text-decoration:none;">Awesome Python Tutorials <img src="../django/link.png" style="height:10px;"></a></p>
...
function next(){
  window.open("intro_numpy.php","_self"); 
}
function prev(){
