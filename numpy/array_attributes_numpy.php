...
<html lang="en-Us">
    <head>
        <title>Array Attributes in Numpy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Array Attributes in NumPy - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="array_attributes_numpy.php" target="_self">Array Attributes</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="array_attributes_numpy.php" target="_self" style="color:white;">Array Attributes</a>
...
<!--search ends-->
    <h2 style="text-align:left;color:#a54eee;">Array Attributes - NumPy</h2>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/array_attributes_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/array_attributes_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we are going to talk about the numpy array attributes.Attributes are special parameters which provide some functionalities to the numpy methods.Let us discuss them - </p>


<h4 class="text-left mt-4" style="color:#a54eee;">ndarray.ndim</h4>
...
<h4 class="text-left mt-4" style="color:#a54eee;">ndarray.shape</h4>
...
<h4 class="text-left mt-4" style="color:#a54eee;">ndarray.size</h4>
...
<h4 class="text-left mt-4" style="color:#a54eee;">ndarray.dtype</h4>
...
<h4 class="text-left mt-4" style="color:#a54eee;">ndarray.itemsize</h4>
