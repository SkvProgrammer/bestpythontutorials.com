...
<html lang="en-Us">
    <head>
        <title>Statistical Functions in NumPy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Statistical Functions in NumPy - How to use Statistical Functions in NumPy BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="statistical_functions_numpy.php" target="_self">Statistical Functions</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="statistical_functions_numpy.php" target="_self" style="color:white;">Statistical Functions</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Statistical Functions - Numpy</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/statistical_functions_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/statistical_functions_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">NumPy provides quiet a lot of Statistical Functions for finding the average,median,mode,mean and standard deviation.</p>
...
###mean###
print("Average value in the array is:",np.mean(a))
###median###
print("Median value in the array is:",np.median(a))
##standard deviation###
print("Standard Deviation is:",np.std(a))
</code>
  </div>

  <h4 class="text-left mt-4" style="color:#a54eee;">numpy.amax() and numpy.amin()</h4>
...
###amin###
print("Minimum value in the array is:",np.amin(a))
###amax###
print("Maximum value in the array is:",np.amax(a))
</code>
  </div>


  <h4 class="text-left mt-4" style="color:#a54eee;">numpy.percentile()</h4>

<div class="container p-1" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">numpy.percentile(input, q, axis)</div>  
<p style="text-align:justify;">It accepts the following parameters.
</p>
<ol style="text-align:justify;list-style:square;">
<li>input: It is the input array.
<li>q: It is the percentile (1-100) which is calculated of the array element.
<li>axis: It is the axis along which the percentile is to be calculated.
</ol>
...
a = np.array([[20,30,40],[80,90,99],[21,40,20]])  
...
function next(){
  window.open("sorting_numpy.php","_self");
}
function prev(){
  window.open("arithmetic_operations_numpy.php","_self");
}
