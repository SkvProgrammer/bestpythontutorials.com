...
<html lang="en-Us">
    <head>
        <title>Indexing and Slicing in NumPy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Indexing in NumPy - Slicing in NumPyh - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="indexing_and_slicing_numpy.php" target="_self">Indexing and Slicing</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="indexing_and_slicing_numpy.php" target="_self" style="color:white;">Indexing and Slicing</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Indexing & Slicing - Numpy</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/indexing_and_slicing_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/indexing_and_slicing_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">The content or elements of NdArray can be easily modified using indexing and slicing in NumPy.There are three types of indexing methods :- <b>Field Access</b>,<b>Basic Slicing</b> and <b>Advanced Indexing</b>.</p>
...
print(array1[1])
#method 2
print(array1[0:2])#elements between 1 and 2 including 1 and excluding 2
</code>
  </div>
<p style="text-align:justify;" class="mt-4">One thing you might have noticed that we are actually using Python's List and we can definitely use them as arrays then why we should use NumPy - The simple answer is that NumPy provides a much wider range of operations through large library of methods and attributes which the Python's Default List does not support.</p>

<h3 class="text-left mt-4" style="color:#a54eee;">Basic Slicing</h3>
<p style="text-align:justify;">Basic Slicing: We are Considering the syntax x[index] where x is the array and index is the index number. Slice object is the index in case of basic slicing. Basic slicing occurs when index is :</p>
<p style="text-align:justify;">1) a slice object that is of the form start : stop : step
an integer</p>
<p style="text-align:justify;">
2) or a tuple of slice objects and integers
</p>
<p style="text-align:justify;">
3) All arrays generated by basic slicing are always view of the original array.
</p>
...
array1 = np.arange(5)#similar to range function of basic python library 
print("Array is:",array1) 

print("Basic slicing, getting all elements = ",array1[0:5]) 
...
print("Basic slicing, getting the elements of  uneven order = ",array1[0:5:2]) 
...
<p style="text-align:justify;">Advanced indexing returns a copy of data rather than a view of it. Advanced indexing is of two types integer and Boolean.</p>
...
<p style="text-align:justify;">This chapter is now over and I recommend you to try out more and more examples as possible as it will help you to grab the concept of indexing and slicing for a long time.</p>
