...
<html lang="en-Us">
    <head>
        <title>Matrix Operations in NumPy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Matrix Operations in NumPy - NumPy Matrix Operations - BestPythonTutorials.com" />
  ...
  <!--vertical menu-->
   <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">NUMPY TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="matrix_operations_numpy.php" target="_self">Matrix Operations</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">NUMPY TUTORIAL</h1></a>
      ...
      <a href="matrix_operations_numpy.php" target="_self" style="color:white;">Matrix Operations</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Matrix Operations - Numpy</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/numpy/matrix_operations_numpy.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/numpy/matrix_operations_numpy.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<div style="overflow:scroll;">
  <table>
    ...
    <tr>
      <td>add()</td>
      <td>This functions adds the corresponding elements of the matrix.</td>
    </tr>
    <tr>
      <td>subtract()</td>
      <td>This method returns the difference of the elements of the natrix.</td>
    </tr>
    <tr>
      <td>divide()</td>
      <td>This method returns the quotient after dividing the matrices.</td>
    </tr>
    <tr>
      <td>multiply()</td>
      <td>This method returns the product of the elements of the matrix(element wise multiplication).</td>
    </tr>
    <tr>
      <td>dot()</td>
      <td>This function is used to compute the matrix multiplication, rather than element wise multiplication.</td>
    </tr>
    <tr>
      <td>sqrt()</td>
      <td>This function is used to compute the square root of each element of matrix.</td>
    </tr>
    <tr>
      <td>sum(x,axis)</td>
      <td>This function is used to add all the elements in matrix. Optional “axis” argument computes the column sum if axis is 0 and row sum if axis is 1.</td>
    </tr>
      <tr>
        <td>T</td>
        <td> This argument is used to transpose the specified matrix.Transpose means rows becomes columns and columns becomes rows.</td>
      </tr>
...
function next(){
  window.open("functions_numpy.php","_self");
}
function prev(){
