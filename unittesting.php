...
<html lang="en-Us">
    <head>
        <title>Unittesting in python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Unittesting in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,unittesting in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li><a href="micropython.php" target="_self">MicroPython</a></li>    
    <li><a href="pythondescriptors.php" target="_self">Python Descriptors</a></li>
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li><a href="forensics.php" target="_self">Python Forensics</a></li>
    <li><a href="virtualenv.php" target="_self">Virtual Environment</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="unittesting.php" target="_self">Unit Testing</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="virtualenv.php" target="_self">Virtual Environment</a>
    ...
    <a href="unittesting.php" target="_self" style="color:white;">Unit Testing</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Unit Testing in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/unittesting.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/unittesting.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<h3 style="text-align:left;color:#a54eee;" class="mt-5">OOPs Concept Supported by unittest Framework</h3>
<p style="text-align:justify;">To achieve this, unittest supports some important concepts in an object-oriented way:</p>

<p style="text-align:justify;"><b>test fixture</b><br>
A test fixture represents the preparation needed to perform one or more tests, and any associated cleanup actions. This may involve, for example, creating temporary or proxy databases, directories, or starting a server process.
</p>
<p style="text-align:justify;"><b>test case</b><br>
A test case is the individual unit of testing. It checks for a specific response to a particular set of inputs. unittest provides a base class, TestCase, which may be used to create new test cases.
</p>
<p style="text-align:justify;"><b>test suite</b><br>
...
if __name__ == '__main__':
  ...
  <p style="text-align:justify;" class="mt-5">A testcase is created by subclassing unittest.TestCase. The three individual tests are defined with methods whose names start with the letters test. This naming convention informs the test runner about which methods represent tests.</p>
 <p style="text-align:justify;">
The crux of each test is a call to <code>assertEqual()</code> to check for an expected result; <code>assertTrue()</code> or <code>assertFalse()</code> to verify a condition; or <code>assertRaises()</code> to verify that a specific exception gets raised. These methods are used instead of the assert statement so the test runner can accumulate all test results and produce a report.
</p>
 <p style="text-align:justify;">
The <code>setUp()</code> and <code>tearDown()</code> methods allow you to define instructions that will be executed before and after each test method. They are covered in more detail in the section Organizing test code.
</p>
 <p style="text-align:justify;">
The final block shows a simple way to run the tests. <code>unittest.main()</code> provides a command-line interface to the test script. When run from the command line, the above script produces an output that looks like this:</p>

<h3 style="text-align:left;color:#a54eee;" class="mt-5">Running Tests</h3>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
...<br>
----------------------------------------------------------------------<br>
...
<h3 class="text-left mt-5" style="color:#a54eee;">Outcomes Possible</h3>
<p style="text-align:justify;">
There are three types of possible test outcomes :
</p>
<p style="text-align:justify;"><b>OK</b> – This means that all the tests are passed.
<p style="text-align:justify;"><b>FAIL</b> – This means that the test did not pass and an AssertionError exception is raised.
<p style="text-align:justify;"><b>ERROR</b> – This means that the test raises an exception other than AssertionError.</p>
<h3 class="text-left mt-5">Test cases</h3>
<p style="text-align:justify;"><i>class unittest.<code>TestCase</code>(methodName='runTest')</i></p>
<p style="text-align:justify;">
...
<p style="text-align:justify;">Methods in the first group (running the test) are:</p>

<h3 style="text-align:left;color:#a54eee;" class="mt-3">setUp()</h3>
<p style="text-align:justify;">
Method called to prepare the test fixture. This is called immediately before calling the test method; other than AssertionError or SkipTest, any exception raised by this method will be considered an error rather than a test failure. The default implementation does nothing.
</p>
<h3 style="text-align:left;color:#a54eee;" class="mt-3">tearDown()</h3>
<p style="text-align:justify;">
...
<h3 style="text-align:left;color:#a54eee;" class="mt-3">setUpClass()</h3>
<p style="text-align:justify;">A class method called before tests in an individual class are run. setUpClass is called with the class as the only argument and must be decorated as a classmethod():
</p>
<p style="text-align:justify;color:#a54eee;" class="mt-4">
...
<tbody>
<tr class="row-even"><td><p><a class="reference internal"  title="unittest.TestCase.assertEqual"><code class="xref py py-meth docutils literal notranslate"><span class="pre">assertEqual(a,</span> <span class="pre">b)</span></code></a></p></td>
<td><p><code class="docutils literal notranslate"><span class="pre">a</span> <span class="pre">==</span> <span class="pre">b</span></code></p></td>
<td></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal"  title="unittest.TestCase.assertNotEqual"><code class="xref py py-meth docutils literal notranslate"><span class="pre">assertNotEqual(a,</span> <span class="pre">b)</span></code></a></p></td>
<td><p><code class="docutils literal notranslate"><span class="pre">a</span> <span class="pre">!=</span> <span class="pre">b</span></code></p></td>
<td></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal"  title="unittest.TestCase.assertTrue"><code class="xref py py-meth docutils literal notranslate"><span class="pre">assertTrue(x)</span></code></a></p></td>
...
<tr class="row-odd"><td><p><a class="reference internal"  title="unittest.TestCase.assertFalse"><code class="xref py py-meth docutils literal notranslate"><span class="pre">assertFalse(x)</span></code></a></p></td>
...
<tr class="row-even"><td><p><a class="reference internal" title="unittest.TestCase.assertIs"><code class="xref py py-meth docutils literal notranslate"><span class="pre">assertIs(a,</span> <span class="pre">b)</span></code></a></p></td>
...
<tr class="row-odd"><td><p><a class="reference internal"  title="unittest.TestCase.assertIsNot"><code class="xref py py-meth docutils literal notranslate"><span class="pre">assertIsNot(a,</span> <span class="pre">b)</span></code></a></p></td>
...
<tr class="row-even"><td><p><a class="reference internal"  title="unittest.TestCase.assertIsNone"><code class="xref py py-meth docutils literal notranslate"><span class="pre">assertIsNone(x)</span></code></a></p></td>
...
<tr class="row-odd"><td><p><a class="reference internal"  title="unittest.TestCase.assertIsNotNone"><code class="xref py py-meth docutils literal notranslate"><span class="pre">assertIsNotNone(x)</span></code></a></p></td>
...
<tr class="row-even"><td><p><a class="reference internal"  title="unittest.TestCase.assertIn"><code class="xref py py-meth docutils literal notranslate"><span class="pre">assertIn(a,</span> <span class="pre">b)</span></code></a></p></td>
...
<tr class="row-odd"><td><p><a class="reference internal"  title="unittest.TestCase.assertNotIn"><code class="xref py py-meth docutils literal notranslate"><span class="pre">assertNotIn(a,</span> <span class="pre">b)</span></code></a></p></td>
...
<tr class="row-even"><td><p><a class="reference internal"  title="unittest.TestCase.assertIsInstance"><code class="xref py py-meth docutils literal notranslate"><span class="pre">assertIsInstance(a,</span> <span class="pre">b)</span></code></a></p></td>
<td><p><code class="docutils literal notranslate"><span class="pre">isinstance(a,</span> <span class="pre">b)</span></code></p></td>
<td><p>3.2</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal"  title="unittest.TestCase.assertNotIsInstance"><code class="xref py py-meth docutils literal notranslate"><span class="pre">assertNotIsInstance(a,</span> <span class="pre">b)</span></code></a></p></td>
...
function next(){
  window.open("subprocessmodule.php","_self"); 
}
function prev(){
  window.open("serialization.php","_self");
}
