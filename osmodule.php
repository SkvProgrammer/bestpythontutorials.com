...
<html lang="en-Us">
    <head>
        <title>OS Module in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="OS Module in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="osmodule.php" target="_self">Os Module</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="osmodule.php" target="_self" style="color:white;">Os Module</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Os Module in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/osmodule.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/osmodule.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
  ...
  <p style="text-align:justify;" class="mt-4">OS Module is a in-built module in python which is used to interact with the Operating System.
        The OS module provides a large range of useful methods to manipulate files and directories in the Operating System.</p>
        <h3 style="text-align:left;">Some of the useful methods are listed below:-</h3>
        <hr>
        <h2 style="text-align:left;color:#a54eee;">os.name</h1>
        <p style="text-align:justify;"> The name of the operating system dependent module imported. The following names have currently been registered: 'posix', 'nt', 'ce', 'java'.</p>  
        <div class="container-fluid" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;font-family: 'Roboto Condensed', sans-serif;">
             <comment>import</comment> os<br>
             <keyword>print</keyword>(os.name)
             </p></div>
             <p class="text-center">Output of the above code</p>
              <div class="container-fluid" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;font-family: 'Roboto Condensed', sans-serif;">
             <keyword>nt</keyword>
             </p></div>
             <p style="text-align:left;">Operating System used:Windows 10</p>
             <hr>

             <h2 style="text-align:left;color:#a54eee;">os.getcwd()</h1>
        <p style="text-align:justify;"> The location of Current Working Directory(CWD) is returned.This varies from System to System.</p>  
        <div class="container-fluid" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;font-family: 'Roboto Condensed', sans-serif;">
             <comment>import</comment> os<br>
             <keyword>print</keyword>(os.getcwd())
             </p></div>
             <p class="text-center">Output of the above code</p>
              <div class="container-fluid" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;font-family: 'Roboto Condensed', sans-serif;">
             <keyword>C:\Users\Raj\AppData\Local\Programs\Python\Python37</keyword>
             </p></div>
             <hr>
               <h2 style="text-align:left;color:#a54eee;">os.error</h1>
        <p style="text-align:justify;">All functions in this module raise OSError in the case of invalid or inaccessible file names and paths, or other arguments that have the correct type, but are not accepted by the operating system. os.error is an alias for built-in OSError exception.</p>  
                 <hr>
                  <h2 style="text-align:left;color:#a54eee;">os.popen()</h1>
                  <p style="text-align:justify;">This method opens a pipe to or from command. The return value can be read or written depending on whether mode is ‘r’ or ‘w’.</p>
                  <hr>
                   <h2 style="text-align:left;color:#a54eee;">os.close()</h1>
                   <p style="text-align:justify;">Close file descriptor fd. A file opened using open(), can be closed by close()only. But file opened through os.popen(), can be closed with close() or os.close(). If we try closing a file opened with open(), using os.close(), Python would throw TypeError.</p>
                   <hr>
                   <h2 style="text-align:left;color:#a54eee;">os.rename()</h1>
                   <p style="text-align:justify;">A file january.txt can be renamed to feb.txt, using the method os.rename(). The name of the file changes only if, the file exists and user has sufficient privilege permission to change the file name.</p>
...
function prev(){
  window.open("timemodule.php","_self");
}
