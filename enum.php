...
<html lang="en-Us">
    <head>
        <title>Enumerate Function in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Enumerate Function in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial, Enumerate Function in Python,count the number of Iterations in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="enum.php" target="_self">Enumerate function</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="enum.php" target="_self" style="color:white;">Enumerate function</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Enumerate Function in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/enum.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/enum.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In Programming we often need to count the number of <b>Iteration</b>.So,for that in Python we have an in-built function called <code>enumerate()</code> which is used to count the number of iterations.</p>
 <div class="mb-3 mt-3">
...
<h3 style="text-align:left;color: #a54eee;" class="mt-5">SYNTAX</h3>
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
            <keyword>enumerate</keyword>(iterable,start)
             </div>


<h3 style="text-align:left;color: #a54eee;" class="mt-5">PARAMETERS</h3>
...
<table>
  ...
  <tr>
    <td>iterable</td>
    <td>Any Object which can be iterated using loops.</td>
  </tr>
  <tr>
    <td>start</td>
    <td>Index number for counting the number of iterations.Default is 0.You can give any value.</td>
  </tr>
</table>
</div>
<div class="text-left mt-5">
  <h3 style="text-align:left;color: #a54eee;" class="mt-4">Using enumerate() function for a List</h3>
...
for count,element in enumerate(list1,100): 
    print(count,element)
...
function prev(){
  window.open("introception.php","_self");
}
