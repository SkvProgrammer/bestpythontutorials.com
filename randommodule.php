...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Random Module in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="randommodule.php" target="_self">Random Module</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="randommodule.php" target="_self" style="color:white;">Random Module</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Random Module in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/randommodule.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/randommodule.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
  ...
  <p style="text-align:justify;" class="mt-4">This module is used to deal with operation on random numbers.It has a set of functions that are used to generate or manipulate random numbers.</p>
         <p style="text-align:left;">Important functions in <code>Random</code> module are listed below :- </p>
         <!-------------------SEED-------------------->
         <h3 style="text-align:left;color:#a54eee;" class="mt-4">seed()</code></h3>
         <p style="text-align:justify;">The <code>seed()</code> is one of the methods in Python's random module. It initializes the pseudorandom number generator. You should call it before generating the random number. If you use the same seed to initialize, then the random output will remain the same.</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
  ...
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
              <keyword>0.5714025946899135</keyword>
             </div>


       

        <h3 style="text-align:left;color:#a54eee;" class="mt-4">choice()</h3>
         <p style="text-align:justify;">The <code>choice()</code> is one of the methods in Python's random module which is used to generate one random number from a container(List,Tuple or other type of Array).</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
  ...
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
      ...
      <div class="container-fluid mt-5" style="background-color:#ffffcc;">
<p style="text-align:justify;" class="mt-4 mb-5 pb-5 pt-5"><strong>Note:</strong>The above code can return any value from the list.</p>
</div>
        ...
        <h3 style="text-align:left;color:#a54eee;" class="mt-4">randint()</h3>
         <p style="text-align:justify;">The <code>randint()</code> method takes two parameters as numbers and return a number between them.</p>
         <h4 style="text-align:left;color:#a54eee;" class="mt-4">SYNTAX</h4>
  ...
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
        ...
        <div class="container-fluid mt-5" style="background-color:#ffffcc;">
<p style="text-align:justify;" class="mt-4 mb-5 pb-5 pt-5"><strong>Note:</strong>
          Both <i>start</i> and <i>stop</i> parameters are required.</p>
</div>
<br>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
  ...
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
       ...
       <br>
             <div class="container-fluid mt-5 pt-5 pb-4" style="background-color:#ffffcc;padding:20px;">
              <p style="text-align:justify;"><strong>Note:</strong>The above code can return any value from the list.</p>
             ...
             <h2 style="text-align:left;color:#a54eee;" class="mt-5">randrange(start,stop,step)</h2>
         <p style="text-align:justify;">This function is also used to generate random number but within a range specified in its arguments. This function takes 3 arguments, start (included in generation), stop (excluded in generation) and step ( to skip numbers in range while selecting).</p>
         <h4 style="text-align:left;color:#a54eee;" class="mt-4">SYNTAX</h4>
        

  <div class="container p-2 mb-5" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
            randrange(start,stop,step)
             </div>
         <!--<p style="text-align:justify;"><strong>Note:</strong>
          Both <i>start</i> and <i>stop</i> parameters are required.</p>-->
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
  ...
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
           3
             ...
             <div class="container-fluid mt-5 pt-5 pb-4" style="background-color:#ffffcc;padding:20px;">
              <p style="text-align:justify;"><strong>Note:</strong>The Output of the above code can vary everytime.</p>
...
function next(){
  window.open("sysmodule.php","_self");
}
function prev(){
  window.open("osmodule.php","_self");
}
