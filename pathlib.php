...
<html lang="en-Us">
    <head>
        <title>Pathlib Module in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Pathlib Module in Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,pathlib module in python"> 
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="pathlib.php" target="_self">Pathlib Module</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="pathlib.php" target="_self" style="color:white;">Pathlib Module</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Pathlib Module in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pathlib.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/pathlib.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">The <code>Pathlib Module</code> in Python simplifies the way in working with files and folders. The Pathlib module is available from <code>Python 3.4</code> and higher versions. It combines the best of Python's file system modules namely os, os.path, glob, etc.</p>
 <div class="mb-3 mt-3">
...
<p style="text-align:justify;">Before moving further into details of the Pathlib module, it's important to understand two different concepts namely - path and directory.
</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Getting Started</h4>
<p style="text-align:justify;">If you’ve never used this module before or just aren’t sure which class is right for your task, Path is most likely what you need. It instantiates a concrete path for the platform the code is running on.
</p>

<p style="text-align:justify;">Pure paths are useful in some special cases; for example:
</p>
<ul style="text-align:justify;font-size:20px;">
    <li>If you want to manipulate Windows paths on a Unix machine (or vice versa). You cannot instantiate a WindowsPath when running on Unix, but you can instantiate PureWindowsPath.
</li>
<li>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Pure Paths
</h4>
<p style="text-align: justify;">
...
<h4 class="text-left mt-2">class pathlib.<b>PurePath</b>(*pathsegments)
</h4>
    <p style="text-align:justify;">A generic class that represents the system’s path flavour (instantiating it creates either a PurePosixPath or a PureWindowsPath):
       </p>
...
obj = PureWindowsPath('directory / file') 
...
<h4 class="text-left mt-4">class pathlib.<b>Path</b>(*pathsegments) </h4>
<p style="text-align:justify;">This is a subclass of <code>pathlib.PurePath</code> class. It represents concrete paths of the system’s path flavour. Upon instantiating, this class will create either pathlib.PosixPath or pathlib.WindowsPath.
</p>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<h4 class="text-left mt-4">class pathlib.<b>PosixPath</b>(*pathsegments)</h4>
<p style="text-align:justify;">This class is a subclass of <code>pathlib.Path</code> and <code>pathlib.PurePosixPath</code> class. This class represents the concrete non-Windows file system paths.
</p>
<p style="text-align:justify;">
<b>Note</b>: You can not instantiate pathlib.Posixpath class on Windows operating system.
</p>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<h4 class="text-left mt-4">class pathlib.<b>WindowsPath</b>(*pathsegments)</h4>
<p style="text-align:justify;">
This class is a subclass of <code>pathlib.Path</code> and <code>pathlib.PureWindowsPath</code>. This class represents the concrete Windows file system paths.
</p>
...
<p style="text-align:justify;" class="mt-2">Learn more about the <b>Pathlib</b> Module in the <a href="https://docs.python.org/3/library/pathlib.html" style="color:grey;text-decoration:none;">Official Docs <img src="django/link.png" style="height:10px;"></a>.</p>
...
function next(){
  window.open("inner.php","_self"); 
}
function prev(){
  window.open("aws.php","_self");
}
