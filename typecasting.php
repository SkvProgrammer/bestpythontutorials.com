...
<html lang="en-Us">
    <head>
        ...
        <meta name="description" content="Type Casting in Python - Type Conversion in Python - Explicit and Implicit Type Conversion in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="typecasting.php" target="_self">Type Casting</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="typecasting.php" target="_self" style="color:white;">Type Casting</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;">Typecasting</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/typecasting.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/typecasting.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
           ...
           <p style="text-align:justify;" class="mt-4">In programming we often need to define the type of data of a variable it can be done manually or the interpreter itself does the job...</p>
            <h3 style="text-decoration:none;text-align:left;color:#a54eee;">DEFINITION</h3>
           <p style="text-align:justify;">Type Casting is the process of specifying a Data Type to the Variable by using Constructor Functions...<br>Now Let us see how to use or implement type casting in Python...
           </p>
            <div class="mb-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           ...
           <p style="text-align:left;">Some commonly used constructor functions for type casting are :- </p>

         
<ol style="text-align:justify;">
             <li><p><code>int</code>() : This function converts a variable type to an integer...</p>
              <li><code>int</code>(a,base):This function converts any data type to integer...<b>a</b> is the required variable or you can directly put some value...variable  ‘Base’ specifies the base in which string is if data type is string...</p></li>
              <li><p><code>float</code>() : This function converts a variable type to a floating point number i.e decimal representation...</p></li>
              <li><p><code>str</code>() : This function converts a variable to string type...</p></li>
              <li><p><code>ord</code>() : This function converts a character type to integer...</p></li>
              <li><p><code>hex</code>() : This function converts an integer to Hexadecimal string...</p></li>
              <li><p><code>oct</code>() : This function converts an integer to octal string...</p></li>
              <li><p><code>list</code>() : This function converts any data type to list type...</p></li>
              <li><p><code>set</code>() : This function converts any data type to set ...</p></li>
              <li><p><code>tuple</code>() : This function converts a variable type to tuple...</p></li>
              <li><p><code>dict</code>() : This function converts a variable type to mapping type(key-value pair)...</p></li>
           </ol>
...
<p style="text-align:justify;" class="mt-4"><b>Note</b>:Now there is a word similar to type casting i.e type conversion.The basic difference between Type Casting and Type Conversion i.e.  type Conversion is made “automatically” by compiler whereas, type casting is to be “explicitly done” by the programmer.</p>
</div>
...
function next(){
  window.open("operators.php","_self");
}
function prev(){
  window.open("datatypes.php","_self");
}
