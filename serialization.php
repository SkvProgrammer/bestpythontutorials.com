...
<html lang="en-Us">
    <head>
        <title>Serialization in python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Serialization in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,serialization in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="serialization.php" target="_self">Serialization</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="serialization.php" target="_self" style="color:white;">Serialization</a><a href="unittesting.php" target="_self">Unit Testing</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Serialization in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/serialization.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/serialization.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<h3 class="text-left mt-4" style="color:#a54eee;">Why do we need to use Serialization?</h3>
<p style="text-align:justify;">If an application requires a nominal amount of data persistency, then picking is the better option to be used. Pickling helps in saving the data on the disk, and thus you can re-work on it whenever needed. Pickling is the best choice while working on algorithms related to machine learning; there will be great time management since there will not be any rewrites or instructions to the model.</p>
...
<p style="text-align:justify;">We have two modules called <code>pickle</code> and <code>json</code> module to implement Serialization.Check out our 
             <a href="pickling.php" style="color:grey;text-decoration:none;">Awesome Pickle Module <img src="django/link.png" style="height:10px;"></a> and 
             <a href="json.php" style="color:grey;text-decoration:none;"> JSON Tutorial <img src="django/link.png" style="height:10px;"></a>.
 </p>
