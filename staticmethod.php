...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="@staticmethod in Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,@staticmethod in python,@static decorator">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="staticmethod.php" target="_self">@staticmethod</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="staticmethod.php" target="_self" style="color:white;">@staticmethod</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">@staticmethod in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/staticmethod.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/staticmethod.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
 ...
 <p style="text-align:justify;" class="mt-4">A static method is a method which is bound to the class and not to the objects of that class. But static method can’t access or modify the state of a class unlike a class method. Static method is defined inside the Class but it should not be considered as a class method. A class method takes “cls” as its first parameter while a static method needs no specific parameters. A class method can access and modify class state whereas a static method can’t access or modify it. Static method knows nothing about class state. A class method is created using <code>@classmethod</code> decorator while static method is created using <code>@staticmethod</code> decorator.</p>
 <div class="mb-3 mt-3">
...
<p style="text-align:justify;">In the above example, <code>@staticmethod</code> is applied to the <code>greet()</code> method. So, the <code>greet()</code> method can be called using the class name <code>person.greet()</code>, as well as using the object.</p>
...
# create greetings static method
person.greetings = staticmethod(person.greetings)
person.greetings()
...
<h4 class="text-left mt-4" style="color:#a54eee;">classmethod Vs staticmethod</h4>
...
A class method gets the class when the method is called. It knows abouts the classes attributes and methods.</p>
...
function next(){
  window.open("instancemethod.php","_self"); 
}
function prev(){
  window.open("classmethod.php","_self");
}
