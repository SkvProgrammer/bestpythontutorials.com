...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Virtual Environment in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,virtual Enviroment in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="virtualenv.php" target="_self">Virtual Environment</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="virtualenv.php" target="_self" style="color:white;">Virtual Environment</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Virtual Environment in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/virtualenv.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/virtualenv.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Python applications will often use packages and modules that don’t come as part of the standard library. Applications will sometimes need a specific version of a library, because the application may require that a particular bug has been fixed or the application may be written using an obsolete version of the library’s interface.
</p>
...
<h3 class="text-left mt-4" style="color:#a54eee;">Installing Virtual Environment</h3>
<p style="text-align:justify;">We can easily install <code>virtualenv</code> using Python's default package manager pip.</p>
<div class="container text-left p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;">pip install virtualenv</div>

<h3 class="text-left mt-4" style="color:#a54eee;">Creating Virtual Environment</h3>
<div class="container text-left p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;">virtualenv environment_name</div>

<p style="text-align: justify;" class="mt-4">After running this command, a directory named environment_name will be created. This is the directory which contains all the necessary executables to use the packages that a Python project would need. This is where Python packages will be installed.
If you want to specify Python interpreter of your choice, for example Python 3, it can be done using the following command:</p>
<h3 class="text-left mt-4" style="color:#a54eee;">Activating Virtual Environment</h3>
<p style="text-align:justify;" class="mb-0">On Windows,</p>
<div class="container text-left p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;">workon environment_name</div>

<p style="text-align:justify;" class="mb-0 mt-3">On Linux,Unix</p>
<div class="container text-left p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;">source environment_name/bin/activate</div>
</div>
</div>
...
function next(){
  window.open("contextmanager.php","_self"); 
}
function prev(){
