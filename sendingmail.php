...
<html lang="en-Us">
    <head>
        <title>Sending Mails in python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Sending Mails in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,sending mails in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="sendingmail.php" target="_self">Sending Mail</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="sendingmail.php" target="_self" style="color:white;">Sending Mail</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Sending Mails in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/sendingmail.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/sendingmail.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In this chapter we are going to cover the topic that how we can send emails using Python.The Simple Mail Transfer Protool is used to send mails.So in Python we have a module called <b>smtplib</b>.The name suggests that it is an SMTP Library.</p>
  <br>
           <script type="text/javascript">
  atOptions = {
...
<h3 class="text-left mt-4" style="color:#a54eee;">importing smtplib and setup</h3>
<div class="container" style="height:auto;width:100%;border:2px solid lightgrey;text-align:justify;background-color:#f2f2f2;">
  import <keyword>smtplib</keyword><br>
  smtp_name = smtplib.SMTP( [host [, port [, local_hostname]]] )
</div>
<h3 class="text-left mt-4" style="color: #a54eee;">EXPLANATION</h3>
<p style="text-align:justify;"><b>host</b> − This is the host running your SMTP server. You can specify IP address of the host or a domain name like bestpythontutorials.com. This is an optional argument.</p>
<p style="text-align:justify;"><b>port</b> − If you are providing host argument, then you need to specify a port, where SMTP server is listening. Usually this port would be 25.</p>
<p style="text-align:justify;"><b>local_hostname</b> − If your SMTP server is running on your local machine, then you can specify just localhost as of this option.</p>

<p style="text-align:justify;">An SMTP Object has an instance method which is called <b>sendmail</b>,which basically has three parameters:-</p>
<ul style="text-align:justify;font-size:20px;">
  <li>The <b>Sender</b> - Sender is the person or end from where the email is to be send.</li>
  <li>The <b>Reciever</b> - Reciever is the end where all the data or mails are recieved.</li>
  <li>The <b>Message</b> - Message is what we are trying to send.In our case it is email.</li>
</ul>
...
# starting TLS protocol for security 
s.starttls() 

# User Authentication 
s.login("sender_email_id", "sender_emails_password") 
...
message["Subject"] = "EMail with HTML content"
...
text = """\
Hi,
Check out bestpythontutorials.com
for awesome python tutorials
"""
html = """\
<html>
  <body>
    <p>Hi,<br>
       Check this:<br>
       <a href="http://www.bestpythontutorials.com">Best Python Tutorials by SkvProgrammer</a>.
    </p>
  </body>
</html>
"""
...
plain_message = MIMEText(text, "plain")
...
encodedcontent = base64.b64encode(file_content)# base64 content

sender = 'satyamvarman2004@gmail.com'
reciever = 'devtipsntricks.help@gmail.com'
...
part1 = """From: From Person &lt;satyamvarman2004@gmail.com&gt;
To: To Person &lt;devtipsntricks.help@gmail.com&gt;
