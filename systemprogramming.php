...
<html lang="en-Us">
    <head>
        <title>System Programming in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="System Programming in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,system programming in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="systemprogramming.php" target="_self">System Programming</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="systemprogramming.php" target="_self" style="color:white;">System Programming</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">System Programming in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/systemprogramming.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/systemprogramming.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">System Programming with Python is made a lot easy with the help of the os module, it serves as an abstract layer between the python program and the operating system, thus the main advantage of using python for system programming is that most commands are independent of the OS i.e, it is platform independent. All functions we discuss here require us to import the os module first,you can do it by using <code>'import os'</code>.</p>
<p style="text-align:justify;">Literally we can say that system programming is done in python with the help modules like <code>sys</code> or <code>os</code>.So,You can check out Tutorials on <a href="sysmodule.php" style="color:grey;text-decoration:none;">Sys Module <img src="django/link.png" style="height:10px;"></a> and <a href="osmodule.php" style="color:grey;text-decoration:none;">Os Module <img src="django/link.png" style="height:10px;"></a>.This chapter is just made to clarify you about System Programming.</p>
