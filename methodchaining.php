...
<html lang="en-Us">
    <head>
        <title>Method Chaining in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Method Chaining in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,method chaining in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="methodchaining.php" target="_self">Method Chaining</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="methodchaining.php" target="_self" style="color:white;">Method Chaining</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Method Chaining in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/methodchaining.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/methodchaining.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Method chaining is simply being able to add one function to whatever the second function returns. It is fairly easily implemented by ensuring that all chainable methods return self. (Note that this has nothing to do with __call()__).
...
<p style="text-align:justify;" class="mt-4">You can use the <kbd style="background-color:#f2f2f2;color:black;">Chain</kbd> Object in non-chained way also by ignoring their returned value.</p>
...
<p style="text-align:justify;" class="mt-4">Since all functions now returned the object itself, you can operate directly on the returned value. You can use method chaining with the below code</p>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
obj = Chain()<br>
obj.myline().printx().fun().printx()<br>
assert obj.kind == 'fun'
</div>
...
obj1 = Chain()
obj1.myline.printx().fun.printx()
assert obj1.kind == 'fun'

obj2 = Chain().myline.printx().fun.printx()
assert obj2.kind == 'fun'
</code>
  </div>
...
function next(){
  window.open("starpattern.php","_self"); 
}
function prev(){
