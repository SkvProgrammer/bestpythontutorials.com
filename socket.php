...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Socket Programming in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,Socket Programming in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="socket.php" target="_self">Socket Programming</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="socket.php" target="_self" style="color:white;">Socket Programming</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Socket Programming in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/socket.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/socket.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<div class="text-left mt-0">
  <h3 style="text-align:left;color:#a54eee;" class="mb-1 mt-3">SOCKET INSTANCE</h3>
...
import socket
socket_instance = socket.socket(socket.AF_INET, socket.SOCK_STREAM)</textarea>
...
<h3 style="text-align:left;color:#a54eee;" class="mt-3">EXPLANATION</h3>
<p style="text-align:justify;">In the Socket Instance we have passed two parameters that are AF_INET and SOCK_STREAM.AF_INET is the address family of ipv4 and SOCK_STREAM means connection oriented TCP Protocol.</p>
...
<h3 style="text-align:left;color:#a54eee;" class="mt-5">Connecting to a Server</h3>
<p style="text-align:justify;">Now we will se how we can connect to a server.In this example we will be connecting to <code>www.youtube.com</code>.In order to connect to a server we first need to know it's IP Address.Generally we have two ways to find out the IP Address of a server.We will discuss both of them in this tutorial.</p>
<h3 style="text-align:justify;color:#a54eee;" class="mt-4">Method 1</h3>
<div class="container" style="text-align:justify;height:auto;width:100%;border: 3px solid #f2f2f2">C:\Users\Your Name><keyword>ping</keyword> www.youtube.com</div><br>
<div class="container pt-2 pb-2" style="height:auto;width:100%;border-radius:10px;background-color:black;color:white;text-align:justify;font-family:'Roboto',sans-serif;">
  <p style="font-size:16px;">C:\Users\Your Name>ping www.youtube.com<br><br>

Pinging youtube-ui.l.google.com [216.58.203.46] with 32 bytes of data:<br>
Reply from 216.58.203.46: bytes=32 time=154ms TTL=51<br>
Reply from 216.58.203.46: bytes=32 time=122ms TTL=51<br>
Reply from 216.58.203.46: bytes=32 time=110ms TTL=51<br>
Reply from 216.58.203.46: bytes=32 time=118ms TTL=51<br><br>

Ping statistics for 216.58.203.46:<br>
    Packets: Sent = 4, Received = 4, Lost = 0 (0% loss),<br>
Approximate round trip times in milli-seconds:<br>
    Minimum = 110ms, Maximum = 154ms, Average = 126ms<br></p>
</div>

<h3 style="text-align:justify;color:#a54eee;" class="mt-4">Method 2</h3>
<div class="text-left mt-0">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<h4 style="text-align:left;text-decoration:none;" class="mt-4">Connecting to <code>youtube.com</code></h4>
<div class="text-left mt-3">
  <h3 class="text-left" style="color:#a54eee;">EXAMPLE</h3>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
try:
  ...
  print("Can't find the host")
  sys.exit() 

# connecting to the server 
socket_instance.connect((ip, port)) 

print("We have successfully connected to a socket") </textarea>
...
<h3 class="mt-5 text-left" style="color:#a54eee;">Designing a Basic Client-Server Architechture</h3>
<p style="text-align:justify;">Now we will build a simple server and client architecture using sockets.we will name the file for server side as <kbd>server.py</kbd> and for the client side <kbd>client.py</kbd>.In this program we will be using methods such as <code>bind()</code>,<code>listen()</code>,<code>accept</code> and <code>close()</code>.</p>

<h4 style="text-align:left" class="mt-5">server.py</h4>
...
</div><h4 style="text-align:left" class="mt-5">client.py</h4>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p style="text-align:justify;" class="mt-4">To run this program you first need to run the server.py file by first running it with the python command and then running it with telnet.</p>
<div class="container text-left" style="height:auto;width:100%;border:3px solid #f2f2f2;">
  $ python server.py
</div>
<p style="text-align:justify;" class="mt-2">Keep the above terminal open and type the below command in a new terminal.</p>
<div class="container text-left" style="height:auto;width:100%;border:3px solid #f2f2f2;">
...
function next(){
  window.open("functional.php","_self"); 
}
function prev(){
  window.open("copying.php","_self");
}
