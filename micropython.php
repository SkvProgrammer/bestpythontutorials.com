...
<html lang="en-Us">
    <head>
        <title>Micropython - The Amazing side of Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Micropython - The Amazing side of Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,micropython in python,pyboard,embedded programming in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="micropython.php" target="_self">MicroPython</a></li>    <li><a href="pythondescriptors.php" target="_self">Python Descriptors</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="micropython.php" target="_self" style="color:white;">MicroPython</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">MicroPython</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/micropython.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/micropython.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">MicroPython is a software implementation of a programming language largely compatible with Python 3, written in C, that is optimized to run on a microcontroller. MicroPython is a full Python compiler and runtime that runs on the micro-controller hardware. The user is presented with an interactive prompt to execute supported commands immediately. Included are a selection of core Python libraries; MicroPython includes modules which give the programmer access to low-level hardware.Let's look at the structure of the <b>PyBoard</b> which is used in <b>MicroPython.</b></p>

<img src="pyboard.jpg" class="img-fluid">


<h3 class="text-left mt-4" style="color:#a54eee;">Features of the PyBoard</h3>
<ul style="text-align:justify;font-size:20px;">
      ...
      <li> 4 LEDs (red, green, yellow and #4537d1) </li>
...
<h5 style="text-align:justify;color:#a54eee;" class="mt-3">If you want to learn more about micropython check out there official website - <a href="https://micropython.org/" style="color:grey;text-decoration:none;">Micropython.org <img src="../django/link.png" style="height:10px;"></a>.</h5>
...
function prev(){
  window.open("encapsulation.php","_self");
}
