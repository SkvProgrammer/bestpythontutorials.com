...
<html lang="en-Us">
    <head>
        <title>Recursion in Python | Recursive Method in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Recursion in Python - Python's Recursive Method"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="recursion.php" target="_self">Recursion</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="recursion.php" target="_self" style="color:white;">Recursion</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Recursion in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/recursion.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/recursion.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
 ...
 <h3 class="text-left mt-4" style="color:#a54eee;">Recursive Function</h3>

           <!--------------------------------- MODAL STARTS ------------------------>
<div id="mymodalfactorial" class="modal modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title text-center">What is Factorial of a number ??</h5>
      </div>
      <div class="modal-body">
        <p>The factorial of a positive integer n, denoted by n!, is the product of all positive integers less than or equal to n: For example, The value of 0! is 1 and of 2! is 2 and 1! is 1 according to the convention for an empty product.</p>
      </div>
...
<!-----------------------------------MODAL ENDS------------------------->
        <p style="text-align:justify;">Recursive function is a special function in which the function is called within it's body.Some problems can be very easily solved by using Recursion but In all cases using Recursion will create Confusion.For Example,For Finding the Factorial of a number Recursion is the best way.</p>
