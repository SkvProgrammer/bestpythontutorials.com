...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Polymorphism in python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,polymorphism in python,method overloading,method overriding,duck typing,operator overloading">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="polymorphism.php" target="_self">Polymorphism</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="polymorphism.php" target="_self" style="color:white;">Polymorphism</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Polymorphism in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/polymorphism.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/polymorphism.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<h3 style="text-align:left;color:#a54eee;" class="mt-4">Ways of Achieving Polymorphism</h3>
<p style="text-align:justify;">We can Achieve Polymorphism in Python by for ways:-
<ol style="text-align:left;font-size:18px;">
  <li>Duck Typing</li>
  <li>Method Overloadding</li>
...
<h3 style="text-align:left;color:#a54eee;" class="mt-4">Duck Typing</h3> 
<p style="text-align:justify;"><b>Duck Typing</b> is  a Type System of the <b>Dynamically Typed Programming Languages</b>.Programming Languages Like Python,Ruby,Perl and Ruby are some of the popular examples of <b>Dynamically Typed Language.</b><br><br>
...
<div class="container" style="border:2px solid lightgrey;">
  <i>“If it looks like a duck and quacks like a duck, it’s a duck”</i>
  <div class="container" style="height:20vh;width:100%;">
  </div>
</div>
<h4 style="text-align:left;color:#a54eee;" class="mt-4">EXAMPLE</h4>
 <div data-datacamp-exercise data-no-lazy-loading data-lang="python">
