...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Generators in Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,programming tutorial,generators,generators in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="generators.php" target="_self">Generators</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="generators.php" target="_self" style="color:white;">Generators</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Generators in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/generators.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/generators.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;">Iterator in python is any python type that can be used with a ‘for in loop’. Python lists, tuples, dicts and sets are all examples of inbuilt iterators. These types are iterators because they implement following methods. In fact, any object that wants to be an iterator must implement following methods.
</p>
<ul style="text-align:justify;font-size:19.5px;">
    <li><b>__iter__ method</b> that is called on initialization of an iterator. This should return an object that has a next or __next__ (in Python 3) method.
    </li><li><b>next ( __next__ in Python 3)</b> The iterator next method should return the next value for the iterable. When an iterator is used with a ‘for in’ loop, the for loop implicitly calls next() on the iterator object. This method should raise a StopIteration to signal the end of the iteration.</li>
  </ul>
<div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>

<p style="text-align:justify;" id="yield">Now I think you are clear with the Iterators let's discuss about the <b>yield keyword ?</b></p>

    <p style="text-align:justify;">The <code>yield</code> statement suspends function’s execution and sends a value back to the caller, but retains enough state to enable function to resume where it is left off. When resumed, the function continues execution immediately after the last yield run. This allows its code to produce a series of values over time, rather than computing them at once and sending them back like a list.</p>

<p style="text-align:justify;">Now guys we are going to move on to the core topic i.e. <b>Generators ?</b>In order to learn Generators we need to learn about two terms that are :- <b>Generator Object</b> and <b>Generator Method</b></p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Generator Function</h4>
...
x = generator(2)
#we can only access the generator using loops
for i in x:
  print(i)
</code>
  </div>
...
<div class="container-fluid p-2 mt-4" style="background-color:#ffffcc;">
<p style="text-align:justify;" class="mt-4"><b>Note:</b>If you try to print out the generator directly it will print some awkward value like <b>&lt;generator object generator at 0x7f320c21fcf0&gt;</b>.This awkward thing is actually a <b>Generator Object</b> and in order to print the actual value we need to use the <b>loops.</b></p>
</div>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Generator Object</h4>
...
print(x.__next__()) 
  ...
  <p class="mt-4" style="text-align:justify;">This Chapter is now over you can solve more problems based on Generators to grab this concept in a well manner.</p>
...
function next(){
  window.open("generatorsvslist.php","_self"); 
}
function prev(){
  window.open("setcomprehension.php","_self");
}
