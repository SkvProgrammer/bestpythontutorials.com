...
<html lang="en-Us">
    <head>
        <title>CGI Programming in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="CGI Programming in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,cgi programming in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="cgiprogramming.php" target="_self">CGI Programming</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="cgiprogramming.php" target="_self" style="color:white;">CGI Programming</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">CGI Programming in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/cgiprogramming.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/cgiprogramming.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<br><br>
<img src="cgi.png" class="img-fluid">
<h3 class="text-left mt-4" style="color:#a54eee;">Installing Apache2</h3>
<p style="text-align:justify;">We recommend you to have the basic knowledge of HTML for this chapter.Check Out Our    <a href="html4/home_html4.php" style="color:grey;text-decoration:none;">HTML Tutorial <img src="django/link.png" style="height:10px;"></a>.For installation read this<a style="color:grey;text-decoration:none;" href="https://ubuntu.com/tutorials/install-and-configure-apache"> Article <img src="django/link.png" style="height:10px;"></a></p>
  ...
  <h3 class="mt-4" style="text-align:left;color:#a54eee;">EXAMPLE</h3>
...
if form.getvalue("name"): 
  ...
  print("<h1>Hello"  + name +"! Thanks for using my server!</h1><br />") 
if form.getvalue("happy"): 
  print("<p>I am very happy </p>") 
if form.getvalue("sad"): 
  print("<p> Why are you sad? </p>") 
...
<h3 style="text-align:justify;color:#a54eee;" class="mt-4">Advantages of CGI</h3>
<p style="text-align:justify;">
  <ul style="text-align:justify;font-size:20px;">
    <li>The advanced tasks are currently a lot easier to perform in CGI than in Java.</li>
<li>It is always easier to use the code already written than to write your own.</li>
<li>CGI specifies that the programs can be written in any language, and on any platform, as long as they conform to the specification.</li>  
  </ul>
</p>
...
<h3 style="text-align:justify;color:#a54eee;" class="mt-4">Disadvantages of CGI</h3>
<p style="text-align:justify;">
  <ul style="text-align:justify;font-size:20px;">
    <li>The main disadvantage of CGI is that each page load incurs overhead by having to load the programs into memory.</li>
    <li> Data cannot easily be cached in memory between page loads. Because of this disadvantage, many developers have moved to application servers that remain running.</li>
    <li>One disadvantage is that CGI programs are slow since they need to fork a new process for every HTTP request and the database connection must be reopened for the next instance of the program, which is quite costly </li>
  </ul>
</p>
...
function next(){
  window.open("logging.php","_self"); 
}
function prev(){
  window.open("xmlprogramming.php","_self");
}
