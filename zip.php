...
<html lang="en-Us">
    <head>
        <title>zip() method in Python | set() method in python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="zip,set method in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,zip() and set() method in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="zip.php" target="_self">Zip,Sets</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="zip.php" target="_self" style="color:white;">Zip,Sets</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">zip() and set() in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/zip.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/zip.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4"><code>zip()</code> method in python is used to map the similar index of multiple containers so that they can be used just using as single entity.</p>
<br>
           <script type="text/javascript">
  atOptions = {
...
<div class="container" style="border:3px solid lightgrey;text-align:justify;">
  <comment>zip</comment>(*iterators)
</div>
...
candidate_1 = ["Abhishek","Mohit","Ahan"]
candidate_2 = ["Anish","Ashish","Harsh"]
# using zip() to map values 
zipped_object = zip(candidate_1,candidate_2) 

# converting values to print as set 
un_mapped = set(zipped_object) 

# printing resultant values 
print ("The Candidates with their Competitors : ",end="") 
print (un_mapped) 

  </code>
  </div>
  <h3 class="text-left mt-5" style="color:#a54eee;">set() method</h3>
  <p style="text-align:justify;">If you have gone through high school mathematics then you might have studied the <b>Sets</b> Chapter in Mathematics.It's not a very difficult topic or you can say it's an easy topic to learn.In Python we have a built-in method for converting any datatype to sets.</p>
<br>
           <script type="text/javascript">
  atOptions = {
    'key' : 'ccab6f0b37ebcf46ae2cc8c860e3836a',
...
dict1 = {1:"BPT",2:"W3"}
tuple1 = ("Sat","Sun","Mon")
print("The list before conversion:",list1)
print("The list after conversion:",set(list1))
...
<div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
        The list before conversion: [1, 2, 3, 4]<br>
The list after conversion: {1, 2, 3, 4}<br>
The Dictionary before conversion: {1: 'BPT', 2: 'W3'}<br>
The Dictionary after conversion: {1, 2}<br>
The Tuple before conversion: ('Sat', 'Sun', 'Mon')<br>
The Tuple after conversion: {'Sun', 'Sat', 'Mon'}<br>
             </div>
...
function next(){
  window.open("sendingmail.php","_self"); 
}
function prev(){
  window.open("pickling.php","_self");
}
