...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Comprehensions in Python - List comprehension in Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,programming tutorial,list comprehension,comprehension">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="listcomprehension.php" target="_self">List Comprehension</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="listcomprehension.php" target="_self" style="color:white;">List Comprehension</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">List Comprehension in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/listcomprehension.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/listcomprehension.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
  ...
  <p style="text-align:justify;" class="mt-4"><code>Comprehensions</code> in Python provide us with a short and concise way to construct new sequences (such as lists, set, dictionary etc.) using sequences which have been already defined.</p>
        <p style="text-align:justify;"><b>List comprehension</b> is an elegant way to define and create list in Python. These lists have often the qualities of sets, but are not in all cases sets. List comprehension is a complete substitute for the lambda function as well as the functions map(), filter() and reduce().</p>
        <h3 style="text-align:left;color:#a54eee;" class="mt-4"><i>for</i> loop Vs List Comprehension</h3>
...
<p style="text-align:justify;" class="mt-4">You can see in the above program that for for finding the even numbers in a List , the <i>for</i> loop took around 5 lines of code while the List Comprehension does the same thing in only 2 lines of code.</p>
<div class="mb-3 mt-3">
...
<h3 style="text-align:left;color:#a54eee;" class="mt-4">List Comprehension Vs Lambda Function</h3>
    
        <p style="text-align: justify;">List comprehensions aren’t the only way to work on lists. Various built-in functions and lambda functions can create and modify lists in less lines of code.</p>
...
function next(){
  window.open("dictionarycomprehension.php","_self"); 
}
function prev(){
