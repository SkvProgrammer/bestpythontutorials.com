        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="HTTP methods in Flask - Flask Tutorial for HTTP - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <ul class="menu text-center">
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">FLASK TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="http_flask.php"  target="_self">HTTP Methods</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">FLASK TUTORIAL</h1></a>
      ...
      <a href="http_flask.php"  target="_self" style="color:white;">HTTP Methods</a>
...
<!--search ends-->
    <h2 style="text-align:left;">Flask HTTP Methods</h2>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/flask/http_flask.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/flask/http_flask.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">HTTP is the HyperText Transfer Protocol which is considered as the foundation of the data transfer in the world wide web. All web frameworks including flask need to provide several HTTP methods for data communication.</p>

<p style="text-align:justify;">The list of HTTP Methods in Flask are:</p>
...
<p style="text-align:justify;" class="mt-3">By default, the Flask route responds to the GET requests. However, this preference can be altered by providing methods argument to <code>route()</code> decorator.</p>

<h3 class="text-left mt-5">The GET() Method</h3>
<p style="text-align:justify;">In order to demonstrate the use of <b>GET()</b> method.We first need to create an HTML file.</p>
<div class="text-left mt-0 mb-1">
  <p class="text-left">login.html</p>
...
def login():  
      ...
      if name=="skv" and password=="12345":  
...
<p style="text-align:justify;" class="mt-3">Run the program and see the output.</p>

<h3 class="text-left mt-3">The POST() Method</h3>
<p style="text-align:justify;">Now we will see the use of the <code>POST()</code> method in flask.</p>
<div class="text-left mt-0 mb-1">
  <p class="text-left">login.html</p>
 <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
