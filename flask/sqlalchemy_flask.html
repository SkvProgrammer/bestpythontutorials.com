...
<html lang="en-Us">
    <head>
        <title>SQLAlchemy - BestPythonTutorials.com</title>
        <meta charset="utf-8">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <ul class="menu text-center">
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">FLASK TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="sqlalchemy_flask.php"  target="_self">SQLAlchemy</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">FLASK TUTORIAL</h1></a>
      ...
      <a href="sqlalchemy_flask.php"  target="_self" style="color:white;">SQLAlchemy</a>
...
<!--search ends-->
    <h2 style="text-align:left;color:#a54eee;">SQLAlchemy</h2>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/flask/sqlalchemy_flask.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/flask/sqlalchemy_flask.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">SQLAlchemy is an example of databases but why should we use SQLAlchemy.The major problem is that working with raw SQL in a Flask Application is quiet difficult so SQLAlchemy solved this problem by the <b>ORM</b> - Object Relational Mapping which helps to use the SQL code in an Object Oriented Programming Language in a better way.</p>

<h3 class="text-left mt-4" style="color:#a54eee;">Installing SQLAlchemy</h3>
<div class="container p-1" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">
  pip install flask-sqlalchemy
</div>
<p style="text-align:justify;" class="mt-3">Import SQLAlchemy class from this module.
</p>
<div class="container p-1" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">from flask_sqlalchemy import SQLAlchemy
</div>
<p style="text-align:justify;" class="mt-3">Now create a Flask application object and set URI for the database to be used.
</p>
<div class="container p-1" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">app = Flask(__name__)<br>
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///students.sqlite3'
</div>

<p style="text-align:justify;" class="mt-2">Then create an object of SQLAlchemy class with application object as the parameter</p>
...
class students(db.Model):
   ...
   roll = db.Column(db.String(3))  
  
def __init__(self, name , roll ):
   self.name = name
   self.roll = roll </textarea>
