        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Flask Tutorial - Introduction to Flask - Features of Flask - Why to use Flask - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <ul class="menu text-center">
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">FLASK TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="intro_flask.php"  target="_self">Introduction</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">FLASK TUTORIAL</h1></a>
      ...
      <a href="intro_flask.php"  target="_self" style="color:white;">Introduction</a>
...
<!--search ends-->
    <h2 style="text-align:left;">Introduction to Flask</h2>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/flask/intro_flask.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/flask/intro_flask.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
  <p style="text-align:justify;" class="mt-4">Flask is a Python Framework for Developing Light-Weight Web Applications.Flask is based on Werkzeug WSGI toolkit and Jinja2 template engine. Both are Pocco projects.Flask was created by <b>Armin Ronacher</b> who leads an international group of python enthusiasts (POCCO).</p>
  <h3 class="text-left mt-4">A Brief Discussion on WSGI and JINJA2?</h3>

<h4 class="text-left mt-3">What is WSGI?</h4>
<p style="text-align:justify;" class="mt-0">It is an acronym for web server gateway interface which is a standard for python web application development. It is considered as the specification for the universal interface between the web server and web application.
</p>

<h4 class="text-left mt-3">What is Jinja2?</h4>
<p style="text-align:justify;" class="mt-0">Jinja2 is a web template engine which combines a template with a certain data source to render the dynamic web pages.
</p>

<h4 style="text-align:justify;" class="mt-5">In the next chapter we will setup the environment for developing a flask application.</h4>
</div>
<br><br>
...
function prev(){
  window.open("home_flask.php","_self");
}
