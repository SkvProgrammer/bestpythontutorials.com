...
<html lang="en-Us">
    <head> 
        <title>URL Building in Flask</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="URL Buidling in Flask - Learn URL Buidling in Flask - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <ul class="menu text-center">
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">FLASK TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="url_building_flask.php"  target="_self">URL Building</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">FLASK TUTORIAL</h1></a>
      ...
      <a href="url_building_flask.php"  target="_self" style="color:white;">URL Building</a>
...
<!--search ends-->
    <h2 style="text-align:left;">Flask URL Building</h2>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/flask/url_building_flask.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/flask/url_buidling_flask.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align: justify;" class="mt-4">URL Building is like mapping URLs for different pages.In Flask we have a function called <code>url_for()</code> function which  is used to build a URL to the specific function dynamically. The first argument is the name of the specified function, and then we can pass any number of keyword argument corresponding to the variable part of the URL. </p>

<h3 class="text-left mt-4">EXAMPLE</h3>
<div class="text-left mt-0 mb-1">
  <p style="text-align:justify;">Below I have created a simple flask application which will route to three pages of URL home , about and services.</p>
...
<p class="text-left mt-3">/home - Home Page </p>
<img src="url_building_flask1.png" alt="homepage" class="img-fluid" style="border:1px solid black;">
<p class="text-left mt-3">/about - About us Page </p>
<img src="url_building_flask2.png" alt="aboutpage" class="img-fluid" style="border:1px solid black;">
<p class="text-left mt-3">/services - Services Page </p>
<img src="url_building_flask3.png" alt="servicepage" class="img-fluid" style="border:1px solid black;">
