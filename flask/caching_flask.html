...
<html lang="en-Us">
    <head>
        <title>Caching in Flask - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Caching in Flask - Flask Cache - Saving files i temporary location - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <ul class="menu text-center">
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">FLASK TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="caching_flask.php"  target="_self">Caching</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">FLASK TUTORIAL</h1></a>
      ...
      <a href="caching_flask.php"  target="_self" style="color:white;">Caching</a>
...
<!--search ends-->
    <h2 style="text-align:left;color:#a54eee;">Caching in Flask</h2>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Caching is the process of storing files in cache or tempory storage location.So that they can be accessed more quickly. Technically, a cache is any temporary storage location for copies of files or data, but usually the term is used in reference to Internet technologies.</p>
<p style="text-align:justify;">Flask do not support Caching but there's an extension called <b>flask-caching</b> which is used for caching in Python.So as you know we first have to install it using pip.</p>
...
<p style="text-align:justify;" class="mt-4">Cache is a type of memory that is used to increase the speed of data access.</p>
</div>

<h3 class="text-left mt-4">Basic Setup</h3>
<div class="text-left mt-0 mb-1">
  <p class="text-left" class="mb-0">Cache is managed by <kbd style="background-color:#f2f2f2;color:black;">cache</kbd> instance</p>
...
cache = Cache(app, config={'CACHE_TYPE': 'simple'})  </textarea>
...
<p style="text-align:justify;" class="mt-3">You may also set up your Cache instance later at configuration time using init_app method:</p>
<div class="text-left mt-0 mb-1">
  <p class="text-left" class="mb-0">Cache is managed by <kbd style="background-color:#f2f2f2;color:black;">cache</kbd> instance</p>
 <form action="" method="post" target="_blank">
...
<h3 class="text-left mt-3" style="color:#a54eee;">Caching View Functions</h3>
<p style="text-align:justify;">To cache view functions you will use the cached() decorator. This decorator will use request.path by default for the cache_key:</p>
<div class="text-left mt-0 mb-1">
 <form action="" method="post" target="_blank">
...
<p style="text-align:justify;" class="mt-4">The cached decorator has another optional argument called unless. This argument accepts a callable that returns True or False. If unless returns True then it will bypass the caching mechanism entirely.
</p>


<p style="text-align:justify;">If you want to read more about caching <a href="https://flask-caching.readthedocs.io/en/latest/" target="_blank" style="color:grey;text-decoration:none;">click this link <img src="../django/link.png" style="height:10px;"></a></p>
