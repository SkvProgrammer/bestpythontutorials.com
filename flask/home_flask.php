...
<html lang="en-Us">
    <head>
        <title>Flask Tutorial - BestPythonTutorials.com</title>
        <meta charset="utf-8">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1 ,#4537d1 );border-top:1px solid white;border-bottom:1px solid white;"><a href="home_flask.php"  target="_self">Flask Home</a></li>
...
<a href="home_flask.php"  target="_self" style="color:white;">Flask Home</a>
...
<p style="text-align:justify;">This tutorial is designed for both beginners and working professionals to learn flask from starting to the end.Flask is an awesome framework for building light weight web applications in Python.</p>
<h3 class="text-center mt-4" style="color:#a6a6a6;">PREREQUISITES</h3>
<p style="text-align:justify;">The only prerequisite for this course is that you should be aware of basic HTML and Python.And for designing beautiful pages the knowledge of CSS will be plus point.</p>
