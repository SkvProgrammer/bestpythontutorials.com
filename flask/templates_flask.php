...
<html lang="en-Us">
    <head>
        <title>Templates in Flask</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Templates in Flask - Flask Template System - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <ul class="menu text-center">
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">FLASK TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="templates_flask.php"  target="_self">Templates</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">FLASK TUTORIAL</h1></a>
      ...
      <a href="templates_flask.php"  target="_self" style="color:white;">Templates</a>
...
<!--search ends-->
    <h2 style="text-align:left;color:#a54eee;">Templates in Flask</h2>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/flask/templates_flask.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/flask/templates_flask.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In Web Applications Templates are nothing but the HTML file which is the main UI component of the website.Although, flask facilitates us to return the response in the form of HTML templates. In this section of the tutorial, we will go through the ways using which we can return the HTML response from the web applications. </p>

<p style="text-align:justify;">First of all we will make an App which will print a statement in the browser without using templates and then we will make another web app which will use the template for doing the same.</p>


<h3 class="text-left mt-4" style="color:#a54eee;">Templates Example</h3>
<div class="text-left mt-0 mb-1">
  <p class="text-left mb-0">app.py</p>
...
<img src="templates1.png" class="img-fluid" style="border:1px solid black;">

<p style="text-align:justify;" class="mt-3">Now we will try to do the same using Templates...</p>
<div class="text-left mt-0 mb-1">
  <p class="text-left mb-0">app.py</p>
...
<h3 class="text-left mt-4" style="color:#a54eee;">Delimeters</h3>


<p style="text-align:justify;">Jinga 2 template engine provides some delimiters which can be used in the HTML to make it capable of dynamic data representation. The template system provides some HTML syntax which are placeholders for variables and expressions that are replaced by their actual values when the template is rendered.
</p>
<p style="text-align:justify;">The jinga2 template engine provides the following delimiters to escape from the HTML.
</p>
<p style="text-align:justify;">
<ul style="text-align:justify;">
<li>{% ... %} for statements
<li>{{ ... }} for expressions to print to the template output
<li>{# ... #} for the comments that are not included in the template output
<li># ... ## for line statements
</ul>
</p>
<h3 class="text-left mt-4" style="color:#a54eee;">Delimeters Example</h3>
<p style="text-align:justify;">In this example we will demonstrate the Deme</p>
<div class="text-left mt-0 mb-1">
  <p class="text-left mb-0">table.py</p>
 <form action="" method="post" target="_blank">
...
<div class="text-left mt-0 mb-1">
  <p class="text-left mb-0">table.html</p>
 <form action="" method="post" target="_blank">
...
<h3 class="text-left mt-4">Output of the code</h3>
<img src="table.png" class="img-fluid" style="border:1px solid black;">
...
function prev(){
  window.open("http_flask.php","_self");
}
