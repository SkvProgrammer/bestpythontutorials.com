...
<html lang="en-Us">
    <head>
        <title>First App in Flask</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Making our First Web App using Flask which will do nothing but will print a statement- BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <ul class="menu text-center">
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">FLASK TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="first_app_flask.php"  target="_self">First App</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">FLASK TUTORIAL</h1></a>
      ...
      <a href="first_app_flask.php"  target="_self" style="color:white;">First App</a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we will build a very basic flask application.In order to do this you need to use an IDE it would be better or you can also use Online IDEs.</p>
<p style="text-align:justify;">In this chapter we will make two simple apps one will simply print values in the page and the other will be a login form.</p>

<h3 class="text-left mt-4">First App in Flask</h3>
...
def first_app(): 
  return 'I am the first flask app'
...
<p style="text-align:justify;" class="mt-3 mb-3">Save the above file the run it and a development server will start at <b>127.0.0.1:5000</b> port and the below output will be given.This program is very small our next app is taking input from the user and printing his name.</p>

<h3 class="text-left mt-3">EXPLANATION</h3>
<p style="text-align:justify;">The above code is quiet simple if you have the knowledge of python programming.In line 1,We have imported the flask module.In line 3 , we have defined the flask app and in line 5 we have literally defined the app route and in line 12 we have executed the app.</p>
<h3 class="text-left mt-4">Output of the above code</h3>
<img src="first_app_flask.png" class="img-fluid" style="border:1px solid black;">


<p style="text-align:justify;" class="mt-3">Digging further into the context, the <code>route()</code> decorator in Flask is used to bind URL to a function. Now to extend this functionality our small web app is also equipped with another method <code>add_url_rule()</code> which is a function of an application object is also available to bind a URL with a function as in the above example, <code>route()</code> is used.
</p>
<div class="text-left mt-0 mb-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
def hello_app():
   return 'Hello'
app.add_url_rule('/', 'hello_app’, hello_app) </textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<div class="container" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">
  hello
</div>

<h3 class="text-left mt-4">EXAMPLE #2</h3>
<p style="text-align:justify;">In this example we are going to create a form in which we will take the user's name and will print it on the page.So we have to design a form it' really an easy task. </p>
<div class="text-left mt-0 mb-1">
  <p style="text-align:justify;">This is our HTML page in which we have created the form and the all the backend stuffs will be done in Flask.</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
function next(){
  window.open("app_routing_flask.php","_self");
}
function prev(){
  window.open("environment_setup_flask.php","_self");
}
