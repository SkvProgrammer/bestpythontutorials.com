...
<html lang="en-Us">
    <head>
        <title>Deploying Flask Applications - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Depolyment Flask - Deploying Flask Applications to heroku , AWS etc. - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <ul class="menu text-center">
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">FLASK TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="deployment_flask.php"  target="_self">Deploying</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">FLASK TUTORIAL</h1></a>
      ...
      <a href="deployment_flask.php"  target="_self" style="color:white;">Deploying</a>
...
<!--search ends-->
    <h2 style="text-align:left;color:#a54eee;">Deployment - Flask</h2>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/flask/deployment_flask.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/flask/deployment_flask.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">After building the complete application in flask you can deploy it to platforms like Heroku or AWS.Now We are not going to cover it.But we will provide links to the pages where it is taught how to deploy flask apps.</p>

<ul style="list-style:square;text-align:justify;">
  <li><p><a href="https://devcenter.heroku.com/articles/getting-started-with-python" style="color:grey;text-decoration:none;">Deploying Flask Applications to Heroku <img src="../django/link.png" style="height:10px;"></a></p></li>
   <li><p><a href="https://cloud.google.com/appengine/docs/standard/python3/runtime" style="color:grey;text-decoration:none;">Deploying Flask Applications to Google App Engine <img src="../django/link.png" style="height:10px;"></a></p></li>
    <li><p><a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/create-deploy-python-flask.html" style="color:grey;text-decoration:none;">Deploying Flask Applications to AWS <img src="../django/link.png" style="height:10px;"></a></p></li>
     <li><p><a href="https://help.pythonanywhere.com/pages/Flask/" style="color:grey;text-decoration:none;">Deploying Flask Applications to PythonAnyWhere <img src="../django/link.png" style="height:10px;"></a></p></li>
</ul>
