...
<html lang="en-Us">
    <head>
        <title>Flask Cookies - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Flask Cookies - What are cookies in Flask - How to use cookies in Flask - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <ul class="menu text-center">
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">FLASK TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="cookies_flask.php"  target="_self">Cookies</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">FLASK TUTORIAL</h1></a>
      ...
      <a href="cookies_flask.php"  target="_self" style="color:white;">Cookies</a>
...
<!--search ends-->
    <h2 style="text-align:left;color:#a54eee;">Flask Cookies</h2>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/flask/cookies_flask.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/flask/cookies_flask.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">A cookie is a normal text file which is stored in your computers while browsing which help the site in remembering the user information to provide better experience to the site visitors.</p>
<p style="text-align:justify;">Cookies are set by the server on the client's machine which will be associated with the client's request to that particular server in all future transactions until the lifetime of the cookie expires or it is deleted by the specific web page on the server.
</p>
...
<h3 class="text-left mt-4">SYNTAX</h3>
...
<p style="text-align:justify;" class="mt-3">In Flask, the cookies are set on the response object by using the set_cookie() method on the response object. The response object can be formed by using the make_response() method in the view function.</p>
<p style="text-align: justify;">
...
<h3 class="mt-4 text-left" style="color:#a54eee;">Cookie Example</h3>
<p style="text-align:justify;">We will create the cookie using an HTML form.</p>
<div class="text-left mt-0 mb-1">
  <p class="text-left mb-0">cookie.html</p>
...
<html>
   <body>
      <form action = "/setcookie" method = "POST">
         <p><h3>Enter Your Name or UserID</h3></p>
...
<div class="text-left mt-0 mb-1">
  <p class="text-left mb-0">cookie.py</p>
 <form action="" method="post" target="_blank">
...
def getcookie():
   ...
   return '<h1>Hello '+name+'</h1></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<p style="text-align:justify;" class="mt-3">Run the program and see the output.Now if he program is working,how we can determine the cookies.See the below Screenshot:</p>
<img src="cookie_check.png" class="img-fluid" style="border:1px solid black;">

<p style="text-align:justify;" class="mt-2">Click on the <i>i</i>    button to check the cookies in use.</p>
<img src="cookie_check1.png" style="border:1px solid black;" class="img-fluid">
...
function next(){
  window.open("static_files_flask.php","_self");
}
function prev(){
  window.open("templates_flask.php","_self");
}
