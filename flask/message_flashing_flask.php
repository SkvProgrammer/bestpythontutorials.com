...
<html lang="en-Us">
    <head>
        <title>Message Flashing in Flask - BestPythonTutorials.com</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Message Flashing in Flask - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <ul class="menu text-center">
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive!important;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px!important;">FLASK TUTORIAL</h4></li><br>
      ...
      <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="message_flashing_flask.php"  target="_self">Message Flashing</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">FLASK TUTORIAL</h1></a>
      ...
      <a href="message_flashing_flask.php"  target="_self" style="color:white;">Message Flashing</a>
...
<!--search ends-->
    <h2 style="text-align:left;color:#a54eee;">Message Flashing - Flask</h2>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/flask/message_flashing_flask.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/flask/message_flashing_flask.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Good applications and user interfaces are all about feedback. If the user does not get enough feedback they will probably end up hating the application. Flask provides a really simple way to give feedback to a user with the flashing system. The flashing system basically makes it possible to record a message at the end of a request and access it next request and only next request. This is usually combined with a layout template that does this. Note that browsers and sometimes web servers enforce a limit on cookie sizes. This means that flashing messages that are too large for session cookies causes message flashing to fail silently.</p>

<!------------------------------------------ADS------------------------>

<div class="container-fluid" style="width:100%;height:20vh;"></div>

<!--------------------------------------ADS---------------------------->


<h3 class="text-left mt-4" style="color:#a54eee;">Flashing EXAMPLE</h3>

<div class="text-left mt-0 mb-1">
<p style="text-align:justify;" class="mt-4">In this example we are going to create a simple flashing which comes in very handy while interacting with users.</p>
...
<p style="text-align:justify;">And here is the main.html template which does the main thing:
...
<p style="text-align:justify;" class="mt-2">Here is the index.html template which inherits from main.html:
</p>
<div class="text-left mt-0 mb-1">
 <form action="" method="post" target="_blank">
...
<p style="text-align:justify;" class="mt-3">And here is the login.html template which also inherits from main.html:
</p>
<div class="text-left mt-0 mb-1">
 <form action="" method="post" target="_blank">
...
function next(){
  window.open("sqlite_flask.php","_self");
}
function prev(){
