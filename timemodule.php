...
<html lang="en-Us">
    <head>
        <title>Time Module in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="time module in python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="timemodule.php" target="_self">Time module</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="timemodule.php" target="_self" style="color:white;">Time module</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Time Module in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/timemodule.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/timemodule.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
   ...
   <p style="text-align:justify;" class="mt-4">Python has a module called <code>Time</code> module which is used to deal with time-related problems.Now to use these module we have to first import it.</p>
     <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
                 import time
             </div>
       
        <p style="text-align:left;" class="mt-3">Now the time module has a bunch of in-built methods,we will be discussing them in this chapter...</p>
        <h3 style="text-align:left;color:#a54eee;">time.time() method</h3>
...
for i in range(1,10):
          ...
          continue
stop = time.time()
print("""Time taken by for loop:""",stop - start) 
...
8<br>
9<br>
Time taken by for loop: 0.015626907348632812</keyword>
             </div>
             ...
             <h3 style="text-align:left;color:#a54eee;" class="mt-4">time.ctime() method</h2>
     
          <p style="text-align:justify;"> This method takes seconds being passed since <i>epoch</i> as an argument and returns a string representing local time.
...
LocalTime = time.ctime(time_in_seconds)
print(LocalTime) 
               ...
               <h3 style="text-align:left;color:#a54eee;" class="mt-4">time.sleep() method</h2>
          
          <!--<p style="text-align:justify;">You can learn about time.sleep() by watching the video below...</p>
          <video controls loop autoplay style="height:auto;width:100%;">
