...
<html lang="en-Us">
    <head>
        <title>User Defined Modules in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="user defined modules in python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="userdefinedmodules.php" target="_self">User defined modules</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="userdefinedmodules.php" target="_self" style="color:white;">User defined modules</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">User Defined Modules</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/usedefinedmodules.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/userdefinedmodules.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
  ...
  <p style="text-align:justify;" class="mt-4"><b>Modules</b> created by the user are called <i>User Defined Modules</i> in Python.We will learn this concept by a simple example.But before we start we will have to learn about keywords such as <code>import</code> and <code>from</code> etc.</p>
        <p style="text-align:justify;">Suppose you have made a python file named <i><b>square.py</b></i> in which you have defined a method for finding the square of a number.Now you want to use the similar function in another python file named <i><b>copy.py </b></i>.So follow the steps given below and write the code in your IDE.</p>
        <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
            ...
            <p class="text-center"><b>square.py</b></p>
          <div class="container-fluid" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;font-family: 'Roboto Condensed', sans-serif;">
            <keyword>def</keyword> sq(n):<br>
            <keyword style="margin-left:20px;">print</keyword>(n**2)
             </p></div>
               <p class="text-center"><b>copy.py</b></p>
          <div class="container-fluid" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;font-family: 'Roboto Condensed', sans-serif;">
            <keyword>import</keyword> square<br>
            <keyword style="margin-left:20px;">print</keyword>(square.sq(2))
             </p></div>

              <p class="text-center">Output of copy.py file</p>
                <div class="container-fluid" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;font-family: 'Roboto Condensed', sans-serif;">
            <keyword>4
            <br>
            None</keyword>
             </p></div>
             <p style="text-align:left;"><strong>Note:</strong> None is nothing but the returned type as no value is assigned to the return.</p>
             <h4  style="text-align:left;text-decoration:none;">Using <code>from</code> keyword with the <code>import</code>  keyword</h4>
                 <p class="text-center"><b>square.py</b></p>
          <div class="container-fluid" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;font-family: 'Roboto Condensed', sans-serif;">
            <keyword>def</keyword> sq(n):<br>
            <keyword style="margin-left:20px;">print</keyword>(n**2)
               ...
               <p class="text-center"><b>copy.py</b></p>
          <div class="container-fluid" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;font-family: 'Roboto Condensed', sans-serif;">
            <keyword>from</keyword> square <keyword>import</keyword> sq<br>
            <keyword style="margin-left:20px;">print</keyword>(sq(2))
             </p></div>
       ...
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
             ...
             <p style="text-align: justify;"><strong>Explanation:</strong> We have noticed that by using <code>from</code> keyword we can directly import specific function or attribute and while calling the function we don't need to use the name of the module...</p>
             <p style="text-align:justify;">Now , Suppose a module contains ten or twenty functions/methods and you have to use all of them in another python file due to which the above code will become messy so we will have to import all the modules by using <code>*</code> Asterisk.See the below code to understand this concept</p>
             <p class="text-center"><b>copy.py</b></p>
               <div class="container-fluid" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;font-family: 'Roboto Condensed', sans-serif;">
            <keyword>from</keyword> square <keyword>import</keyword> *<br>
            <keyword style="margin-left:20px;">print</keyword>(sq(2))
             </p></div>
             <p class="text-center">Output of copy.py file</p>
                <div class="container-fluid" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;font-family: 'Roboto Condensed', sans-serif;">
       ...
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
             ...
             <p style="text-align:justify;">The above code gave the same output as given in other programs of this chapter...</p>
