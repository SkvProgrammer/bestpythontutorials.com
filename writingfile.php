...
<html lang="en-Us">
    <head>
        <title>Writing into a File in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Writing into a File in Python"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,writing into a file in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">PATTERNS</h4></li><br>
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">FILE HANDLING</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="writingfile.php" target="_self">Writing into a file </a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="writingfile.php" target="_self" style="color:white;">Writing into a file </a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Writing into a file in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/writingfile.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/writingfile.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In Python we have methods like <code>write()</code> and <code>append()</code> to write into a file and both of these function creates a new file when the specified file does not exists.</p>

   <div class="text-left mt-1">
    <h3 class="text-left mt-2" style="color:#a54eee;">Writing into an existing file</h3>
...
<div class="container mt-3 mb-3" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
  I am write() method
</div>
<p class="text-align:justify;" class="mt-5">We have used <a download href="demo.txt" style="color:white;background-color:orangered;text-decoration:none;border-radius:5px;padding-left:4px;padding-right:4px;">Demo.txt File</a> in all the examples.</p>
<div class="container-fluid" style="background-color:#ffffcc;">
<p style="text-align:justify;" class="mt-4 p-4">It's a good practice to close the file after certain operations because sometimes due to buffering the changes  may not be saved till the file is closed.</p>
</div>
 <div class="text-left mt-1">
    <h3 class="text-left mt-2" style="color:#a54eee;">Append Content to a File</h3>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
BestPythonTutorials.com is great place to learn coding<br>
  I am write() method
</div>
<div class="container-fluid" style="background-color:#ffffcc;">
<p style="text-align:justify;" class="mt-4 p-4"><b>Note:</b>If the file specified in <code>append()</code> and <code>write()</code> method is not defined then it will automatically create the file of same name.</p>
</div>
...
function next(){
  window.open("deletingfile.php","_self"); 
}
function prev(){
  window.open("readingfile.php","_self");
}
