...
<html lang="en-Us">
    <head>
        <title>C Extension Module in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="C Extension Modules in Python - C Modules in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,cmodules in Python,c-extension modules in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="cmodule.php" target="_self">C extension module</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="cmodule.php" target="_self" style="color:white;">C extension module</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">C Extensions Module in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/cmodule.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/cmodule.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In Python , We can easily integrate or add new in-built modules which are written in Java,C or C++.With another Python Script that's know as an <code>extension</code>.<br>In Your Computer you might have seen the weird <code>.dll</code>(Dynamically Linked Library) extension files,do you know what are these files these are actually C Extension Python Modules and In case of Unix Machines it's <code>.so</code> extension.</p>
...
<h3 style="text-align:justify;color:#a54eee;" class="mt-4">Writing Extensions</h3>
<p style="text-align:justify;">In Order to write your C Extension Modules you first need to install one of the versions of python developers Edition.We also need developer-specific packages of Python.Windows users get these headers as part of the package when they use the binary Python installer.<br>While writing a C Extension Module keep in mind to add <kbd>python.h</kbd> header in your C source File.</p>

<h3 style="text-align:justify;color:#a54eee;">C Functions</h3>
<p style="text-align:justify;">All user-visible symbols defined by Python.h have a prefix of Py or PY, except those defined in standard header files. For convenience, and since they are used extensively by the Python interpreter, "Python.h" includes a few standard header files: <code>&lt;stdio.h&gt;</code>, <code>&lt;string.h&gt;</code>, <code>&lt;errno.h&gt;</code>, and <code>&lt;stdlib.h&gt;</code>. If the latter header file does not exist on your system, it declares the functions <code>malloc()</code>, <code>free()</code> and <code>realloc()</code> directly.
<br>
...
<br><br>
<keyword>PyArg_ParseTuple()</keyword> returns true (nonzero) if all arguments have the right type and its components have been stored in the variables whose addresses are passed. It returns false (zero) if an invalid argument list was passed. In the latter case it also raises an appropriate exception so the calling function can return NULL immediately (as we saw in the example)</p>
<br>
           <script type="text/javascript">
  atOptions = {
...
<h3 style="text-align:justify;color:#a54eee;" class="mt-5">The Module’s Method Table and Initialization Function</h3>
<p style="text-align:justify;">This method table is a simple array of PyMethodDef structures. That structure looks something like this −</p>
...
<p style="text-align:justify;">The last part of your extension module is the initialization function. This function is called by the Python interpreter when the module is loaded. It is required that the function be named initModule, where Module is the name of the module.<br><br>

The initialization function needs to be exported from the library you will be building. The Python headers define <code>PyMODINIT_FUNC</code> to include the appropriate incantations for that to happen for the particular environment in which we're compiling. All you have to do is use it when defining the function.
<br><br>
Your C initialization function generally has the following overall structure.</p>
<br>
           <script type="text/javascript">
  atOptions = {
    'key' : 'ccab6f0b37ebcf46ae2cc8c860e3836a',
...
<h3 style="text-align:left;color:#a54eee;" class="mt-4">Using an Extension</h3>
<p style="text-align:justify;">In this section we will be trying to learn how to build and install an extension in Python.So in Python we have a special package called <i>distutils</i> which are used to build extensions.Look at the below program to understand what actually you have to do for building an Extension:</p>
<div class="text-left mt-0">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
setup(name='first_extension', version='1.0',  \
      ext_modules=[Extension('first_extension', ['first_extension.c'])])</textarea>
              <!---->
...
<p style="text-align:justify;" class="mt-3">Type the below command for making the extension ready to use.</p>
<div class="container" style="text-align:justify;border:3px solid #f2f2f2;">
  <keyword>python</keyword> file_name.py <comment>install</comment>
</div>
<p style="text-align:justify;" class="mt-4">After you have completed the above command you can make a new python file and use the module created in it.</p>
<div class="text-left mt-0">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
print(first_extension.helloworld())</textarea>
              <!---->
...
function next(){
  window.open("asynciomodule.php","_self"); 
}
function prev(){
  window.open("interfaces.php","_self");
}
