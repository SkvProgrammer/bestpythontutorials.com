...
<html lang="en-Us">
    <head>
        ...
        <meta name="description" content="Loops in Python - For Loop in python - While Loop in python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="loops.php" target="_self">Loops</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="loops.php" target="_self" style="color:white;">Loops</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;">Loops in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/loops.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/loops.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
<div class="container-fluid mt-5 mb-3" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><p style="text-align:justify;" class="mt-4"><strong>Note:</strong>Loops are also called <b>Iteration</b> or <b>Repetition Statements...</b></p></p>
       ...
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
        ...
        <h3 style="text-align:left;color:#a54eee;">for loop</h3>
      
        <p style="text-align:justify;">The for loop in Python is used to iterate over a sequence (it can be a list , tuple or a string) or other iterable objects. Iterating over a sequence is called <b style="color:#4537d1;">Traversal</b>.</p>
...
2 x 10 = 20<br>
 ...
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
             ...
             <h2 style="text-align:left;color:#a54eee;" class="mt-4">while loop</h2>
             
             <p style="text-align:justify;">while loop is used to execute a block of statements repeatedly until a given a condition is satisfied. And when the condition becomes false, the line immediately after the loop in program is executed.</p>
              <h3 style="text-align:justify;color:#a54eee;" class="mt-4">SYNTAX</h3>
              <div class="container p-2" style="background-color: #f2f2f2;border:2px solid lightgrey;text-align: justify;">while condition:<br>
statement(s)
              </div>
