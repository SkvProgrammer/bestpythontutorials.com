...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Modules in Python - what Are Modules in Python - Types of Modules in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="modules.php" target="_self">Modules</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="modules.php" target="_self" style="color:white;">Modules</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Modules in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/modules.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/modules.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
     ...
     <p style="text-align:justify;" class="mt-4">In Python Modules are used for organizing the code.In Simple Language , Modules are Python files which allows you to logically organize your code.Modules in Python can  have Functions,Classes and Objects that can be used in any python files...
          You can make your own modules or you have many built in modules such as <code1>math</code1> , <code1>platform</code1> , <code1>sys</code1> and <code1>os</code1>.You might be wondering that how we can use the <i>module</i> so we have a special keyword <code>import</code> which is used for this purpose. 
          </p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
  ...
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
             ...
             <h3 style="text-align:left;color:#a54eee;" class="mt-4">globals() and locals() Method</h3>
             
             <p style="text-align:justify;">The <code>globals()</code> method returns a dictionary containing the variables defined in the global namespace. When <code>globals()</code> is called from a method, a dictionary representing the global namespace of the module where the function or method is defined is returned , not from where it is being called.</p>
             <p style="text-align:justify">The <code>locals()</code> method returns a dictionary containing the variables defined in the local namespaces. Calling <code>locals()</code> in the global namespace is same as calling <code>globals()</code> and returning a dictionary representing the global namespace of the module</p>
...
<p style="text-align:justify;" class="mt-4"><strong>Note:</strong>First of all we will be Learning how to use a <i>user defined module</i> in our <a href="userdefinedmodules.php" style="color:grey;text-decoration:none;">next chapter <img src="django/link.png" style="height:10px;"></a>.</p>
</div>
          <h3 style="text-align:left;color:#a54eee;" class="mt-5">Module References</h3>
        
          <ul style="text-align:left;" id="modulereference"> 
            <li><a href="timemodule.php" style="text-decoration:underline;color:black;font-size:25px;">Time Module</a></li>
             <li><a href="timemodule.php" style="text-decoration:underline;color:black;font-size:25px;">Datetime Module</a></li>
              <li><a href="osmodule.php" style="text-decoration:underline;color:black;font-size:25px;">OS Module</a></li>
               <li><a href="randommodule.php" style="text-decoration:underline;color:black;font-size:25px;">Random Module</a></li>
                <li><a href="requestsmodule.php" style="text-decoration:underline;color:black;font-size:25px;">Request Module</a></li>
              <li><a href="sysmodule.php" style="text-decoration:underline;color:black;font-size:25px;">sys Module</a></li>
              <li><a href="cmathmodule.php" style="text-decoration:underline;color:black;font-size:25px;">CMath Module</a></li>
              <li><a href="cmathmodule.php" style="text-decoration:underline;color:black;font-size:25px;">Math Module</a></li>
          </ul>
...
function next(){
  window.open("userdefinedmodules.php","_self");
}
function prev(){
  window.open("recursionvsiteration.php","_self");
}
