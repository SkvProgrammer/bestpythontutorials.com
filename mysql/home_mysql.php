...
<meta charset="utf-8">
        ...
        <meta name="description" content="Abstraction in Python - Abstract Classes and Methods in Python"/>
...
<div class="bgimg">
  ...
  <div class="middle">
    <h1 style="font-size:10vw;">COMING SOON</h1>
    <button class="btn btn-success" onclick="window.open('../index.php','_self');" style="box-shadow:none;outline:none;border:none;">Return to Homepage</button><br>
    <hr>
