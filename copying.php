...
<html lang="en-Us">
    <head>
        <title>Object Copying in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Object Copying in Python - Shallow Copying - Deep Copying"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,object copying in Python,shallow copying in python,deep copying in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="copying.php" target="_self">Object Copying</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="copying.php" target="_self" style="color:white;">Object Copying</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Object Copying in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/copying.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/copying.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Assignment statements in Python do not copy objects, they create bindings between a target and an object.When we use = operator user thinks that this creates a new object; well, it doesn’t. It only creates a new variable that shares the reference of the original object. Sometimes a user wants to work with mutable objects, in order to do that user looks for a way to create “real copies” or “clones” of these objects. Or, sometimes a user wants copies that user can modify without automatically modifying the original at the same time, in order to do that we create copies of objects.<br><br>
...
<p style="text-align:justify;">To Copy Objects in Python you first need to import a module called <code>copy</code>.Below I have Provided a simple example of how <b>Deep Copying</b> and <b>Shallow Copying</b> Works in Python.</p>
</p>
...
<p style="text-align:justify;" class="mt-4">Deep Copying is the process in which the copying process occurs recursively. It means that first constructing a new collection object and then recursively populating it with copies of the child objects present in the original one. In case of deep copying, a copy of object is copied in other object. It means that any changes made to a copy of object do not reflect in the original object. In python, this is implemented using <code>deepcopy()</code> function.</p>
    <br>
           <script type="text/javascript">
  atOptions = {
    'key' : 'ccab6f0b37ebcf46ae2cc8c860e3836a',
...
import copy
list1 = [1,2,3,4]
print("Original List before DeepCopying:",list1)
list2 = copy.deepcopy(list1)
print("New List after DeepCopying:",list2)
list1[0] = 0
print("New List after making changes:",list2)
print("Original List after making changes:",list1)
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
              Original List before DeepCopying: [1, 2, 3, 4]<br>
New List after DeepCopying: [1, 2, 3, 4]<br>
New List after making changes: [1, 2, 3, 4]<br>
Original List after making changes: [0, 2, 3, 4]<br>

             </div>
<p style="text-align:justify;" class="mt-3">

You can see that changes are not made in the new list and are only made in original list.
</p>

<p style="text-align:justify;" class="mt-3">A shallow copy means creating a new object and then populating it with references of the child object found in the original one. The copying process does not follow recursion and therefore will not create copies of the child objects themselves. In case of shallow copy, a reference of object is copied in other object. It means that any changes made to a copy of object do reflect in the original object. In python, this is implemented using <code>copy()</code> function.</p>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
...
list1 = [1,2,3,4]
print("Original List before shallow copying:",list1)
list2 = copy.copy(list1)
print("New List after shallow copying:",list2)
list2[3] = 5
print("Original List after making changes:",list1)
print("New List after making changes:",list2)
