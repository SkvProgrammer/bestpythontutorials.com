        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Seaborn Tutorial - Seaborn Tutorial for Data Visualization - Seaborn is a Python data visualization library based on matplotlib. It provides a high-level interface for drawing attractive and informative statistical graphics.  - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <li class="nav-item active mr-auto ml-auto">
        <a class="nav-link" href="../seaborn/home_seaborn.php" target="_self">Seaborn</a>
      </li>
      <li class="nav-item mr-auto ml-auto">
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
    <ul class="mt-1">
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;">SEABORN TUTORIAL</h4></li><br>
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="home_seaborn.php"  target="_self">Seaborn Home</a></li>
   <li><a href="intro_seaborn.php"  target="_self">Introduction</a></li>
   <li><a href="environment_setup_seaborn.php"  target="_self">Environment Setup</a></li>
   <li><a href="inporting_datasets_seaborn.php"  target="_self">Importing Datasets</a></li>
   <li><a href="statistical_relationships_seaborn.php"  target="_self">Statistical Relationships</a></li>
   <li><a href="plotting_with_categorial_data_seaborn.php"  target="_self">Plotting With Categorial Data</a></li>
   <li><a href="visualizing_datasets_seaborn.php"  target="_self">Visualizing the Datasets</a></li>
   <li><a href="multiplot_grid_seaborn.php"  target="_self">Multiplot Grid</a></li>
   <li><a href="figure_aesthetics_seaborn.php"  target="_self">Figure Aesthetics</a></li>
   <li><a href="color_palletes_seaborn.php"  target="_self">Color Palletes</a></li>
   <li><a href="kernel_density_estimates_seaborn.php"  target="_self">Kernel Density Estimates</a></li>
   <li><a href="plotting_form_data_seaborn.php"  target="_self">Plotting Form Data</a></li>
   <li><a href="multipanel_categorial_plots_seaborn.php"  target="_self">Multi-Panel Categorial Plots</a></li>
   <li><a href="linear_relationships_seaborn.php"  target="_self">Linear Relationships</a></li>
   <li><a href="facet_grid_seaborn.php"  target="_self">Facet Grid</a></li>
   <li><a href="pair_grid.php"  target="_self">Pair Grid</a></li>
    </ul>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">SEABORN TUTORIAL</h1></a>
             <a href="home_seaborn.php"  target="_self" style="color:white;">Seaborn Home</a>
   <a href="intro_seaborn.php"  target="_self">Introduction</a>
   <a href="environment_setup_seaborn.php"  target="_self">Environment Setup</a>
   <a href="inporting_datasets_seaborn.php"  target="_self">Importing Datasets</a>
   <a href="statistical_relationships_seaborn.php"  target="_self">Statistical Relationships</a>
   <a href="plotting_with_categorial_data_seaborn.php"  target="_self">Plotting With Categorial Data</a>
   <a href="visualizing_datasets_seaborn.php"  target="_self">Visualizing the Datasets</a>
   <a href="multiplot_grid_seaborn.php"  target="_self">Multiplot Grid</a>
   <a href="figure_aesthetics_seaborn.php"  target="_self">Figure Aesthetics</a>
   <a href="color_palletes_seaborn.php"  target="_self">Color Palletes</a>
   <a href="kernel_density_estimates_seaborn.php"  target="_self">Kernel Density Estimates</a>
   <a href="plotting_form_data_seaborn.php"  target="_self">Plotting Form Data</a>
   <a href="multipanel_categorial_plots_seaborn.php"  target="_self">Multi-Panel Categorial Plots</a>
   <a href="linear_relationships_seaborn.php"  target="_self">Linear Relationships</a>
   <a href="facet_grid_seaborn.php"  target="_self">Facet Grid</a>
   <a href="pair_grid.php"  target="_self">Pair Grid</a>
  </div>
</div>
</div>
...
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/seaborn/home_seaborn.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/seaborn/home_seaborn.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
