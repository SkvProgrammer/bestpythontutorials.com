...
<html lang="en-Us">
    <head>
        <title>Quizzes - Python QUIZ - BestPythonTutorials.com</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="python quiz"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,python quiz">
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Quizzes</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/quizzes.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Awesome%20Quizzes%20at:http%3A//bestpythontutorials.com/quizzes.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<div class="container card-group">
  <div class="card m-1">  
    <img class="card-img-top img-fluid p-5" src="basicpythonquizbanner.png" alt="Card image">
    <div class="card-body">
      <h4 class="card-title">Basic Python Quiz</h4>
      <p class="card-text">It covers the basic concepts of Python.</p>
      <ul style="text-align:justify;font-family: 'Barlow', sans-serif!important;">
        <li><p style="text-align:justify;font-family: 'Barlow', sans-serif!important;">This quiz contains 25 questions.</p></li>
        <li><p style="text-align:justify;font-family: 'Barlow', sans-serif!important;">All questions will be MCQ.</p></li>
        <li><p style="text-align:justify;font-family: 'Barlow', sans-serif!important;">You will have to solve all questions within 5 minutes.</p></li>
      </ul>

    <a href="basic_python_quiz.php" class="btn btn-default newcolorbtn">Start Quiz</a>


    </div>
  </div>
    <div class="card m-1">
    <img class="card-img-top img-fluid p-5" src="pythonintermediatequizbanner.png" alt="Card image">
    <div class="card-body">
      <h4 class="card-title">Intermediate Python Quiz</h4>
      <p class="card-text">It covers many important topics of Python.</p>
       <ul style="text-align:justify;font-family: 'Barlow', sans-serif!important;">
        <li><p style="text-align:justify;font-family: 'Barlow', sans-serif!important;">This quiz contains 25 questions.</p></li>
        <li><p style="text-align:justify;font-family: 'Barlow', sans-serif!important;">All questions will be MCQ.</p></li>
        <li><p style="text-align:justify;font-family: 'Barlow', sans-serif!important;">You will have to solve all questions within 10 minutes.</p></li>
      </ul>

      <a href="intermediate_python_quiz.php" class="btn btn-default newcolorbtn">Start Quiz</a>
    </div>
  </div>

   <div class="card m-1">
    <img class="card-img-top img-fluid p-5" src="pythonadvancequizbanner.png" alt="Card image">
    <div class="card-body">
      <h4 class="card-title">Advance Python Quiz</h4>
      <p class="card-text">It covers the advance topics of Python.</p>
      <ul style="text-align:justify;font-family: 'Barlow', sans-serif!important;">
        <li><p style="text-align:justify;font-family: 'Barlow', sans-serif!important;">This quiz contains 25 questions.</p></li>
        <li><p style="text-align:justify;font-family: 'Barlow', sans-serif!important;">All questions will be MCQ.</p></li>
        <li><p style="text-align:justify;font-family: 'Barlow', sans-serif!important;">You will have to solve all questions within 15 minutes.</p></li>
      </ul>

      <a href="advance_python_quiz.php" class="btn btn-default newcolorbtn">Start Quiz</a>
    </div>
  </div>
</div>
