...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Descriptors in Python - Python Descriptors"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,python descriptors,descriptors in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="pythondescriptors.php" target="_self">Python Descriptors</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="pythondescriptors.php" target="_self" style="color:white;">Python Descriptors</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Descriptors in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pythondescriptors.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/pythondescriptors.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4"><b>Python Descriptors</b> 
are created in order to manage the attributes of different classes which uses the objects as references. In descriptors we use three different methods that are <code>__getters__()</code>,<code> __setters__()</code>, and <code>__delete__()</code>. If any of thsese methods are defined for an object, it can be termed as a <b>Descriptor</b>. Normally, Python uses methods like getters and setters to adjust the values on attributes without any special processing. It’s just a basic storage system. Sometimes, You might need to validate the values that are being assigned to a value. A descriptor is a mechanism behind properties, methods, static methods, class methods, and <code>super()</code>.</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Invoking Descriptor</h4>
<p style="text-align:justify;">Descriptors are invoked automatically whenever it receives the call for a <code>set()</code> method or <code>get()</code> method. For example, obj.skv looks up skv in the dictionary of obj. If g defines the method <code>__get__()</code>, then skv.__get__(obj) is invoked. It can also directly be invoked by method name i.e skv.__get__(obj).
</p>
...
class Descriptor(object): 
  ...
  def __get__(self, obj, objtype): 
    return "{} is a great programmer.".format(self.name) 
...
class Return_Name(object): 
  name = Descriptor() 
  
g = Return_Name() 
g.name = "Satyam Kumar Verman"
print(g.name) 
...
<h4 class="text-left mt-4" style="color:#a54eee;">Python Descriptors in Properties
</h4>
...
class Descriptor():
    def getter(self) -> object:
        print("Accessing the attribute to get the value,the value is:")
        return 102

    def setter(self, value) -> None:
        print("accessing the attribute to set the value,the value is:")
        raise AttributeError("Cannot change the value")

    attribute1 = property(getter, setter)

my_Descriptor_object = Descriptor()
x = my_Descriptor_object.attribute1
print(x)
...
function next(){
  window.open("typechecking.php","_self"); 
}
function prev(){
  window.open("micropython.php","_self");
}
