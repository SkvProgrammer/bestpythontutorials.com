...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Interfaces in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,Interfaces in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="interfaces.php" target="_self">Interfaces</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="interfaces.php" target="_self" style="color:white;">Interfaces</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Interfaces in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/interfaces.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/interfaces.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p class="mt-4 mb-3">Python does not have any equivalent of interfaces. Since Python does support multiple inheritance, you can easily emulate the equivalence of interfaces.Interfaces are concepts that belong to statically typed languages such as <a href="../java/home_java.php">Java</a> or <a href="../csharp/home_csharp.php">C#</a>, and do not really apply to dynamic language such as Python.</p>
    <h2 style="text-align:left;color:#a54eee;" class="mt-5">Interfaces in Python</h2>
...
<p style="text-align:justify;">Interfaces are nothing but 100% Abstract Classes.If you don't know what are abstract classes then check out our <a href="abstraction.php" style="color:grey;text-decoration:none;">Abstraction Chapter <img src="django/link.png" style="height:10px;"></a>.Interfaces in Python are implemented by using Abstract Class i.e. the <code>abc</code> module.</p>
...
class SubClass(AbstractClass):
    def method(self):
      print("subclass method is being called")
