...
<html lang="en-Us">
    <head>
        <title>String Functions in Python</title>
        <meta charset="utf-8">
        ...
        <meta name="description" content="String Functions in Python - String Methods in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="stringfunctions.php" target="_self">String Functions</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="stringfunctions.php" target="_self" style="color:white;">String Functions</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;">String Functions</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/stringfunctions.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/stringfunctions.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:left;" class="mt-4">There are a bunch of useful <strong>methods(Functions in object oriented programming language are called methods)</strong> available in python for string manipulation i.e modification or making changes in the string.</p>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
        ...
        <p style="text-align:left;">A list of commonly used String functions are given below in the table...</p>
  ...
  <table>
    ...
    <tr>
      <td>capitalize()</td>
      <td>This method converts the first characters of a string to capital letter </td>
      <td>"programming".capitalize()</td>
      <td>'Programming'</td>
     
    </tr>
    <tr>
      <td>upper()</td>
      <td>Returns uppercased string(only capital letters)</td>
      <td>"programming".upper()</td>
      <td>'PROGRAMMING'</td>      
    </tr>
    <tr>
      <td>lower()</td>
      <td>Returns lowercased string(opposite of upper())</td>
      <td>"PROGRAMMING".lower()</td>
      <td>'programming'</td>
      
    </tr>
    <tr>
      <td>isupper()</td>
      <td>Returns True if the string is uppercased</td>
      <td>"Programming".isupper()</td>
      <td>False</td>
    </tr>
    <tr>
      <td>islower()</td>
      <td>Returns True if the string is lowercased</td>
      <td>"Programming".islower()</td>
      <td>False</td>
    </tr>
    <tr>
      <td>swapcase()</td>
      <td>Changes the uppercased to lowercased characters and vice -versa</td>
      <td>"Programming".swapcase()</td>
      <td>'pROGRAMMING'</td>
      
    </tr>
      <tr>
      <td>lstrip()</td>
      <td>Removes the leading whitespace</td>
      <td>"  Programming  ".lstrip()</td>
      <td>'Programming  '</td>
      
    </tr>
     <tr>
      <td>rstrip()</td>
      <td>Removes the ending whitespace</td>
      <td>"  Programming  ".rstrip()</td>
      <td>' Programming'</td>
      ...
      <tr>
      <td>strip()</td>
      <td>Combination of rstrip and lstrip</td>
      <td>"  Programming  ".rstrip()</td>
      <td>'Programming'</td>
      ...
      <tr>
      <td>partition()</td>
      <td>Returns a tuple by breaking a string from specified character</td>
      <td>"Programming is fun".partition("is")</td>
      <td>('Programming ', 'is', ' fun')</td>
       ...
       <tr>
      <td>replace()</td>
      <td>Replaces a part from a string</td>
      <td>"Programming was fun".replace("was","is")</td>
      <td>'Programming is fun'</td>
    ...
    <tr>
      ...
      <td>"Programming is fun".split("is")</td>
   ...
   <tr>
      ...
      <td>"Programming is fun".rsplit("is")</td>
      <td>['Programming ', ' fun']</td>
   ...
   <tr>
      ...
      <td>"Programming is fun".casefold()</td>
      <td>'programming is fun'</td>
    ...
    <tr>
      ...
      <td>isalpha()</td>
      <td>Returns True if all the characters are in alphabet</td>
      <td>"Programming".isalpha()</td>
      <td>True</td>
    ...
    <tr>
     ...
     <tr>
      ...
      <td>"Programming is fun".startswith("Programming")</td>
      <td>True</td>
     ...
     <tr>
      ...
      <td>"Programming is fun".endswith("fun")</td>
      <td>True</td>
     ...
     <tr>
      ...
      <td>"Programming is fun".isnumeric()</td>
      <td>False</td>
    ...
    <tr>
      ...
      <td>"programming is fun".title()</td>
      <td>'Programming Is Fun'</td>
    ...
    <tr>
     <td>istitle()</td>
      ...
      <td>"Programming is fun".istitle()</td>
      <td>False</td>
      
    </tr>
<tr>
     <td>isidentifier()</td>
      <td>  Returns True if the string i an identifier</td>
      <td>"print".isidentifier()</td>
      <td>True</td>
...
function next(){
  window.open("controlstructures.php","_self");
}
function prev(){
  window.open("stringoperations.php","_self");
}
