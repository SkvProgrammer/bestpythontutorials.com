...
<html lang="en-Us">
    <head>
        <title>User Input in Python</title>
        <meta charset="utf-8">
        ...
        <meta name="description" content="User Input in Python - input() method in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="userinput.php" target="_self">User Input</a></li> 
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="userinput.php" target="_self" style="color:white;">User Input</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;">User Input in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/userinput.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/userinput.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
<p style="text-align:justify;" class="mt-4">Programmers often need to interact with the user either to get data or some sort of result...Mostly all programs today uses a dialog box for asking the user to provide some  input whereas Python provides us with two inbuilt functions to take or read the input from the keyboard.</p>
                 <ul style="text-align:left;">
                   <li><strong>raw_input()</strong></li>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of The Above Code</h4>
  <div class="container p-2 mb-4" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
         Enter a String : bestpythontutorials<br>
bestpythontutorials 
             </div>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
