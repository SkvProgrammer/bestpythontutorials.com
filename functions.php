...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Functions in Python - Methods in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="functions.php" target="_self">Functions</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="functions.php" target="_self" style="color:white;">Functions</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Functions in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/functions.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/functions.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
<p style="text-align:justify;" class="mt-4">Function are generally called methods in an object oriented programming.</p>
<div id="mySidenav" class="sidenav" style="font-size:15px;z-index:1;"><br>
  ...
  <a href="#functionsintro"><i class="fa fa-arrow-right"></i>Functions Intro</a>
  <a href="#parameters"><i class="fa fa-arrow-right"></i>Parameters</a>
  <a href="#arguments"><i class="fa fa-arrow-right"></i>Arguments</a>
  <a href="#parvsargu"><i class="fa fa-arrow-right"></i>Parameters Vs Arguments</a>
  <a href="#unequalparameters"><i class="fa fa-arrow-right"></i>Unequal Parameters</a>
</div>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
  ...
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
            <keyword>Hello Abhijeet</keyword>
             </div>



           
             <p style="text-align:justify;" class="mt-3 mb-3">We can't have more or less values than specified as <b>parameter</b> while calling a function.First of all let us discuss about <code>Parameters</code> of a Function. </p>
             <h2 class="text-left mt-4" style="color:#a54eee;" id="parameters">Parameters</h2>
<p style="text-align:justify;"><code>Parameters</code> allow a function to perform tasks without knowing the specific input values ahead of time. Parameters are indispensable components of functions, which programmers use to divide their code into logical blocks.</p>
<h2 class="text-left mt-4" style="color:#a54eee;" id="arguments">Arguments</h2>
<p style="text-align:justify;">Information can be passed into functions as arguments.

Arguments are specified after the function name, inside the parentheses. You can add as many arguments as you want, just separate them with a comma.</p>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>

<h3 class="text-left mt-4" style="color:#a54eee;" id="parvsargu">Parameters Vs. Arguments </h3>
<p style="text-align:justify;">The terms <code>parameter</code> and <code>argument</code> can be used for the same thing: information that are passed into a function.
</p>

<h4 class="text-left mt-4" style="color:#a54eee;">From a function's perspective:
</h4>
...
def sayHello(fname,lname,age):
        print("Hello " + fname + " " + lname + "You are now",age) 
...
<p style="text-align:justify;" class="mt-3 mb-3">The above code will produce an error because <code>sayHello</code> function has <code>3</code> parameters but only <code>1</code> is given...</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
  ...
  File "C:/Users/skv/AppData/Local/Programs/Python/Python38-32/3857.py", line 6, in &lt;module&gt;
    sayHello("Abhijeet");
TypeError: sayHello() missing 2 required positional arguments: 'lname' and 'age'
               </code>
             </div>
...
<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
 <p style="text-align:justify;" class="mt-4">We can solve this error by either giving all parameters or by using <a href="args.php" style="color:grey;text-decoration:none;"> *args,**kwargs <img src="django/link.png" style="height:10px;"></a> which we will be going to discuss in later chapters...There are many other important concepts such as <a href="recursion.php" style="color:grey;text-decoration:none;"> Recursion <img src="django/link.png" style="height:10px;"></a> and <a href="decorators.php" style="color:grey;text-decoration:none;">Decorators <img src="django/link.png" style="height:10px;"></a>.</p>
</div>
