...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Exception Handling in Python - Exceptions in Python"/> 
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="exception.php" target="_self">Exception Handling</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="exception.php" target="_self" style="color:white;">Exception Handling</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Exception Handling in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/exception.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/exception.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Before this tutorial you might have encountered errors while running the Python code.Mainly those errors were of two kind:<b>Syntax Errors</b> and <b>Exceptions.</b><br>
          Now what is Syntax Error,Syntax error is the error you have made while writing the code such as missed Indentations or wrong spellings of keywords.Whereas Exceptions are those part of code which are Syntactically Correct but Logically incorrect are called <b>Exceptions</b> such as trying to divide a number by 0 is called <code>ZeroDivisionError</code>
        </p>
        <h4 style="text-align:justify;text-decoration:none;color:#a54eee;">Now we will see how to Handle these Exceptions.</h4>
       
        <p style="text-align:left;">In Python,We have Keywords such as <code><i>try</i></code> , <code><i>except</i></code> and <code><i>Finally</i></code> to handle these exceptions.Look at the following example to understand the concept of Exception Handling in Python.</p>
          <p>The <code>try</code> statement checks a block of code for errors.
...
try: 
   ...
   print("I am Weak in Mathematics") 
...
if maths_score < 100 or maths_score == 99:
             raise Exception("""You just missed to score 100 marks in Mathematics""") 
...
function prev(){
  window.open("commandline.php","_self");
}
