...
<html lang="en-Us">
    <head>
        <title>XML Processing in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="XML Processing in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,xml processing in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="xmlprogramming.php" target="_self">XML Processing</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="xmlprogramming.php" target="_self" style="color:white;">XML Processing</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">XML Processing in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/xmlprogramming.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/xmlprogramming.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">XML is a Portable and Open Source Programming Language which stands for e<b>X</b>tensible <b>M</b>arkup <b>L</b>anguage.It is quite similar to HTML but instead of predefined tags you can make your own tags.</p>
<p style="text-align:justify;">XML is also a medium for exchange of Data with requiring a SQL-based backbone.</p>
...
<h3 style="text-align:left;color:#a54eee;" class="mt-4">XML Parsing</h3>
<p style="text-align:justify;">Python provides minimal but enough set of interfaces to work with <i>XML</i> Files.We are provided with mainly two APIs to work with XML file in Python:
<ul style="text-align:justify;list-style:square;">
  <li><b>SAX - Simple API for XML</b>: Here, you register callbacks for events of interest and then let the parser proceed through the document. This is useful when your documents are large or you have memory limitations, it parses the file as it reads it from disk and the entire file is never stored in memory.</li>
  <li><b>DOM API - Document Object Model API</b>:This API is W3C Recommendation to work with XML Files.</li>
</ul>
</p>
<h3 style="text-align:left;color:#a54eee;" class="mt-4">SAX Versus DOM API</h3>
<p>DOM API is faster than the SAX API but DOM can kill Resources such too many small Files.SAX is Readonly whereas DOM allows to edit the XML Code.</p>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
<h3 style="text-align:left;color:#a54eee;">SAX Example</h3>
<div class="text-left mt-1">
  <p style="text-align:justify;">In this chapter we will be using the below XML file for all practical examples</p>
...
<h3 style="text-align:left;color:#a54eee;" class="mt-5">Parsing XML with the SAX API</h3>
<p style="text-align:justify;">SAX is an standard interface for event driven XML Processing.Parsing XML with SAX generally requires you to create your own ContentHandler by subclassing xml.sax.ContentHandler.</p>

<p style="text-align:justify;">Your ContentHandler handles the particular tags and attributes of your flavor(s) of XML. A ContentHandler object provides methods to handle various parsing events. Its owning parser calls ContentHandler methods as it parses the XML file.</p>

<p style="text-align:justify;">The methods startDocument and endDocument are called at the start and the end of the XML file. The method characters(text) is passed character data of the XML file via the parameter text.
</p>

<p style="text-align:justify;">The ContentHandler is called at the start and end of each element. If the parser is not in namespace mode, the methods startElement(tag, attributes) and endElement(tag) are called; otherwise, the corresponding methods startElementNS and endElementNS are called. Here, tag is the element tag, and attributes is an Attributes object.</p>
 <br>
           <script type="text/javascript">
  atOptions = {
...
<h3 style="text-align:left;color:#a54eee;" class="mt-4">Methods</h3>
<p style="text-align:justify;"><i>xml.sax.<b>make_parser</b>(parser_list=[])</i><br>
Create and return a SAX XMLReader object. The first parser found will be used. If parser_list is provided, it must be an iterable of strings which name modules that have a function named create_parser(). Modules listed in parser_list will be used before modules in the default list of parsers.</p>
<p style="text-align:justify;"><i>xml.sax.<b>parseString</b>(string, handler, error_handler=handler.ErrorHandler())</i><br>
Similar to parse(), but parses from a buffer string received as a parameter. string must be a str instance or a bytes-like object.</p>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
class Ranker( xml.sax.ContentHandler ):
   def __init__(self):
     self.CurrentData = ""
     self.name = ""
     self.rank = ""
   ...
   def startElement(self, tag,title):
     self.CurrentData = tag
     if tag == "codingwebsite":
...
if  __name__ == "__main__":
  ...
  parser.parse("data.xml")</textarea>
...
<h3 class="text-left mt-4" style="color:#a54eee;">Parsing with DOM API</h3>
<p style="text-align:justify;">The Document Object Model ("DOM") is a cross-language API from the World Wide Web Consortium (W3C) for accessing and modifying XML documents.</p>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
for movie in movies:
   ...
   print "Description: %s" % description.childNodes[0].data</textarea>
...
function next(){
  window.open("cgiprogramming.php","_self"); 
}
function prev(){
  window.open("systemprogramming.php","_self");
}
