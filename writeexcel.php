...
<html lang="en-Us">
    <head>
        <title>Writing into an Excel File in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Writing into an Excel File in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="writeexcel.php" target="_self">Write Excel File</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="writeexcel.php" target="_self" style="color:white;">Write Excel File</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Writing into an Excel</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/writeexcel.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/writeexcel.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">To work with Excel Documents , we first need to install a module called <b>xlwt</b>.Using <b>xlwt</b> module, one can retrieve information from a spreadsheet. For example, reading, writing or modifying the data can be done in Python. Also, user might have to go through various sheets and retrieve data based on some criteria or modify some rows and columns and do a lot of work.</p>


<h4 class="text-left mt-4" style="color:#a54eee;">INSTALLATION</h4>
...
<div class="mb-3 mt-3">
 ...
 <h4 class="text-left mt-4" style="color:#a54eee;">Input File</h4>
<img src="input_excel_sheet.png" class="img-fluid" alt="input">

<br><br>
<a href="Book.xlsx" style="background-color:orangered;color:white;padding-left:5px;padding-right:5px;border-radius:3px;" download>Download this Excel File <i class="fa fa-download"></i></a>



<h3 class="text-left mt-4" style="color:#a54eee;">EXAMPLES</h3>
<h5 class="text-left mb-0 mt-1">Code #1(Writing into an Excel File)</h5>
...
sheet1.write(1, 0, 'Alpga Programmer') 
sheet1.write(2, 0, 'Beta Programmer') 


# Input data into columns
sheet1.write(0, 1, 'Skv') 
sheet1.write(0, 2, 'Ksv2') 

  
wb.save('xlwt main.xls') </textarea>
...
<div class="mb-3 mt-3">
    ...
    <h4 class="text-left mt-4" style="color:#a54eee;">Styling the Workbook</h4>
...
style_value= xw.easyxf('font: bold 10') 
  
# Specifying column value with styling
sheet.write(0, 0, 'Skv', style_value) 
wb.save("skv.xls") </textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<div class="mb-3 mt-3">
    ...
    <h4 class="text-left mt-4" style="color:#a54eee;">Multiple Style Parameters</h4>
...
style = xw.easyxf('font: bold 10, color red;') 
  
# Writing on specified sheet 
sheet.write(0, 0, 'Skv', style) 
