...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Automation in Python - Manual Testing - Automation Testing"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,  automation in python,automation testing in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="automation.php" target="_self">Automation in Python</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="automation.php" target="_self" style="color:white;">Automation in Python</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Automation in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/automation.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/automation.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
We have testing. Testing is mainly divided into two streams – one is functional and another one is non-functional. In functional, we have two types of testing.</p>
<ul style="text-align:justify;font-size:20px;">

    <li><b>Manual Testing</b> : In manual testing, our main activity is write the test cases and these test cases will be executed manually by some resource that is Test engineer.</li>

    <li><b>Automation Testing</b> :  In automation testing, all the manual test cases will be converted to Test scripts with the help of some tools like selenium, QTP, RFT etc.</li>
</ul>
 <div class="mb-3 mt-3">
...
<p style="text-align:justify;">Advantages Of Automation
</p>
<ul style="text-align:justify;font-size:20px;">
    <li>Saves time
    <li>Reduces Cost To Company(CTC)
    <li>Maintain accuracy
    <li>Scripts are repeatable
    <li>Identifying bugs
    <li>Better quality
</ul>

<p style="text-align:justify;">Now we will discuss about browser automation.</p>

<h4 class="text-left mt-4" style="color:#a54eee;">Browser Automation</h4>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Why Browser Automation ?
</h4>
<p style="text-align:justify;">We use browser automation for the following reason –
</p>
<ul style="text-align:justify;font-size:20px;">
    <li>Testing Web Applications
    <li>Web Scraping
    <li>Automate anything
</ul>
...
<p style="text-align:justify;">Now we will learn how to automate the web browser testing using the <b>Selenium</b> Framework.Selenium supports all major browsers such as Google Chrome,Firefox,Safari,Internet Explorer and Opera Browser and It also supports programming languages such 
    ...
    Perl,
    Scala and 
    Groovy.Nearly all major Languages are supported by Selenium.
</p>

<h5 class="text-left mt-4 mb-2" style="color:#a54eee;">SET UP</h5>
<p style="text-align:justify;" class="mb-1">First of all all we will need to install <b>Chrome Web Drivers</b> and to install the chrome web drivers you can go to  <a href="https://chromedriver.chromium.org/" style="color:grey;text-decoration:none;">this link<img src="django/link.png" style="height:10px;"></a>.</p>

<img src="webdrivers.png" class="img-fluid" alt="Web Drivers">



  <p style="text-align:justify;" class="mt-2">After installing the Web Drivers you need to install <code>selenium</code> using the <code>pip</code> package manager.</p>

<div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
  pip install selenium
</div>
<img src="selenium.png" class="img-fluid mt-3 mb-3" alt="Selenium">

<h4 class="text-left mt-4" style="color:#a54eee;">Test Driving a Headless Browser
</h4>
<p style="text-align:justify;">
To test that everything is working, I am going to open the chrome the web page <a>https://www.google.com</a>:
</p>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
...
#mention the path where you have installed the chromedriver.exe file
driver = webdriver.Chrome('C://Users/satya/chromedriver')
...
<img src="automating_the_browser.png" class="img-fluid mb-3" alt="drivers">



<h4 class="text-left mt-4" style="color:#a54eee;">Automated Search</h4>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
driver = webdriver.Chrome('C://Users/satya/chromedriver')  # Optional argument, if not specified will search path.
driver.get('http://www.google.com/');
time.sleep(5) # Let the user actually see something!
search_box = driver.find_element_by_name('q')
search_box.send_keys('bestpythontutorials.com')
search_box.submit()
time.sleep(5) # Let the user actually see something!
driver.quit() </textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of The Above Code</h4>
<img src="automating_search.png" class="img-fluid mb-3" alt="drivers">



<p class="mt-3" style="text-align:justify;">So this is the end.This chapter is Complete Hope you liked it.</p>
