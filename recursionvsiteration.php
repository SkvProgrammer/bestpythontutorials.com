...
<html lang="en-Us">
    <head>
        <title>Recursion Vs Iteration in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Recursion Vs Iteration in Python - Recursion and Iteration Comparison"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="recursionvsiteration.php" target="_self">Recursion vs Iteration</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="recursionvsiteration.php" target="_self" style="color:white;">Recursion vs Iteration</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Recursion Vs Iteration</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/recursionvsiteration.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/recursionvsiteration.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
      ...
      <p style="text-align:justify;" class="mt-4">A program is called Recursive when an entity calls iteself and A program is called Iterative , the programs contains Loops...While dicussing recursion,a basic question comes in the mind that which is better ? -Recursion or Iteration.The answer to this question depends upon what we are trying to do...Below I have listed some properties of Recursion and Iteration</p>
        ...
        <ul style="text-align:justify;font-size:20px;">
          <li>A Recursive call terminates when the base case is reached.</li>
          <li>A Recursive Program requires extra memory that an Iterative Program.</li>
          <li>Some Problems like finding the factorial of a number can be easily solved by using Recursion.</li>
          <li>Recursion has Smaller Sizes of Code i.e. less lines of code.</li>
          <li>In Recursion,the time complexity is very high.</li>
        </ul>

         <h3 style="text-align:left;color:#a54eee;" class="mt-4">Iteration</h3>
        <ul style="text-align:justify;font-size:20px;">
        <li>An Iteration stops when the specified condition is proven to be false.</li>
        <li>It does not require any extra space like in Recursion.</li>
        <li>Some problems are not obvious as of a Recursive Solution.</li> 
        <li>Size of Code is larger in comparison to Recursion.</li>
        <li>Time Complexity is relatively lower.</li>     
        </ul>

        <h4 style="text-align:justify;color:#a54eee;">From the above points you can understand the differences between Recursion and Iteration.</h4>
...
function prev(){
  window.open("recursion.php","_self");
}
