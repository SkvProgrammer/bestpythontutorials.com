...
<html lang="en-Us">
    <head>
        <title>Linguistics in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Linguistics in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,Linguistics in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="linguistics.php" target="_self">Linguistics</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="linguistics.php" target="_self" style="color:white;">Linguistics</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Linguistics in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/linguistics.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/linguistics.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Linguistics is an Python Library for Natural Language Processing.Now what is Natual Language Processing ? <br>
<br>
...
<p style="text-align:justify;">In this Tutorial we are not going to cover Linguistics this is just an introduction  and in future we will be launching tutorials on NLP and Artificial Intelligence.</p>
<img src="nlp.png" class="img-fluid">

<h3 style="text-align:left;color:#a54eee;" class="mt-4">INSTALLATION</h3>
<p style="text-align:justify;">You can easily install linguistics using python's pip package manager.</p>
<div class="container" style="height:auto;text-align:left;border:3px solid lightgrey;">pip install linguistics</div>
<h3 style="text-align:left;color:#a54eee;" class="mt-4">EXAMPLES</h3>
<p style="text-align: justify;">Linguistics uses Abstract and Graphviz to visualize graphs of the document.</p>
<div class="text-left mt-2">
  <h4 style="text-align:left;color:#a54eee;" class="mb-1 mt-3">USAGE</h4>
...
display(document.entity_graph.render())#Entity Graph
display(document.graph.render())#Document Graph</textarea>
...
function prev(){
  window.open("buffering.php","_self");
}
