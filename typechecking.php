...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Type Checking in Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,type checking in python,python type checking">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="typechecking.php" target="_self">Type Checking</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="typechecking.php" target="_self" style="color:white;">Type Checking</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Type checking in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/typechecking.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/typechecking.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4"><b>Type Checking</b> means getting acknowledged by the type of Data used in the Program.Now in Python all the stuffs are done automatically.The above lines are not easy to grab as you might not be knowing about <b>Type Systems</b> in Programming Languages.Now what are these <b>Type Systems?</b></p>
<div class="mb-3 mt-3">
...
<div class="mb-3 mt-3">
  ...
  <h4 class="text-left mt-4" style="color:#a54eee;">Static Typed Language</h4><p style="text-align:justify;">
    The type checking of the variable type is done at compile-time. Also, the type system of the language forces to explicitly declare the 'data-type' of the variable before its usage. The programming languages which are statically typed are: Scala, Java, C++, etc.</p>
    <p style="text-align:justify;">
For example, the declaration of String in Scala is defined below:<br>
int x = 10;
</p>
<p style="text-align:justify;">
The above code shows that the variable name <b>x</b> is explicitly declared as <b>Integer</b> data-type with the value as <b>10</b>.
  </p>     
<br>
           <script type="text/javascript">
  atOptions = {
  ...
  <h4 class="text-left mt-4" style="color:#a54eee;">Dynamic Typed Language</h4>
    
<p style="text-align:justify;">The type checking of the variable type is done at run-time. Also, the type system of the language doesn't force to explicitly declare the 'data-type' of the variable before its usage. The programming languages which are dynamically typed are: Python, Javascript, Ruby, etc.</p>
<p style="text-align:justify;">
For example, the String in Python is defined below:<br>
x = 20
</p>
<p style="text-align:justify;">
The above code shows that the variable name <b>x</b> doesn't need to be explicitly declared.</p>


<h4 style="text-align:justify;color:#a54eee;" class="mt-4"><i>type()</i> and <i>isinstance()</i> method</h4>
...
<img src="output_type_checking.png" alt="Output" class="img-fluid">
...
<p style="text-align:justify;" class="mt-3"><b>isinstance()</b>:The 'insinstance('obj','class')' of Python can be used to know whether the 'obj', which is the object is the instance of the class or not. The returned output value is boolean can be one of True or False.</p>
<div data-datacamp-exercise data-lang="python">
  <code data-type="sample-code">
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="output_type_checking2.png" alt="Output" class="img-fluid">
...
function next(){
  window.open("exploringhttps.php","_self"); 
}
function prev(){
  window.open("pythondescriptors.php","_self");
}
