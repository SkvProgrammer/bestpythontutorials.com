...
<html lang="en-Us">
    <head>
        <title>if,elif and else condition in Python</title>
        <meta charset="utf-8">
        ...
        <meta name="description" content="if condition in python - elif condition - else condition in python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="if.php" target="_self">If,else,elif</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="if.php" target="_self" style="color:white;">If,else,elif</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;">if,elif and else</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/if.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/if.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
<p style="text-align:left;" class="mt-4">First of all we need to understand the meaning of statements in Python Programming Language...</p>
<div class="mb-3 mt-3">
...
<h4 class="text-left mt-4" style="color:#a54eee;">Statements</h4>
                 <p style="text-align:justify;">In computer programming statements are the command given to the computer to perform some action,it can be data manipulation,statement or decision making in Python...In general we have three types of statements in Python :-</strong></p>
       ...
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
                 ...
                 <h4 class="text-left mt-4" style="color:#a54eee;">Empty Statements</h4>
                 <p style="text-align:justify;"></strong>The simplest statement is an Empty Statement which does nothing.In Python an empty statement is a <b>Pass</b> statement...Whenever Python encounters a <b>Pass</b> statement,Python interpreter does nothing and moves to next line of statements...A <b>Pass</b> statements is useful when there's no need for a statement in the logic but there's a need of statement in the syntax.So Pass keyword is useful there</p>
                  <h4 class="text-left mt-4" style="color:#a54eee;">Simple Statements</h4>
                 <p style="text-align:justify;">Any single executable line of statement in Python can be regarded as a Simple statement such as Taking the user input using the input() method...</p>
                  <h4 class="text-left mt-4" style="color:#a54eee;">Compound Statements</h4>
                 <p style="text-align:justify;">In Python a group of statements executed as a unit is called Compound Statement such as A function with it's body...</p>
<div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
                 <p style="text-align:justify;">Now moving to core topic of if-else condition but before we start let us understand the meaning of a word in which Python highly relies on i.e. <strong>Indentation</strong></p> 
                 <h4 class="text-left mt-4" style="color:#a54eee;">Indentation</h4>
               <p style="text-align:justify;">If you are coming from C or C++ background then you might have wondered that how statements are separated in Python because there's no use of semi-colons in Python in comparison to other languages like C and C++ which highly relies on semi-colons for separating different statements...Instead Python uses the Indentation for separating statements...</p>

 <h4 class="text-left mt-4" style="color:#a54eee;">if Statement</h4>
               <p style="text-align:justify;">If statement checks a given condition and if the condition is correct the statement's in it's body are executed or if not the elif i.e. else if condition is executed but if the elif condition is also incorrect then the else condition is executed... </p>
                <h4 class="text-left mt-4" style="color:#a54eee;">elif Statements</h4>
                       <p style="text-align:justify;">This statement is executed when the if condition is false or incorrect... </p>
                        <h4 class="text-left mt-4" style="color:#a54eee;">else Statements</h4>
                <p style="text-align:justify;">This statement is executed when all the if and elif statements are false... </p>

                <h3 class="text-left mt-4" style="color:#a54eee;">EXAMPLE</h3>
                <p style="text-align:justify;">If the age of a person reaches more that 18 years old he/she becomes eligible for casting vote</p>
...
rohans_age = 19
if rohans_age < 18:
      print("Rohan you are not eligible to cast vote")
elif rohans_age == 18:  
      print("Rohan you are behind one year")
else:
      print("Rohan you are eligible to cast vote") 
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
                'Rohan you are eligible to cast vote'
             </div>
            <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
...
function next(){
  window.open("loops.php","_self");
}
function prev(){
  window.open("userinput.php","_self");
}
