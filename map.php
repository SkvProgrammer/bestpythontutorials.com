...
<html lang="en-Us">
    <head>
        <title>Map,Filter and Reduce Functions in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Map,Filter and Reduce Functions in Python"/> 
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="map.php" target="_self">map,filter,reduce functions</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="map.php" target="_self" style="color:white;">map,filter,reduce functions</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">map,filter and reduce method</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/map.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/map.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
    ...
    <h2 style="text-align:left;color:#a54eee;" class="mt-4">map()</h2>
        <p style="text-align:justify;"><code>map()</code> function returns a mapped object of the results after applying the given function to each item of a given iterable (list, tuple etc.)</p>
        <h4 style="text-align:left;color:#a54eee;" class="mt-5">SYNTAX</h4>
          <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
                <keyword>map</keyword>(function , iterable)
             </div><br>
         <script type="text/javascript">
  atOptions = {
...
<p style="text-align:justify;" class="mt-4">The above code will return a mapped object.In this case it's <code>&lt;map object at 0x7fef5feae210&gt;</code>.So what to do with this.You can typecast it to a list and then you will be able to see the actual output.</p>
...
<p style="text-align:justify;" class="mt-4">The above code will return a new list containing the square of values of the previous list.</p>
<h2 style="text-align:left;color:#a54eee;" class="mt-5">filter()</h2>
<p style="text-align:justify;">The <code>filter()</code> function returns an iterator were all the items are filtered through a function to test for which the item is true or not.</p>
 <h3 style="text-align:left;color:#a54eee;" class="mt-4">SYNTAX</h3>
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
             <keyword>filter</keyword>(function , iterable)
             </div>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
...
<!--reduce-->
<h2 style="text-align:left;color:#a54eee;" class="mt-5">reduce()</h2>
<p style="text-align:justify;">The <code>reduce(function,sequence)</code> function is used to apply a particular function passed in its argument to all of the list elements mentioned in the sequence passed along.This function is defined in <code>“functools”</code> module.</p>
 <h3 style="text-align:left;color:#a54eee;" class="mt-4">SYNTAX</h3>

  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
               <keyword>reduce</keyword>(function , sequence)
             </div><br>
...
function next(){
  window.open("listcomprehension.php","_self"); 
}
function prev(){
