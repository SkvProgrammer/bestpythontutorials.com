...
<html lang="en-Us">
    <head>
        <title>Command Line Arguments in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Command Line Arguments in Python"/> 
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="commandline.php" target="_self">Command Line Arguments</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="commandline.php" target="_self" style="color:white;">Command Line Arguments</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Command Line Arguments</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/commandline.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/commandline.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">The arguments given to a program in the Command Line(cmd or Terminal) of the Operating System are called <b>Command Line Arguments.</b></p>
         <h5 style="text-align:justify;" class="mt-5">What are ways by which we can use Command Line Arguments in a Python Program??</h5>
  
        <h3 style="text-align:left;color:#a54eee;" class="mt-4">sys.argv</h3>
        <p style="text-align:justify;">The list of command line arguments passed to a Python script. <b>argv[0]</b> is the script name (it is operating system dependent whether this is a full pathname or not). If the command was executed using the <b>-c</b> command line option to the interpreter, <b>argv[0]</b> is set to the string <b>'-c'</b>. If no script name was passed to the Python interpreter, <b>argv[0]</b> is the empty string.

To loop over the standard input, or the list of files given on the command line, see the fileinput module.</p>
...
print(a + b)  </textarea>
    ...
    readOnly: true
             ...
             <h3 style="text-align:left;color:#a54eee;" class="mt-4">getopt.<b>getopt</b>(args, shortopts, longopts=[]) module</h3>
             <p style="text-align:justify;">Parses command line options and parameter list. args is the argument list to be parsed, without the leading reference to the running program. Typically, this means sys.argv[1:]. shortopts is the string of option letters that the script wants to recognize, with options that require an argument followed by a colon (':'; i.e., the same format that Unix getopt() uses).<br>
             longopts, if specified, must be a list of strings with the names of the long options which should be supported. The leading '--' characters should not be included in the option name. Long options which require an argument should be followed by an equal sign ('='). Optional arguments are not supported. To accept only long options, shortopts should be an empty string. Long options on the command line can be recognized so long as they provide a prefix of the option name that matches exactly one of the accepted options. For example, if longopts is ['foo', 'frob'], the option --fo will match as --foo, but --f will not match uniquely, so GetoptError will be raised.</p>
...
function next(){
  window.open("exception.php","_self");
}
function prev(){
  window.open("assert.php","_self");
}
