...
<html lang="en-Us">
    <head>
        <title>Working with AWS in Python using the BOTO3 Module</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Working with AWS in Python using the BOTO3 Module - AWS in Python - BOTO3 Module in Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,aws in python,working with boto3 module in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="aws.php" target="_self">AWS S3 and BOTO3</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="aws.php" target="_self" style="color:white;">AWS S3 and BOTO3</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">AWS and BOTO3 in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/aws.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/aws.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In this chapter we will try to learn about <b>AWS</b> in Python.First of all what is AWS - AWS Stands for <b>Amazon Web Services</b>.Now what is this thing.See below to learn about AWS.</p>

<p style="text-align:justify;">Amazon Web Services is a Cloud Computing Service provided by one of the most rich companies in the World i.e. the <b>Amazon</b>.Also AWS is the most popular cloud provided followed by <b>Microsoft Azure</b>.</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">BOTO3</h4>
<p style="text-align:justify;">Now let's talk about the <b>BOTO3</b> Module.<b>BOTO3</b> is a python module which is used to integrate Python Applications with the AWS Cloud Provider.You can easily install it using the <b>pip</b> package manager.</p>

<h5 class="text-left mt-4" style="color:#a54eee;">INSTALLATION</h5>
<div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
  pip install boto3
</div>

<p style="text-align:justify;" class="mt-3">You’ve got the SDK. But, you won’t be able to use it right now, because it doesn’t know which AWS account it should connect to.
</p>

<img src="homepage_aws.png" class="img-fluid" alt="aws">
...
<img src="user_aws.png" class="img-fluid" alt="aws">
<p style="text-align:justify;" class="mt-3">
Give the user a name (for example, botouserskv). Enable programmatic access. This will ensure that this user will be able to work with any AWS supported SDK or make separate API calls:
</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Getting Started With AWS</h4><p style="text-align:justify;">To get started with AWS you first need to create a new folder in this case I am creating a folder with name <code>aws_cloud</code>.Now Create a new file,<code> ~/.aws/config:</code></p>
...
<div class="text-left mt-4 mb-1 p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
 [default]<br>
 region = YOUR_PREFERRED_REGION
</div>
<p style="text-align:justify;">Save your file.
</p>
<p style="text-align:justify;">
You are now officially set up for the rest of the tutorial.
</p>

<h4 class="text-left mt-4" style="color:#a54eee;">Client Versus Resource
</h4>
<p style="text-align:justify;">
...
<ul style="text-align:justify;font-size:19px;">
    <li><b>Client</b>: low-level service access
    <li><b>Resource</b>: higher-level object-oriented service access
</ul>
...
<p style="text-align:justify;">To connect to the low-level client interface, you must use Boto3’s client(). You then pass in the name of the service you want to connect to, in this case, <code>s3</code>:
</p>
<div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
import boto3<br>
s3_client = boto3.client('s3')
</div>
<p style="text-align:justify;" class="mt-2">To connect to the high-level interface, you’ll follow a similar approach, but use <code>resource()</code>:
</p>
<div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
import boto3<br>
...
<h3 class="text-left mt-4" style="color:#a54eee;">Creating Using Buckets</h3>


<p style="text-align:justify;">This Python example shows you how to:
</p>
<ul style="text-align:justify;font-size:20px;">
    <li>Obtain and display a list of Amazon S3 buckets in your account.
    <li>Create an Amazon S3 bucket.
    <li>Upload an object to a specified bucket.
</ul>
<h4 class="text-left mt-4" style="color:#a54eee;">The Scenario
</h4>
<p style="text-align:justify;">
...
<p style="text-align:justify;">
All the example code for the Amazon Web Services (AWS) SDK for Python is available here on GitHub.</p>
<h4 class="text-left mt-4" style="color:#a54eee;">Prerequisite Tasks
</h4>
<ul style="text-align:justify;font-size:20px;">

<li>To set up and run this example, you must first complete this task:

    <li>Configure your AWS credentials, as described in Quickstart.

<li>Display a List of Amazon S3 Buckets

<li>List all the buckets owned by the authenticated sender of the request.

</ul>

<p style="text-align:justify;">The example below shows how to:
</p>
    <h5 class="text-center">List buckets using <code>list_buckets</code>.
</h5>

<h4 class="text-left mt-4" style="color:#a54eee;">Example
</h4>
...
print("Bucket List: %s" % buckets)</textarea>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Create an Amazon S3 Bucket
</h4>
<p style="text-align:justify;">
The example below shows how to:
</p>
    <h5 class="text-center">Create a new bucket using <code>create_bucket</code>.
</h5>

<h4 class="text-left mt-4" style="color:#a54eee;">
Example
</h4>
...
s3 = boto3.client('s3')
s3.create_bucket(Bucket='my-bucket')</textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<h4 class="text-left mt-4" style="color:#a54eee;">Upload a File to an Amazon S3 Bucket
</h4>
<p style="text-align:justify;">
The example below shows how to:
</p>
<h5 class="text-center">
    Upload a file to a bucket using <code>upload_file</code>.
</h5>
...
s3.upload_file(filename, bucket_name, filename)</textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
function next(){
  window.open("pathlib.php","_self"); 
}
function prev(){
  window.open("memory.php","_self");
}
