...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="WSGI in Python - Web Server Gateway Interface"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,wsgi in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="wsgi.php" target="_self">WSGI Protocol</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="wsgi.php" target="_self" style="color:white;">WSGI Protocol</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">WSGI in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/wsgi.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/wsgi.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-5">WSGI stands for <b>W</b>eb <b>S</b>erver <b>G</b>ateway <b>I</b>nterface.WSGI Server implements the web server side of the WSGI interface for running Python web applications.</p>
<p style="text-align:justify;">This Chapter will help you when you will start developing Web Application with Python Frameworks like <a href="django/home_django.php" style="color:grey;text-decoration:none;">Django <img src="django/link.png" style="height:10px;"></a> and <a href="django/home_django.php" style="color:grey;text-decoration:none;">Flask <img src="django/link.png" style="height:10px;"></a>.Actually in 1990s when Python was gaining it's popularity Python was mostly used for developing Web Applications.But traditional Web Servers are not ideal for running a Python Applications.So during that time,Grisha Trubetskoy a developer introduced a module for Apache Server that was called mode_python which was the new alternative to traditional servers.But with the passage of time many vulnerabilities was detected which resulted in the security issues.<br><br>Due to this , the Python Community developed the WSGI Server.as a standard interface that modules and containers could implement. WSGI is now the accepted approach for running Python web applications.</p>
     <br>
           <script type="text/javascript">
  atOptions = {
...
<h3 style="text-align:left;color:#a54eee;" class="mt-5">Features of WSGI Protocol:</h3>
<ul style="text-align:justify;">
  <li><b>WSGI is flexible</b>:Application developers can swap out web stack components for others. For example, a developer can switch from Green Unicorn to uWSGI without modifying the application or framework that implements WSGI.</li>
  <li class="mt-3"><b>WSGI is Powerful or Scalable</b>:It can handle comparatively more requests than any other server.WSGI servers handle processing requests from the web server and deciding how to communicate those requests to an application framework's process. The segregation of responsibilities is important for efficiently scaling web traffic.</li>
</ul>
     <br>
           <script type="text/javascript">
  atOptions = {
...
<div class="text-left mt-5">
  <h3 style="text-align:left;color:#a54eee;">The Server Side</h3>
  <p style="text-align:justify;">The server or gateway invokes the application callable once for each request it receives from an HTTP client, that is directed at the application. To illustrate, here is a simple CGI gateway, implemented as a function taking an application object. Note that this simple example has limited error handling, because by default an uncaught exception will be dumped to sys.stderr and logged by the web server.</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
function next(){
  window.open("graph.php","_self"); 
}
function prev(){
  window.open("polynomial.php","_self");
}
