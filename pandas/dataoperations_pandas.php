...
<html lang="en-Us">
    <head>
        <title>Data Operations - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Data Operations in Pandas - Pandas Data Operations - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="dataoperations_pandas.php"  target="_self">Data Operations</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="dataoperations_pandas.php"  target="_self" style="color:white;">Data Operations</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Data Operations - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/dataoperations_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/dataoperations_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Pandas support a large number of Operations for it's Data Structures.Python handles data of various formats mainly through the two libraries, Pandas and Numpy. We have already seen the important features of these two libraries in the previous chapters. In this chapter we will see some basic examples from each of the libraries on how to operate on data.</p>

<p style="text-align:justify;">Pandas and Numpy supports Operations such as Mathematical Operations , String Operations and In Pandas,Operations like Row and Column Selection is also Supported.</p>

<h4 class="text-left mt-4" style="color:#a54eee;">Row and column selection</h4>
<p style="text-align:justify;">We can select any row and column of the DataFrame by passing the name of the rows and column. When you select it from the DartaFame, it becomes <i>one-dimensional</i> and considered as <i>Series</i>.</p>

<p style="text-align:justify;" class="mt-3"><i>You can check out the <a href="https://pandas.pydata.org/pandas-docs/stable/getting_started/basics.html#accelerated-operations" style="color:grey;text-decoration:none;"> official docs <img src="../django/link.png" style="height:12px;"></a> for more detailed info of Data Operations.</i></p>
...
function next(){
  window.open("multiple_indexing_pandas.php","_self");
}
function prev(){
  window.open("iotools_pandas.php","_self");
}
