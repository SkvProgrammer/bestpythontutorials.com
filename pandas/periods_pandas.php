        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Periods in Pandas - Periods attributes in Pandas - year,week periods  - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="periods_pandas.php"  target="_self">Periods</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="periods_pandas.php"  target="_self" style="color:white;">Periods</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Periods - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/periods_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/periods_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Periods are nothing,they represent the time in the form of weeks , year or days.There are a lot of attributes available for this.Pandas <code>Period.year</code> attribute return an integer value representing the year the given period lies in.</p>

<h4 class="text-left mt-4" style="color:#a54eee;">Table of Attributes</h4>
...
<tbody>
<tr class="row-odd"><td><p><a class="reference internal"  title="pandas.Period.day"><code class="xref py py-obj docutils literal notranslate"><span class="pre">day</span></code></a></p></td>
<td><p>Get day of the month that a Period falls on.</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" title="pandas.Period.dayofweek"><code class="xref py py-obj docutils literal notranslate"><span class="pre">dayofweek</span></code></a></p></td>
<td><p>Day of the week the period lies in, with Monday=0 and Sunday=6.</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" title="pandas.Period.dayofyear"><code class="xref py py-obj docutils literal notranslate"><span class="pre">dayofyear</span></code></a></p></td>
<td><p>Return the day of the year.</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" title="pandas.Period.days_in_month"><code class="xref py py-obj docutils literal notranslate"><span class="pre">days_in_month</span></code></a></p></td>
<td><p>Get the total number of days in the month that this period falls on.</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" title="pandas.Period.daysinmonth"><code class="xref py py-obj docutils literal notranslate"><span class="pre">daysinmonth</span></code></a></p></td>
<td><p>Get the total number of days of the month that the Period falls in.</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" title="pandas.Period.hour"><code class="xref py py-obj docutils literal notranslate"><span class="pre">hour</span></code></a></p></td>
<td><p>Get the hour of the day component of the Period.</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" title="pandas.Period.minute"><code class="xref py py-obj docutils literal notranslate"><span class="pre">minute</span></code></a></p></td>
<td><p>Get minute of the hour component of the Period.</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" title="pandas.Period.qyear"><code class="xref py py-obj docutils literal notranslate"><span class="pre">qyear</span></code></a></p></td>
<td><p>Fiscal year the Period lies in according to its starting-quarter.</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" title="pandas.Period.second"><code class="xref py py-obj docutils literal notranslate"><span class="pre">second</span></code></a></p></td>
<td><p>Get the second component of the Period.</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" title="pandas.Period.start_time"><code class="xref py py-obj docutils literal notranslate"><span class="pre">start_time</span></code></a></p></td>
<td><p>Get the Timestamp for the start of the period.</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" title="pandas.Period.week"><code class="xref py py-obj docutils literal notranslate"><span class="pre">week</span></code></a></p></td>
<td><p>Get the week of the year on the given Period.</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" title="pandas.Period.weekday"><code class="xref py py-obj docutils literal notranslate"><span class="pre">weekday</span></code></a></p></td>
<td><p>Day of the week the period lies in, with Monday=0 and Sunday=6.</p></td>
</tr>
</tbody>
</table>
...
prd = pd.Period(freq ='T', year = 2020, month = 10, 
              hour = 12, minute = 50) 
...
# Create the Period object 
prd = pd.Period(freq ='T', year = 2010, month = 10, 
              hour = 12, minute = 50) 

# Print the Period in year
prd.year
...
<p style="text-align:justify;" class="mt-3"><i>Similarly you can use all the attributes...</i></p>
...
function next(){
  window.open("working_with_text_pandas.php","_self");
}
function prev(){
  window.open("time_offset_pandas.php","_self");
}
