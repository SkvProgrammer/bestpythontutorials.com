        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Data Frame in Pandas - DataFrame is a 2-dimensional labeled data structure with columns of potentially different types. You can think of it like a spreadsheet or SQL table. - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="dataframe_pandas.php"  target="_self">Data Frame</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="dataframe_pandas.php"  target="_self" style="color:white;">Data Frame</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Data Frames - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/dataframe_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/dataframe_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;"><i>Now as usual we are first going to create a DataFrame using a numpy ndarray</i>.</p>
...
<td style="text-align:center;">
<p><b>index</b></p>
<p>For the row labels, the Index to be used for the resulting frame is Optional Default np.arange(n) if no index is passed.</p>
</td>
</tr>
<tr>
<td class="ts">3</td>
<td style="text-align:center;">
<p><b>columns</b></p>
<p>For column labels, the optional default syntax is - np.arange(n). This is only true if no index is passed.</p>
</td>
</tr>
<tr>
<td class="ts">4</td>
...
<h5 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h5>
<img src="dataframe_pandas2.png" class="img-fluid">

<h4 class="text-left mt-5" style="color:#a54eee;">Row Selection,Addition and Deletion</h4>
<p style="text-align:justify;">In this section we will see that how we can perform row selection,addition and deletion Operations.</p>
...
<h4 class="text-left mt-5" style="color:#a54eee;">Column Selection,Addition and Deletion</h4>
...
df = pd.DataFrame(data)
print(df)#will print the df
del df
print(df)#will generate error because df is already deleted
</code>
  </div>
