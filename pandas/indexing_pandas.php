        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Indexing in Pandas - Pandas Indexing - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="indexing_pandas.php"  target="_self">Indexing</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="indexing_pandas.php"  target="_self" style="color:white;">Indexing</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Indexing - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/indexing_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/indexing_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4"><b>Indexing</b> in Pandas means selecting particular and columns. Indexing could mean selecting all the rows and some of the columns, some of the rows and all of the columns, or some of each of the rows and columns. Indexing can also be known as Subset Selection.</p>

<p style="text-align:justify;">In Pandas we have four ways to access the items of the DataFrame.The four ways are given below:-</p>
<ol style="text-align:justify;list-style:square;font-size:19px;">
  <li>DataFrame.[] - This is called <b>Indexing Operator.</b></li>
  <li>DataFrame.loc[] - This takes the label as Parameter.</li>
  <li>DataFrame.iloc[] - This takes the integer location.</li>
  <li>DataFrame.ix[] - This function is used for both label and integer based</li>
</ol>
<p style="text-align:justify;">For this example we are using the <a href="./demo.csv" download="" style="background-color:orangered;color:white;border-radius:10px;text-decoration:none;" class="p-0 pl-1 pr-1">demo.csv</a> File.</p>


<h4 class="text-left mt-4" style="color:#a54eee;">EXAMPLES</h4>
<div class="text-left mt-0 mb-1">
  <p class="text-left mb-0">code #1(Selecting all rows for a specific column)</p>
...
<div class="text-left mt-0 mb-1">
  <p class="text-left mb-0 mt-4">code #2(Selecting all rows for multiple columns)</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<div class="text-left mt-0 mb-1">
  <p class="text-left mb-0 mt-4">code #3( Select few rows for multiple columns)</p>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
print(df.loc[['a','b','f','h'],['A','C']])</textarea>            
           </form>
                     <script>
...
function next(){
  window.open("iteration_pandas.php","_self");
}
function prev(){
