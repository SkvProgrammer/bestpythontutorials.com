...
<html lang="en-Us">
    <head>
        <title>Manipulating Data - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Manipulating Data in Pandas - How to manipulate Data in Pandas  - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="manipulating_data_pandas.php"  target="_self">Manipulating Data</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="manipulating_data_pandas.php"  target="_self" style="color:white;">Manipulating Data</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Manipulating Data - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/manipulating_data_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/manipulating_data_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a> 
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Nowadays Data is much more precious than the gold or any other expensive accessories.But why this data is Precious - The answer is that these Data allows us to understand the behaviour of the USer for better marketing,selling or any other meaning business methods.</p>

<p style="text-align:justify;">This chapter is just for creating an awareness that what we have learned till now.Actually Pandas is all about Data Manipulation and in this tutorial series we have only and only studied about Data Analysis from starting to end in the form of:-</p>
<ul style="text-align:justify;font-size:19px;">
  <li><b>Transforming Data</b>:-Inspecting DataFrames and perform fundamental manipulations, including sorting rows, subsetting, and adding new columns.<a href="sorting_pandas.php" style="color:grey;text-decoration:none;"> To Learn Click Here <img src="../django/link.png" style="height:12px;"></a></li>
  <li><b>Aggregating Data</b>:-Aggregating Data in Pandas by using the DataFrame.aggregate() method.In this chapter, you’ll calculate summary statistics on DataFrame columns, and master grouped summary statistics and pivot tables.<a href="aggregation_pandas.php" style="color:grey;text-decoration:none;"> To Learn Click Here <img src="../django/link.png" style="height:12px;"></a></li></li>
  <li><b>Slicing and indexing</b>:-
Indexes are supercharged row and column names. Learn how they can be combined with slicing for powerful DataFrame subsetting.<a href="indexing_pandas.php" style="color:grey;text-decoration:none;"> To Learn Click Here <img src="../django/link.png" style="height:12px;"></a></li></li>
<li><b>Creating and Visualizing DataFrames</b>:-
Learn to visualize the contents of your DataFrames, handle missing data values, and import data from and export data to CSV files.<a href="data_visualization_pandas.php" style="color:grey;text-decoration:none;"> To Learn Click Here <img src="../django/link.png" style="height:12px;"></a></li>
</ul>
...
function prev(){
  window.open("selection_pandas.php","_self");
}
