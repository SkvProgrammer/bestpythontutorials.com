...
<html lang="en-Us">
    <head>
        <title>Working with Text Data - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Working with Text Data in Pandas - Handling Text Data in Pandad  - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="working_with_text_pandas.php"  target="_self">Working with Text Data</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="working_with_text_pandas.php"  target="_self"  style="color:white;">Working with Text Data</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Working with Text Data - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/working_with_text_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/working_with_text_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a> 
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Pandas provides a set of methods for String Slicing,So in this chapter we are going to cover all important string methods for Data Analysis in Pandas.A list of all possible functions is given in the form of the table.</p>
...
<td>
<p><b>lower()</b></p>
<p>Converts strings in the Series/Index to lower case.</p></td>
</tr>
<tr>
<td class="ts">2</td>
<td>
<p><b>upper()</b></p>
<p>Converts strings in the Series/Index to upper case.</p></td>
</tr>
<tr>
<td class="ts">3</td>
<td>
<p><b>len()</b></p>
<p>Computes String length().</p></td>
</tr>
<tr>
<td class="ts">4</td>
<td>
<p><b>strip()</b></p>
<p>Helps strip whitespace(including newline) from each string in the Series/index from both the sides.</p></td>
</tr>
<tr>
<td class="ts">5</td>
<td>
<p><b>split(' ')</b></p>
<p>Splits each string with the given pattern.</p></td>
</tr>
<tr>
<td class="ts">6</td>
<td>
<p><b>cat(sep=' ')</b></p>
<p>Concatenates the series/index elements with given separator.</p></td>
</tr>
<tr>
<td class="ts">7</td>
<td>
<p><b>get_dummies()</b></p>
<p>Returns the DataFrame with One-Hot Encoded values.</p></td>
</tr>
<tr>
<td class="ts">8</td>
<td>
<p><b>contains(pattern)</b></p>
<p>Returns a Boolean value True for each element if the substring contains in the element, else False.</p></td>
</tr>
<tr>
<td class="ts">9</td>
<td>
<p><b>replace(a,b)</b></p>
<p>Replaces the value <b>a</b> with the value <b>b</b>.</p></td>
</tr>
<tr>
<td class="ts">10</td>
<td>
<p><b>repeat(value)</b></p>
<p>Repeats each element with specified number of times.</p></td>
</tr>
<tr>
<td class="ts">11</td>
<td>
<p><b>count(pattern)</b></p>
<p>Returns count of appearance of pattern in each element.</p></td>
</tr>
<tr>
<td class="ts">12</td>
<td>
<p><b>startswith(pattern)</b></p>
<p>Returns true if the element in the Series/Index starts with the pattern.</p></td>
</tr>
<tr>
<td class="ts">13</td>
<td>
<p><b>endswith(pattern)</b></p>
<p>Returns true if the element in the Series/Index ends with the pattern.</p></td>
</tr>
<tr>
<td class="ts">14</td>
<td>
<p><b>find(pattern)</b></p>
<p>Returns the first position of the first occurrence of the pattern.</p></td>
</tr>
<tr>
<td class="ts">15</td>
<td>
<p><b>findall(pattern)</b></p>
<p>Returns a list of all occurrence of the pattern.</p></td>
</tr>
<tr>
<td class="ts">16</td>
<td>
<p><b>swapcase</b></p>
<p>Swaps the case lower/upper.</p></td>
</tr>
<tr>
<td class="ts">17</td>
<td>
<p><b>islower()</b></p>
<p>Checks whether all characters in each string in the Series/Index in lower case or not. Returns Boolean</p></td>
</tr>
<tr>
<td class="ts">18</td>
<td>
<p><b>isupper()</b></p>
<p>Checks whether all characters in each string in the Series/Index in upper case or not. Returns Boolean.</p></td>
</tr>
<tr>
<td class="ts">19</td>
<td>
<p><b>isnumeric()</b></p>
<p>Checks whether all characters in each string in the
Series/Index are numeric. Returns Boolean.</p></td>
</tr>
</tbody></table>


<p style="text-align:justify;" class="mt-3">Now we will discuss some fundamental string methods in Pandas.</p>
...
s = pd.Series(['Skv', 'SkvProgrammer', 'Satyam', 'Satyam Verman'])
...
function prev(){
  window.open("periods_pandas.php","_self");
}
