...
<html lang="en-Us">
    <head>
        <title>Multiple Indexing - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Multiple indexing in Pandas - Pandas Multiple Indexing - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="multiple_indexing_pandas.php"  target="_self">Multiple Indexing</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="multiple_indexing_pandas.php"  target="_self" style="color:white;">Multiple Indexing</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Multiple Indexing - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/multiple_indexing_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/multiple_indexing_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Hierarchical / Multi-level /Multiple indexing is very exciting as it opens the door to some quite sophisticated data analysis and manipulation, especially for working with higher dimensional data. In essence, it enables you to store and manipulate data with an arbitrary number of dimensions in lower dimensional data structures like Series (1d) and DataFrame (2d).</p>

<p style="text-align:justify;">Pandas <code>MultiIndex.to_frame()</code> function create a DataFrame with the levels of the MultiIndex as columns.</p>
<h4 class="text-left mt-4" style="color:#a54eee;">SYNTAX</h4>
<div class="container p-2" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">MultiIndex.to_frame(index=True)</div>
<h4 class="text-left mt-4" style="color:#a54eee;">PARAMETERS</h4>
<p style="text-align:justify;">
  <b>index</b> : Set the index of the returned DataFrame as the original MultiIndex.<br>

<b>Returns</b> : DataFrame - a DataFrame containing the original MultiIndex data.
</p>
...
muix = pd.MultiIndex.from_tuples([(10, 'Ten'), (10, 'Twenty'), 
                (20, 'Ten'), (20, 'Twenty')], 
                    names =['Num', 'Char']) 
...
muix.to_frame(index = False)
</code>
  </div>

<p style="text-align:justify;" class="mt-4"><i>Now this chapter is over for queries you can use the comment section i.e. you can ask your doubts in the comment section...</i></p>
...
function prev(){
  window.open("dataoperations_pandas.php","_self");
}
