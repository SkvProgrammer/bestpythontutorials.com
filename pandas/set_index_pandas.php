        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Setting Index in Pandas - Set index in Pandas  - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="set_index_pandas.php"  target="_self">Set Index</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="set_index_pandas.php"  target="_self" style="color:white;">Set Index</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Set Index - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/set_index_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/set_index_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we are going to see that how we can set index in a DataFrame in Pandas using the <code>set_index()</code> method.Pandas <code>set_index()</code> is a method to set a List, Series or Data frame as index of a Data Frame. Index column can be set while making a data frame too. But sometimes a data frame is made out of two or more data frames and hence later index can be changed using this method.</p>
...
<tr>
    <td>keys</td> 
    <td>Column name or list of column name</td>
  </tr>
<tr><td>drop</td> 
<td>Boolean value which drops the column used for index if True</td></tr>
<tr><td>append</td>
<td> Appends the column to existing index column if True</td></tr>
<tr><td>inplace</td>
<td> Makes the changes in the dataframe if True</td></tr>
<tr><td>verify_integrity</td>
<td> Checks the new index column for duplicates if True</td></tr>
  </table>
</div>
...
'Age': [33, 12, 33, 16],  
'id': [115, 112, 131, 127]})  
info = info.set_index([pd.Index([1, 2, 3, 4]), 'Name'])    
info
</code>
  </div>


<p style="text-align:justify;" class="mt-3">We are done with it,Now in the next chapter we will learn about <i>Time Series</i>.</p>
...
function prev(){
  window.open("reset_index_pandas.php","_self");
}
