        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Pandas Tutorial - Introduction to Pandas - Python's Data Science Tool for Data Manipulation - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="intro_pandas.php"  target="_self">Introduction</a></li>
  ...
  <div class="overlay-content">
     ...
     <a href="" style="border:none;color:white;"><h1 id="tag1">PANDAS TUTORIAL</h1></a>
         <a href="home_pandas.php"  target="_self">Pandas Home</a>
            <a href="intro_pandas.php"  target="_self" style="color:white;">Introduction</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Introduction to Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/intro_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/intro_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Pandas is a Python Library which was developed by Wes McKinney in 2008.It's a great tool for Data Analysis and Data Manipulations.It can easily work with csv or other data formats.</p>
<p style="text-align:justify;">Python with Pandas is used in a wide range of fields including academic and commercial domains including finance, economics, Statistics, analytics, etc.</p>

<h4 class="text-left mt-4" style="color:#a54eee;">Features of Pandas</h4>
<ol style="text-align:justify;list-style:square;">
  <li>High Performance for Merging and Joining Data.</li>
  <li>Supports Time Series Functionality.</li>
  <li>Can easily deal with large Data Sets.</li>
  <li>Provides support for label based indexing and slicing.</li>
...
<p style="text-align:justify;" class="mt-5">In the next chapter we will see how to start using Pandas for Data Manipulation...</p>
...
function prev(){
  window.open("home_pandas.php","_self");
}
