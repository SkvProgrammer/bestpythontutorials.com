        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Sorting in Pandas - Sorting Data in Pandas - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="sorting_pandas.php"  target="_self">Sorting</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="sorting_pandas.php"  target="_self" style="color:white;">Sorting</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Sorting - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/sorting_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/sorting_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In Pandas What we do is manipulate the data.Therefore there might be many situations where we will need to <i>sort</i> the Data i.e. arrange them in any specific order <b>(generally ascending and descending order)</b> .Now In Pandas We have two ways to sort Data:-</p>
<ol style="text-align:justify;font-size:19px;">
  <li>By Label</li>
  <li>By Index</li>
</ol>

<p style="text-align:justify;" class="mt-3">Now in order to grab this concept of Sorting in Pandas We will create a simple DataFrame and then I will show you by printing it when it is unsorted and then I will show you how to sort Data using the above two ways.</p>
...
# creating a dataframe from a dictionary 
df = pd.DataFrame(dict) 
sorted_df = df.sort_index(axis = 1)#axis = 1 represents column
print(sorted_df)
</code>
  </div>

<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><b>Note:</b>A DataFrame has two axes:- axis = 1,which represents columns and axis = 0,which represents rows.</p>
</div>
<h3 class="text-left mt-5" style="color:#a54eee;">Sort - By Index</h3>
...
function next(){
  window.open("aggregation_pandas.php","_self");
}
function prev(){
