        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="io tools in Pandas - I/O Tools in Pandas - IO in Pandas - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="iotools_pandas.php"  target="_self">IO Tools</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="iotools_pandas.php"  target="_self" style="color:white;">IO Tools</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">I/O Tools - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/iotools_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/iotools_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">The pandas I/O API is a set of top level reader functions accessed like <code>pd.read_csv()</code> that generally return a pandas object.A List of those Functions is given below:</p>
...
<p style="text-align:justify;">The corresponding <code>writer</code> functions are object methods that are accessed like <code>df.to_csv()</code></p>
<ol style="text-align:justify;font-size:20px;">
<li>to_csv
<li>to_excel
<li>to_hdf
...
<p style="text-align:justify;">The two workhorse functions for reading text files (or the flat files) are <code>read_csv()</code> and <code>read_table()</code>. They both use the same parsing code to intelligently convert tabular data into a DataFrame object</p>
...
a.to_hdf('main.h5','table',append=True)
read_hdf('store_tl.h5', 'table', where = ['index>2'])
</code>
  </div>
<p style="text-align:justify;" class="mt-4">In case you don't what is this <b>HDFStore</b> - HDFStore is a dict-like object which reads and writes pandas using the high performance HDF5 format using the excellent PyTables library.</p>
...
function prev(){
  window.open("sparse_data_pandas.php","_self");
}
