...
<html lang="en-Us">
    <head>
        <title>Sparse Data - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Sparse Data in Pandas - Pandas Sparse Data - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="sparse_data_pandas.php"  target="_self">Sparse Data</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="sparse_data_pandas.php"  target="_self" style="color:white;">Sparse Data</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Sparse Data - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/sparse_data_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/sparse_data_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">We have implemented “sparse” versions of Series and DataFrame. These are not sparse in the typical “mostly 0”.In this chapter we will learn the concept of sparse data in Deep.</p>


<p style="text-align:justify;">Sparse objects are “compressed” when any data matching a specific value (NaN / missing value, though any value can be chosen) is omitted. A special SparseIndex object tracks where data has been “sparsified”. This will make much more sense in an example. All of the standard Pandas data structures apply the to_sparse method −
...
import pandas as pd  
import numpy as np  
a = pd.DataFrame({"Name":["Abhi","Subo","Vishu"],
                 "Favourite Subject":["Geography","Maths","Biology"],
"Score":[98,98,100]
})
sparse_data = a.to_sparse()
print(sparse_data)
</code>
  </div>
...
sparse_data = a.to_sparse()
print(sparse_data.density)
print(sparse_data.fill_value)
</code>
  </div>

<h4 class="text-left mt-4" style="color:#a54eee;">Sparse Dtypes</h4>
<p style="text-align:justify;">Sparse data should have the same dtype as its dense representation. Currently, float64, int64 and booldtypes are supported. Depending on the original dtype, fill_value default changes −
</p>
<ol style="list-style:square;text-align:justify;font-size:20px;">
<li>float64 − np.nan
...
function prev(){
  window.open("data_visualization_pandas.php","_self");
}
