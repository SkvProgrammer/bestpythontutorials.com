...
<html lang="en-Us">
    <head>
        <title>Reset Index - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Reset Index in Pandas DataFrame - Resetting index in Pandas - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="reset_index_pandas.php"  target="_self">Reset Index</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="reset_index_pandas.php"  target="_self" style="color:white;">Reset Index</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Reset Index - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/reset_index_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/reset_index_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In the previous chapter we have seen the concept of Reindexing in Pandas and Now We will taking a look at the Reset Index Property in Pandas.But wait the two concepts i.e. the Reindexing and Reset Indexing sounds quiet similar but again there are few difference that we will be talking in this chapter.</p>
<p style="text-align: justify;"><b>DIFFERENCE:</b>If the original index are numbers, now we have indexes that are not continuous. Well, pandas has <code>reset_index()</code> function. So to reset the index to the default integer index beginning at 0, We can simply use the <code>reset_index()</code> function. So let's see the different ways we can reset the index of a DataFrame.</p>

<h3 class="text-center mt-3 mb-3" style="color:#a54eee;"><i>WHEREAS</i> </h3>
<p style="text-align:justify;">Reindexing changes the row labels and column labels of a DataFrame. To reindex means to conform the data to match a given set of labels along a particular axis. Reorder the existing data to match a new set of labels.</p>

<p style="text-align:justify;" class="mt-5">In order to grab this concept of reset indexing we will first create a DataFrame then we will create it's index and later we will see how to reset indexes in Pandas.</p>
...
data = {'Name':['Suraj', 'Prince', 'Aurav', 'Arjun', 'Chiku'], 
    'Age':[37, 28, 12, 12, 19], 
    'Address':['Delhi NCR', 'Kharagpur', 'Prayagraj', 'Greater Noida', 'UP'], 
    'Qualification':['M.TECH', 'MSc', 'BSc', '12th', '9th'] } 
...
<p style="text-align:justify;" class="mt-4"><i>That's great we are done with it,Now in the next chapter we will see how we can set index of a DataFrame...</i></p>
...
function prev(){
  window.open("reindexing_pandas.php","_self");
}
