...
<html lang="en-Us">
    <head>
        <title>Concatenation - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Concatenation in Pandas - Concatenating Rows and Columns of the DataFrame - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="concatenation_pandas.php"  target="_self">Concatenation</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="concatenation_pandas.php"  target="_self" style="color:white;">Concatenation</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Concatenation - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/concatenation_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/concatenation_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Pandas Provides some built-in methods two concatenate columns and rows of a dataframe,series or a panel using the <code>concat()</code> method.The Syntax for this method is given below-</p>

<h4 class="text-left mt-4" style="color:#a54eee;">SYNTAX</h4>
<div class="container p-2" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">pandas.concat(objs,axis=0,join='outer',join_axes=None,
ignore_index=False)</div>
...
<div style="overflow:scroll;">
  <table>
    ...
    <tr>
      <td>objs</td>
      <td>This is a sequence or mapping of Series, DataFrame, or Panel objects.</td>
    </tr>
    <tr>
      <td>axis</td>
...
b = pd.DataFrame({"Name":["Laxmi","Sonali","Surbhi"],
                 "Favourite Subject":["Geography","History","Physics"]  
})
...
#concatenating a and b
print(pd.concat([a,b],keys = ["x","y"],ignore_index = True,axis=1))
</code>
  </div>
...
<p style="text-align:justify;" class="mt-4">The <b>append()</b> method takes multiple values i.e. we can concatenate more that two DataFrames.</p>
</div>
