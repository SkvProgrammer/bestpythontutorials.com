...
<html lang="en-Us">
    <head>
        <title>Basic Functionalities - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Basic Functionalities in Pandas - Pandas Basic Functionalities - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="basic_functionalities_pandas.php"  target="_self">Basic Functionalities</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="basic_functionalities_pandas.php"  target="_self" style="color:white;">Basic Functionalities</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Basic Functionalities - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/basic_functionalties_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/basic_functionalities_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
long_series = np.random.randn(2000)

s = pd.Series(long_series)
#printing first 5 elements(default)
print("printing first 5 elements:",s.head())
#printing last 5 elements(default)
...
<p style="text-align:justify;">Pandas objects have a number of attributes enabling you to access the metadata...
</p>
<ol style="text-align:justify;list-style:square;">
<li>shape: gives the axis dimensions of the object, consistent with ndarray</li>
<li>Axis labels
<ol style="text-align:justify;list-style: square;">
  <li><b>Series</b>: index (only axis)
   <li><b>DataFrame</b>: index (rows) and columns
</ol>
</li>
</ol>
...
print ("The axis labels of the series are:")
print(s.axes)
print ("The axis labels of the DataFrame are:")
print(df.axes)
</code>
  </div>
...
print ("The shape of the series are:")
print(s.shape)
print ("The shape of the DataFrame are:")
print(df.shape)
</code>
  </div>

<h4 style="text-align: justify;color:#a54eee" class="mt-5">More Atrributes(DataFrame Supported)</h4>
