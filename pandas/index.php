...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="../codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Pandas Tutorials - BestPythonTutorials.com"/> 
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border:1px solid white;"><a href="home_pandas.php"  target="_self">Pandas Home</a></li>
...
<a href="home_pandas.php"  target="_self" style="color:white;">Pandas Home</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Pandas Tutorials</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/home_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/pandas/home_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--<div id="mySidenav" class="sidenav" style="font-size:15px;z-index:1;"><br>
  ...
  <a href="../#passinloops"><i class="fsa fa-arrow-right"></i>Pass in loops</a>
...
<p style="text-align:justify;">This tutorial is designed for both beginners and working professionals to enhance their skill of Data Manipulation using tools like <a href="../numpy/home_numpy.php" style="color:grey;text-decoration:none;"> numpy <img src="../django/link.png" style="height:12px;"></a> , <a href="../matplotlib/home_matplotlib.php" style="color:grey;text-decoration:none;"> matplotlib <img src="../django/link.png" style="height:12px;"></a> and pandas.Hope you like this tutorial series.It's made with absolute love.</p>

<h3 class="text-center mt-4" style="color:#a6a6a6;">PREREQUISITES</h3>
<p style="text-align:justify;">For sure the prerequisite for this course is the knowledge of <a href="../home_python.php" style="color:grey;text-decoration:none;"> Python Programming Language <img src="../django/link.png" style="height:12px;"></a> and if you have the knowledge of <a href="../numpy/home_numpy.php" style="color:grey;text-decoration:none;"> numpy <img src="../django/link.png" style="height:12px;"></a>,It will be a plus point as we are going to dig into the Data Manipulation or Analysis.</p>
...
function next(){
  window.open("intro_pandas.php","_self"); 
}
function prev(){
