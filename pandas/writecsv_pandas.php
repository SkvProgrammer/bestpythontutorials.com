...
<html lang="en-Us">
    <head>
        <title>Writing a CSV File - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="CSV File Handling - Writing a CSV File - import csv - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="writecsv_pandas.php"  target="_self">Write CSV</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="writecsv_pandas.php"  target="_self" style="color:white;">Write CSV</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Writing a CSV File - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/writecsv_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/writecsv_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
DataFrame.to_csv(self, path_or_buf: Union[str, pathlib.Path, IO[~ 
AnyStr], NoneType] = None, sep: str = ',', na_rep: str = '',
float_format: Union[str, NoneType] = None, columns: Union[Sequence[Unio
[Hashable, NoneType]], NoneType] = None, header: Union[bool, List[str]]
= True, index: bool = True, index_label: Union[bool, str, Sequence[Unio
[Hashable, NoneType]], NoneType] = None, mode: str = 'w', encoding:
Union[str, NoneType] = None, compression: Union[str, Mapping[str, str],
NoneType] = 'infer', quoting: Union[int, NoneType] = None, quotechar:
str = '"', line_terminator: Union[str, NoneType] = None, chunksize:
Union[int, NoneType] = None, date_format: Union[str, NoneType] = None,
doublequote: bool = True, escapechar: Union[str, NoneType] = None,
decimal: Union[str, NoneType] = '.') → Union[str, NoneType]</textarea>
...
<p style="text-align:justify;" class="mt-3">Now to learn about the Parameters.You can check the <a href="https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.to_csv.html#pandas.DataFrame.to_csv" target="_blank" style="color:grey;text-decoration:none;;">Official Docs <img src="../django/link.png" style="height:10px;"></a></p>
<p style="text-align:justify;">The process of creating or writing a CSV file through Pandas can be a little more complicated than reading CSV, but it's still relatively simple. We use the to_csv() function to perform this task. However, you have to create a Pandas DataFrame first, followed by writing that DataFrame to the CSV file.
</p>
...
<p style="text-align:justify;">
Here is a simple example showing how to export a DataFrame to a CSV file via <code>to_csv()</code>:</p>
<div class="text-left mt-0 mb-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
info = pd.DataFrame([['Dhoni', 'India'], ['Gayle', 'Windies']], columns=['Player', 'Country'])
info.to_csv('player.csv')</textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<p style="text-align:justify;" class="mt-4">The above code will create a <code>player.csv</code> file which looks like:</p>
<div class="container p-1 pl-3" style="background-color:black;border-radius:10px;color:white;text-align:justify;">
,Player,Country<br>
0,Dhoni,India<br>
1,Gayle,Windies<br>
...
function next(){
  window.open("indexing_pandas.php","_self");
}
function prev(){
  window.open("readcsv_pandas.php","_self");
}
