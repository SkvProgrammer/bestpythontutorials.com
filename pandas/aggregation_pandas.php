...
<html lang="en-Us">
    <head>
        <title>Aggregation - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Aggregation in Pandas - Aggregate Data in Pandas - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="aggregation_pandas.php"  target="_self">Aggregation</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="aggregation_pandas.php"  target="_self" style="color:white;">Aggregation</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Aggregation - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/aggregation_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/aggregation_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<li><b>sum</b>: Return the sum of the values for the requested axis
<li><b>min</b>: Return the minimum of the values for the requested axis
<li><b>max</b>: Return the maximum of the values for the requested axis
</ol>
...
<div style="overflow:scroll;">
  <table>
    <tr style="background-image:linear-gradient(154deg,#4537d1,#a54eee);color:white;">
      <td>Parameters</td>
      <td>Description</td>
    </tr>
    <tr>
      <td>func</td>
      <td> It refers callable, string, dictionary, or list of string/callables.
</td>
    </tr>
    <tr>
      <td>axis : (default 0)</td><td> {0 or ‘index’, 1 or ‘columns’} 0 or ‘index’: apply function to each column. 1 or ‘columns’: apply function to each row.</td>
    </tr>
    <tr>
      <td>*args</td>
      <td> It is a positional argument that is to be passed to func.</td>
    </tr>
    <tr>
      <td>**kwargs</td>
      <td> It is a keyword argument that is to be passed to the func.</td>
    </tr>
  </table>
</div>
...
import pandas as pd  
import numpy as np  
data=pd.DataFrame([[1,2,3],[4,5,6],[7,8,9],[np.nan,np.nan,np.nan]],columns=['A','B','C'])  
data.agg(['sum','min'])
</code>
  </div>
...
<p class="mt-3" style="text-align:justify;"><i><b>Tip</b>:If you find any difficulties please ask in the comment section.</i></p>
...
function next(){
  window.open("concatenation_pandas.php","_self");
}
function prev(){
