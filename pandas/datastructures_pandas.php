...
<html lang="en-Us">
    <head>
        <title>Data Structures - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Data Structures in Pandas - Series , Panel and DataFrame - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="datastructures_pandas.php"  target="_self">Data Structures</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="datastructures_pandas.php"  target="_self" style="color:white;">Data Structures</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Data Structures - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/installation_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/installation_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4"><b>Data Structures</b> in Pandas are used to store and display the data in various forms many be in the 2D or 3D form.Some Data Structures stores homogenous data and some stores heterogenous data.There are three types of Data Structures in Pandas:-</p>
...
<p style="text-align:justify;">Now we will discuss all the three structures in brief and in later chapters we will look at more detailed chapters on these Data Structures.First of all We will talk about the <b>Series</b> Data Structure.<b>Series</b> are one-dimensional array like structure with homogeneous data. For example, the following series is a collection of integers 10,20,30...</p>
<table>
  <tr style="border:1px solid grey;">
    <td style="border:1px solid grey;">10</td>
    <td style="border:1px solid grey;">20</td>
    <td style="border:1px solid grey;">30</td>
    <td style="border:1px solid grey;">40</td>
    <td style="border:1px solid grey;">50</td>
    <td style="border:1px solid grey;">60</td>
    <td style="border:1px solid grey;">70</td>
    <td style="border:1px solid grey;">80</td>
    <td style="border:1px solid grey;">90</td>
    <td style="border:1px solid grey;">100</td>
  </tr>
</table>
<h4 class="text-left mt-4" style="color:#a54eee;">Panel</h4>
<p style="text-align:justify;" class="mt-4">The <b>Panel</b> Data Structure  is a three-dimensional data structure with heterogeneous data. It is hard to represent the panel in graphical representation. But a panel can be illustrated as a container of DataFrame.</p>

<h4 class="text-left mt-4" style="color:#a54eee;">Data Frame</h4>
<p style="text-align:justify;">DataFrame is a two-dimensional array with heterogeneous data. For example,
</p>
<table>
  <tr>
    <th>Name</th>
...
function next(){
  window.open("series_pandas.php","_self");
}
function prev(){
  window.open("installation_pandas.php","_self");
}
