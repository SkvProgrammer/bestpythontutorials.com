...
<html lang="en-Us">
    <head>
        <title>Reading a CSV File - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="CSV File Handling - Reading CSV File in Pandas - import csv - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="readcsv_pandas.php"  target="_self">Read CSV</a></li>
    ...
    <li><a href="datatime_pandas.php"  target="_self">Data Time</a></li>
    ...
    <li><a href="selection_pandas.php"  target="_self">Selection</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="readcsv_pandas.php"  target="_self" style="color:white;">Read CSV</a>
    ...
    <a href="datatime_pandas.php"  target="_self">Data Time</a>
    ...
    <a href="selection_pandas.php"  target="_self">Selection</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Reading CSV File - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/readcsv_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/readcsv_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we will see how to read a CSV file in Pandas.Now what is this CSV File ? CSV stands for <b>Comma Seperated Files</b> which is one of the most popular data format.You can import Spreadsheet Document using it.</p>


<p style="text-align:justify;">In Pandas we have a method called <b>read_csv</b>,which is used to read a csv in Python.Below is the Syntax of this method...</p>
...
<div class="text-left mt-0 mb-1">
 ...
 <textarea id="editor1" name="initScript" style="height:20vh!important;text-align:justify;overflow:hidden;-webkit-border-radius: 5px;
    -moz-border-radius: 5px;border-radius: 5px;z-index:0;width:100%;" readOnly = 'nocursor'>
pandas.read_csv(filepath_or_buffer: Union[str, pathlib.Path, IO[~ 
AnyStr]], sep=',', delimiter=None, header='infer', names=None, 
...
<h4 class="text-left mt-5" style="color:#a54eee;">Important Parameters</h4>
<div style="overflow:scroll;">
  <table width="100%" style="box-shadow:1px 1px lightgrey;">
<thead>
<tr>
<td style="padding:8px;background-image: linear-gradient(to left,#4537d1,#a54eee);color:white;">Parameter</td>
<td style="padding:8px;background-image: linear-gradient(to right,#4537d1,#a54eee);color:white;">Description</td>
</tr>
</thead>
<tbody>
<tr>
<td>filepath_or_buffer</td>
<td>URL or Dir location of file</td>
</tr>
<tr>
<td>sep</td>
<td>Stands for separator, default is  ‘, ‘ as in csv(comma separated values)</td>
</tr>
<tr>
<td>index_col</td>
<td>Makes passed column as index instead of 0, 1, 2, 3…r<br>
</td>
</tr>
<tr>
<td>header</td>
<td>Makes passed row/s[int/int list] as header<p></p>
<p>
</p></td>
</tr>
<tr>
<td>use_cols</td>
<td>Only uses the passed col[string list] to make data frame</td>
</tr>
<tr>
<td>squeeze</td>
<td>If true and only one column is passed, returns pandas series</td>
</tr>
<tr>
<td>skiprows</td>
<td>Skips passed rows in new data frame</td>
</tr>
</tbody>
</table>
</div>
<p style="text-align:justify;" class="mt-2">For More Details about the Parameters,<a href="https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.read_csv.html" style="color:grey;text-decoration:none;"> Click Here. <img src="../django/link.png" style="height:12px;"></a></p>

<h4 style="text-align:left;color:#a54eee;" class="mt-3">EXAMPLE</h4>
<p style="text-align:justify;">For this example we will be using the <a href="./demo.csv" download style="background-color:orangered;color:white;border-radius:10px;text-decoration:none;" class="p-0 pl-1 pr-1">demo.csv</a></p>
...
<h5 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h5>
<img src="csv1.png" class="img-fluid">

<h4 class="text-left mt-4" style="color:#a54eee;">Options for Convering a CSV File into DataFrame</h4>
<div style="overflow:scroll;">
  <table>
    <tr style="background-image:linear-gradient(to right,#a54eee,#4537d1);color:white;">
      <td>Option</td>
      <td>Description</td>
    </tr> 
    <tr>
      <td>filepath_or_buffer</td>
      <td> this is the file name or file path</td>
    </tr> 
    <tr>
      <td>header</td>
      <td> this allows you to specify which row will be used as column names for your dataframe. Expected an int value or a list of int values.</td>
    </tr>
    <tr>
      <td>sep</td>
      <td> Specify a custom delimiter for the CSV input, the default is a comma.</td>
    </tr>
    <tr>
      <td>index_col</td>
      <td>This is to allow you to set which columns to be used as the index of the dataframe. The default value is None, and pandas will add a new column start from 0 to specify the index column.</td>
    </tr>
    <tr>
      <td>nrows</td>
      <td> Only read the number of first rows from the file. Needs an int value.</td>
    </tr>
    <tr>
      <td>usecols</td>
      <td>Specify which columns to import to the dataframe. It can a list of int values or column names.</td>
    </tr>
    <tr>
      <td>converters</td>
      <td> Helps to convert values in the columns by defined functions.
</td>
    </tr>
    <tr>
      <td>na_values</td>
      <td> The default missing values will be NaN. Use this if you want other strings to be considered as NaN. The expected input is a list of strings.</td>
    </tr>
  </table>
</div>
...
<p style="text-align:justify;" class="mt-3">That's great we are done.We have made a DataFrame Using the CSV file...If you have any queries,ask it in the comment section,You will get the reply within an hour.</p>
...
function next(){
  window.open("writecsv_pandas.php","_self");
}
function prev(){
  window.open("basic_functionalities_pandas.php","_self");
}
