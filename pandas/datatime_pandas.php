        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Date Time in Pandas - Pandas Date Time - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="time_series_pandas.php"  target="_self">Time Series</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="time_series_pandas.php"  target="_self" style="color:white;">Time Series</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Time Series - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/time_series_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/time_series_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">You may be knowing that Pandas along with <a href="../matplotlib/home_matplotlib.php" style="color:grey;text-decoration:none;"> Matplotlib <img src="../django/link.png" style="height:12px;"></a> and <a href="../numpy/home_numpy.php" style="color:grey;text-decoration:none;"> NumPy <img src="../django/link.png" style="height:12px;"></a> are a great combination of tools for Data Analysis with Python Programming Language and along with <i>Sci-Kit Learn</i> which we are currently not making courses on will be suitable for practicing Machine Learning.So we apologise for this and  We promise you that within few months we will launch courses on <i>Sci-Kit Learn and Tensorflow.</i></p>
<p style="text-align:justify;">Now why we are talking about this - Sci-kit Learn also provides Time Series Manipulations Concepts or Functionality but In Pandas there are few more features that are not supported by Sci-Kit Learn.So I think you got the answer for your question...</p>

<h5 class="text-left mt-4" style="color:#a54eee;">Objectives of Time Series Analysis:-</h5>
<ul style="text-align:justify;font-size:20px;">
  <li>We can Work with Time Stamp.</li>
  <li>Convert string data to timestamp</li>
  <li>Slicing of data using timestamp</li>
  <li>Resample your time series for different time period aggregates/summary statistics
...
date_range = pd.date_range(start ='1/1/2019', end ='1/12/2019', freq ='Min') 
print(date_range) 

</code>
  </div>

<p style="text-align:justify;" class="mt-4">In this chapter we will use a word called <i>Timestamp</i> a lot of times.So what does it mean - A timestamp is a sequence of characters or encoded information identifying when a certain event occurred, usually giving date and time of day, sometimes accurate to a small fraction of a second.</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">EXPLANATION</h4>
<p style="text-align:justify;">We are checking the type of our object named <b>date_range</b>.</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">EXPLANATION</h4>
<p style="text-align:justify;">We have used the <code>head()</code> method to print the top 5 dates.</p>
...
range_data = pd.date_range(start ='1/1/2019', end ='1/12/2019',freq ='Min') 
...
function next(){
  window.open("datatime_pandas.php","_self");
}
function prev(){
  window.open("set_index_pandas.php","_self");
}
