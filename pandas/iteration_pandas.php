        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Iteration in Pandas - Iterating over rows and columns - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="iteration_pandas.php"  target="_self">Iteration</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="iteration_pandas.php"  target="_self" style="color:white;">Iteration</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Iteration - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/iteration_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/iteration_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4"><b>Iteration</b> is not a complex precess.In iteration,all the elements are accessed one after one using Loops.The behavior of basic iteration over Pandas objects depends on the type. When iterating over a Series, it is regarded as array-like, and basic iteration produces the values. Other data structures, like DataFrame and Panel, follow the dict-like convention of iterating over the keys of the objects.</p>
...
<p style="text-align:justify;" class="mt-4">Now pandas itself provide some build-in methods for iterating over a DataFrame.For iteration there are three methods:-</p>
<ol style="text-align:justify;">
<li>iteritems() − to iterate over the (key,value) pairs
</li>
<li>iterrows() − iterate over the rows as (index,series) pairs
</li>
<li>itertuples() − iterate over the rows as <a href="../collectionmodule.php" style="color:grey;text-decoration:none;"> namedtuples <img src="../django/link.png" style="height:12px;"></a>
</li>
</ol>
...
df = pd.DataFrame(np.random.randn(10,3),columns=['col_1','col_2','col_3'])
...
# dictionary of lists 
dict = {'name':["skv", "skvprogrammer", "sv"], 
    'profession': ["unemployed", "programmer", "Manager"], 
    'age':[45, 40, 30]} 
...
# dictionary of lists 
dict = {'name':["skv", "skvprogrammer", "sv"], 
    'professional': ["unemployed", "programmer", "Manager"], 
    'age':[45, 40, 30]} 
...
<p style="text-align:justify;" class="mt-4">Now this chapter is over,if you have any queries,ask me in the comment section.</p>
...
function next(){
  window.open("sorting_pandas.php","_self");
}
function prev(){
