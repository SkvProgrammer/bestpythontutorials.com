...
<html lang="en-Us">
    <head>
        <title>Merging and Joining - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Merging and Joining in Pandas - Merging/Joining. left − A DataFrame object. right − Another DataFrame object. on − Columns (names) to join on. left_on - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="merging_joining_pandas.php"  target="_self">Merging and Joining</a></li>
    </ul>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="merging_joining_pandas.php"  target="_self" style="color:white;">Merging and Joining</a>
  </div>
</div>
</div>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Merging and Joining - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/merging_and_joining_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/merging_and_joining_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a> 
...
<h4 class="text-left mt-4" style="color:#a54eee;">PARAMETER</h4>
<div style="overflow:scroll;">
  <table>
    ...
    <tr><td>left</td> <td> A DataFrame object.</td></tr>

<tr><td>right</td> <td> Another DataFrame object.</td></tr>

<tr><td>on</td> <td> Columns (names) to join on. Must be found in both the left and right DataFrame objects.</td>
</tr>
<tr><td>left_on</td> <td> Columns from the left DataFrame to use as keys. Can either be column names or arrays with length equal to the length of the DataFrame.</td>
</tr>
<tr>
  <td>
right_on</td> <td> Columns from the right DataFrame to use as keys. Can either be column names or arrays with length equal to the length of the DataFrame.
</td>
</tr>

<tr><td>left_index</td>  <td>If True, use the index (row labels) from the left DataFrame as its join key(s). In case of a DataFrame with a MultiIndex (hierarchical), the number of levels must match the number of join keys from the right DataFrame.</td></tr>

<tr><td>right_index</td> <td> Same usage as left_index for the right DataFrame.</td>
</tr>
<tr><td>how</td> <td>One of 'left', 'right', 'outer', 'inner'. Defaults to inner. Each method has been described below.</td></tr>

<tr><td>sort</td><td> Sort the result DataFrame by the join keys in lexicographical order. Defaults to True, setting to False will improve the performance substantially in many cases.</td></tr>
  </table>
</div>
...
left = pd.DataFrame({
   'id':[1,2,3,4,5],
   'Name': ['Manish', 'Amy', 'Anish', 'Bob', 'Ayush'],
   'Subject':['Science','Arts','Arts','Commerce','Commerce']})
right = pd.DataFrame(
   {'id':[1,2,3,4,5],
   'Name': ['Bobby', 'Sunny', 'Broad', 'Bruce', 'Alia'],
   'Subject':['Maths','Bio','Bio','Maths','Maths']})
print(left)
print(right)
...
right = pd.DataFrame(
   ...
   'Name': ['Bobby', 'Sunny', 'Broad', 'Bruce', 'Alia'],
   'Subject':['Maths','Bio','Bio','Maths','Maths']})
print(pd.merge(left,right,on=["Name","Subject"]))
...
<h4 class="text-left mt-4" style="color:#a54eee;">Merge Using <i>how</i> Argument</h4>
<p style="text-align:justify;">The <i>how</i> argument specifies how to determine which keys are to be included in the resulting table. If a key combination does not appear in either the left or the right tables, the values in the joined table will be <b>NA</b>.
</p>
<h5 class="text-left mt-4" style="color:#a54eee;">Consider the below table:-</h5>
<div style="overflow:scroll;">
...
right = pd.DataFrame(
   ...
   'Name': ['Bobby', 'Sunny', 'Broad', 'Bruce', 'Alia'],
   'Subject':['Maths','Bio','Bio','Maths','Maths']})
print(pd.merge(left,right,on=["Name","Subject"],how="left"))#left outer join
print(pd.merge(left,right,on=["Name","Subject"],how="right"))#right outer join
print(pd.merge(left,right,on=["Name","Subject"],how="outer"))#full outer join
print(pd.merge(left,right,on=["Name","Subject"],how="inner"))#inner join
...
function next(){
  window.open("merging_joining_pandas.php","_self");
}
function prev(){
