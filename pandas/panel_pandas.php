        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Panel Data Structure in Pandas - Panel in Pandas - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="panel_pandas.php"  target="_self">Panel</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="panel_pandas.php"  target="_self" style="color:white;">Panel</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Panel - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/panel_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/panel_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<ol style="text-align:justify;list-style:square;font-size:20px;">
...
<li>minor_axis − axis 2, it is the columns of each of the DataFrames.</li>
</ol>


<h4 class="text-left mt-5" style="color:#a54eee;">pandas.Panel</h4>
<p style="text-align:justify;">Now in this section we are going to see that what is the syntax for creating a Panel Class in Pandas.</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Creating Panel</h4>
...
Dimensions: 2 (items) x 4 (major_axis) x 5 (minor_axis)<br>
Items axis: 0 to 1<br>
Major_axis axis: 0 to 3<br>
Minor_axis axis: 0 to 4<br>
</div>

<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><b>Note</b> − Observe the dimensions of the empty panel and the above panel, all the objects are different.</p>
</div>
...
data = {'Item_1' : pd.DataFrame(np.random.randn(10, 3)), 
   'Item_2' : pd.DataFrame(np.random.randn(10, 2))}
p = pd.Panel(data)
print(p)
</code>
  </div>

<h4 class="text-left mt-5" style="color:#a54eee;">Now we will see how to access the items of a Panel.We have three things to access in the Panel-</h4>
...
function next(){
  window.open("dataframe_pandas.php","_self");
}
function prev(){
