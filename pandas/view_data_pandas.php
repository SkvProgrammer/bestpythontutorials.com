...
<html lang="en-Us">
    <head>
        <title>Viewing Data - Pandas</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Viewing Data in Pandas - How to view Data in Pandas  - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="view_data_pandas.php"  target="_self">Viewing Data</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="view_data_pandas.php"  target="_self" style="color:white;">Viewing Data</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Viewing Data - Pandas</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pandas/view_data_pandas.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/pandas/view_data_pandas.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a> 
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we are going to see the concept of Exploration of Data in a Pandas DataFrame i.e. how we can view the Data of the DataFrame or Series in Pandas.Now we will see different ways to access the data of the DataFrame...</p>
...
s = pd.DataFrame({'Name':['skv','sub','sunil'],'Profession':['Developer','AI Expert','Programmer']})
...
<p style="text-align:justify;" class="mt-3">We have now completed another chapter and in the next chapter we are going to cover the concept of <b>Selection</b> in Pandas...</p>
