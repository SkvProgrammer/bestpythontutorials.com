...
<html lang="en-Us">
    <head>
        <title>Print Function in Python | Docstrings in Python</title>
        <meta charset="utf-8">
        ...
        <meta name="description" content="print() method in Python - How to display text in Python - Docstrings in Python - How to print docstring content in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="print.php" target="_self">print,docstring</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="print.php" target="_self" style="color:white;">print,docstring</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;">print function in python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/print.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/print.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
 ...
 <p style="text-align:left;" class="mt-4"><code>print()</code> function  prints a specified statement or message in the console or standard output window.</p>
           <h4 class="text-left mt-1 mb-1" style="color:#a54eee;">SYNTAX</h4>
           <div class="container p-2 mb-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">print(object(s), separator=separator, end=end, file=file, flush=flush)</div>
...
<h2 class="text-left mt-4" style="color:#a54eee;">Docstring - Python</h2>
<p style="text-align:justify;"><b>Docstrings</b> are <i>Multiline</i> Strings which is generally used for Documentation of the Code.You can also use it to print multi line string using the <code>print()</code> method.</p>

<h4 class="text-left mt-4" style="color:#a54eee;"> What should a docstring look like?
</h4>

<ul style="text-align:justify;font-size:20px;">
    <li>The doc string line should begin with a capital letter and end with a period.
...
<li>
    ...
    <li>
    The following lines should be one or more paragraphs describing the object’s calling conventions, its side effects, etc.</li>
</ul>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Declaring a Docstring</h4>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Accessing a Docstring</h4>
...
print(docmethod.__doc__)
print(help(docmethod))
</code>
  </div>          


<h4 class="text-left mt-4" style="color:#a54eee;">Multiline String</h4>
<p style="text-align:justify;">In Python using the <code>print()</code> function you cannot print multiline strings but you can use a backslash( / ) while the breaking of the line.See the examples below:</p>
