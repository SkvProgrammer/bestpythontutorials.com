...
<html lang="en-Us">
    <head>
        ...
        <meta name="description" content="String Operations in Python - Basic String Operations in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="stringoperations.php" target="_self">String Operations</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="stringoperations.php" target="_self" style="color:white;">String Operations</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;">String Operations</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/stringoperations.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/stringoperations.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
 ...
 <h4 style="text-align:left;text-decoration:none;" class="mt-4">Length of a String using <keyword>len()</keyword> method</h4>
...
print(len("programming"))
             ...
             <div class="container p-2" style="background-color: #f2f2f2;border:2px solid lightgrey;text-align:justify;">11</div>
...
print(a.index("P")) 
               ...
               <h4 class="text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
              <div class="container p-2" style="background-color: #f2f2f2;border:2px solid lightgrey;text-align:justify;">0</div>
            
             
            
             <p style="text-align:justify;" class="mt-3"><code>count()</code> function is used to count the number of times a character occurs in a string...</p>
...
print(a.count("m")) 
 ...
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
               ...
               <h4 class="text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
              <div class="container p-2" style="background-color: #f2f2f2;border:2px solid lightgrey;text-align:justify;">2</div>
             ...
             <h2 class="text-left mt-4" style="color:#a54eee;">String Slicing</h2>
             <p style="text-align:left;">String Slicing refers to dividing a string into different parts...</p>
...
print(a[2:5]) 
               ...
               <h4 class="text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
              <div class="container p-2" style="background-color: #f2f2f2;border:2px solid lightgrey;text-align:justify;">ogr</div>
            ...
            <p style="text-align:justify;">In the above programmer we saw a little example of string slicing in we sliced the string <b>"Programming"</b> between the index value of <b>2(included)</b> and <b>5(not included)</b>...</p>

             <h4 class="text-left mt-4" style="color:#a54eee;">Reversing a String
           </h4>
