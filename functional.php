...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Functional Programming in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,Functional Programming in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="functional.php" target="_self">Functional Programming</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="functional.php" target="_self" style="color:white;">Functional Programming</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Functional Programming in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/functional.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/functional.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4"><b>Functional Programming</b> is a programming paradigm in which we try to bind everything in pure mathematical functions style. It is a declarative type of programming style.In simple language we can say that in functional programming we are more dependent on functions for performing different operations unlike object oriented programming where we are mostly dependent on classes and objects.</p>
...
<h3 style="text-align:justify;color:#a54eee;" class="mt-4">Different Types of Programming Paradigms:-</h3>
<ul style="text-align:justify;font-size:20px;">
  <li>Most programming languages are procedural i.e. programs are lists of instructions that tell the computer what to do with the program’s input. C is one of the most popular procedural oriented languages.</li>
  <li>In declarative languages, you write a specification that describes the problem to be solved, and the language implementation figures out how to perform the computation efficiently. SQL is the declarative language you’re most likely to be familiar with; a SQL query describes the data set you want to retrieve, and the SQL engine decides whether to scan tables or use indexes, which subclauses should be performed first, etc.</li>
  <li>Object-oriented programs manipulate collections of objects. Objects have internal state and support methods that query or modify this internal state in some way. Smalltalk and Java are object-oriented languages. C++ and Python are languages that support object-oriented programming, but don’t force the use of object-oriented features.</li>
  <li>Functional programming decomposes a problem into a set of functions. Ideally, functions only take inputs and produce outputs, and don’t have any internal state that affects the output produced for a given input. Well-known functional languages include the ML family (Standard ML, OCaml, and other variants) and Haskell.</li>
</ul>

<p style="text-align:justify;">In Python we are provided with some features like <b>generators</b> and <b>itertools</b> and some modules like <b>itertools</b> and <b>functools</b> which promotes Functional Programming in Python.Its main focus is on “what to solve” in contrast to an imperative style where the main focus is “how to solve“.</p>

 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
<h3 style="text-align:left;color:#a54eee;" class="mt-4">Concepts of Functional Programming</h3>
<ul style="text-align:justify;font-size:20px;">
  <li><b>Pure Functions:</b>A function is called <b>pure function</b> if it always returns the same result for same argument values and it has no side effects like modifying an argument (or global variable) or outputting something. The only result of calling a pure function is the return value. Examples of pure functions are strlen(), pow(), sqrt() etc.</li>
  <li class="mt-2"><b>Recursion</b>:Recursion is one of the most important feature of functional programming.With the help of Recursion we can solve those problems which literally can't be solved using Loops.</li>
  <li class="mt-2"><b>Functions are First-Class and can be Higher-Order</b>: First-class functions are treated as first-class variable. The first-class variables can be passed to functions as a parameter, can be returned from functions or stored in data structures.</li>
<li class="mt-2"><b>Variables are Immutable</b>: In functional programming, we can’t modify a variable after it’s been initialized. We can create new variables – but we can’t modify existing variables.</li>
</ul>
...
<h3 style="text-align:left;color:#a54eee;" class="mt-5">Functions are First-Class and can be Higher-Order</h3>
...
function next(){
  window.open("cpython.php","_self"); 
}
function prev(){
  window.open("socket.php","_self");
}
