...
<html lang="en-Us">
    <head>
        <title>Environment Setup - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Setting Up the Environment for Matplotlib - Start using Matplotlib - Installing Matplotlib  - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="environment_setup_matplotlib.php"  target="_self">Environment Setup</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="environment_setup_matplotlib.php"  target="_self" style="color:white;">Environment Setup</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Environment Setup - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/environment_setup_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/environment_setup_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">The previous chapter was an introductory chapter for Matplotlib and we have also discussed some common features of Matplotlib and in this chapter we will see that what we need to get started with Matpltolib.You can use <a href="https://jupyter.org/try" style="color:grey;text-decoration:none;"> Jupyter Notebook <img src="../django/link.png" style="height:12px;"></a>,which is an awesome tools for Data Science.You can either use it online you can even download the offline i.e. the Downloadable IDE.The following image will help you to understand the plus points of using Jupyter Notebook as it has a great UI,some useful features:</p>
<img src="jupyternotebook.png" class="img-fluid mb-3">
<p style="text-align:justify;">The other way of using Matplotlib is by installing matplotlib using the pip package manager.It is recommended that you must installed <a href="../numpy/home_numpy.php" style="color:grey;text-decoration:none;"> numpy <img src="../django/link.png" style="height:12px;"></a> and <a href="../pandas/home_pandas.php" style="color:grey;text-decoration:none;"> pandas <img src="../django/link.png" style="height:12px;"></a> before installing matplotlib as they all three are a combo for Data Manipulation,Creation and Visualization.</p>

<div class="container p-2" style="text-align:justify;background-color:#f2f2f2;border:1px solid lightgrey;">
  pip install matplotlib
</div>

<h5 style="text-align:justify;" class="mt-4">If you have already installed matplotlib in your computer then after typing the above command the following output will be given.</h5>
<img src="cmdcommand.png" class="img-fluid mt-4">
