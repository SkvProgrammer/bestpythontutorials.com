...
<html lang="en-Us">
    <head>
        <title>Pie Chart - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Pie Chart in Matplotlib - pie() function that generates a pie diagram representing data in an array. - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="pie_chart_matplotlib.php"  target="_self">Pie Chart</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="pie_chart_matplotlib.php"  target="_self" style="color:white;">Pie Chart</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Pie Chart - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/pie_chart_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/pie_chart_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we are going to plot a simple pie chart in matplotlib using the <b>pie()</b> method.But before plotting a Pie Chart,We need to know what is a Pie Chart?</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">How the Pie() method Works ?</h4>
<p style="text-align:justify;"><code>Pie()</code> method generates a pie diagram representing data in an array. The fractional area of each wedge is given by x/sum(x). If sum(x)< 1, then the values of x give the fractional area directly and the array will not be normalized. Theresulting pie will have an empty wedge of size 1 - sum(x).</p>
...
langs = ['C', 'C++', 'Java', 'Python', 'PHP']
students = [18,17,40,29,12]
explode_var = (0, 0, 0.1, 0, 0) 
ax.pie(students, labels = langs,explode = explode_var,autopct='%1.2f%%')
plt.show()
</code>
  </div>
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="pie2.svg" class="img-fluid" style="height:550px;">
...
function next(){
  window.open("scatter_chart_matplotlib.php","_self");
}
function prev(){
