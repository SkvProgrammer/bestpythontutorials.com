        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Figure in Matplotlib - Matplotlib Figure - Figure class in Matplotlib - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="figure_matplotlib.php"  target="_self">Figure</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="figure_matplotlib.php"  target="_self" style="color:white;">Figure</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;"> Figure - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/figure_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/figure_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we are going to see the use of Figure Function but before we should start we first need to know the meaning of this function - The <code>figure()</code> function in pyplot module of matplotlib library is used to create a new figure.</p>
...
<div style="overflow:scroll;">
  <table>
    ...
    <tr><td>num</td> <td> This parameter is provided, and a figure with this id already exists.</td></tr>
    <tr><td>
figsize(float, float)</td> <td>These parameter are the width, height in inches.</td></tr>
<tr><td>
dpi </td> <td>This parameter is the resolution of the figure.</td></tr>
<tr><td>
facecolor </td><td> This parameter is the the background color.</td></tr>
<tr><td>edgecolor </td><td> This parameter is the border color.</td></tr>
<tr><td>frameon </td> <td>This parameter suppress drawing the figure frame.</td></tr>
<tr><td>FigureClass </td><td> This parameter use a custom Figure instance.</td></tr>
<tr><td>
clear </td><td> This parameter if True and the figure already exists, then it is cleared.</td></tr>
  </table>
</div>

<h3 class="text-left mt-4" style="color:#a54eee;">EXAMPLES</h3>
<h5 class="text-left mb-0 mt-4">code #1( Custom Figure Subclass )</h5>
...
<h5 class="text-left mb-0 mt-5">code #2( Resizing axes with constrained layout )</h5>
<div data-datacamp-exercise data-lang="python">
  <code data-type="sample-code">
import matplotlib.pyplot as plt
...
ax.plot(xdata1, ydata1, color='tab:#4537d1')
ax.plot(xdata2, ydata2, color='tab:orange')

# create the events marking the x data points
xevents1 = EventCollection(xdata1, color='tab:#4537d1', linelength=0.05)
xevents2 = EventCollection(xdata2, color='tab:orange', linelength=0.05)

# create the events marking the y data points
yevents1 = EventCollection(ydata1, color='tab:#4537d1', linelength=0.05,
...
<h5 style="text-align:justify;" class="mt-3"><i>Now this chapter is over,In this chapter you will learn about the <b>axes</b> in the plot.</i></h5>
...
function next(){
  window.open("axes_matplotlib.php","_self");
}
function prev(){
