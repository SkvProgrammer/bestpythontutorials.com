        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Legend in Matplotlib - A legend is an area describing the elements of the graph. In the matplotlib library, there's a function called legend() which is used to Place a legend on the axes. - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="legend_matplotlib.php"  target="_self">Legend</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="legend_matplotlib.php"  target="_self" style="color:white;">Legend</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;"> Legend - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/legend_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/legend_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Legend in a graph is nothing but an area or notation which describes the elements of the graph you can visualize it as the mark of vales.For better understandng we will be looking at the examples.Believe me that will be really awesome.</p>
<p style="text-align:justify;">
The attribute <b>Loc</b> in <code>legend()</code> is used to specify the location of the legend.Default value of loc is loc=”best” (upper left). The strings ‘upper left’, ‘upper right’, ‘lower left’, ‘lower right’ place the legend at the corresponding corner of the axes/figure.</p>
<p style="text-align:justify;">
The attribute <code>bbox_to_anchor=(x, y)</code> of <code>legend()</code> function is used to specify the coordinates of the legend, and the attribute ncol represents the number of columns that the legend has.It’s default value is 1.
</p>
...
<div class="container p-2" style="background-color: #f2f2f2;border:1px solid lightgrey;text-align:justify;">
  matplotlib.pyplot.legend(["red", "yellow"], bbox_to_anchor=(0.75, 1.15), ncol=2)
</div>
<h5 style="text-align:justify;" class="mt-4">More possible attributes of the <code>legend()</code> method are given below:</h5>
<ul style="text-align:justify;font-size:20px;">
  <li><b>shadow:</b> [None or bool] Whether to draw a shadow behind the legend.It’s Default value is None.</li>
<li>
<b>markerscale:</b> [None or int or float] The relative size of legend markers compared with the originally drawn ones.The Default is None.</li>
<li>
<b>numpoints:</b> [None or int] The number of marker points in the legend when creating a legend entry for a Line2D (line).The Default is None.
</li>
<li>
<b>fontsize:</b> The font size of the legend.If the value is numeric the size will be the absolute font size in points.
</li>
<li>
<b>facecolor:</b> [None or "inherit" or color] The legend’s background color.
</li>
<li>
<b>edgecolor:</b> [None or "inherit" or color] The legend’s background patch edge color.</li>
</ul>
...
plt.legend(["#4537d1", "green"], loc ="lower right") 
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of code #2</h4>
<img src="legend_output.svg" class="img-fluid" style="height:500px;">

<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4">You can use different loc for positioning of the legend in the figure.</p>
</div>

<h3 class="text-left mt-4" style="color:#a54eee;">Legend Styles</h3>
...
<h3 class="text-left mt-4" style="color:#a54eee;">Legend Markers</h3>
<p style="text-align:justify;">In this section we are going to see the use of markers in the figure.</p>
...
#4537d1_star = mlines.Line2D([], [], color='#4537d1', marker='*', linestyle='None',
                          markersize=10, label='#4537d1 stars')
red_square = mlines.Line2D([], [], color='red', marker='s', linestyle='None',
                          markersize=10, label='Red squares')
#a54eee_triangle = mlines.Line2D([], [], color='#a54eee', marker='^', linestyle='None',
                          markersize=10, label='#a54eee triangles')

plt.legend(handles=[#4537d1_star, red_square, #a54eee_triangle])
...
<img src="markers.png" class="img-fluid" style="height:500px;">

<h3 class="text-left mt-4" style="color:#a54eee;">List of Possible Markers</h3>
<img src="markerslist.png" class="img-fluid" style="border:1px solid lightgrey;">
...
function next(){
  window.open("grid_matplotlib.php","_self");
}
function prev(){
  window.open("subplots_matplotlib.php","_self");
}
