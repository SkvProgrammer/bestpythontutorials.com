...
<html lang="en-Us">
    <head>
        <title>Violin Plot - Matplotlib</title>
        <meta charset="utf-8">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;""><a href="violin_plot_matplotlib.php"  target="_self">Violin Plot</a></li>
    </ul>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="violin_plot_matplotlib.php"  target="_self" style="color:white;">Violin Plot</a>
  </div>
</div>
</div>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Violin Plot - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/violin_plot_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/violin_plot_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
 <p style="text-align:justify;">Violin Plots are almost similar to Box plots and histogram or you can say that it is the combination of 
...
<div data-datacamp-exercise data-no-lazy-loading data-lang="python">
    <code data-type="sample-code"> 
        ...
        np.random.seed(10)
        c_1 = np.random.normal(100, 8, 100)
        c_2 = np.random.normal(81, 32, 100)
    ...
    <img src="violin_plot_ex_one.png" class="img-fluid">
...
function prev(){
  window.open("box_plot_matplotlib.php","_self");
}
