...
<html lang="en-Us">
    <head>
        <title>Matplotlib Tutorials - BestPythonTutorials.com</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="../codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Django Tutorials - BestPythonTutorials.com"/> 
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
       <img src="matplotlibbanner.png" class="ml-auto mr-auto img-fluid mt-3 mb-3 text-center" style="width:70%;height:80px;">
       <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:32px;">MATPLOTLIB TUTORIAL</h4></li><br>
       <li style="background-image:linear-gradient(#4537d1,#4537d1);border:1px solid white;"><a href="home_matplotlib.php"  target="_self">Matplotlib Home</a></li>
       ...
       <li><a href="bar_plot_matplotlib.php"  target="_self">Bar Plot</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="home_matplotlib.php"  target="_self" style="color:white;">Matplotlib Home</a>
...
<a href="bar_plot_matplotlib.php"  target="_self">Bar Plot</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Matplotlib Tutorials</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">

<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/home_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/matplotlib/home_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;">This tutorial is designed for both beginners and working professionals to enhance their skill of Data Visualization using  matplotlib.Hope you like this tutorial series.It's made with absolute love.</p>

<h3 class="text-center mt-4" style="color:#a6a6a6;">PREREQUISITES</h3>
<p style="text-align:justify;">For sure the prerequisite for this course is the knowledge of <a href="../home_python.php" style="color:grey;text-decoration:none;"> Python Programming Language <img src="../django/link.png" style="height:12px;"></a> and if you have the knowledge of <a href="../numpy/home_numpy.php" style="color:grey;text-decoration:none;"> numpy <img src="../django/link.png" style="height:12px;"></a> and <a href="../pandas/home_pandas.php" style="color:grey;text-decoration:none;"> pandas <img src="../django/link.png" style="height:12px;"></a>,It will be a plus point Matplotlib uses Pandas and NumPy for Data Creation and Manipulation,as we must have some Data to visualize.</p>


<h3 class="text-center mt-4" style="color:#a6a6a6;">OVERVIEW</h3>
<p style="text-align:justify;">Our Platform is providing tutorials on Python's Data Science Tools like  <a href="../numpy/home_numpy.php" style="color:grey;text-decoration:none;"> numpy <img src="../django/link.png" style="height:12px;"></a> ,  <a href="../pandas/home_pandas.php" style="color:grey;text-decoration:none;"> pandas <img src="../django/link.png" style="height:12px;"></a> and  <a href="../matplotlib/home_matplotlib.php" style="color:grey;text-decoration:none;"> matplotlib <img src="../django/link.png" style="height:12px;"></a>.We actually are not providing tutorials on SciPy,Sci-Kit Learn or any other Data Science Tools but with the passage of time,We will be launching the tutorials on these tools.</p>
...
function next(){
  window.open("intro_matplotlib.php","_self"); 
}
function prev(){
