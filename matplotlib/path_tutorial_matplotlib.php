...
<html lang="en-Us">
    <head>
        <title>Path Tutorial - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Path Tutorial in Matplotlib - Path is instantiated with a (N, 2) array of (x, y) vertices, and a N-length array of path codes - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="path_tutorial_matplotlib.php"  target="_self">Path Tutorial</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="path_tutorial_matplotlib.php"  target="_self" style="color:white;">Path Tutorial</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Path Tutorial - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/path_tutorial_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/path_tutorial_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<h5 style="text-align:justify;" class="mt-4"><i>According to Official Documentation:</i></h5><p style="text-align:justify;">The object underlying all of the matplotlib.patches objects is the Path, which supports the standard set of moveto, lineto, curveto commands to draw simple and compound outlines consisting of line segments and splines. The Path is instantiated with a (N, 2) array of (x, y) vertices, and a N-length array of path codes. For example to draw the unit rectangle from (0, 0) to (1, 1), we could use this code:</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="path2.svg" style="height:400px;" class="img-fluid">

<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4">You can change the vertices to see more figures as output.</p>
</div>

<h4 class="mt-4" style="color:#a54eee;">Path Codes Table</h4>
...
<tr class="row-odd"><td><code class="docutils literal notranslate"><span class="pre">MOVETO</span></code></td>
<td>1</td>
<td>Pick up the pen and move to the given vertex.</td>
</tr>
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">LINETO</span></code></td>
<td>1</td>
<td>Draw a line from the current position to the given vertex.</td>
</tr>
<tr class="row-odd"><td><code class="docutils literal notranslate"><span class="pre">CURVE3</span></code></td>
...
<tr class="row-even"><td><code class="docutils literal notranslate"><span class="pre">CURVE4</span></code></td>
...
<tr class="row-odd"><td><code class="docutils literal notranslate"><span class="pre">CLOSEPOLY</span></code></td>
...
<p style="text-align:justify;" class="mt-3">This chapter is over now and in the next chapter we are going to style our paths in a more and more better way in the <i>path effects chapter.</i></p>
...
function next(){
  window.open("path_effects_matplotlib.php","_self");
}
function prev(){
  window.open("ticks_and_label_matplotlib.php","_self");
}
