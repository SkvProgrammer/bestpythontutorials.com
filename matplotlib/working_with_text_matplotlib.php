...
<html lang="en-Us">
    <head>
        <title>Working With Text - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Working with Text in Matplotlib - Text Matplotlib - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="working_with_text_matplotlib.php"  target="_self">Working with Text</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="working_with_text_matplotlib.php"  target="_self" style="color:white;">Working with Text</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Working With Text - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/working_with_text_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/working_with_text_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Matplotlib provides a lot of functionalities for working with text.These include changing the weight of font i.e. making it bold or italic , changing the color of the font or putting the text inside a coloured box.We will look at some examples to easily grab this concept.</p>  
<p style="text-align:justify;">
Matplotlib includes its own <code>matplotlib.font_manager</code> (thanks to Paul Barrett), which implements a cross platform, W3C compliant font finding algorithm.
The user has a great deal of control over text properties (font size, font weight, text location and color, etc.)
</p>
...
<p style="text-align:justify;" class="mt-3">All of these functions create and return a <code>Text</code> instance, which can be configured with a variety of font and other properties. The example below shows all of these commands in action, and more detail is provided in the sections that follow.</p>
...
<img src="workingwithtext.svg" class="img-fluid" style="height:300px;">
...
function next(){
  window.open("bar_plot_matplotlib.php","_self");
}
function prev(){
