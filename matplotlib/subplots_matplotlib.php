...
<html lang="en-Us">
    <head>
        <title>Subplots - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Subplots in Matplotlib - which acts as a utility wrapper and helps in creating common layouts of subplots, including the enclosing figure object, in a single call. - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="subplots_matplotlib.php"  target="_self">Subplots</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="subplots_matplotlib.php"  target="_self" style="color:white;">Subplots</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;"> Subplots - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/subplots_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/subplots_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Matplotlib's Pyplot API provides the <code>subplot()</code> method,which is used to create multiple plots in a single figure or you can say that it acts as a utility wrapper and helps in creating common layouts of subplots, including the enclosing figure object, in a single call.Now we will look at the syntax:</p>
...
<p style="text-align:justify;" class="mt-3">All the parameters are optional.By default there value is 1.They are number of rows and columns.Now we will create a simple subplot with two rows and two columns.</p>
...
<img src="subplot_output.svg" class="img-fluid">
...
function next(){
  window.open("legend_matplotlib.php","_self");
}
function prev(){
