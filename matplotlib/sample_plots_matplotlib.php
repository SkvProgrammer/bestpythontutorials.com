...
<html lang="en-Us">
    <head>
        <title>Sample Plots - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Some Basic Plots in Matplotlib - Sample Plots Matplotlib  - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="sample_plots_matplotlib.php"  target="_self">Sample Plots</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="sample_plots_matplotlib.php"  target="_self" style="color:white;">Sample Plots</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Sample Plots - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/sample_plots_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/sample_plots_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we will try to see all the possible plots in matplotlib.Believe me they are really awesome...</p>
<h4 class="text-left mt-4" style="color:#a54eee;">Histograms</h4>
<p style="text-align:justify;">The <code>hist()</code> function automatically generates histograms and returns the bin counts or probabilities:
</p>
<img src="histogram.webp" class="img-fluid mt-2">
<h4 class="text-left mt-4" style="color:#a54eee;">Bar charts</h4>
<p style="text-align:justify;">Use the <code>bar()</code> function to make bar charts, which includes customizations such as error bars:
</p>
<img src="barcharts.webp" class="img-fluid">
<h4 class="text-left mt-4" style="color:#a54eee;">Pie charts</h4>
<p style="text-align:justify;">The <code>pie()</code> function allows you to create pie charts. Optional features include auto-labeling the percentage of area, exploding one or more wedges from the center of the pie, and a shadow effect. Take a close look at the attached code, which generates this figure in just a few lines of code.
</p>
<img src="piechart.webp" class="img-fluid">

<h4 class="text-left mt-4" style="color:#a54eee;">Scatter plots</h4>
<p style="text-align:justify;">The <code>scatter()</code> function makes a scatter plot with (optional) size and color arguments. This example plots changes in Google's stock price, with marker sizes reflecting the trading volume and colors varying with time. Here, the alpha attribute is used to make semitransparent circle markers.
</p>
<img src="scatterplot.webp" class="img-fluid">

<p style="text-align:justify;" class="mt-4"><i>I recommend you to check out the official docs of Matplotlib for more sample plots.To See the docs <a href="https://matplotlib.org/tutorials/introductory/sample_plots.html" style="color:grey;text-decoration:none;"> Click Here <img src="../django/link.png" style="height:12px;"></a></i></p>
...
function next(){
  window.open("lifecycle_of_plot_matplotlib.php","_self");
}
function prev(){
  window.open("pyplot_matplotlib.php","_self");
}
