...
<html lang="en-Us">
    <head>
        <title>Path Effects Guide - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Path Effects Guide  in Matplotlib  - Path Effects Matplotlib - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="path_effects_matplotlib.php"  target="_self">Path Effects Guide</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="path_effects_matplotlib.php"  target="_self" style="color:white;">Path Effects Guide</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Path Effects - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/path_effects_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/path_effects_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Path Effects Functionalities in Matplotlib allows the programmer to add effects in objects like <b>Line2D</b>, <b>Patch</b>, <b>Collection</b> and even <b>Text</b>.You can use the matplotlib's <b>patheffects</b> module for this purpose.</p>
<p style="text-align:justify;">
 Each artist's path effects can be controlled via the <code>set_path_effects</code> method (set_path_effects), which takes an iterable of AbstractPathEffect instances.
</p>
<p style="text-align:justify;">The simplest path effect is the Normal effect, which simply draws the artist without any effect:
</p>
...
text = fig.text(0.5, 0.5, 'Hello Normal Text ...',
...
<img src="normaltext.svg" class="img-fluid" style="height:400px;">
...
import matplotlib.patheffects as path_effects
import matplotlib.pyplot as plt
text = plt.text(0.5, 0.5, 'Hello Shadow ...',
                path_effects=[path_effects.withSimplePatchShadow()])

plt.plot([0, 3, 2, 5], linewidth=5, color='green',
...
plt.show()
  ...
  <h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="path3.svg" class="img-fluid">
...
text = fig.text(0.5, 0.5, 'Hello amazing', color='white',
                          ha='center', va='center', size=30)
...
plt.show()
  ...
  <h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="path4.svg" class="img-fluid" style="height:400px;">

<p style="text-align:justify;" class="mt-3"></p>
...
function next(){
  window.open("transformation_matplotlib.php","_self");
}
function prev(){
  window.open("path_tutorial_matplotlib.php","_self");
}
