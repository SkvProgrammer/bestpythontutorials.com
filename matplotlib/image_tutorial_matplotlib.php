...
<html lang="en-Us">
    <head>
        <title>Image Tutorial - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Image Tutorial - Learn to plot images in Matplotlib - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="image_tutorial_matplotlib.php"  target="_self">Image Tutorial</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="image_tutorial_matplotlib.php"  target="_self" style="color:white;">Image Tutorial</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Image Tutorial - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/image_tutorial_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/image_tutorial_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we will try to plot images and we will see how we can make changes in the images such as making it blur or more effects.There's an startup command.We now need to connect to a GUI event loop. This tells IPython where (and how) to display plots. To connect to a GUI loop, execute the <b>%matplotlib</b> magic at your IPython prompt. </p>

<p style="text-align:justify;">Now you have to import the following libraries and sub libraries.</p>
<div class="container p-2" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">import matplotlib.pyplot as plt<br>
import matplotlib.image as mpimg</div>

<h4 class="text-left mt-4" style="color:#a54eee;">Importing image data into Numpy arrays</h4>

<p style="text-align:justify;">Loading image data is supported by the <b>Pillow</b>( Install Pillow using Pip - pip install pillow ) library. Natively, Matplotlib only supports PNG images. The commands shown below fall back on Pillow if the native read fails.
</p>
<p style="text-align:justify;">
The image used in this example is a PNG file, but keep that Pillow requirement in mind for your own data.</p>
<p style="text-align:justify;">

Here's the image we're going to play with:
</p>

<img src="../django.png" class="img-fluid mb-3" style="border:1px solid black;">


<p style="text-align:justify;">It's a 24-bit RGB PNG image (8 bits for each of R, G, B). Depending on where you get your data, the other kinds of image that you'll most likely encounter are RGBA images, which allow for transparency, or single-channel grayscale (luminosity) images. You can right click on it and choose "Save image as" to download it to your computer for the rest of this tutorial.
</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Plotting numpy arrays as images</h4>
<p style="text-align:justify;">
...
img = mpimg.imread('../images/django.png')
img = imgplot.set_cmap('nipy_spectral')
print(img)
</code>
  </div>
...
function next(){
  window.open("customizing_matplotlib_with_stylesheets_matplotlib.php","_self");
}
function prev(){
