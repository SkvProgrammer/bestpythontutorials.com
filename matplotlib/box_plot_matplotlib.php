...
<html lang="en-Us">
    <head>
        <title>Box Plot - Matplotlib</title>
        <meta charset="utf-8">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="box_plot_matplotlib.php"  target="_self">Box Plot</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="box_plot_matplotlib.php"  target="_self" style="color:white;">Box Plot</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Box Plot - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/box_plot_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/box_plot_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
  <p style="text-align:justify;margin-top:5px;">A box plot is created in order to display a group of values having properties like minimum, first quartile, median, third quartile and maximum. Now we will try to understand how a box plot is made.So In the box plot, a box is created from the first quartile to the third quartile, a verticle line is also there which goes through the box at the median. Here x-axis denotes the data to be plotted while the y-axis shows the frequency distribution.</p>


  <p style="text-align:justify;">Now let us try to create a box plot.The <code>matplotlib.pyplot</code> module of matplotlib library provides <code>boxplot()</code> function with the help of which we can create box plots.</p>
  <h3 class="text-left" style="color:#a54eee;">SYNTAX</h3>
  <div class="container p-1" style="background-color:#f1f1f1;text-align:justify;border:2px solid lightgrey;">matplotlib.pyplot.boxplot(data, notch=None, vert=None, patch_artist=None, widths=None)</div>
  
  <h3 class="text-left mt-4" style="color:#a54eee;">PARAMETERS</h3>


  <table width="100%">
    <thead style="background-color:#a54eee;color:white;">
    <tr>
    <th>Attribute</th>
    <th>Value</th>
    </tr>
    ...
    <tr>
    <td>data</td>
    <td>array or aequence of array to be plotted</td>
    </tr>
    <tr>
    <td>notch</td>
    <td>optional parameter accepts boolean values</td>
    </tr>
    <tr>
    <td>vert</td>
    <td>optional parameter accepts boolean values false and true for horizontal and vertical plot respectively</td>
    </tr>
    <tr>
    <td>bootstrap</td>
    <td>optional parameter accepts int specifies intervals around notched boxplots</td>
    </tr>
    <tr>
    <td>usermedians</td>
    <td>optional parameter accepts array or sequnce of array dimension compatible with data</td>
    </tr>
    <tr>
    <td>positions</td>
    <td>optional parameter accepts array and sets the position of boxes</td>
    </tr>
    <tr>
    <td>widths</td>
    <td>optional parameter accepts array and sets the width of boxes</td>
    </tr>
    <tr>
    <td>patch_artist</td>
    <td>optional parameter having boolean values </td>
    </tr>
    <tr>
    <td>labels</td>
    <td>sequence of strings sets label for each dataset</td>
    </tr>
    <tr>
    <td>meanline</td>
    <td>optinal having boolean value try to render meanline as full width of box</td>
    </tr>
    <tr>
    <td>zorder</td>
    <td>optional parameter sets the zorder of the boxplot</td>
    </tr>
    <tr>
    <td>showcaps</td>
    <td>optional,Show the caps on the ends of whiskers.</td>
</tr>
<tr>
<td>showbox</td>
<td>optional,Show the central box.</td>
</tr>
<tr>
  <td>
showfliers</td>
<td>optional,Show the outliers beyond the caps.</td>
</tr>
...
plt.show()
  ...
  <h4 class="text-left mt-4" style="color:#a54eee;">OUTPUT</h4>
  <img src="box_plot_ex_one.png" class="img-fluid">
  ...
  <div data-datacamp-exercise data-no-lazy-loading data-lang="python">
    ...
    <h4 class="text-left mt-4" style="color:#a54eee;">OUTPUT</h4>
    <img src="box_plot_ex_two.png" class="img-fluid">
  ...
  <div data-datacamp-exercise data-no-lazy-loading data-lang="python">
    <code data-type="sample-code"> 
      ...
      ax3.boxplot(data, vert=False, flierprops=red_square)
      plt.show()
  </code>
    </div>
    ...
    <h4 class="text-left mt-4" style="color:#a54eee;">OUTPUT</h4>
    <img src="box_plot_ex_three.png" class="img-fluid">
...
function next(){
  window.open("violin_plot_matplotlib.php","_self");
}
function prev(){
  window.open("3d_graph_matplotlib.php","_self");
}
