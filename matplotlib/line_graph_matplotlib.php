...
<html lang="en-Us">
    <head>
        <title>Line Graph - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Plotting a Line Graph in Python - Simple Line plots in Matplotlib - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="line_graph_matplotlib.php"  target="_self">Line Graph</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="line_graph_matplotlib.php"  target="_self" style="color:white;">Line Graph</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Line Graph - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/line_graph_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/line_graph_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="sineandcos.png" class="img-fluid">

<h4 class="text-left mt-4" style="color:#a54eee;">Adjusting the Plot:Line Colors and Styles</h4>
...
x = np.linspace(0, 10, 1000)
plt.plot(x, np.sin(x - 0), color='#4537d1')        # specify color by name
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="multipleplot.png" class="img-fluid">


<h4 class="text-left mt-4" style="color:#a54eee;">Changing the weight of the Line</h4>
...
plt.plot(x, x + 5, '--r') # dashed,red
plt.plot(x, x + 6, '-.y') # dashdot,yellow
plt.plot(x, x + 7, ':');  # dotted,
</code>
  </div>
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="weightline.png" class="img-fluid">
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="limit.png" class="img-fluid">
