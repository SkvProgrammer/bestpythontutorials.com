        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Introduction to Matplotlib - Matplotlib Library in Python - Data Visualizations in Matplotlib  - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="intro_matplotlib.php"  target="_self">Introduction</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="intro_matplotlib.php"  target="_self" style="color:white;">Introduction</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Introduction to Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/intro_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/intro_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Matplotlib is a Python based library which outputs great Visualizations such as Graph or Pie Chart or any other charts.It is considered as an alternative to <b>MATLAB</b> programming language which is meant for Visualizations.Matplotlib is really an awesome library in Python.I personally love it.</p>
<p style="text-align:justify;">Matplotlib is one of the most popular Python packages used for data visualization. It is a cross-platform library for making 2D plots from data in arrays. It provides an object-oriented API that helps in embedding plots in applications using Python GUI toolkits such as PyQt, WxPythonotTkinter. It can be used in Python and IPython shells, Jupyter notebook and web application servers also.</p>

<h4 style="text-align:justify;color:#a54eee;" class="mt-4">Features of Matplotlib</h4>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Overview</h4>
<p style="text-align:justify;">Matplotlib has a procedural interface named the Pylab, which is designed to resemble MATLAB, a proprietary programming language developed by MathWorks. Matplotlib along with NumPy can be considered as the open source equivalent of MATLAB.</p>
<p style="text-align:justify-all;">
Matplotlib was originally written by John D. Hunter in 2003. The current stable version is 2.2.0 released in January 2018.</p>


<p style="text-align:justify;" class="mt-4"><i>This chapter is over.Now in the next chapter we will see the installation of Matplotlib.</i></p>
...
function next(){
  window.open("environment_setup_matplotlib.php","_self");
}
function prev(){
  window.open("home_matplotlib.php","_self");
}
