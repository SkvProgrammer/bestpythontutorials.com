...
<html lang="en-Us">
    <head>
        <title>Stylesheets - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Matplotlib with Stylesheets - Customizing matplotlib with stylesheets - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="customizing_matplotlib_with_stylesheets_matplotlib.php"  target="_self">Matplotlib with Stylesheets</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="customizing_matplotlib_with_stylesheets_matplotlib.php"  target="_self" style="color:white;">Matplotlib with Stylesheets</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;"> Stylesheets - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/customizing_matplotlib_with_stylesheets_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/customizing_matplotlib_with_stylesheets_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Changing the Defaults: rcParams </h4>
<p style="text-align:justify;">Each time Matplotlib loads, it defines a runtime configuration (rc) containing the default styles for every plot element you create. This configuration can be adjusted at any time using the plt.rc convenience routine. Let's see what it looks like to modify the rc parameters so that our default plot will look similar to what we did before.
</p>
...
function next(){
  window.open("figure_matplotlib.php","_self");
}
function prev(){
