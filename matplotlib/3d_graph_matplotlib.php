...
<html lang="en-Us">
    <head>
        <title>3D Graph - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Plotting a 3D graph in Matplotlib - 3D Surface Plot - 3D Scatter Plot - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="3d_graph_matplotlib.php"  target="_self">3D Graph Chart</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="3d_graph_matplotlib.php"  target="_self" style="color:white;">3D Graph Chart</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">3D Plots - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/3d_graph_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/3d_graph_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="3dscatter.png" class="img-fluid">
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="3d2.png" class="img-fluid">
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="3dbars.png" class="img-fluid">
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="3dcontour.png" class="img-fluid">
