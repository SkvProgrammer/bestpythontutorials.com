...
<html lang="en-Us">
    <head>
        <title>Constraint Layout - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Constraint Layout in Matplotlib - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="constraint_layout_matplotlib.php"  target="_self">Constraint Layout</a></li> 
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="constraint_layout_matplotlib.php"  target="_self" style="color:white;">Constraint Layout</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;"> Constrained Layout - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/constraint_layout_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/constraint_layout_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<code>constrained_layout</code> automatically adjusts subplots and decorations like legends and colorbars so that they fit in the figure window while still preserving, as best they can, the logical layout requested by the user.
</p>
<p style="text-align:justify;">
<code>constrained_layout</code> is similar to <code>tight_layout</code>, but uses a constraint solver to determine the size of axes that allows them to fit.
</p>
<p style="text-align:justify;">
<code>constrained_layout</code> needs to be activated before any axes are added to a figure. Two ways of doing so are:</p>

<p style="text-align:justify;" class="mt-5">Using the respective argument to <code>subplots()</code> or <code>figure()</code>, e.g.:
</p>
<div class="container p-2" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align: justify;">
plt.subplots(constrained_layout=True)
</div>

<p style="text-align:justify;" class="mt-2">Activate it via <code>rcParams</code>, like:
</p>
<div class="container p-2" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align: justify;">
...
1( Constrained Layout is set to False )</h5>
...
2( Constrained Layout is set to True )</h5>
<div data-datacamp-exercise data-lang="python">
  <code data-type="sample-code"> 
import matplotlib.pyplot as plt
import matplotlib.colors as mcolors
