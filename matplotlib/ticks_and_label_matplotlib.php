...
<html lang="en-Us">
    <head>
        <title>Ticks and Ticks Label - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Ticks and Ticks Label in Matplotlib - Setting ticks and ticks label in a plot - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="ticks_and_label_matplotlib.php"  target="_self">Ticks and Ticks Label</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="ticks_and_label_matplotlib.php"  target="_self" style="color:white;">Ticks and Ticks Label</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;"> Ticks and Ticks Label - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/ticks_and_ticks_label_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/ticks_and_ticks_label_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we are going to read about the <b>ticks</b> and <b>tickslabel</b> in Matplotlib.First of all what are Ticks - Ticks are nothing but the markers that denotes the data points on the axes.Matplotlib's default tick locators and formatters are designed to be generally sufficient in many common situations. Position and labels of ticks can be explicitly mentioned to suit specific requirements.</p>

<p style="text-align: justify;">There are two methods related to this concept of Ticks and Ticks Label that are <b>xticks</b> and <b>yticks</b>.They take
 list object as argument. The elements in the list denote the positions on corresponding action where ticks will be displayed.</p>
...
function prev(){
  window.open("constraint_layout_matplotlib.php","_self");
}
