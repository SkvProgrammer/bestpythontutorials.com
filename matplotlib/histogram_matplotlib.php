...
<html lang="en-Us">
    <head>
        <title>Histogram - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Histogram in Matplotlib - Plotting Histogram using Matplotlib - A histogram is an accurate representation of the distribution of numerical data. It is an estimate of the probability distribution of a continuous variable. It is a kind of bar graph - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="histogram_matplotlib.php"  target="_self">Histogram</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="histogram_matplotlib.php"  target="_self" style="color:white;">Histogram</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Histogram - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/histogram_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/histogram_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">A histogram is an approximate representation of the distribution of numerical or categorical data. It was first introduced by <b>Karl Pearson</b>.It's a kind of graph.</p>


<h4 class="text-left mt-4" style="color:#a54eee;">Steps to plot a Histogram</h4>
<p style="text-align:justify;">In order to construct a histogram we need to use the <b>hist()</b> method of the Pyplot API.Below is a table for the parameter and it's description:</p>
<div style="overflow:scroll;">
  <table class="table table-bordered">
<tbody>
<tr style="background-image:linear-gradient(to right,#4537d1,#a54eee);color:white;border:none!important;">
  <td>Parameter</td>
  <td>Description</td>
</tr>
<tr>
...
a = np.array([26,97,15,83,56,73,55,54,11,20,51,5,72,11,17])
ax.hist(a, bins = [0,25,50,75,100])
ax.set_title("Class 12 Result")
...
<img src="hist.png" class="img-fluid">
...
function next(){
  window.open("pie_chart_matplotlib.php","_self");
}
function prev(){
