...
<html lang="en-Us">
    <head>
        <title>Transformation - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Transformation in Matplotlib - Matplotlib Transformation - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="transformation_matplotlib.php"  target="_self">Transformation</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="transformation_matplotlib.php"  target="_self" style="color:white;">Transformation</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Transformation - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/transformation_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/transformation_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;">Now we will see some examples for grabbing the concept of <b>Transformation</b> by creating a simple plot and then applying transformation to it using the tranformation objects provided by matplotlib.</p>
<div class="container p-2" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">
  axes.text(x,y,"label") 
</div>
<p style="text-align:justify;" class="mt-3">The text is placed at the theoretical position of a data point (x,y). Thus we would speak of "data coords".
</p>
...
<div class="container p-2" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">
  axes.text(0.5, 0.5, "in the middle of the graph", transform=axes.transAxes)
</div>

<p style="text-align:justify;" class="mt-3">Similarly you can apply the concept of tranformation for different transforms...</p>
