...
<html lang="en-Us">
    <head>
        <title>Lifecycle of a Plot - Matplotlib</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Lifecycle of a Plot - Matplotlib Plots Lifecycle - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="lifecycle_of_plot_matplotlib.php"  target="_self">Lifecycle of Plot</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
   ...
   <a href="lifecycle_of_plot_matplotlib.php"  target="_self" style="color:white;">Lifecycle of Plot</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Lifecycle of a Plot - Matplotlib</h3>
<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/matplotlib/lifecycle_of_plot_matplotlib.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/matplotlib/lifecycle_of_plot_matplotlib.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
data = {'Skv': 10943800.50,
        'SkvProgrammer': 10032932,
        'SatyamVerman': 329094238,
        'Suraj': 32917,
        'Suman': 7328821   
        }
...
<h4 class="text-left mt-4" style="color:#a54eee;">Combining multiple visualizations</h4>
<p style="text-align:justify;">The next stage is Combining multiple visualizations.It is possible to draw multiple plot elements on the same instance of <code>axes.Axes</code>. To do this we simply need to call another one of the plot methods on that axes object.The final step is saving the plot.
</p>

<h4 class="text-left mt-4" style="color:#a54eee;">Saving our plot</h4>
<p style="text-align:justify;">Now that we're happy with the outcome of our plot, we want to save it to disk. There are many file formats we can save to in Matplotlib. To see a list of available options, use:
</p>
<div class="container p-2" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">print(fig.canvas.get_supported_filetypes())</div>

<p style="text-align:justify;" class="mt-3">Now type the below command to save the plot.</p>
<div class="container p-2" style="background-color:#f2f2f2;border:1px solid lightgrey;text-align:justify;">fig.savefig('sales.png', transparent=False, dpi=80, bbox_inches="tight")</div>
...
function next(){
  window.open("image_tutorial_matplotlib.php","_self");
}
function prev(){
  window.open("sample_plots_matplotlib.php","_self");
}
