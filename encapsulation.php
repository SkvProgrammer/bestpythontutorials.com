...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Encapsulation in python - Getter and Setter Method"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,encapsulation in python,getter and setter methods">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="encapsulation.php" target="_self">Encapsulation</a></li>
    <!--new-->
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="encapsulation.php" target="_self" style="color:white;">Encapsulation</a>
    <!--new-->
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Encapsulation in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/encapsulation.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/encapsulation.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<br><br>
<img src="encapsulation.png" class="img-fluid" style="height:80px;width:180px;" class="mt-5">
<p style="text-align:justify;" class="mt-3">The above image will help you to understand the concept of Encapsulation.Now we will be looking at the technical definition of <b>Encapsulation</b> : -<br><br>
Encapsulation is the wrapping down of code and Data in a Single Unit which increases the security of data as the variables cannot be accessed directly and such variables are called <b>Privately Declared Variables</b> and we can only access them by using <b>getters</b> and <b>setters </b> Methods.
 </p>
     <br>
           <script type="text/javascript">
  atOptions = {
...
<p style="text-align:justify;">Now,In the previous section we have discussed about Private Members.Now what are these private members.These are actually <b>Access Modifiers</b>.Python supports three types of access modifiers:-</p>
<ol style="text-align:left;">
<li class="mb-2"><b>Public</b>:-Accessible to whole world</li>
<li class="mb-2"><b>Private</b>:-Not Accesible to other Classes</li>
<li class="mb-2"><b>Protected</b>:-Only Accesible to Sub Classes</li> 
</ol>
...
<p style="text-align:justify;overflow:scroll;" class="mt-3">The output of the above code will below as below:-<br>
  2<br>

<numbers>Traceback (most recent call last):<br>
  File "jdoodle.py", line 9, in &lt;module&gt;<br>
    print(obj.protected)<br>
AttributeError: 'A' object has no attribute 'protected'</numbers>
</p>
     <div class="mb-3 mt-3">
...
function prev(){
  window.open("polymorphism.php","_self");
}
