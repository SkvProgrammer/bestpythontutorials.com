...
<html lang="en-Us">
    <head>
        <title>Basic Calculations in Python</title>
        <meta charset="utf-8">
        ...
        <meta name="description" content="Basic Calculations in Python - Python Basic Calculations"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="calculations.php" target="_self">Basic Calculations</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="calculations.php" target="_self" style="color:white;">Basic Calculations</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;">Basic Calculations in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/calculations.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/calculations.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
print(2 + 2j) #Adding an integer with a complex number
...
<a href="calculator.py" download="calculator.py" class="pl-2 pr-2" style="background-color:orangered;border-radius:4px;color:white;">Download Calculator <i class="fa fa-download"></i></a>
