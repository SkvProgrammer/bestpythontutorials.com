...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Memory Management in python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,memory management in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="memory.php" target="_self">Memory Management</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="memory.php" target="_self" style="color:white;">Memory Management</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Memory management in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/memory.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/memory.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p class="mt-4" style="text-align:justify;"><b>Memory Managment</b> is a very important topic in terms of Software Development as writing memory efficient code is very very important.In Python we have learn about some concepts such as <b>Garbage Collection</b>,<b>Reference Counting</b> and <b>Memory Allocation</b>.First of all lets learn more about the <b>Memory Management</b>.</p>
...
<p style="text-align:justify;">Memory management in Python involves a private heap containing all Python objects and data structures. The management of this private heap is ensured internally by the Python memory manager. The Python memory manager has different components which deal with various dynamic storage management aspects, like sharing, segmentation, preallocation or caching.
</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Garbage Collection</h4>
<p style="text-align:justify;"><b>Garbage Collection</b> is a process in which the interpreter <i>frees</i> up the memory when it is not in use to make it available for other objects.
Assume a case where no reference is pointing to an object in memory i.e. it is not in use so, the virtual machine has a garbage collector that automatically deletes that object from the heap memory</p>

 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
<h4 class="text-left mt-4" style="color:#a54eee;">Reference Couting</h4>  
<p style="text-align:justify;">Reference counting is the process of counting how many times certain memory address is referenced. Introduction . Every variable in Python is a reference to an object and not the actual value. This reference is also known as Pointer to an object.</p>
       
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
<h4 class="mt-4 text-left" style="color:#a54eee;">Memory Allocation</h4>
<p style="text-align:justify;">In this section we will about <b>Memory Allocation</b> in Python.Allocating Memory is actually a ver important topic it eventually happens in every program even a <b>Hello World</b> Program is associated with <b>Memory Allocation</b>.</p>

<p style="text-align:justify;" class="mt-3">There are two parts of memory:
</p>
...
<p style="text-align:justify;">
The methods/method calls and the references are stored in <b>stack memory</b> and all the values objects are stored in a <b>private heap</b>.
</p>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
<h4 class="text-left mt-4" style="color:#a54eee;">Stack Memory</h4>
<p style="text-align:justify;">
The Memory Allocation happens on <i>contiguous</i> blocks of memory. We call it <b>Stack Memory Allocation</b> as the allocation happens in the <i>function call stack</i>. The size of memory to be allocated is known to the compiler and whenever a function is called, its variables get memory allocated on the stack.
</p>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Heap Memory</h4>
<p style="text-align:justify;">The memory is allocated during the execution of instructions written by programmers. Note that the name heap has nothing to do with the heap data structure. It is called heap because it is a pile of memory space available to programmers to allocated and de-allocate. The variables are needed outside of method or function calls or are shared within multiple functions globally are stored in Heap memory.</p>
