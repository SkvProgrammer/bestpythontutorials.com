...
<html lang="en-Us">
    <head>
        <title>Control Structures in Python</title>
        <meta charset="utf-8">
        ...
        <meta name="description" content="Control Structures in Python - Python Control Structures"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="controlstructures.php" target="_self">Control Structures</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="controlstructures.php" target="_self" style="color:white;">Control Structures</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;">Control Structures</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/controlstructures.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/controlstructures.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
<p style="text-align:justify;" class="mt-4">Typically,  A control structure is like a block of programming that analyses variables and chooses a direction in which to go based on given parameters. The term flow control details the direction the program takes (which way program control "flows"). Hence it is the basic decision-making process in computing; It is a prediction.</p>
 <div class="mb-3 mt-3">
...
<p style="text-align:justify;" class="mt-4">And in simple languages Control Structures simply controls the flow of a program while we will be using <a href="loops.php" style="color:grey;text-decoration:none;"> Loops <img src="django/link.png" style="height:10px;"></a> in python...In control structures we have to study about <button class
          ="btn btn-default" data-target="#myModaltwo" data-toggle="modal" style="border:none;outline:none;box-shadow:none;background-color:white;color:black;">keywords</button> like
          <a href="break.php" style="color:grey;text-decoration:none;">Break an Continue <img src="django/link.png" style="height:10px;"></a> which has a separate chapter in this tutorials but for a brief for a brief introduction this page is must read.</p>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
          <p style="text-align:justify;color:#a54eee;"><strong>Now,we need to understand that why we need to use the control structures??</strong></p>
          <p style="text-align:justify;">Control Structures are very important while using Loops or Iteration statement if we will not use control statements or structures our loop may run infinitely or we will not get the correct output,also Control Structures which we know that it can be considered as the building blocks of computer programs. They are commands that enable a program to “take decisions”, following one path or another. A program is usually not limited to a linear sequence of instructions since during its process it may bifurcate, repeat code or bypass sections.</p>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p style="text-align:justify;">In a Programming Language , Keywords are those terms which have some special meaning in it.For example,while in programming is used as a loop statement.</p>
      </div>
...
function prev(){
  window.open("stringfunctions.php","_self");
}
