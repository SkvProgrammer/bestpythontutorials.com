...
<html lang="en-Us">
    <head>
        <title>Python programs/Examples</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Python programs - Python Examples "/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,Python programs">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">PATTERNS</h4></li><br>
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">FILE HANDLING</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="programs.php" target="_self">Python programs</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="tell.php" target="_self">tell and seek method</a>
        <a href="programs.php" target="_self" style="color:white;">Python programS</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Python programs</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/deletingfile.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/deletingfile.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<h5><b>Note:</b>This page is under construction</h5>

<ul id="programslist">
  <li><a href="hello_world_python.php">Hello World Python program</a></li>
  <li><a href="hello_world_python.php">Python program for Adding two numbers</a></li>
  <li><a href="hello_world_python.php">Python program to find the square root of a number</a></li>
  <li><a href="hello_world_python.php">Python program for calculating area of a triangle</a></li>
  <li><a href="hello_world_python.php">Python program for solving a Quadratic Equation</a></li>
  <li><a href="hello_world_python.php">Python program for swapping variables(4 ways)</a></li>
  <li><a href="hello_world_python.php">Python program to check if number is +ve,-ve or 0</a></li>
  <li><a href="hello_world_python.php">Python program to print the Fibonacci Series</a></li>
  <li><a href="hello_world_python.php">Python program to find the factorial of a number</a></li>
  <li><a href="hello_world_python.php">Python program to find the factors of a number</a></li>
  <li><a href="hello_world_python.php">Python program for finding HCF and LCM</a></li>
  <li><a href="hello_world_python.php">Python program to print multiplication table</a></li>
  <li><a href="hello_world_python.php">Python program for Number Conversion</a></li>
  <li><a href="hello_world_python.php">Python program displaying the calendar</a></li>
  <li><a href="hello_world_python.php">Python program for counting the number of vowels</a></li>
  <li><a href="hello_world_python.php">Python program to check palindrome numbers</a></li>
  <li><a href="hello_world_python.php">Python program to check palindrome string</a></li>
  <li><a href="hello_world_python.php">Python program to reverse a string</a></li>
    <li><a href="hello_world_python.php">Python program to reverse a number</a></li>
    <li><a href="hello_world_python.php">Python program to find the size of the image</a></li>
    <li><a href="hello_world_python.php">Python program to check odd and even numbers</a></li>
    <li><a href="hello_world_python.php">Python program to check check leap year</a></li>
    <li><a href="hello_world_python.php">Python program to find largest number among given number</li></th></a></li>
    <li><a href="hello_world_python.php">Python program to convert temperatures from one unit to another</a></li>
    <li><a href="hello_world_python.php">Python program to Generate Random Numbers</a></li>
    <li><a href="hello_world_python.php">Python program for a number guessing game</a> </li>
    <li><a href="hello_world_python.php">Python program for printing all the numbers in an interval</a></li>
    <li><a href="hello_world_python.php">Python program to shuffle a desk of card  </a></li>
    <li><a href="hello_world_python.php">Python program to add two matrices</a></li>
<li><a href="hello_world_python.php">Python program to find the hash of a file </a></li>
    <li><a href="hello_world_python.php">Python program to make a simple calculator</a></li>
    <li><a href="hello_world_python.php">Python program to check armstrong number </a></li>
    <li><a href="hello_world_python.php">Python program to find the ASCII value of a character</a></li>
    <li><a href="hello_world_python.php">Python program to multiply two matrices</a></li>
    <li><a href="hello_world_python.php">Python program to transpose a matrix</a></li>
    <li><a href="hello_world_python.php">Python program to sort word in alphabetical order</a></li>
    <li><a href="hello_world_python.php">Python program to  remove punctuation from a string</a></li>
    <li><a href="hello_world_python.php">Python program to copy all the elements of one array into another</a></li>
    <li><a href="hello_world_python.php">Python program to find the frequency of any element in a list</a></li>
    <li><a href="hello_world_python.php">Python program to print the elements of an array</a></li>
    <li><a href="hello_world_python.php">Python program to print the elements of an array in reverse order</a></li>
    <li><a href="hello_world_python.php">Python program to  print the duplicate elements of an array</a></li>
    <li><a href="hello_world_python.php">Python program to print the largest  and smallest element of a list</a></li>
    <li><a href="hello_world_python.php">Python program to print the sum of all the elements of a list</a></li>
    <li><a href="hello_world_python.php">Python program to sort the elements of list</a></li>
    <li><a href="hello_world_python.php">Python program to check if the given number is disarsium or not</a></li>
    <li><a href="hello_world_python.php">Python program to check if the given number is happy number or not</a></li>
    <li><a href="hello_world_python.php">Python program to check if the given number is harshad number or not</a></li>
    <li><a href="hello_world_python.php">Python program to print kilometers in miles</a></li>
...
<button class="btn newcolorbtn" style="box-shadow:none;outline:none;border-radius:50px;" data-toggle="modal" data-target="#myModalfeedback">Feedback/Suggest Improvement</button>
    ...
    <div class="modal-content" style="border-radius:10px!important;color:white;background-image: linear-gradient(to right,#a54eee,#4537d1);border:none!important;">
      ...
      <div class="modal-body">
        ...
        <ul style="font-size:20px;text-align:justify;">
          <li>Write articles and <a href="mailto:contact@bestpythontutorials.com" style="color:white!important;text-decoration:underline;">mail us.</a></li>
