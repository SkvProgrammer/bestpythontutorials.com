...
<html lang="en-Us">
    <head>
        <title>Pattern Programming in Python - Star Patterns in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Pattern Programming in Python - Star Patterns in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,star patterns in python - pattern programming in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">PATTERNS</h4></li><br>
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="starpattern.php" target="_self">Star Pattern</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="" style="color:white;border:none;"><h1 id="tag1">PATTERN PROGRAMMING</h1></a>
      <a href="starpattern.php" target="_self" style="color:white;">Star Pattern</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Pattern Programming in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/starpattern.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/starpattern.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
pattern(5)
  ...
  <p style="text-align:justify;">It's easy to copy the code and run the program but I will suggest you to learn how this pattern is made which is better for improving your coding skills.</p>
  <p style="text-align:justify;">In line 1 , I have declared a function called <code>pattern</code> with a parameter <b>n</b> which is the number of rows in our program.Now what is in the second line the 2nd line consist a variable called <b>k</b> which has value equal to 2 times n subtracted by 2.That's the main logic we have to apply in it.I have used nested loop in it.You can easily understand the logic by manually putting value of n and going deep into it.Believe me it's not a difficult task to do.</p>
