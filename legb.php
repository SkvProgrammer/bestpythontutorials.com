...
<html lang="en-Us">
    <head>
        <title>LEGB Rule in Python | scope resolution python | legb rule</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="LEGB Rule in Python | scope resolution python | legb rule"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,legb rule python,scope resolution python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="legb.php" target="_self">LEGB Rule</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="legb.php" target="_self" style="color:white;">LEGB Rule</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Scope Resolution in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/legb.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/legb.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<h4 class="text-left mt-4" style="color:#a54eee;">LEGB Rule - Python</h4>
<p style="text-align:justify;">In Python,the <b>LEGB Rule</b> to decide he order in which the namespaces are to be searched for scope resolution.</p>

<ul style="text-align:justify;font-size:19.5px;">
  <li><b>Local(L)</b>:This is defined inside a class or a function.</li>
  <li><b>Enclosing(E)</b>:Defined inside enclosing functions(Nested function concept).</li>

   <li><b> Global(G)</b>: Defined at the uppermost level
</li>
<li>
    <b>Built-in(B)</b>: Reserved names in Python builtin modules
</li>
</ul>
...
<h4 class="mt-4 text-left mt-4" style="color:#a54eee;">Output of the Above Code</h4>
...
<h2 class="text-left mt-4" style="color:#a54eee;">Built-In Scope</h2>
<p style="text-align:justify;">The built-in scope is a special Python scope that’s implemented as a standard library module named builtins in Python 3.x. All of Python’s built-in objects live in this module. They’re automatically loaded to the built-in scope when you run the Python interpreter. Python searches builtins last in its LEGB lookup, so you get all the names it defines for free. This means that you can use them without importing any module.</p>
