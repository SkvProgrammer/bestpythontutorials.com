...
<html lang="en-Us">
    <head>
        <title>Asyncio Module in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Asyncio Module in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,asyncio module in Python,asyncio in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="asynciomodule.php" target="_self">Asyncio Module</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="asynciomodule.php" target="_self" style="color:white;">Asyncio Module</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Asyncio Module in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/asynciomodule.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/asynciomodule.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Asyncio is the standard library package with Python that aims to help you write asynchronous code by giving you an easy way to write, execute, and structure your coroutines. The Asyncio library is for concurrency, which is not to be confused with parallelism.</p>

<h3 style="text-align:justify;color:#a54eee;" class="mt-4">EXPLANATION</h3>
<p style="text-align:justify;">Suppose you are out for a jog,and while jogging you become uncomfortable and felt something in your shoes.In This situation what would you do.Definetly you will wait and check what's wrong happening there and due to this your entire run will be affected.So the similar Concept can be applied to asyncronous programming.Suppose a website is loading and there's a problem in loading of an image file then in synchronous programming it will create a bad impact in the loading of the entire page but in asyncronous programming the both loading processes will go parallel that is the partial loading of the image will not affect the loading of other widgets of your site.</p>
 <div class="mb-3 mt-3">
...
def divisibles(g_range, div_by):
    ...
    for i in range(g_range):
        if i % div_by == 0:
            location.append(i)
    print("Done  numbers in range {} divisible by {}".format(g_range, div_by))
    return location
...
<h3 style="text-align:left;color:#a54eee;" class="mt-4">Output of the Above Code</h3>
 <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
               Finding numbers in range 508000 divisible by 34113<br>
Done  numbers in range 508000 divisible by 34113<br>
Finding numbers in range 100052 divisible by 3210<br>
Done  numbers in range 100052 divisible by 3210<br>
Finding numbers in range 500 divisible by 3<br>
Done  numbers in range 500 divisible by 3<br>
             </div>
<br>
<p style="text-align:justify;">As we can see, each function was run in the order that we called it, and we had to wait for the first long one to complete for the other 2, shorter ones, could complete.<br><br>

It's not really necessary in this case that we run like this, what if we'd like the other 2 to return if possible? Enter Asyncio!</p>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
