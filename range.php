...
<html lang="en-Us">
    <head>
        <title>Range and XRange Methods in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Range Method in Python - XRange Method in Python - XRange vs Range in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="range.php" target="_self">range and xrange()</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="range.php" target="_self" style="color:white;">range and xrange()</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">range() and xrange()</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/range.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/range.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
   ...
   <p style="text-align:justify;" class="mt-4"><code>range()</code> method is a built-in method in Python 3.x versions...It is used when the programmer needs to perform an action for a specific number of times ot for a specific group of values...<code>range()</code> is just the renamed version in Python 3.x of <code>xrange()</code> method in Python 2.x versions</p>
      <div class="mb-3 mt-3">
      ...
      <h4 class="text-left mt-4" style="color:#a54eee;">DEFINITION</h4>
        <p style="text-align:justify;">The <code>range()</code> function returns a sequence of code having a <code>starting point</code> , <code>Ending point</code> and <code>difference between two values</code>...</p>
        <h4 style="text-align:left;color:#a54eee;" class="mt-4">SYNTAX</h4>
        <div style="width:100%;height:auto;border:2px solid lightgrey;font-size:20px;background-color:#f2f2f2;text-align:justify;" class="container-fluid p-2">
          <keyword>range</keyword>(start , stop , step)
          
        </div>
        <h4 style="text-align:left;color:#a54eee;" class="mt-3  mb-3">Key Terms</h4>
        <ul style="text-align:justify;" class="mt-3">
          <li><strong>start:</strong>The very first value of the <code>range()</code> function.It is Optional Parameter.</li>
          <li><strong>stop:</strong>The last value of the <code>range()</code> function.It is Required Parameter.</li>
          <li><strong>step:</strong>The difference between two consecutive values.Default is 1.It is also Optional Parameter.</li>
        </ul>
        <h4 style="text-align:left;color:#a54eee;" class="mt-4">EXAMPLES</h4>
        <p style="text-align:left;" class="mt-2"><code>range() </code> method with only two <b>parameters</b> <code>start</code> and <code>stop</code>...</p>
...
<div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
             ...
             <p style="text-align:left;" class="mt-4"><code>range() </code> method with only one <b>parameter </b><code>stop</code>...</p>
...
<div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
              ...
              <p style="text-align:left;" class="mt-4"><code>range() </code> method with all three <b>parameters </b><code>start</code> , <code>stop</code> and <code>step</code>...</p>
...
function next(){
  window.open("returnvsprint.php","_self");
}
function prev(){
