...
<html lang="en-Us">
    <head>
        <title>Python IDEs - Getting Started With Python</title>
        <meta charset="utf-8">
        ...
        <meta name="description" content="What are IDEs in Python - How to use IDEs in Python - How to use Code editor in Python - How to use online code editors "/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="pythonides.php" target="_self">Python IDEs</a></li>                      
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="pythonides.php" target="_self" style="color:white;">Python IDE </a>                   
...
<h2 style="text-align:justify;color:#a54eee;">Python IDEs</h2>
...
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/pythonides.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------Google Translate API ends----------------->
    ...
    <p style="text-align:left;" class="mt-4">In the previous chapter we have talked about the Python's default IDLE i.e a graphical tool for interactive development so the question arises if we have a default tool for interactive development  provided by python itself then<b><i>why we need an IDE ?? </i></b>Simply the answer is that it's not powerful to work with it is good for beginners but when someone wants to build large applications then he/she definitely need a good and powerful IDE..</p>
    ...
    <iframe style="width:120px;height:240px;" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="https://ws-in.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&OneJS=1&Operation=GetAdHtml&MarketPlace=IN&source=ac&ref=qf_sp_asin_til&ad_type=product_link&tracking_id=skv09-21&marketplace=amazon&region=IN&placement=B089NZ7RMH&asins=B089NZ7RMH&linkId=c74c3a61e4087756be9a3d5bd77a1e07&show_border=false&link_opens_in_new_window=false&price_color=333333&title_color=0066c0&bg_color=ffffff">
           ...
           <p style="text-align:left;">Now what are the some features of an IDE:- </p>
           <ul style="text-align:justify;font-size:20px;">
             <li style="text-align:justify;">The most important thing is the User Interface Now a days I think no one would like to work with the 1970s command line type of coding,We need graphics to make tasks easy and friendly but it doesn't mean that CLI(Command Line Interpreter) is just waste,It's actually very helpful in hacking,Big data Analysis etc. </li>


              <li style="text-align:justify;">It has a bunch of tools which simplifies the way one programs such as one click run or build.It has debugger and compiler/interpreter integrated.</li>

              <li style="text-align:justify;">Features like code completion or error detection ,while writing the code makes it easy and fast to code with very less errors at the compile time.</li>

              <li style="text-align:justify;">It can be easily extended by adding plugins and build tools like maven and ant.</li>
           </ul>
           <p style="text-align:justify;">Now,I will list down the three most popular IDEs for python programming according to me:-</p>
           <ul style="text-align:justify;font-size:20px;">
             <li><strong>Pycharm</strong> :- It is a paid software but a community version is available for free.It has been developed by Jetbrains.</li>
             <li><strong>Jupyter Notebook </strong>:- It's actually a great IDE it runs on the browser and the way it  works is awesome.</li>
             <li><strong>Spyder </strong>:- It is basically used for scientific development with python.It comes along with Anaconda distribution</li>
           </ul>
          
           
        
           <div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><strong>Note:</strong>But for now if you are a absolute beginner just use the Python's default IDLE.</p>
</div>
</div>
