...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Comments in Python - Single Line Comment - Multiline Comment - Comments using Docstring"/> 
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="comments.php" target="_self">comments/Documentation</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="comments.php" target="_self" style="color:white;">comments/Documentation</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Comments in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/comments.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/comments.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
 ...
 <p style="text-align:justify;" class="mt-4">Comments are the blocks of code that are ignored by the compiler or interpreter while compilation  of the code.<br><br>
          This makes the code more readable and informs about the functionality of the program.<br><br>
          Comments can be used to avoid the execution of the testing code.
        </p>
        <h3 style="text-align:left;color:#a54eee;" class="mt-4">Creating Comments in Python</h3>
       
        <h5 style="text-align:justify;">In Python we use  <code>   #</code> symbol for creating a <b>Single-Line Comment</b></h5>
...
print("Comments!") 
        ...
        <h3 style="text-align:left;color:#a54eee;" class="mt-4">Multi-Line Comments</h3>
       
        <p style="text-align:justify;">Python does not provide Support <b>Multiline Comment</b>.You can start each line of the comment with <code>#</code></p>
...
<div data-datacamp-exercise data-lang="python">
  <code data-type="sample-code">
#I am the comment
#I am very useful for a programmer
#I makes the code more readable
print("Comments!")
       ...
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
        ...
        <p style="text-align:justify;">There's another way of implementing Multi-Line Comments in Python with the use of <b>Docstrings</b>.As Python ignores the string value which is not stored in any variable</p>
