...
<html lang="en-Us">
    <head>
        <title>Deleting a File in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Deleting a File in Python"/> 
           <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,Deleting a file in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">PATTERNS</h4></li><br>
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">FILE HANDLING</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="deletingfile.php" target="_self">Deleting a file</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="deletingfile.php" target="_self" style="color:white;">Deleting a file</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Deleting a file in Python</h2>
...
<p style="text-align::justify;" class="mt-4">In this chapter we will see how to delete a file from a python program.There are many ways to delete a file in python.</p>
   <div class="text-left mt-1">
    <h3 class="text-left mt-2" style="color:#a54eee;">os.remove() - Removes a file</h3>
...
os.remove("demo.txt")</textarea>
   ...
   <div class="text-left mt-5">
    <h3 class="text-left mt-2" style="color:#a54eee;">os.rmdir() - Deletes a Folder</h3>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<div class="text-left mt-5">
    <h3 class="text-left mt-2" style="color:#a54eee;">del Keyword - Deletes a File</h3>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
