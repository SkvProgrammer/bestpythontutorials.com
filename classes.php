...
<html lang="en-Us">
    <head>
        <title>OOPs Concept in Python - Classes and Objects in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="OOPs Concept in Python - Classes and Objects in Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,oops concept,oops concept in python,classes in python,classes and objects in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="classes.php" target="_self">Classes and Objects</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="classes.php" target="_self" style="color:white;">Classes and Objects</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">OOPs concept in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/classes.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/classes.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
   ...
   <p style="text-align:justify;" class="mt-4">Python is an Object Oriented Programming Language.Unlike procedure oriented programming, where the main emphasis is on functions, object oriented programming stress on objects.<br><br>
          Everything in Python is an Object with it's Properties and Methods.An object-oriented paradigm is to design the program using classes and objects. The object is related to real-word entities such as book, house, pencil, etc. The oops concept focuses on writing the reusable code. It is a widespread technique to solve the problem by creating objects.
        </p>
         <div class="mb-3 mt-3">
...
<h3 class="text-left mt-3" style="color:#a54eee;">Objects</h3>
...
<h3 class="text-left mt-3" style="color:#a54eee;">__init__ method</h3>
<p style="text-align:justify;">The programs we made in this tutorial till now are not really useful in real-life.<br><br>
To understand the meaning of Classes you need to use the <code>__init__()</code> method which is similar to constructor in other Programming Languages like Java,C and C++.<br><br>

Now what are <b>Constructors</b>,Constructors are Special Functions which are used to initialize <b>Objects</b>.<b>Initializing</b> Objects means assigning them some values.
...
<h3 class="text-left mt-3" style="color:#a54eee;">The Self Parameter</h3>
<p style="text-align:justify;">The <code>self</code> parameter is a reference to the current instance of the class, and is used to access variables that belongs to the class.
</p>
...
function next(){
  window.open("abstraction.php","_self"); 
}
function prev(){
