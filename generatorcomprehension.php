...
<html lang="en-Us">
    <head>
        <title>Generator Comprehension in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Generator Comprehension in Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,generator comprehension,generator comprehension in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="generatorcomprehension.php" target="_self">Generator comprehension</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="generatorcomprehension.php" target="_self" style="color:white;">Generator comprehension</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Generator Comprehension in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/generatorcomprehension.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/generatorcomprehension.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
 ...
 <p style="text-align:justify;" class="mt-4">In the Previous chapters we have covered topics such <b>List Comprehension</b>,<b>Dictionary Comprehension</b> and <b>Set Comprehension</b>.Now we are going to discuss another concept of this group i.e. the Generator Expressions.If you don't know about Generators Check Out Our <a href="generators.php" style="color:grey;text-decoration:none;">Generators Tutorial <img src="django/link.png" style="height:10px;"></a>.</p>
 <div class="mb-3 mt-3">
...
<img src="output_generators.png" class="img-fluid">
...
function next(){
  window.open("cmathmodule.php","_self"); 
}
function prev(){
