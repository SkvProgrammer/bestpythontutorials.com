...
<html lang="en-Us">
    <head>
        <title>Pass statement in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Pass Statement in Python - How to use Pass Statement in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="pass.php" target="_self">Pass Keyword</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="pass.php" target="_self" style="color:white;">Pass Keyword</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">pass statement</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pass.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/pass.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
<p style="text-align:justify;" class="mt-4">In the empty statements section of one of the previous tutorials we have discussed about the simplest Empty statement i.e. the <b>pass</b> keyword which is very helpful to maintain the logic and syntax of a program...<br>
          Now let us assume that in a python program you have to declare a function but actually you don't need to add some data to it's body as the Logic of the program didn't need it So what you will do you can't delete the function as well as you don't need to define it's body In this situation the <b>pass keyword will be very very helpful to avoid compile time errors...</b>
        </p>
        <h4 style="text-align:left;color:#a54eee;" class="mt-4">EXAMPLE</h4>
   
        <h5 style="text-align:left;" id="passinfunction">Using Pass Statement in a function</h5>
        <div class="container-fluid mt-1" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;">
          <comment>"""using pass keyword in a function for future operations"""</comment><br>
          <keyword>def</keyword> sayHello():<br>
          <keyword style="margin-left:20px;">pass</keyword>

        

             </p></div>

              <h5 style="text-align:left;" id="passinloops">Using Pass Statement in for loop</h5>
              <div class="container-fluid mt-1" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;">
          <comment>"""using pass keyword in for loop"""</comment><br>
          <keyword>for</keyword> i <keyword>in</keyword> <str>"Python"</str>:<br>
          <keyword style="margin-left:20px;">pass</keyword>
             ...
             <h5 style="text-align:left;" id="passinclassdefinition">Using Pass statement after the <a href="classes.php" id="pass_a">class definition</a></h5>

                <div class="container-fluid mt-1" style="background-color:black;height:auto;color:white;border-left:5px solid #a54eee;"><p style="text-align: left;">
          <comment>"""using pass keyword in a class definition"""</comment><br>
          <keyword>class</keyword>  A:<br>
          <keyword style="margin-left:20px;">pass</keyword>
...
function next(){
  window.open("range.php","_self");
}
function prev(){
  window.open("functions.php","_self");
}
