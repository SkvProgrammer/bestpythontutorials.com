...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Threads in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,Threads in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="threads.php" target="_self">Threads</a></li>
    <!--new-->
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="threads.php" target="_self" style="color:white;">Threads</a>
    <!--new-->
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Threads in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/threads.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/threads.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-5">In Programming , a <b>process</b> is an instance of a computer program which is to be executed.Any Program has 3 basic parts :</p>
<ul style="text-align:justify;font-size:20px;">
  <li>An Executable Part which actually runs.</li>
  <li>Data Required.</li>
  <li>Execution of the Program.</li>
</ul>
     <br>
           <script type="text/javascript">
  atOptions = {
...
<div style="overflow:auto;">
  <table>
    ...
    <tr>
      ...
      <td>It's an unique ID given to every new thread.</td>
    </tr>
    <tr>
      <td>Stack Pointer</td>
      <td>Points to thread’s stack in the process. Stack contains the local variables under thread’s scope.</td>
    </tr>
    <tr>
      <td>Program Counter</td>
      <td>Each thread has a program counter VALUE that is only loaded into the hardware program count when the thread is executing.</td>
    </tr>
    <tr>
      <td>Thread State</td>
      <td>There can be states like running, ready, waiting, start or done.</td>
    </tr>
    <tr>
      <td>Thread Register Set</td>
      <td>These are Registers assigned to every set for computations</td>
    </tr>
    <tr>
      <td>Parent process Pointer</td>
      <td>A pointer to the Process control block (PCB) of the process that the thread lives on.</td>
    </tr>
  </table>
</div>
...
<p style="text-align:justify;" class="mt-4">I think you might have understood the meaning of <b>threads</b> and now you can learn the concept of <b>Multi-Threading</b>.</p>
<h2 style="text-align:left;color:#a54eee;" class="mt-4">Multithreading</h2>
<p style="text-align:justify;">Since we have read about threads,now the question arises where the multiple threads can occur.So,multiple threads can only occur where:</p>
<ul style="text-align:justify;font-size:20px;">
  <li>Each thread contains its own register set and local variables (stored in stack).</li>
  <li>All thread of a process share global variables (stored in heap) and the program code.</li>
</ul>
...
class Greetings(Thread):
  def run(self):
    for i in range(20):
      print("Hello")
      sleep(1)

class Greetings_1(Thread):
  def run(self):
    for i in range(20):
      print("Hi")
      sleep(1)
...
<p style="text-align:justify;">In the above program we have started the thread execution by using the <code>start()</code> method.We have delayed the execution of each sub threads by 0.2 seconds using <code>time.sleep()</code> and we have used the <code>join()</code> method to perform any task(in our case printing a string) after the end of the execution of the main thread.</p>
    ...
    <!--<li class="list-inline-item">
      <a class="btn-floating btn-dribbble mx-1">
        <i class="fa fa-dribbble"> </i>
             ...
             <!--like button end-->
                <div class="footer text-center py-3 text-light" style="font-family: 'Big Shoulders Stencil Text', cursive!impor2tant;font-size:20px;">&copy <?php
...
function next(){
  window.open("meta.php","_self"); 
}
function prev(){
  window.open("regexp.php","_self");
}
