...
<html lang="en-Us">
    <head>
        ...
        <meta name="description" content="Introduction to Python - Python Tutorial - Intro to Python - start Learning Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--navbar-->
  <nav class="navbar navbar-expand-lg navbar-dark sticky-top navbar-fixed-top topulli p-4" style="background-image:linear-gradient(192deg,#4537d1,#a54eee);font-family: 'Gayathri', sans-serif!important;">
  ...
  <a class="navbar-brand" href="index.php" style="font-size:25px;font-family: 'Big Shoulders Stencil Text', cursive;">BestPythonTutorials<y style="color:lime;">.com</y></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
       <ul class="navbar-nav ml-auto" style="font-family: 'Big Shoulders Stencil Text', cursive!important;">
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
     ...
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:30px!important;">PYTHON TUTORIAL</h4></li><br>
      <li><a href="home.php"  target="_self">Python Home</a></li>
   <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="intro3.php"  target="_self">Introduction</a></li>
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:30px!important;">OOPS</h4></li><br>
    ...
    <!--new-->
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:30px!important;">INTERMEDIATE</h4></li><br>
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:30px!important;">ADVANCE PYTHON</h4></li><br>
 ...
 <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:30px!important;">PATTERNS</h4></li><br>
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:30px!important;">FILE HANDLING</h4></li><br>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="intro3.php"  target="_self" style="color:white;">Introduction</a>
...
<h2 style="text-align:justify;color:#a54eee;">Introduction to Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/intro3.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/intro3.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------Google Translate API ends----------------->
   ...
   <p style="text-align:justify;" class="mt-4">Python is an Object Oriented Language developed by Guido Van Rossoum as a replacement of ABC and modula-3 Language.Python was actually developed with a goal to make a programming language whose syntax is very easy to learn and also It is very widely used in the field of AI</p>
            <h3 class="text-left mt-4" style="color:#a54eee;">Features of Python</h3>
            <ul style="text-align:justify;font-size: 19px;">
              <li> Python is easy to learn as it's syntax is like plain english.</li>
              <li>Python is a high level language thus a very-very programmer friendly language.</li>
              <li>Python is an interpreted language so it is easy to debug for advance or a beginner user .</li>
              <li>Python is a cross platform language i.e it can be run on Windows,Mac or Linux.</li>
              <li>Python is free and open source i.e you can use it for free and can also modify it if you are a advance programmer.</li>
            </ul>
            <!-- Ads -->
            ...
            <!-- Ads --> 
            <h3 class="text-left mt-4" style="color:#a54eee;">Some disadvantages of Python</h3>
        
            <ul style="text-align:justify;font-size:19px;">
              <li>Python is not a fast Language like C or C++.</li>
              <li>Python has lesser Libraries than other languages like Java and C++.</li>


              <li>Python is not a type safe language.</li>
              <li style="text-decoration:none!important;">Many <abbr title="Object Oriented Programming">OOPs</abbr> feature is not supported directly.</li>
            </ul>
            <!-- Ads -->
            <div class="container-fluid text-center" style="height:250px;width:200px;">
              <p style="text-align:center;line-height:250px;">Advertisement</p>
            ...
            <h3 class="text-left mt-4" style="color:#a54eee;">What we can build or do with Python</h3>
            
             <iframe style="width:120px;height:240px;" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="https://ws-in.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&OneJS=1&Operation=GetAdHtml&MarketPlace=IN&source=ac&ref=tf_til&ad_type=product_link&tracking_id=skv09-21&marketplace=amazon&region=IN&placement=B07GVR9TG7&asins=B07GVR9TG7&linkId=674c2facc6551ca2b94cddf58a925a9d&show_border=false&link_opens_in_new_window=false&price_color=333333&title_color=0066C0&bg_color=FFFFFF">
    </iframe>
            <ul style="text-align:justify;font-size:19px;">
              <li>Currently python is widely used in the field of Artificial Intelligence.</li>
              <li>Python can be used for developing graphical games using pygame module.</li>
              <li>Python can be easily integrated to Database Applications.</li>
              <li>Python is also used for System Administration.</li>
              <li>GDscript whose syntax is similar to python is supported by godot game engine.</li>
              <li>It is also used for developing Powerful web applications with frameworks like Django or Flask.</li>
            ...
            <h3 class="text-left mt-4" style="color:#a54eee;">What type of Language is Python</h3>
            <iframe style="width:120px;height:240px;" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="https://ws-in.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&OneJS=1&Operation=GetAdHtml&MarketPlace=IN&source=ac&ref=tf_til&ad_type=product_link&tracking_id=skv09-21&marketplace=amazon&region=IN&placement=B077T3BG5L&asins=B077T3BG5L&linkId=fa9f9d6adb6136795fa54a462f6666e3&show_border=false&link_opens_in_new_window=false&price_color=333333&title_color=0066C0&bg_color=FFFFFF">
    </iframe>
            
            <p>Python is an object oriented,interpreted and dynamic language.
             Its high-level built in data structures, combined with dynamic typing and dynamic binding, make it very attractive for Rapid Application Development.</p>
</div>       
<br><br>
...
function next(){
  window.open("installation.php","_self");
}
function prev(){
