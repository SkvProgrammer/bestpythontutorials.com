...
<html lang="en-Us">
    <head>
        <title>Inner Functions in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="inner functions in Python - nested functions in python
        "/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,nested functions in python,inner functions in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="inner.php" target="_self">Inner Functions</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="inner.php" target="_self" style="color:white;">Inner Functions</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Inner Functions in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/inner.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/inner.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4"><b>Inner Functions</b> are also know as <b>Nested Function</b>.So please don't confuse.In this chapter we will learn about the <b>Inner Functions</b> in Python.</p>
<p style="text-align:justify;">A function inside a function is known as an <b>Inner Function</b>. It is the concept of <a href="encapsulation.php" style="color:grey;text-decoration:none;">Encapsulation <img src="django/link.png" style="height:10px;"></a>. Encapsulation is the process of binding of data and properties to a single unit. We can use the inner function to protect it from the outside of the function.</p>
 <div class="mb-3 mt-3">
...
<h5 class="text-left mb-0 mt-3">Code #1(A Simple Inner Function Example)</h5>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Scope of Nested Functions</h4>
<p style="text-align:justify;">The location where we can find a variable and also access it if required is called the scope of a variable.
It is known how to access a global variable inside a function, but, what about accessing the variable of an outer function? Let’s see an example:</p>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p style="text-align:justify;">From the above example you will be able to see that all the variables inside the outer function is accessible in the inner function.If you want learn about another concept which is related to Inner Fucntions i.e. <a href="closure.php" style="color:grey;text-decoration:none;">Closures <img src="django/link.png" style="height:10px;"></a>.</p>
...
function next(){
  window.open("automation.php","_self"); 
}
function prev(){
