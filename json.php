...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Json in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,JSON in Python,Javascript Object Notation in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="json.php" target="_self">JSON</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="json.php" target="_self" style="color:white;">JSON</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">JSON in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/json.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/json.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4"><b>JSON</b> stands for <b>J</b>ava<b>S</b>cript <b>O</b>bject <b>N</b>otation.It's a medium for exchanging data and information from a server to a user.JSON is like a string of Dictionary i.e. Dictionary surmounted by double or single quotes.
</p>
<img src="server.png" class="img-fluid" style="height:250px;width:auto;">

<h3 style="text-align:left;color:#a54eee;" class="mt-4">JSON Module</h3>
<p style="text-align:justify;">In Python We have a module called <code>json</code> to deal with JSON Files.Now we will see how to import json.</p>
  <div class="container p-2" style="background-color:#f2f2f2;border:2px solid lightgrey;text-align:justify;">
           <keyword>import</keyword> json
             </div>
...
<p style="text-align:justify;" class="mt-4">There is another method called <code>load()</code>.Now is there any difference between <code>load()</code> and <code>loads()</code> method.The answer is yes there is actually a huge difference as the <code>loads()</code> method lets you to convert the json data in the program itself into python's Dictionary but the <code>load()</code> method lets you to open a json file which then can be converted to a Dictionary.</p>
</div>
     <br>
           <script type="text/javascript">
  atOptions = {
