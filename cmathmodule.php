...
<html lang="en-Us">
    <head>
        <title>CMath and Math Module in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="CMath and Math Module in Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,cmathmodule in python,math module in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="cmathmodule.php" target="_self">CMath,Math module</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="cmathmodule.php" target="_self" style="color:white;">CMath,Math module</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">CMath,Math modules in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/cmathmodule.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/cmathmodule.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
 ...
 <p style="text-align:justify;" class="mt-4">In this chapter we are going to learn about two important module that are <b>Math Module</b> and <b>CMath Module</b>.The Difference between the two modules is that <b>Math Module</b> is used to deal with Real Number including Integers and Floating Points whereas the <b>CMath Module</b> is used to deal with Imaginary Numbers.</b></p>

 <h3 class="text-left mt-4" style="color:#a54eee;">Math Module</h3>   
<p style="text-align:justify;">This method contains a lot of methods to deal with Mathematical Operations and Calculations.Please note that this module deals with only and only Real Numbers.A Complete List of Mathematical functions is given below:</p>
...
#floor
print(math.floor(4.332))
</code>
  </div> 
       

  <h4 class="text-left mt-4" style="color:#a54eee;">CMath Module</h4>     
<p style="text-align:justify;">All the methods of <b>Math Module</b> are suitable with the <b>CMath Module</b>.But We have also provided a list of methods in the table below.</p>
...
<div style="overflow:scroll;">
  ...
  <tr>
    <td><a>cmath.acos(x)</a></td>
    <td>Returns the arc cosine value of x</td>
  </tr>
  <tr>
    <td><a>cmath.acosh(x)</a></td>
    <td>Returns the hyperbolic arc cosine of x</td>
  </tr>
  <tr>
    <td><a>cmath.asin(x)</a></td>
    <td>Returns the arc sine of x</td>
  </tr>
  <tr>
    <td><a>cmath.asinh(x)</a></td>
    <td>Returns the hyperbolic arc sine of x</td>
  </tr>
  <tr>
    <td><a>cmath.atan(x)</a></td>
    <td>Returns the arc tangent value of x</td>
  </tr>
  <tr>
    <td><a>cmath.atanh(x)</a></td>
    <td>Returns the hyperbolic arctangent value of x</td>
  </tr>
  <tr>
    <td><a>cmath.cos(x)</a></td>
    <td>Returns the cosine of x</td>
  </tr>
  <tr>
    <td><a>cmath.cosh(x)</a></td>
    <td>Returns the hyperbolic cosine of x</td>
 </tr>
 <tr>
    <td><a>cmath.exp(x)</a></td>
    <td>Returns the value of E<sup>x</sup>, where E is Euler's number (approximately 2.718281...), and x is the number passed to it</td>
 </tr>
  <tr>
    <td><a>cmath.isclose()</a></td>
    <td>Checks whether two values are close, or not</td>
 </tr>
  <tr>
    <td><a>cmath.isfinite(x)</a></td>
    <td>Checks whether x is a finite number</td>
 </tr>
  <tr>
 ...
 <tr>
    <td><a>cmath.log(x[, base])</a></td>
    <td>Returns the logarithm of x to the base</td>
</tr>
  <tr>
    <td><a>cmath.log10(x)</a></td>
    <td>Returns the base-10 logarithm of x</td>
 </tr>
   <tr>
    <td><a>cmath.phase()</a></td>
    <td>Return the phase of a complex number</td>
   </tr>
   <tr>
    <td><a>cmath.polar()</a></td>
    <td>Convert a complex number to polar coordinates</td>
   </tr>
   <tr>
    <td><a>cmath.rect()</a></td>
    <td>Convert polar coordinates to rectangular form</td>
 </tr>
  <tr>
    <td><a>cmath.sin(x)</a></td>
    <td>Returns the sine of x</td>
 </tr>
  <tr>
    <td><a>cmath.sinh(x)</a></td>
    <td>Returns the hyperbolic sine of x</td>
 </tr>
  <tr>
    <td><a>cmath.sqrt(x)</a></td>
    <td>Returns the square root of x</td>
  </tr>
  <tr>
    <td><a>cmath.tan(x)</a></td>
    <td>Returns the tangent of x</td>
  </tr>
  <tr>
    <td><a>cmath.tanh(x)</a></td>
    <td>Returns the hyperbolic tangent of x</td>
 </tr>
</tbody>
</table>
...
print(cmath.exp(2j))
#sine
print(cmath.sin(0j + 1j))
#cosine
print(cmath.cos(0 + 2j))
#tan
print(cmath.tan(3j))
...
function next(){
  window.open("decorators.php","_self"); 
}
function prev(){
  window.open("generatorcomprehension.php","_self");
}
