...
<html lang="en-Us">
    <head>
        <title>Sys Module in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="sys Module in Python - System Module in Python"/>
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="sysmodule.php" target="_self">sys Module</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="sysmodule.php" target="_self" style="color:white;">sys Module</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Sys Module in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/sysmodule.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/sysodule.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!-----------------------------CONTENT------------------->
 ...
 <p style="text-align:justify;" class="mt-4">The sys module provides information about constants, functions and methods of the Python interpreter. dir(system) gives a summary of the available constants, functions and methods. Another possibility is the help() function. Using help(sys) provides valuable detail information.</p>
        <h3 style="text-align:left;">Important function in <code>sys</code> module</h3>
        <hr>
        <h1 style="text-align:left;"><code>sys.modules()</code></h1>
        <p style="text-align:justify;">This function return the name of all existing python modules which have been imported.</p>
        <hr>
        <h1 style="text-align:left;"><code>sys.argv()</code></h1>
        <p style="text-align:justify;">This function is used for command line arguments i.e. it returns a list of command line arguments passed to a Python script</p>
        <hr>
         <h1 style="text-align:left;"><code>sys.platform()</code></h1>
         <p style="text-align:justify;">This value of this function is used to identify the platform on which we are working.</p>
         <hr>
         <h1 style="text-align:left;"><code>sys.base_exec_prefix</code></h1>
         <p style="text-align:justify;">This function provides an efficient way to the same value as exec_prefix. If not running a virtual environment, the value will remain the same.</p>
         <hr>
         <h1 style="text-align:left;"><code>sys.base_prefix</code></h1>
         <p style="text-align:justify;">Set during Python startup, before site.py is run, to the same value as prefix. If not running in a virtual environment, the values will stay the same; if site.py finds that a virtual environment is in use, the values of prefix and exec_prefix will be changed to point to the virtual environment, whereas base_prefix and base_exec_prefix will remain pointing to the base Python installation (the one which the virtual environment was created from).</p>
         <hr>
         <h1 style="text-align:left;"><code>sys.byteorder</code></h1>
         <p style="text-align:justify;">An indicator of the native byte order. This will have the value 'big' on big-endian (most-significant byte first) platforms, and 'little' on little-endian (least-significant byte first) platforms.</p>
         <hr>
          <h1 style="text-align:left;"><code>sys.audit(event, *args)</code></h1>
          <p style="text-align:justify;">Raise an auditing event with any active hooks. The event name is a string identifying the event and its associated schema, which is the number and types of arguments. The schema for a given event is considered public and stable API and should not be modified between releases.

This function will raise the first exception raised by any hook. In general, these errors should not be handled and should terminate the process as quickly as possible.</p>
<hr>
<h1 style="text-align:left;"><code>sys.call_tracing(func, args)</code></h1>
          <p style="text-align:justify;">Call func(*args), while tracing is enabled. The tracing state is saved, and restored afterwards. This is intended to be called from a debugger from a checkpoint, to recursively debug some other code.</p>
          <hr>
          <h1 style="text-align:left;"><code>sys.path</code></h1>
          <p style="text-align:justify;">This function shows the PYTHONPATH set in the current system. It is an environment variable that is a search path for all the python modules.</p>
          <hr>
          <h1 style="text-align:left;"><code>sys.stdin</code></h1>
          <p style="text-align:justify;">It is an object that contains the original values of stdin at the start of the program and used during finalization. It can restore the files.</p>
          <hr>
          <h1 style="text-align:left;"><code>sys.dllhandle</code></h1>
          <p style="text-align:justify;">Integer specifying the handle of the Python DLL.</p>
          <hr>
          <h1 style="text-align:left;"><code>sys.displayhook(value)</code></h1>
          <p style="text-align:justify;">If value is not None, this function prints repr(value) to sys.stdout, and saves value in builtins._. If repr(value) is not encodable to sys.stdout.encoding with sys.stdout.errors error handler (which is probably 'strict'), encode it to sys.stdout.encoding with 'backslashreplace' error handler.</p>
          <hr>
          <h1 style="text-align:left;"><code>sys.stdout</code></h1>
          <p style="text-align:justify;">stdout is used for the output of print() and expression statements and for the prompts of input();</p>
          <hr>
          <h1 style="text-align:left;"><code>sys.stderr</code></h1>
          <p style="text-align:justify;">The interpreter’s own prompts and its error messages go to stderr.</p>
...
function next(){
  window.open("statisticsmodule.php","_self");
}
function prev(){
  window.open("randommodule.php","_self");
}
