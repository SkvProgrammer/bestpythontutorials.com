...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Arrays in Python - List - Sets - Frozensets - Tuples - Dictionary"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,programming tutorial">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <ul class="menu text-center">
       <img src="pythonbanner5.png" class="ml-auto mr-auto img-fluid mt-3 mb-3 text-center" style="width:85%;height:185px;">
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:30px;">PYTHON TUTORIAL</h4></li><br>
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="arrays.php" target="_self">Arrays</a></li> 
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <!--new-->
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">INTERMEDIATE</h4></li><br>
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li><a href="forensics.php" target="_self">Python Forencics</a></li>
 ...
 <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">PATTERNS</h4></li><br>
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">FILE HANDLING</h4></li><br>
    ...
    <li><a href="programs.php" target="_self">PYTHON PROGRAMS</a></li>
   <!--<li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:50px;line-height:55px;color:#a54eee;background-color:white;">DS & ALGO</h4></li><br>
   ...
   <li> <a href="dynamicprogramming.php" target="_self">Dynamic Programming</a></li>
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:50px;line-height:55px;color:#a54eee;background-color:white;">MORE TOPICS</h4></li><br>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="arrays.php" target="_self" style="color:white;">Arrays</a>
    ...
    <a href="forensics.php" target="_self">Python Forencics</a>
    ...
    <a href="serialization.php" target="_self">Serialization</a><a href="unittesting.php" target="_self">Unit Testing</a>
    ...
    <a href="tell.php" target="_self">tell and seek method</a>
        <a href="programs.php" target="_self">PYTHON PROGRAMS</a>
  ...
  <section class="container-fluid text-center" id="content" style="width:79%;background-color:white;font-family: 'Baloo Thambi 2', cursive;font-size:18px;position:absolute;top:60px;right:0px;padding:0px;">
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Arrays in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/arrays.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/arrays.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
<a href="https://www.youtube.com/channel/UC_pPPgwvndi8f2RkbkbvOIA" target="_blank" style="background-color:red;color:white;border-radius:10px;padding:1px;font-size:15px;" class="col-lg-3 col-sm-3 col-md-3 mb-1" id="facebookshare">   <i class="fa fa-youtube"></i> Youtube </a>
<a style="background-color:orangered;color:white;border-radius:10px;padding:1px;font-size:15px;" class="col-lg-3 col-sm-3 col-md-3 mb-1" id="facebookshare" onclick="languagedisplay()">   <i class="fa fa-language"></i><text>Language</text> </a></button>
...
<!-----------------------Google Translate API ends----------------->
    ...
    <div id="main">
<!--<div id="mySidenav" class="sidenav" style="font-size:15px;z-index:1;"><br>
  <a href="javascript:void(0)" class="closebtn text-left onclick="closetoc()">&times;</a>
  <a style="color:white;"><h3>Table of Content</h3></a>
  <a href="#passinfunction"><i class="fa fa-arrow-right"></i>Pass in Function</a>
  <a href="#passinloops"><i class="fa fa-arrow-right"></i>Pass in loops</a>
  <a href="#passinclassdefinition"><i class="fa fa-arrow-right"></i>Pass in Class Defintion</a>
</div>
-->
...
<!-----------------------------CONTENT------------------->
  ...
  <p style="text-align:justify;" class="mt-4"><b>Arrays</b> are a special variable which can store multiple but same type of values.In Python We will be dealing with Lists not arrays.There are four types of Arrays in Python:
<ul style="text-align:justify;font-size:19px;" id="arrayslist">
  <li onclick="window.open('#list','_self');">List</li>
  <li onclick="window.open('#tuple','_self');">Tuple</li>
  <li onclick="window.open('#set','_self');">Set</li>
  <li onclick="window.open('#dict','_self');">Dictionary</li>
</ul>
</p>


  <p style="text-align:justify;">
          Actually Python doesn't have the support of Arrays to use arrays you need to use the <a href="numpy/home_numpy.php" style="color:grey;text-decoration:none;"> NumPy Library <img src="django/link.png" style="height:10px;"></a>.<br><br>
          In this chapter we will Learn how to use LISTS as ARRAYS in Python.Now what are lists,Lists are containers which stores multiple values of same kind and allows duplicate members.So what does it mean when I say that Lists allows duplicate members indicates that the List can contains same value many times i.e one number can appear many times.
        </p>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
        ...
        <h3 style="text-align:left;color:#a54eee;" id="list">Declaring a List</h3>
        
        <p style="text-align:justify;">To declare a list in Python,first you need to declare a variable for it and the you  have to put the values of same type inside the <code>[]</code> Square Brackets.</p>
...
print(list_1[-1])
        ...
        <h3 style="text-align:left;color:#a54eee;">Deleting a List</h3>
...
print(list_1)
      ...
      <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
        ...
        <p style="text-align: justify;">The above code will generate an error because we are trying to print the list but we had already deleted the List</p>
...
print(len(list_1))  
         ...
         <h3 style="text-align:left;color:#a54eee;">Adding Items in a List</h3>
        <p style="text-align:justify;">We will use the <code>append()</code> method to add the elements at the end of the list<br><br>
          <code>insert()</code> method can be used to insert element at specified index of the list.<br>
        </p>
...
print(list_1)   
        ...
        <p style="text-align:justify;" class="mt-3 mb-3">In the above example we have added 0 at the 0th index position of the list and also we have added 6 at the end of the list.</p>
          <h3 style="text-align:left;color:#a54eee;" class="mt-5">Deleting items of the List</h3>
        
        <p style="text-align:justify;">We will use the <code>clear()</code> method to empty the List.<br><br>
          <code>remove()</code> method can also be used to delete specified items of the List.<br>
        </p>
...
print(list_1)    
        ...
        <p style="text-align:justify;">Using the <code>clear()</code> method which empties the List.</p>
...
print(list_1)    
       ...
       <h3 style="text-align:left;color:#a54eee;">Removing the Last item in a List</h3>
...
print(list_1)     
    ...
    <h2 class="text-left mt-4" style="color:#a54eee;" id="tuple">Tuples - Python</h2>
<p style="text-align:justify;">A tuple is a collection of objects which ordered and immutable. Tuples are sequences, just like lists. The differences between tuples and lists are, the tuples cannot be changed unlike lists and tuples use parentheses, whereas lists use square brackets.
</p>
<p style="text-align:justify;">
...
<h4 class="text-left mt-4" style="color:#a54eee;">Declaring a Tuple</h4>
<p style="text-align:justify;">The Syntax for Declaring a Tuple is very simple and almost similar to that of the List.The only difference is that List uses <b>Square Brackets</b> whereas Tuples uses <b>Parathesis</b>.</p>
...
tuple2 = ()#empty tuple
  ...
  <h4 class="text-left mt-4" style="color:#a54eee;">Access the items of a Tuple</h4>
<p style="text-align:justify;">In this section we are going to learn how to access items of a Tuple using index or loop.</p>
...
for i in tuple1:
        print(i)
           ...
           <script type="text/javascript">
  atOptions = {
    'key' : 'ccab6f0b37ebcf46ae2cc8c860e3836a',
    'format' : 'iframe',
    'height' : 280,
    'width' : 336,
    'params' : {}
  ...
  <h4 class="text-left mt-4" style="color:#a54eee;">Changing the items of a Tuple</h4>
...
<p style="text-align:justify;" class="mt-2 mb-2">The above code will generate an Error like below shown.</p>
<div class="container" style="border:2px solid lightgrey;text-align:justify;width:100%;color:red;overflow:scroll;">
  Traceback (most recent call last):<br>
  File "C:/Users/skv/AppData/Local/Programs/Python/Python38-32/98476.py", line 3, in &lt;module&gt;<br>
    tuple1[0] = "Skv"<br>
...
<p style="text-align:justify;" class="mt-4"><b>Note:</b>Once a tuple is created, you  cannot remove,change or items it.</p>
</div>
...
<h2 class="text-left mt-4" style="color:#a54eee;" id="set">Sets - Python</h2>
<p style="text-align:justify;">A Set is an unordered collection data type that is iterable, mutable and has no duplicate elements. Python’s set class represents the mathematical notion of a set.</p>
...
<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><b>Note:</b>Once a set is created, you cannot change its items, but you can add new items.</p>
</div>
...
set2 = {"Skv","is","a"}
#add
set1.add("Skvprogrammer")
#update
set2.update(["Great","Programmer"])
...
print(set1)
  ...
  <div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><b>Note:</b>In the <code>remove()</code> method if the specified value is not found then it will <b>raise an error</b> whereas in the <code>discard()</code> method if the specified value is not found then it will <b>NOT</b> raise an error.</p>
</div>
...
set1 = {"Satyam","Kumar","Verman"}
set1.pop()#will delete the last element
print(set1)
  ...
  <div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><b>Note:</b>As we know that Sets are <B>Unordered</B> so whenever you will use the <code>pop()</code> method which deletes the last item of the array you will not be known about which element is going to be deleted.</p>
</div>
...
set1 = {"Satyam","Kumar","Verman"}
del set1 
print(set1)#this will generate an error because the set is already deleted
...
<p style="text-align:justify;">We can also join two sets using the <code>update()</code> method with a simple trick by adding the elements of one set into another.</p>
...
<h2 class="text-left mt-4" style="color:#a54eee;" id="dict">Dictionary - Python</h2>
<p style="text-align:justify;">Now we will talk about the last type of array i.e. the dictionary.First of all what is a Dictionary - A dictionary is a collection which is unordered, changeable and indexed. In Python dictionaries are written with curly brackets, and they have keys and values.</p>
...
company_data = {"Amazon":"Warren Buffet","Microsoft":"Bill Gates","RIL":"Mukesh Ambani"}

company_data["Amazon"] = "Jeff Bezos" #owner of Amazon is Jeff Bezos not Warren Buffet
...
company_data = {"Amazon":"Jeff Bezos","Microsoft":"Bill Gates","RIL":"Mukesh Ambani"}
...
<h4 class="text-left mt-4" style="color:#a54eee;">Removing items from a Dictionary</h4>
...
company_data = {"Amazon":"Jeff Bezos","Microsoft":"Bill Gates","RIL":"Mukesh Ambani"}
del company_data
print(company_data)#this will raise an error as the dictionary is already deleted
</code>
  </div> 
...
<h4 class="text-left mt-4">Sponsored</h4>
<script async="async" data-cfasync="false" src="//partitiondetergenttumor.com/347cb2f24917930b6e3cc399b6a8e449/invoke.js"></script>
<div id="container-347cb2f24917930b6e3cc399b6a8e449"></div>
...
<!--End of Tawk.to Script-->
      ...
      <button class="btn mt-2 mb-2 col-lg-6 col-md-12 col-sm-6"  style="background-color:lightgrey;border-radius:1px!important;" onclick="window.open('https://www.facebook.com/skvprogrammer')"><i class="fa fa-thumbs-up"></i> <b>LIKE US ON FACEBOOK</b></button>
       <button class="btn mt-2 mb-2 col-lg-6 col-md-12 col-sm-6"  style="background-color:lightgrey;border-radius:1px!important;" onclick="window.open('../aboutus.html')"><i class="fa fa-envelope-o"></i> <b>ABOUT US</b></button>
    </div>
  </div>
      <hr>
