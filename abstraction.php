...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Abstraction in Python - abc module in python - abstract classes in python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,abstraction in python,abstract classes in python,abc module in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="abstraction.php" target="_self">Abstraction</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="abstraction.php" target="_self" style="color:white;">Abstraction</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Abstraction in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/abstraction.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/abstraction.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4"><b>Abstraction</b> is the process of hiding the basic implementation of the function or a class and only showing the essential functionalities of that function.In Python we can implement abstract classes using the <b>abc</b> module.</p>
<div class="mb-3 mt-3">
...
<h4 class="text-left mt-4" style="color:#a54eee;">Important points about abstract class in Python
</h4>
<ul style="text-align:justify;font-size:20px;">
    <li>Abstract class can have both concrete methods as well as abstract methods.</li>
    <li>Abstract class works as a template for other classes. Using an abstract class you can define a generalized structure without providing complete implementation of every method.
    </li>
    <li> Methods which provide common functionality to be used for all derived classes are defined as concrete methods in abstract class where as the methods where implementation may vary are defined as abstract methods.</li>
    <li>
    Abstract class can’t be instantiated so it is not possible to create objects of an abstract class.
    </li><li>Generally abstract methods defined in abstract class don’t have any body but it is possible to have abstract methods with implementation in abstract class. Any sub class deriving from such abstract class still needs to provide implementation for such abstract methods.</li>
    <li>
    If any abstract method is not implemented by the derived class Python throws an error.</li>
</ul>
...
function next(){
  window.open("inheritance.php","_self"); 
}
function prev(){
  window.open("classes.php","_self");
}
