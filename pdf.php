...
<html lang="en-Us">
    <head>
        <title>Handling PDF Files in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="Description" content="Handling PDF Files in Python"/> 
        <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,handling pdf files in python,pdf file handling">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">OOPS</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="pdf.php" target="_self">Working with PDF Docs</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="pdf.php" target="_self" style="color:white;">Working with PDF Docs</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Handling PDf Files in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/pdf.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/pdf.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Python is a Versatile Programming Language so we can easily deal with the PDF(Portable Document Format) Documents.For this chapter we will be using the <b>PyPDF2</b> Module which you can easily install using the <b>pip</b> Package Manager.</p>
<br>
           <script type="text/javascript">
  atOptions = {
...
<p style="text-align:justify;">PyPDF2 is a pure-python PDF library capable of splitting, merging together, cropping, and transforming the pages of PDF files. It can also add custom data, viewing options, and passwords to PDF files. It can retrieve text and metadata from PDFs as well as merge entire files together.</p>
<h4 class="text-left mt-3 mb-1" style="color:#a54eee;"> SYNTAX</h4>
<div class="container p-2" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
  pip install pypdf2
</div>
...
<img src="output_pdf.png" class="img-fluid" alt="output">
...
<h4 class="text-left mt-4" style="color:#a54eee;">Extracting Text From the PDF</h4>  
<p style="text-align:justify;">We can extract text from the pdfs. Though it have built-in support for extracting images.
...
def extract_pdfText(path):
   with open(path, 'rb') as f:
      ...
      #Extract text from the 1st page
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="output_pdf3.png" align="output" class="img-fluid">
...
def main(): 
  ...
  originalpdf = 'sample.pdf'
  
  # new pdf file name 
  newFileName = 'watermarked.pdf'
