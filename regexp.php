...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Regular Expression in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,Regular Expression in Python,Regex in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="regexp.php" target="_self">RegExp</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="regexp.php" target="_self" style="color:white;">RegExp</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Regular Expressions in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/regexp.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/regexp.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Regular Expression is a Sequence of Characters that forms a Search Pattern.Regular expressions are widely used in UNIX world.RegEx can be used to check if a string contains the specified search pattern.<br><br>
Python provides a <code>re</code> Module to deal with Regular Expression or to perform regular expression operation.In this module we have two methods called <code>search()</code> and <code>match()</code> which are used for basic Regular Expression Operations.

</p>

<h2 style="text-align:left;color:#a54eee;" class="mt-5">Search() Method</h2>
<p style="text-align:justify;">This function searches for first occurrence of Regular Expression pattern within string with optional flags.</p>
...
<div class="container" style="width:auto;height:auto;border:3px solid #f2f2f2;text-align:justify;">
  re.<comment>search</comment>(pattern, string, flags=0)
</div>
<h3 style="text-align:left;color:#a54eee;" class="mt-4">PARAMETERS</h3>
...
text = "The Rain is Awesome"
x = re.search("^The.*Awesome$", text)
print(x)
...
<h3 style="text-align:left;color:#a54eee;" class="mt-4">PARMETERS</h3>
<div class="overflow:auto;">
  <table class="table table-bordered">
<tbody><tr>
<th style="text-align:center;width:10%">Sr.No.</th>
...
pattern = '^a...s$'
test_string = 'A great man /'' great journey aka safar' 
result = re.match(pattern, test_string)

if result:
  print("Search is done Successful.")
else:
...
<h2 style="text-align:left;color:#a54eee;" class="mt-5"> Match versus Search</h2>
<p style="text-align:justify;">Python offers two different primitive operations based on regular expressions: match checks for a match only at the beginning of the string, while search checks for a match anywhere in the string.</p>
<h1 style="text-align:left;color:#a54eee;" class="mt-5">sub() method</h1> 
<p style="text-align:justify;">It is used to search and replace a part of string.</p>
<h3 style="text-align:left;color:#a54eee;" class="mt-4">SYNTAX</h3>
<div class="container text-left" style="height:auto;width:100%;border:3px solid #f2f2f2;">
  re.<comment>sub</comment>(pattern, repl, string, max=0)
...
<div class="overflow:auto;"> 
<h3 style="text-align:left;" class="mt-5">Metacharacters</h3> 
<table>
<tbody><tr>
...
<div class="overflow:auto;">
  <h3 class="mt-4" style="text-align:left;">Character Classes</h3>
  <table class="table table-bordered">
<tbody><tr>
<th style="text-align:center;width:10%">Sr.No.</th>
...
<div style="overflow:auto;">
  <h3 style="text-align:left;" class="mt-4">Special Sequences</h3>
...
function next(){
  window.open("threads.php","_self"); 
}
function prev(){
  window.open("json.php","_self");
}
