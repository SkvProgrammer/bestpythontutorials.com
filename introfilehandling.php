...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Introduction to file handling in python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,introduction to file handling in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
 ...
 <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">PATTERNS</h4></li><br>
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;height:50px;line-height:55px;color:#a54eee;background-color:white;">FILE HANDLING</h4></li><br>
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="introfilehandling.php" target="_self">Intro to file handling</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="introfilehandling.php" target="_self" style="color:white;">Intro to file handling</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Introduction to File Handling </h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/introfilehandling.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/introfilehandling.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">File Handling is an important part of an Web Application.The key function for working with files in Python is the <code>open()</code> function.</p>
<p style="text-align:justify;">File Handling means opening a File from our Systems and we can perform actions such as Reading the File,Writing into a File etc.</p>
 <div class="mb-3 mt-3">
...
<h3 class="text-left mt-4" style="color:#a54eee;">Actions Related to File Handling</h3>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
  r - Reading a File<br>
  w - Writing into a File<br>
  a - Appending the content of a File<br>
  x - Creates a Specified File
</div>
<h3 class="text-left mt-4" style="color:#a54eee;">File Types</h3>
<div class="container" style="text-align:justify;background-color:#f2f2f2;border:2px solid lightgrey;">
  t - Normal Text File<br>
  b - Binary Files Like Images<br>
</div>

<h3 class="text-left mt-4" style="color:#a54eee;">Opening a File</h3>
...
file1 = open("file_name.txt" , rt)
#second way of opening a file
file2 = open("file_name.txt")</textarea>
...
<p style="text-align:justify;" class="mt-4">In line 2 and line 4 we have two different syntax for opening a file they both are same because <code>rt</code> means read a text file and the file itself is a <code>.txt</code> file.So both ways are same and 100% correct.</p>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
<div class="text-left mt-5">
  <h3 class="text-left" style="color:#a54eee;">Opening a file using <code>with</code> statement</h3>
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
function prev(){
  window.open("morepatterns.php","_self");
}
