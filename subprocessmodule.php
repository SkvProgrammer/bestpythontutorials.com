...
<html lang="en-Us">
    <head>
        <title>Subprocess Module in python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Subprocess in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,subprocess in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="subprocessmodule.php" target="_self">Subprocess Module</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="subprocessmodule.php" target="_self" style="color:white;">Subprocess Module</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Subprocess Module in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/subprocessmodule.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/subprocessmodule.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In Python we have a module called <code>subprocess</code>.The subprocess module allows you to spawn new processes, connect to their input/output/error pipes, and obtain their return codes. This module intends to replace several older modules and functions:</code></p>
 <div class="mb-3 mt-3">
...
<h3 class="text-left mt-4" style="color:#a54eee;">High Level APIs of Subprocess Module</h3>
<p style="text-align:justify;">Prior to Python 3.5, these three functions comprised the high level API to subprocess. You can now use <code>run()</code> in many cases, but lots of existing code calls these functions.</p>
<pre style="width:100%;" class="mb-0">
<p style="text-align:justify;">subprocess.<b>call</b>(args, *, stdin=None, stdout=None, stderr=None, shell=False, cwd=None, timeout=None, **other_popen_kwargs)</p></pre>
<i class="fa fa-arrow-right" class="mt-0"></i>Scroll left to view the complete function.
<p style="text-align:justify;">
Run the command described by args. Wait for command to complete, then return the returncode attribute.</p>

<p style="text-align:justify;">Code needing to capture stdout or stderr should use <code>run()</code> instead:</p>
<br>
<br>

<pre style="width:100%;" class="mb-0">
<p style="text-align:justify;">subprocess.check_call(args, *, stdin=None, stdout=None, stderr=None, shell=False, cwd=None, timeout=None, **other_popen_kwargs)</p></pre>
<i class="fa fa-arrow-right" class="mt-0"></i>Scroll left to view the complete function.
<p style="text-align:justify;">
...
<h3 class="text-left mt-4" style="color:#a54eee;">C Language</h3>
...
<h3 class="text-left mt-4" style="color:#a54eee;">C++</h3>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<h3 class="text-left mt-4" style="color:#a54eee;">Java</h3>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
function next(){
  window.open("methodchaining.php","_self"); 
}
function prev(){
  window.open("unittesting.php","_self");
}
