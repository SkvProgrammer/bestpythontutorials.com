...
<html lang="en-Us">
    <head>
        <title>Content Manager in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="context manager in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,context manager in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="contextmanager.php" target="_self">Python Context Manager</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="contextmanager.php" target="_self" style="color:white;">Python Context Manager</a>  
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Context Manager in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/contextmanager.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/contextmanager.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">One of the most undiscovered features of Python that almost all Python programmers use, even the beginners, but they  really don't understand, is context managers. You've probably seen them in the form of with statements, usually first encountered when you learn opening files in Python. Although context managers seem a little  strange at first, when we really dive into them, understand the motivation and techniques behind it, we get access to a new weapon in our programming arsenal. So without further ado, let's dive into it!</p>
<br>
           <script type="text/javascript">
  atOptions = {
...
<h3 style="text-align:left;color:#a54eee;" class="mt-4">Managing Resources</h3>
<p style="text-align:justify;">The most common use of a Context Manager is for managing different resources in a computer.Thatswhy we use Context Manager in the form of with statement while reading a file.Do you what happens when you read a file.The act of opening a file consumes a resource called file descriptor which is in limited amount in the OS and if you try process maximum number of file your OS may crash or show errors like <numbers>can't open too many</numbers>.</p>
<p style="text-align:justify;">When you try to open too many files the file descriptor may leak. As by not closing the opened files. When working with files, it's easy to forget that any file that is <code>open()</code>-ed must also be <code>close</code>()-ed. Failure to do so will lead you to discover that there is (usually) a limit to the number of file descriptors a process can be assigned. On UNIX-like systems, $ ulimit -n should give you the value of that upper limit (it's 7168 on my system). If you want to prove it to yourself, re-run the example code and replace 100000 with whatever number you got (minus about 5, to account for files the Python interpreter opens on startup). You should now see the program run to completion.
...
<h3 style="text-align:left;color:#a54eee;" class="mt-4">Creating a Context Manager</h3>
<p style="text-align:justify;">You must keep in mind that you have to use function like  <code>__enter__()</code> and <code>__exit__()</code>.So what they do.The <code>__enter__()</code> returns the resource that needs to be managed and the <code>__exit__()</code> does not return anything but performs the cleanup operations.</p>
...
with ContextManager() as manager: 
  print("Opened with ContextManager") </textarea>
...
<h4 style="text-align:justify;color:#a54eee;" class="mt-5">Handling Files and Database using the Context Manager</h4>
<p style="text-align:justify;">First of all we will try to open a file,write something and then closing it using the context manager.</p>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
# loading a file 
with ContextManager('data.txt', 'w') as f: 
  f.write('Context Manager is Working') 

print(f.closed) </textarea>
...
<p style="text-align:justify;" class="mt-4">Now we will try to establish the connection to a MySQL Database</p>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p class="mt-4" style="text-align:justify;">Now we will try to establish the connection to a MongoDB</p>
<div class="text-left mt-1">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
with MongoDBConnectionManager('localhost', '1200') as mongo: 
...
function next(){
  window.open("functionfactory.php","_self"); 
}
function prev(){
