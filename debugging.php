...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Debugging in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,debugging in python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="debugging.php" target="_self">Debugging</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="debugging.php" target="_self" style="color:white;">Debugging</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Debugging in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/debugging.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/debugging.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4"><b>Debugging</b> is the process of finding bugs in the system or a program.Now what are bugs suppose you have made a program in python to find out the square of a number but it's showing the cube of the that number in the console then it's a bug i.e. the program is not working as expected.</p>
 <div class="mb-3 mt-3">
...
<p style="text-align:justify;" class="mt-4">In Python,We have some good tools to debug code such as pdb , web-pdb , wdb , pyflame etc.In this chapter we will be learning <b>pdb</b>.It is the most popular module to debug code in Python.</p>
<h3 style="text-align:left;color:#a54eee;" class="mt-4">pdb - The Python Debugger</h3>
<p style="text-align:justify;">The module pdb defines an interactive source code debugger for Python programs. It supports setting (conditional) breakpoints and single stepping at the source line level, inspection of stack frames, source code listing, and evaluation of arbitrary Python code in the context of any stack frame. It also supports post-mortem debugging and can be called under program control.</p>
<h4 style="text-align:left;color:#a54eee;" class="mt-5">breakpoint() and set_trace()</h4>
<p style="text-align:justify;"> Python comes with the latest built-in function <code>breakpoint</code> which do the same thing as <code>pdb.set_trace()</code> in <code>Python 3.6</code> and below versions.</p>
<p style="text-align:justify;">Debugger finds the bug in the code line by line where we add the <code>breakpoint</code>, if a bug is found then program stops temporarily then you can remove the error and start to execute the code again.</p>
 <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>
...
<h3 class="text-left mt-5" style="color:#a54eee;">Commands for Debugging</h3>
...
q -> quit the debugger/execution<br>
n -> step to next line within the same function<br>
...
function next(){
  window.open("forensics.php","_self"); 
}
function prev(){
