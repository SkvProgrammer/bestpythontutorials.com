...
<html lang="en-Us">
    <head>
        <title>Collection Module in Python</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Collection Module in Python"/> 
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="collectionmodule.php" target="_self">Collection Module</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="collectionmodule.php" target="_self" style="color:white;">Collection Module</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Collection Module in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/collectionmodule.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/collectionmodule.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">This module implements specialized container datatypes providing alternatives to Python’s general purpose built-in containers, dict, list, set, and tuple.</p>
...
<h1 style="text-align:left;color:#a54eee;" class="mt-5">EXAMPLE</h1>

<h3 style="text-align:left;"><code>namedTuple()</code></h3>
...
for i in dq:
     print(i.upper())  
        ...
        <!--Counter--->
        <h3 style="text-align:left;"><code>Counter()</code></h3>
...
print(Counter(dict1)) 
        ...
        <!--chainmap-->
        <h3 style="text-align:left;"><code>ChainMap()</code></h3>
...
import collections
dic_1 = { 'one' : 1, 'two' : 2 }
dic_2 = { 'three' : 3, 'four' : 4 }
chain_map = collections.ChainMap(dic_1, dic_2)
...
for key,value in dict1.items():
        ...
        <h3 style="text-align:left;"><code>defaultDict()</code></h3>
<p style="text-align:justify;">Returns a new dictionary-like object. defaultdict is a subclass of the built-in dict class. It overrides one method and adds one writable instance variable.</p>
...
function next(){
  window.open("itetools.php","_self");
}
function prev(){
