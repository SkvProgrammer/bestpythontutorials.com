...
<html lang="en-Us">
    <head>
        <title>Polynomials in Python - Polynomial Manipulation</title>
        <meta charset="utf-8">
...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="codemirror/theme/dracula.css" >
        ...
        <meta name="Description" content="Polynomial Manipulation in Python"/> 
         <meta name="Keywords" content="python,django,flask,numpy,pandas,matplotlib,python tutorial,matplotlib tutorial,polynomials in Python">
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
    ...
    <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;"><h4 style="text-align:center;font-family: 'Big Shoulders Stencil Text', cursive;height:30px;line-height:55px;color:#a54eee;background-color:white;font-size:35px;">PYTHON TUTORIAL</h4></li><br>
   ...
   <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;height:50px;font-family: 'Big Shoulders Stencil Text', cursive;font-size:30px;line-height:55px;color:#a54eee;background-color:white;">ADVANCE PYTHON</h4></li><br>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="polynomial.php" target="_self">Polynomial Manipulation</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="polynomial.php" target="_self" style="color:white;">Polynomial Manipulation</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Polynomials in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/polynomial.php" style="background-color:#3377ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/polynomial.php" style="background-color:#1ac6ff;color:white;border-radius:1px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In highschools we all have studied a mathematical topic called Polynomial and Polynomial function.In this chapter we will be manipulating or simply implementing Polynomials in Python.</p>

<p style="text-align: justify;">We will define various arithmetic operations for polynomials in our class, like addition, subtraction, multiplication and division. Our polynomial class will also provide means to calculate the derivation and the integral of polynomials. We will not miss out on plotting polynomials.</p>
 <div class="mb-3 mt-3">
...
<h3 style="text-align:left;color:#a54eee;" class="mt-4">Overview</h3>
<p style="text-align:justify;">We will only deal with polynomial in a single indeterminate (also called variable) x. A general form of a polynomial in a single indeterminate looks like this:
<br><br>
...
where a0,a1,...an are the constants - non-negative integers - and x is the indeterminate or variable. The term "indeterminate" means that x represents no particular value, but any value may be substituted for it.
<br>
...
"""instantiating the Polynomial Class"""
p1 = Polynomial(3, 0, 2, 3, 0)
print(p1)
...
<img src="polynomial_plot.png" alt="polynomial" class="img-fluid">
    ...
    <div class="modal-content" style="border-radius:10px!important;color:white;background-image: linear-gradient(to right,#a54eee,#4537d1);border:none!important;">
      ...
      <div class="modal-body">
        ...
        <ul style="font-size:20px;text-align:justify;">
          <li><a href="https://bestpythontutorials.com/blogs/write-your-article" style="color:white!important;text-decoration:none;">Write articles for us</a></li>
...
<!--End of Tawk.to Script-->
      ...
      <button class="btn mt-2 mb-2 col-lg-6 col-md-12 col-sm-6"  style="background-color:lightgrey;border-radius:1px!important;" onclick="window.open('https://bestpythontutorials.com/blogs')"><i class="fa fa-newspaper-o"></i> <b>BLOGS</b></button>
