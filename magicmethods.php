...
<link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet">
        ...
        <meta name="description" content="Magic Methods in Python - Dunder Method in Python"/> 
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <!--vertical menu-->
   ...
   <li><a href="intro3.php"  target="_self">Introduction</a></li>
    ...
    <li style="background-image:linear-gradient(to right,#4537d1,#4537d1);color:white;border-bottom:1px solid white;border-top:1px solid white;text-align:left;"><a href="magicmethods.php" target="_self">Python Magic Methods</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="magicmethods.php" target="_self" style="color:white;">Python Magic Methods</a>
...
<!--testingends-->
<h2 style="text-align:justify;color:#a54eee;font-family: 'Big Shoulders Stencil Text', cursive!important;">Magic Methods in Python</h2>

<div class="row ml-auto mr-auto" style="width:40%!important;">
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/magicmethods.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="
https://twitter.com/intent/tweet?text=Check%20Out%20this%20Awesome%20Tutorial:http%3A//bestpythontutorials.com/magicmethods.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="col-lg-3 col-sm-3 col-md-3 mb-1"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Magic Methods in Python are special methods which are having two prefix and suffix underscores at the end and starting of the method name.For Example : __repr__ , __init__ ,__add__ and __len__.<br>
       ...
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
        ...
        <h1 style="text-align:left;"><code>__repr__</code></h1>
        <p style="text-align:justify;">Return a representation of the proxy object.This function is called by the repr() built-in function to compute the "official" string representation of an object and returns a machine-readable representation of a type.</p>

        <h1 style="text-align:left;"><code>__init__</code></h1>
        <p style="text-align:justify;">The _init_ method is called after the instance of the class has been created but before it returned to the caller. It is invoked without any call, when an instance of the class is created like constructors in other programming languages such as C++, Java, C# etc. </p>
         <div class="mb-3 mt-3">
       <a href="https://partners.hostgator.com/c/2548499/178160/3094" target="_top" id="178160"><img src="//a.impactradius-go.com/display-ad/3094-178160" border="0" alt="" width="336" height="280"/></a><img height="0" width="0" src="https://partners.hostgator.com/i/2548499/178160/3094" style="position:absolute;visibility:hidden;" border="0" /><br>
           </div>

          <h1 style="text-align:left;"><code>__len__</code></h1>
        <p style="text-align:justify;">This method returns the length of an Object.  </p>
        <h1 style="text-align:left;"><code>__add__</code></h1>
        <p style="text-align:justify;">Python executes each + operator separately, the two + operators are distinct expressions.</p>

        <h1 style="text-align:left;"><code>__str__</code></h1>
        <p style="text-align:justify;">__str__ is the built-in function in python, used for string representation of object.  </p>

        <iframe style="width:120px;height:240px;" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="https://ws-in.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&OneJS=1&Operation=GetAdHtml&MarketPlace=IN&source=ac&ref=tf_til&ad_type=product_link&tracking_id=skv09-21&marketplace=amazon&region=IN&placement=B07GVR9TG7&asins=B07GVR9TG7&linkId=54e5ea48dd35a50de72ed784b944ea11&show_border=false&link_opens_in_new_window=false&price_color=333333&title_color=0066c0&bg_color=ffffff">
    </iframe>
       <h1 style="text-align:left;"><code>__del__</code></h1>
        <p style="text-align:justify;">__del__ is like Destructors for closing the instance created by __init__ method.  </p>
...
function next(){
  window.open("and.php","_self");
}
function prev(){
  window.open("itertools.php","_self");
}
