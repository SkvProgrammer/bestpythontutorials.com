        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Id Selector in HTML - ID in html - # selector in html - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="id_html4.php"  target="_self">Id</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="id_html4.php"  target="_self" style="color:white;">Id</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Id - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/id_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/id_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">Hello Programmers In this chapter we are going to learn about the <code>id</code> attribute of HTML Attribute which is a selector.Please remember that <code>id</code> names are case-sensitive.</p>



<h4 class="text-left mt-4" style="color:#a54eee;">Styling Elements</h4>
<p style="text-align:justify;">We can easily style an HTML Element with <code>id</code> selector by a syntax which is like:<b>#id_name{property:value;}</b>.The syntax is really very simple and I am sure you can easily grab it.</p>
<p style="text-align:justify;">The <code>id</code> attribute specifies a unique <code>id</code> for an HTML element. The value of the <code>id</code> attribute must be unique within the HTML document.
</p>
<p style="text-align:justify;">
The <code>id</code> attribute is used to point to a specific style declaration in a style sheet. It is also used by JavaScript to access and manipulate the element with the specific <code>id</code>.</p>
...
<body>
<div id="example">div element with class="example".</div>
...
<p style="text-align:justify;" class="mt-5">In the above example I have used a method from JavaScript's DOM Object i.e. the <b>document.getElementById()</b> method.In order to demonstrate the use of this selector the above example is best.</p>

<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><b>Note:</b>The <code>id</code> name must contain at least one character, and must not contain whitespaces (spaces, tabs, etc.).</p>
</div>

<h4 class="text-left mt-5" style="color:#a54eee">Difference Between <i>Class</i> and <i>Id</i>
</h4>
<p style="text-align:justify;">A <code>class</code> name can be used by multiple HTML elements, while an <code>id</code> name must only be used by one HTML element within the page.This is the very basic difference between a <code>class</code> and an <code>id</code> selector.Please note down this.
</p>
...
function next(){
  window.open("iframes_html4.php","_self");
}
function prev(){
