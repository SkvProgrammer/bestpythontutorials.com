        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Anchor tag in HTML - HTML Hyperlinks - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="anchor_html4.php"  target="_self">Anchor</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="anchor_html4.php"  target="_self" style="color:white;">Anchor</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Anchor - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/anchor_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/anchor_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">In HTML we have an <code>&lt;a&gt;</code> tag which is pronounced as <b>Anchor</b> Tag.This tag is used to define Hyperlinks We have already discussed every thing about this tag in our <a href="../html/links_html4.php" style="color:grey;text-decoration:none;"> Links <img src="../django/link.png" style="height:12px;"></a> Chapter.</p>


<p style="text-align:justify;">This Chapter is created in order to help you clear the doubts about the difference of Hyperlinks and Anchor.Actually Anchor Tag is used to create Hyperlinks.So you can say that both are related terms.</p>
...
function next(){
  window.open("responsive_html4.php","_self");
}
function prev(){
