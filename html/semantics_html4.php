        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Semantics in HTML  - Semantic Tags in HTML - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="semantics_html4.php"  target="_self">Semantics</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="semantics_html4.php"  target="_self" style="color:white;">Semantics</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Semantics - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/semantics_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/semantics_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4 mb-3">Semantic Elements or Semantic Tags or Simply Semantics are HTML Elements which has some special meaning to it's developer and the browser.This feature is added in HTML5 i.e. latest version of HTML.</p>
<img src="semantics.jpg" alt="semantics" class="img-fluid">
<p style="text-align:justify;" class="mt-3"><code>&lt;div&gt;</code> and <code>&lt;span&gt;</code> are the examples of <b>non-semantic</b> tags.</p>
<p style="text-align:justify;"><code>&lt;form&gt;</code>, <code>&lt;table&gt;</code>, and <code>&lt;article&gt;</code> are the examples of <b>semantic</b> tags.</p>
...
<!----------------------------ADS------------------->
    ...
    <h4 class="text-left mt-4" style="color:#a54eee;">Semantic Tags</h4>
...
<p style="text-align:justify;" class="mt-4">Now we are going to discuss about some important semantic tags in HTML5.</p>



<h3 class="text-left mt-4" style="color:#a54eee;">&lt;article&gt;</h3>
<p style="text-align:justify;">HTML &lt;article&gt; element defines article content within a document, page, application, or a website. It can be used to represent a forum post, a magazine, a newspaper article, or a big story. </p>


<!--<div class="text-left mt-2">
  <form method="post" target="_blank">
 <textarea id="editor1" style="height:20vh!important;text-align:justify;overflow:hidden;-webkit-border-radius: 5px;
    -moz-border-radius: 5px;border-radius: 5px;z-index:0;" onkeyup="do_this(this)">
<!DOCTYPE html>
<html>
<head>
...
<body>
<p>Read My Blogs</p>
<iframe src="https://www.devtipsntricks.com/" height="30vh" width="100%"></iframe>
</body>
</html></textarea>
