        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Formatting in HTML - HTML Formatting is a process of formatting text for better look and feel. HTML provides us ability to format text without using CSS. There are many formatting tags in HTML. These tags are used to make text bold, italicized, or underlined - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="formatting_html4.php"  target="_self">Formatting</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="formatting_html4.php"  target="_self" style="color:white;">Formatting</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Formatting - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/formatting_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/formatting_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we are going to learn about Text Formatting in HTML.First of all what is text formatting.Text formatting means making changes in the text and making it more attrctive such as making the text bold italic or giving underline maybe line through.A table of some common formatting tags is given below.</p>
<p style="text-align:justify;">In HTML the formatting tags are divided into two categories:</p>
<ol style="text-align:justify;">

    <li>Physical tag: These tags are used to provide the visual appearance to the text.
    <li>Logical tag: These tags are used to add some logical or semantic value to the text.
</ol>
...
<h4 class="text-left mt-3">Bold,Italic and Underlined Text</h4>
<p style="text-align:justify;">In this example we are going to make the text bold italic and underline using tags such as &lt;b&gt;,&lt;strong&gt;,&lt;i&gt;,&lt;emp&gt; and &lt;u&gt;</p>
...
<p><strong>I am also a bold text</strong></p>
<p><i>I am italic text</i></p>
<p><i>I am also italic text</i></p>
<p><u>I am underlined text</u></p>
</body>
</html></textarea>
...
<h4 class="text-left mt-3">small,mark and del</h4>
<p style="text-align:justify;">In this example we are going to use the tags such as &lt;small&gt;,&lt;del&gt; and &lt;mark&gt;.</p>
...
<body> 
<p>I am a <mark>mark</mark> text</p>
...
<h4 class="text-left mt-3">Superscript and Subscript</h4>
<p style="text-align:justify;">In this example we are going to use the Superscript and Subscript Tags.</p>
...
<body> 
<p>The formula of Oxygen is:O<sub>2</sub></p>
<p>The output of 2 <sup>2</sup> is:4</p>
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<h4 class="text-left mt-3">Inserted Text</h4>
<p style="text-align:justify;">In this example we are going to use the ins tag which is used to insert a value after the deleted value using the del tag.</p>
...
<body> 
<p style="text-align:justify;">Now the price of detergent is slashed from <del>5$</del> to <ins>2$.</ins></p>
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
function prev(){
  window.open("styles_html4.php","_self");
}
