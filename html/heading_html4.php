        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Headings in HTML , H1 - H6 in HTMl - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="heading_html4.php"  target="_self">Heading</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="heading_html4.php"  target="_self" style="color:white;">Heading</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Heading - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/heading_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/heading_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Heading are used to display title and subtitles in the Webpage they are greater than any other paragraph elements.</p>
...
<p style="text-align:justify;" class="mt-4"><b>Note:</b>HTML heading tags are from <b>h1 to h6</b>.Please keep this in Mind and also remember that the browser puts some whitespaces after and before the heading tags.</p>
</div>

<h3 class="text-left mt-4" style="color:#a54eee;">Another way to put Headings</h3>
<p style="text-align:justify;">There's a property called <b>Font-Size</b> which is use to chage the size of font.We can use this property inside the <code>style</code> attribute.</p>
...
<body>
<p style="font-size:50px;">Heading 1</p>
...
<p style="text-align:justify;" class="mt-3">Now this chapter is over in the next chapter we will learn more about the <b>style</b> attribute in HTML.</p>
...
function prev(){
  window.open("attributes_html4.php","_self");
}
