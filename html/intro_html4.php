        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Introduction to HTML - Features of HTML  - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="intro_html4.php"  target="_self">Introduction</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   <a href="intro_html4.php"  target="_self" style="color:white;">Introduction</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Introduction to HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/intro_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/intro_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">HTML stands for <b>Hyper Text Transfer Protocol</b>,which is a <a href="https://www.w3.org/" style="color:black;text-decoration:none;">W3C</a> Standard which is used to build the skeleton of the web pages i.e. it used for creating very basic webpages with some styling through it's <a href="attributes_html4.php" style="color:grey;text-decoration:none;"> Attributes <img src="../django/link.png" style="height:12px;"></a> or you can say that it describes the structure of the webpage.</p>

<p style="text-align:justify;">Now we will make a simple HTML page and we will see the basic tags and attributes used in the page.</p>


<div class="text-left mt-0">
  <h3 style="text-align:left;" class="mb-1 mt-3">EXAMPLE</h3>
...
<body>
<h1>My First Web Page using HTML</h1>
</body>
</html></textarea>

              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3 ml-0">
              <a type="submit" class="pl-4 pr-4 text-center" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
             </button>
             -->
...
<p style="text-align:justify;" class="mt-3">In the above program we have used very basic html tags such as <code>&lt;DOCTYPE html!&gt;</code>,<code>&lt;html&gt;</code>,<code>&lt;head&gt;</code>,<code>&lt;title&gt;</code>,<code>&lt;body&gt;</code> and <code>&lt;h1&gt;</code>.Now our task is to gain some knowledge about these tags.</p>
<ul style="text-align:justify;font-size:20px;">
  <li><code>&lt;DOCTYPE html!&gt;</code>:This specifies that the document is of HTML5.</li>
  <li><code>&lt;html&gt;</code>:This specifies that the main HTML Document.</li>
  <li><code>&lt;head&gt;</code>:This tag contains all the meta information.</li>
  <li><code>&lt;title&gt;</code>:This tag specifies the title of the page.</li>
  <li><code>&lt;body&gt;</code>:This is where you write the working code.</li>
</ul> 

<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><b>Note:</b>In this series of tutorials we are going to learn <b>HTML5</b>.The general file extension for HTML is <b>.html</b></p>
</div>
...
function next(){
  window.open("installation_html4.php","_self");
}
function prev(){
  window.open("home_html4.php","_self");
}
