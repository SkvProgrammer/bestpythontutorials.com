        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Tables in HTML - <table> tag in HTML - <img> tag in HTML - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="tables_html4.php"  target="_self">Tables</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="tables_html4.php"  target="_self" style="color:white;">Tables</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Tables - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/tables_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/tables_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
 <p style="text-align:justify;" class="mt-4">Tables are a very important part of an Webpage because tables are highly enhanced to display the data in row and columns.You can even style the tables as you want using <a href="../css/home_css.php" style="color:grey;text-decoration:none;"> css <img src="../django/link.png" style="height:12px;"></a>.Now we will start this chapter by created a very basic table with absolutely no styles.</p>
...
<p style="text-align:justify;" class="mt-4">As you can see we have designed a very simple table with absolutely no styles but with a border of 1px width.Now we are going to discuss the tags such as <code>&lt;table&gt;</code>,<code>&lt;th&gt;</code>,<code>&lt;tr&gt;</code> and <code>&lt;td&gt;</code>.</p>

<p style="text-align:justify;">These are very simple tags.The First tag i.e. the <b>&lt;table&gt;</b> tag is used to create the table with <b>&lt;tr&gt;</b> for creating table rows and <b>&lt;th&gt;</b> for table heading and <b>&lt;td&gt;</b> for table data.</p>


<h4 class="text-left mt-4" style="color:#a54eee;">Adding Cell Padding</h4>
<p style="text-align:justify;">In this section we are going to see that how we can add cell padding to table rows using the <b>padding</b> property.</p>
<div class="text-left mt-2">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<table border="1px">
  <tr>
    <th style="padding:20px;">Heading 1</th>
    <th style="padding:20px;">Heading 2</th>
  </tr>
  <tr>
  ...
  <tr>
    <td style="padding:20px;">Data 1</td>
    <td style="padding:20px;">Data 2</td>
  </tr>
</table></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<h4 class="text-left mt-4" style="color:#a54eee;"><i>rowspan</i> and <i>colspan</i></h4>

<p style="text-align:justify;">To make a cell span more than one column, use the <code>colspan</code> attribute and To make a cell span more than one row, use the <code>rowspan</code> attribute
</p>
<div class="text-left mt-2">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<html>
<head>
  <title>Tables With Row Span and Column Span</title>
</head>
<body>
<p>Column Span</p>
<table>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Adding a Title or Caption to the Table</h4>
<p style="text-align:justify;">We can use the <code>&lt;caption&gt;</code> tag to put the heading of the table.</p>
<div class="text-left mt-2">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<table border="1px" style="width:100%;">
 ...
 <h4 class="text-left mt-4" style="color:#a54eee;">HTML Table - Add Border Spacing
</h4>
<p style="text-align:justify;">
Border spacing specifies the space between the cells.

To set the border spacing for a table, use the CSS <code>border-spacing</code> property:
</p>
...
<body>
<table border="1px" style="width:100%;border-spacing:10px;">
  <caption>Row Span Demo</caption>
  <tr>
    <th>Name</th>
    <th colspan="2">Companies</th>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above</h4>
<style>
  table, th, td {
...
<p style="text-align:justify;" class="mt-4">Now this chapter is over,In the next chapter we are going to learn about Lists.</p>
...
function prev(){
  window.open("images_html4.php","_self");
}
