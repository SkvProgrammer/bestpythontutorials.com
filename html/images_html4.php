        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Images in HTML - <img> tag in HTML - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="images_html4.php"  target="_self">Images</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="images_html4.php"  target="_self" style="color:white;">Images</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Images - HTML</h3>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we are going to see that how we can render images using HTMl's <kbd style="color:crimson;background-color:#f1f1f1; ">&lt;img&gt;</kbd>.This tag has two main attributes that are <code>src</code> and <code>alt</code>.First of all lets look at a simple example before having a close look at these two attributes.</p>
...
<body>
<img src="firefox.jpg" alt="This is an image" /> 
</body>
</html></textarea>
...
<p style="text-align:justify;" class="mt-4">Now let's talk about these two attributes i.e. the <code>src</code> and the <code>alt</code> attribute.By the name I think you have got the answer that for what purpose the <code>src</code> attribute is used,the <code>src</code> attribute is used to point to the image file you want to render in the page.Now we are going to talk about the alt attribute.</p>

<h4 class="text-left mt-4" style="color:#a54eee;">The <i>alt</i> Attribute</h4>
<p style="text-align:justify;">This attribute adds a text in place of an Image if the image file is corrupt,deleted or not found in the system.The syntax of <i>alt</i> tag is quite similar,It is like:<b>alt = "Text to be Displayed"</b></p>


<h4 style="text-align:left; color:#a54eee;" class="mt-4">Location of Image File</h4>
<p style="text-align:justify;">This is an important topic while working with <kbd style="color:crimson;background-color:#f1f1f1; ">&lt;img&gt;</kbd> tag in HTML as it is neccessary to have the knowledge about where the desired image file is located in the computer.Suppose you are working with a <code>main.html</code> file wherev you want to render an image and the html file you are working with is present in a folder named <code>mainfiles</code>.Imagine that the file is in the same folder then you have to just write the name of image file in the <code>src</code> attribute and if the file in outside the folder you are working with you have to enter the complete destination of the image file.</p>

<h4 class="text-left mt-4" style="color:#a54eee;">Image Size - Height and Width</h4>
<p style="text-align:justify;">You must set the size of image or when your page will be loaded the image will flicker.The <code>width</code> and <code>height</code> attributes always define the width and height of the image in pixels.</p>
...
<body>
<img src="firefox.jpg" alt="This is an image" width="100px" height="100px" /> 
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<p style="text-align:justify;" class="mt-4">Alternatively,you can use the <code>style</code> attribute to put the <code>width</code> and <code>height</code> of the image file.</p>
<div class="text-left mt-2">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<body>
<img src="firefox.jpg" alt="This is an image" style="height:100px;width:100px;" /> 
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<img src="firefox.jpg" alt="This is an image" style="width:100px;height:100px;" /> 
...
function next(){
  window.open("tables_html4.php","_self");
}
function prev(){
  window.open("links_html4.php","_self");
}
