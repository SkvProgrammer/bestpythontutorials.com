        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Colors in HTMl - Normal Color Values - RGB Color Codes - Hex color Codes  - RGBA - HSL - HSLA - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="color_html4.php"  target="_self">Color</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="color_html4.php"  target="_self" style="color:white;">Color</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Colors - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/color_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/color_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Colors are a very important part of a Web Page.It makes the website look better and attractive.By some sources HTML supports almost 140 standard colors as well as you can create different color mixers using the RGB,RGBA,HSL and HSLA.Now we can use colors for background,text,outline,shadow and border.</p>


<h4 class="text-left mt-4" style="color:#a54eee;">Background-Color</h4>
<p style="text-align:justify;">In this example we are going to see that how we can add some background color to our HTML Document using all possible methods such as HEX,HSL,RGB etc.</p>
...
<button class="btn btn-success mt-4 ml-0" onclick="window.open('color_example.html','_blank')"; style="box-shadow:none;border:none;outline:none;border-radius:1px!important;">View the Output</button>


<h4 class="text-left mt-4" style="color:#a54eee;">Background-Color(Using Hex Value)</h4>
...
<body style="background-color:#423fa8;"> 
<p>Demo Colors</p>
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
...
<button class="btn btn-success mt-4 ml-0" onclick="window.open('color_example2.html','_blank')"; style="box-shadow:none;border:none;outline:none;border-radius:1px!important;">View the Output</button>

<h4 class="text-left mt-4" style="color:#a54eee;">Background-Color(Using RGB and RGBA Values)</h4>
...
<body>
<div style="height:200px;background-color:rgb(2,31,11);"></div> 
<div style="height:200px;background-color:rgba(2,31,11,0.8);"></div>
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<button class="btn btn-success mt-4 ml-0" onclick="window.open('color_example3.html','_blank')"; style="box-shadow:none;border:none;outline:none;border-radius:1px!important;">View the Output</button>


<h4 class="text-left mt-4" style="color:#a54eee;">Background-Color(Using HSL and HSLA Values)</h4>
...
<body>
<div style="height:200px;background-color:hsl(1,2,3);"></div> 
<div style="height:200px;background-color:hsla(2,1,1,0.8);"></div>
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<button class="btn btn-success mt-4 ml-0" onclick="window.open('color_example4.html','_blank')"; style="box-shadow:none;border:none;outline:none;border-radius:1px!important;">View the Output</button>



<h3 class="text-left mt-5" style="color:#a54eee;">Text Colors</h3>
<div class="text-left mt-2">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<body>
 <p style="color:rgb(121,32,31);">I am RGB Text</p>
<p style="color:rgba(121,32,31,0.7);">I am RGBA Text</p>
<p style="color:hsl(9,40%;10%);">I am HSL Text</p>
<p style="color:hsla(24,50%,60%,0.4);">I am HSLA Text</p>
<p style="color:red;">I am Normal Color Text</p>
<p style="color:#3279be;">I am HEX Valued Text</p>
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<output style="text-align:justify;">
  <p style="color:rgb(121,32,31);">I am RGB Text</p>
<p style="color:rgba(121,32,31,0.7);">I am RGBA Text</p>
<p style="color:hsl(9,40%;10%);">I am HSL Text</p>
<p style="color:hsla(24,50%,60%,0.4);">I am HSLA Text</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Same Colors Using Different Techniques</h4>
...
<h1 style="background-color:hsla(9, 100%, 64%,1);">RGB</h1>  
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
function prev(){
  window.open("comment_html4.php","_self");
}
