...
<html lang="en-Us">
    <head>
        <title>Style Attribute - HTML</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Style Attribute in HTML - Inline CSS Demo in HTMl - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="styles_html4.php"  target="_self">Styles</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="styles_html4.php"  target="_self" style="color:white;">Styles</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Styles - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/styles_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/styles_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In the <b>Attributes</b> Chapter of this course we have discussed about the some commonly used attributes such as src and href.Now in this chapter we are going to look at an Attribute which is used to style element.We are talking about the <b>style</b> attribute in HTMl.</p>

<h4 class="mt-4 text-left" style="color:#a54eee;">Definition and Usage</h4>
<p style="text-align: justify;">The <b>style</b> attribute is used to style different elements of the HTML document.The syntax of the style attribute is very simple it is like <b>style="property:value;"</b>.Here Property refers to <a href="../css/home_css.php" style="color:grey;text-decoration:none;"> CSS <img src="../django/link.png" style="height:12px;"></a> Properties.</p>

<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4">We are going to learn more about CSS in later tutorial.</p>
</div>

<h3 class="text-left mt-4" style="color:#a54eee;">EXAMPLES</h3>


<h4 class="text-left mb-0 mt-3">Background-Color</h4>
<p style="text-align:justify;">In this example we are going to change the background color of the webpage from white to red.</p>
...
<h4 class="text-left mb-0 mt-4">Font Color</h4>
<p style="text-align:justify;">In this example we are going to change the color of fonts or text.</p>
<div class="text-left mt-2">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<body> 
<p style="color:red;">I am a red Line</p>
<p style="color:green;">I am a green Line</p>
<p style="color:#4537d1;">I am a #4537d1 Line</p>
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<h4 class="text-left mb-0 mt-4">Font Size</h4>
<p style="text-align:justify;">In this example we are going to change the size of fonts or text.</p>
<div class="text-left mt-2">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<body> 
<p style="color:red;font-size:30px;">I am a red Line</p>
<p style="color:green;font-size:30px;">I am a green Line</p>
<p style="color:#4537d1;font-size:30px;">I am a #4537d1 Line</p>
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
