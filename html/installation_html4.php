...
<html lang="en-Us">
    <head>
        <title>Environment Setup - HTML</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Environment Setup in HTML - Getting Started With HTML - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="installation_html4.php"  target="_self">Installation</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="installation_html4.php"  target="_self" style="color:white;">Installation</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Environment Setup - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/installation_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/installation_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In HTML you actually don't need install any software but wait you must have a browser in your system to run HTML Files.The most recommended browser is obviously the <b>Chrome</b> browser as it provides a bunch of quality Development Tools.The next thing is that where you wil write the code.So listen carefully you can simply use the default notepad in windows or any default text editors in different Operating Systems.But for more easy way of Development You can use Text Editors or Code Editors such as <a href="https://code.visualstudio.com/" style="color:grey;text-decoration:none;"> Visual Studio Code <img src="../django/link.png" style="height:12px;"></a> or <a href="https://notepad-plus-plus.org/downloads/" style="color:grey;text-decoration:none;"> Notepad++ <img src="../django/link.png" style="height:12px;"></a>
 and My personal favourite is <a href="https://www.sublimetext.com/" style="color:grey;text-decoration:none;"> Sublime Text <img src="../django/link.png" style="height:12px;"></a>.</p>

<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><b>Note:</b>All the above softwares are free to use and remember that you must save the file with <b>.html</b> extension.</p>
</div>
...
function next(){
  window.open("text_editors_html4.php","_self");
}
function prev(){
  window.open("intro_html4.php","_self");
}
