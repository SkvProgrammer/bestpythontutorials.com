...
<html lang="en-Us">
    <head>
        <title>Basic Webpage - HTML</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="How to design a basic webpage in HTML - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="basic_webpage_html4.php"  target="_self">Basic Webpage</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="basic_webpage_html4.php"  target="_self" style="color:white;">Basic Webpage</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Basic Webpage - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/basic_webpage_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/basic_webpage_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we are going to create a simple webpage which will display a Heading and a Paragraph in the Browser.The code is below:-</p>
...
<img src="output1.png" class="img-fluid" style="border:1px solid black;">
<h4 class="text-left mt-4" style="color:#a54eee;">EXPLANATION</h4>
<p style="text-align:justify;">Just now we have created a very basic webpage which is just displaying a heading and a paragraph in the Document.I would like to say that instead of copying the code you should grab the concepts about different tags.</p>
