        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Lists in HTML - Definition List in HTML - Ordered List in HTML - Unordered List in HTML - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="lists_html4.php"  target="_self">List</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="lists_html4.php"  target="_self" style="color:white;">List</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Lists - HTML</h3>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">Lists are an important part of any Web Page It is used to deliver contents in the form of a list.There are three types of Lists available in HTML that are:-Ordered List , Unordered List and Definition/Descriptive List.First of all we are goint to discuss about the Unordered List.</p>


<h4 class="text-left mt-4" style="color:#a54eee;">Unordered List</h4>
<p style="text-align:justify;">This are very simple lists starting from a dot or square.In the below example we will see that how we can create an Unordered List using the <code>&lt;ul&gt;</code>.</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Changing the Bullets from circle to square and more</h4>
<p style="text-align:justify;">In this section we are going to use a CSS Property called <code>list-style</code> which is used to change the list bullets.A List of all possible values is given below.</p>
...
<table>
  ...
  <tr>
    ...
    <td>The marker is a number with leading zeros (01, 02,  03, etc.)</td>
                      </tr>
  <tr>
    <td>georgian</td>
  ...
  <tr>
    <td>upper-greek</td>
    <td>The marker is upper-greek</td>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Ordered List</h4>
<p style="text-align:justify;">In this section we are going to create a simple ordered List using the <code>&lt;ol&gt;</code> tag.</p>
<div class="text-left mt-2">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<p style="text-align:justify;" class="mt-3">Now the last type of List is none other than the definition or descriptive list using the <code>&lt;dl&gt;</code>.A description list is a list of terms, with a description of each term.</p>
<div class="text-left mt-2">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<dl style="text-align:justify;">
  <dt>Paneer</dt>
  <dd> - Panner is a Daily Product and it is very tasty.</dd>
  <dt>Coffee</dt>
...
<p style="text-align:justify;" class="mt-3">This chapter is over now in the next chapter we are going to learn about the <b>Block</b> Elements.</p>
