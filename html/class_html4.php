        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Class in HTML - HTML Class Attribute - . in HTML - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="class_html4.php"  target="_self">Class</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="class_html4.php"  target="_self" style="color:white;">Class</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Class - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/class_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/class_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">This attribute is used to specify a class selector to any HTML Element.Selectors are important as they are used to access html element with <code>.</code> before class name and giving them styles.</p>

<p style="text-align:justify;">Now in order to grab this concept of class selector we need to use the <code>class</code> attribute and below I have provided a very simple example where I have assigned a class a paragraph and make it red coloured.</p>
<div class="container-fluid mt-5 mb-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><b>Note:</b>You can use the class attribute with any HTML Element.</p>
</div>
...
<p class="para1">I am styled by a class selector</p>
</body>
</html></textarea>
...
<p class="para1 text-center" style="color:red;">I am styled by a class selector</p>

<div class="container-fluid mt-5 mb-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><b>Tip:</b> You can learn much more about CSS in our <a href="../css/home_css.php" style="color:grey;text-decoration:underline;"> CSS Tutorial <img src="../django/link.png" style="height:12px;"></a>.</p>
</div>

<h4 class="text-left mt-5" style="color:#a54eee;">Same Class For Different Elements</h4>
<p style="text-align:justify;">In HTML we can have same class name with different HTML Elements.Suppose you have one paragraph and one heading,you can use use same class name for both of the elements.</p>
...
<p class="para1">I am styled by a class selector</p>
<p class="para1">I am styled by a class selector 1</p>
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Output of the above code</h4>
<p class="para1 text-center" style="color:red;">I am styled by a class selector</p>
<p class="para1 text-center" style="color:red;">I am styled by a class selector 1</p>


<h4 class="text-left mt-4" style="color:#a54eee;">Accessing Elements using JavaScript</h4>
<p style="text-align:justify;">In our <a href="../javaScript/home_javascript.php" style="color:grey;text-decoration:none;"> JavaScript Tutorial <img src="../django/link.png" style="height:12px;"></a> We will about <a href="../javaScript/document_object_javascript.php" style="color:grey;text-decoration:none;"> DOM Manipulation <img src="../django/link.png" style="height:12px;"></a>.Javascript provides few methods to manipulate the DOM in this tutorial we are going to use the method called <b>document.ElementByClassNames.</b>Look at the below example for better understanding of the code.</p>
...
function next(){
  window.open("id_html4.php","_self");
}
function prev(){
  window.open("block_html4.php","_self");
}
