...
<html lang="en-Us">
    <head>
        <title>Responsive Webpages - HTML</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Responsive Webpages in HTML - Responsive Images - Bootstrap and Media Queries in CSS - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li><a href="block_html4.php"  target="_self">Block</a></li>
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="responsive_html4.php"  target="_self">Responsive</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="block_html4.php"  target="_self">Block</a>
   ...
   <a href="responsive_html4.php"  target="_self" style="color:white;">Responsive</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Responsive Design - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/responsive_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/responsive_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">First of all let's talk about <b>Responsive Design</b>.Any Design which tends to look beautiful in all type of Devices from an Smart Phone to a Powerful Desktop.This definition I think is clear to you all but a more detailed and traditional definition is given below:</p>

<p style="text-align:justify;">Responsive Web Design is about using <b>HTML</b> and <b>CSS</b> to automatically resize, hide, shrink, or enlarge, a website, to make it look good on all devices (desktops, tablets, and phones).</p>



<img src="responsive.jpg" class="img-fluid mb-5 mt-5">
...
<p style="text-align:justify;" class="mt-5">There are various ways by which we can make a webpage responsive.First of all we need to set the <code>viewport</code> of the webpage,you can do the same by adding the below code.</p>

<div class="text-left mt-2">
  <form target="_blank">
 <textarea action="output.php" method="post" id="editor7" style="height:20vh!important;text-align:justify;overflow:hidden;-webkit-border-radius: 5px;
    -moz-border-radius: 5px;border-radius: 5px;z-index:0;"><meta name="viewport" content="width=device-width, initial-scale=1.0"> </textarea>
...
<p style="text-align:justify;" class="mt-3">Now in order to make a responsive webpage you are now  in the first stage but actually this is not enough you need to know about <code>max-width</code> and <code>Media Queries.</code></p>

<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><b>Tip:</b>Set the image width to be 100% or use the max-width property.</p>
</div>

<h4 class="text-left mt-5" style="color:#a54eee;">Responsive Images</h4>
<p style="text-align:justify;">As discussed above use the <code>max-width</code> property or set the  of images in terms of percentage or <code>viewport</code> height or width that will make the image responsive.</p>


<div class="text-left mt-2">
  <form target="_blank">
 <textarea action="output.php" method="post" id="editor1" style="height:20vh!important;text-align:justify;overflow:hidden;-webkit-border-radius: 5px;
...
<p style="text-align:justify;" class="mt-4">This is not looking good we want our image to look a bit smaller that the one we have tried last.</p>

<div class="text-left mt-2">
  <form target="_blank">
 <textarea action="output.php" method="post" id="editor2" style="height:20vh!important;text-align:justify;overflow:hidden;-webkit-border-radius: 5px;
    -moz-border-radius: 5px;border-radius: 5px;z-index:0;">
<!DOCTYPE html>
<html>
<head>
...
<body>
<p>Max Width</p>
<img src="img_avatar2.png" style="max-width:500px;" />
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<h4 style="text-align:justify;color: #a54eee;" class="mt-4">Responsive Text</h4>
<p style="text-align:justify;">In this chapter we are going to craete responsive text using the <code>viewport width</code>.That way the text size will follow the size of the browser window.</p>

<div class="container-fluid" style="background-color:#f2f2f2;">
  <h1 style="font-size: 10vw;">Hello BPT</h1>
  <p style="font-size:2vw;">This is an example for Responsive Text</p>
</div>

<p style="text-align:justify;" class="mt-4">See the below code to grab the concept of the <code>viewport width</code> in HTML.</p>

<div class="text-left mt-2">
  <form target="_blank">
 <textarea action="output.php" method="post" id="editor3" style="height:20vh!important;text-align:justify;overflow:hidden;-webkit-border-radius: 5px;
    -moz-border-radius: 5px;border-radius: 5px;z-index:0;">
<!DOCTYPE html>
<html>
<head>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Media Queries</h4>
<p style="text-align:justify;">This is the most important concept in order to make a responsive webpage.<b>Media Queries</b> allows us to change CSS properties of HTML Elements on device width and height change.In this chapter we will try to learn about media queries in a lot simpler way other platforms do.</p>

<div class="text-left mt-2">
  <form target="_blank">
 <textarea action="output.php" method="post" id="editor4" style="height:20vh!important;text-align:justify;overflow:hidden;-webkit-border-radius: 5px;
    -moz-border-radius: 5px;border-radius: 5px;z-index:0;">
<!DOCTYPE html>
<html>
<head>
...
<button class="btn btn-success mt-3" style="box-shadow:none;border:none;outline:none;border-radius:1px!important;" onclick="window.open('media.html','_blank')"><i class="fa fa-eye"></i> View Output</button>


<p style="text-align:justify;" class="mt-3">To learn more about Media Queries.Check Out Our <a href="../css/complete_media_queries.php" style="color:grey;text-decoration:none;"> Complete Media Queries Tutorial<img src="../django/link.png" style="height:12px;"></a></p>


<h4 class="text-left mt-4" style="color:#a54eee;">RWD using Frameworks</h4>
<p style="text-align:justify;">Now to build a large website we need to know about Web Frameworks.Actually they are nothing but they already provide some code snippets to work with that's make the task really simple.Some of the popular frontend frameworks are W3.CSS and Bootstrap.Check out our <a href="../bootstrap/home_bootstrap.php" style="color:grey;text-decoration:none;"> Bootstrap 4 Tutorial<img src="../django/link.png" style="height:12px;"></a>.Currently we are not planning to launch any tutorial on W3.CSS,So Check out the Tutorial Provided By <i>W3Schools.com</i> on <a href="https://www.w3schools.com/w3css/" style="color:grey;text-decoration:none;"> W3.CSS<img src="../django/link.png" style="height:12px;"></a>.</p>
...
<br><br><br><br><br>
<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;border-radius:50px;" class="btn btn-danger  pl-5 pr-5">Subscribe for Updates</button>
<br><br>
...
function next(){
  window.open("forms_html4.php","_self");
}
function prev(){
  window.open("anchor_html4.php","_self");
}
...
function do_this(val){
    ...
    document.getElementById('editor1').innerHTML=val.value;
