        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Text Editors and Code Editors in HTML - What are Text Editors in HTML or Code Editors in HTML - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="text_editors_html4.php"  target="_self">Text Editors</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="text_editors_html4.php"  target="_self" style="color:white;">Text Editors</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Text Editors - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/text_editors_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/text_editors_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align: justify;" class="mt-4">In the previous chaapter we have discussed about the installation required for getting started with HTML.Now on the same chapter we have also discussed about Text Editors.Now since we have already discussed that text editors are nothing but an Application Software which is used to write code.</p>

<p style="text-align:justify;">I recommend you to download Sublime Text or Visual Studio Code.They both are great code editors.Visual Studio Code is developed by Microsoft.So at some points you will find that Visual Studio Code is a better Code Editor Than Sublime Text.At Last It's on you that what you wnat to use.</p>
