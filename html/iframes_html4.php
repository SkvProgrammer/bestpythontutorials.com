        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Iframes in HTML - Opening a webpage in another webpage using Iframes - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="iframes_html4.php"  target="_self">Iframes</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="iframes_html4.php"  target="_self" style="color:white;">Iframes</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">IFrames - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/iframes_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/iframes_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;" class="mt-4">The <code>&lt;iframe&gt;</code> tag specifies an inline frame.
...
<table class="" style="border:1px solid lightgrey;">
  <tbody><tr>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Attributes</h4>
<div style="overflow:scroll;">
...
<p style="text-align:justify;" class="mt-4"><b>Note</b> − The frameborder, marginwidth, longdesc, scrolling, marginheight attributes deprecated in HTML5. Do not use these attributes.</p>
</div>
...
<p>Read My Blogs</p>
<iframe src="https://www.devtipsntricks.com/" height="300px" width="100%"></iframe>
...
function next(){
  window.open("semantics_html4.php","_self");
}
function prev(){
