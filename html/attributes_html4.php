        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="HTML Tag Attributes - What are Tag Attributes in HTML - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="attributes_html4.php"  target="_self">Attributes</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="attributes_html4.php"  target="_self" style="color:white;">Attributes</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Attributes - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/attributes_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/attributes_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we are going to learn about the attributes of HTML Tags.Attributes in HTML Tags provides some additional information about the tags.The syntax of attributes is really very simple it is like:<b>attribute_name = "value"</b>.</p>


<p style="text-align:justify;">In this chapter we are going to cover some important attributes such <b>src</b>,<b>href</b>.Believe me attributes are really very simple thing.You can easily grab the concept of Attributes in HTML.</p>

<h4 class="text-left nt-4" style="color:#a54eee;">The src Attribute</h4>
<p style="text-align:justify;">This attribute is used with tags such as <b>img</b>,<b>video</b> and <b>audio</b>.This specifies the location of desired file in the System.Now we will see an example related to the src attribute where we will fetch and image using the src attribute.</p>
...
<body>
<img src="img_avatar2" alt="My image" />
</body>
</html></textarea>
...
<div class="container">
<img src="img_avatar2.png" alt="My image" class="img-fluid" style="height:200px;width:200px;" />
</div>


<p style="text-align:justify;" class="mt-3">The above code will produce the output as shown.It will display an image in the browser.You might have noticed that we have used an <b>alt</b> attribute.Now what is this <b>alt</b> attributes - This attribute displays the text of the <b>alt</b> attribute if the image is not found in the computer.</p>



<h4 class="text-left nt-4" style="color:#a54eee;">The href Attribute</h4>
<p style="text-align:justify;">For &lt;a&gt; and &lt;area&gt; elements, the href attribute specifies the URL of the page the link goes to.

For &lt;base&gt; elements, the href attribute specifies the base URL for all relative URLs on a page.

For &lt;link&gt; elements, the href attribute specifies the location (URL) of the external resource (most often a style sheet file).</p>
...
<body>
<a href="https://w3c.org">W3C.org</a>
<base href="https://w3c.org" />
...
<h4 class="text-left mt-4" style="color:#a54eee;">Browser Support</h4>
<div style="overflow:scroll;">
<table class="browserref notranslate">
  <tbody><tr>
    <th style="width:20%;font-size:16px;text-align:left;">Element</th>
    <th style="height:10px;" class="bsChrome" title="Chrome"><img src="chrome.jpg" class="img-fluid" style="height:25px;"></th>
    <th style="width:16%;" class="bsEdge" title="Internet Explorer / Edge"><img src="edge.png" class="img-fluid" style="height:25px;"></th>
    <th style="width:16%;" class="bsFirefox" title="Firefox"><img src="firefox.jpg" class="img-fluid" style="height:25px;"></th>
    <th style="width:16%;" class="bsSafari" title="Safari"><img src="Safari.png" class="img-fluid" style="height:25px;"></th>
    <th style="width:16%;" class="bsOpera" title="Opera"><img src="opera.png" class="img-fluid" style="height:25px;"></th>                
  </tr>
  <tr>
...
<p style="text-align:justify;" class="mt-4">This chapter is now over in the later chapters we are going to learn about many more attributes associated with different tags.</p>
...
function next(){
  window.open("heading_html4.php","_self");
}
function prev(){
  window.open("basic_webpage_html4.php","_self");
}
