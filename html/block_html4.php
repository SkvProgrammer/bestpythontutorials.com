        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Block Elements in HTML - Block value of display property - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <div class="btn-group dropleft" style="border-radius:1px!important;">
        ...
        <div class="dropdown-menu">
            <a href="../html/home_html4.php" class="dropdown-item" style="background-image:linear-gradient(#4537d1,#4537d1);">HTML</a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
    <ul class="mt-1">
     <li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;">HTML TUTORIAL</h4></li><br>
    <li><a href="home_html4.php"  target="_self">HTML Home</a></li>
   <li><a href="intro_html4.php"  target="_self">Introduction</a></li>
   <li><a href="installation_html4.php"  target="_self">Installation</a></li>
   <li><a href="text_editors_html4.php"  target="_self">Text Editors</a></li>
   <li><a href="basic_webpage_html4.php"  target="_self">Basic Webpage</a></li>
   <li><a href="attributes_html4.php"  target="_self">Attributes</a></li>
   <li><a href="heading_html4.php"  target="_self">Heading</a></li>
   <li><a href="styles_html4.php"  target="_self">Styles</a></li>
   <li><a href="formatting_html4.php"  target="_self">Formatting</a></li>
   <li><a href="paragraphs_html4.php"  target="_self">Paragraphs</a></li>
   <li><a href="quotation_html4.php"  target="_self">Quotation</a></li>
   <li><a href="comment_html4.php"  target="_self">Comment</a></li>
   <li><a href="color_html4.php"  target="_self">Color</a></li>
   <li><a href="links_html4.php"  target="_self">Links</a></li>
   <li><a href="images_html4.php"  target="_self">Images</a></li>
   <li><a href="tables_html4.php"  target="_self">Tables</a></li>
   <li><a href="lists_html4.php"  target="_self">List</a></li>
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="block_html4.php"  target="_self">Block</a></li>
   <li><a href="class_html4.php"  target="_self">Class</a></li>
   <li><a href="id_html4.php"  target="_self">Id</a></li>
   <li><a href="iframes_html4.php"  target="_self">Iframes</a></li>
   <li><a href="semantics_html4.php"  target="_self">Semantics</a></li>
   <li><a href="anchor_html4.php"  target="_self">Anchor</a></li>
   <li><a href="responsive_html4.php"  target="_self">Responsive</a></li>
   <li><a href="forms_html4.php"  target="_self">Forms</a></li>
   <li><a href="from_attributes_html4.php"  target="_self">Form Attributes</a></li>
   <li><a href="head_html4.php"  target="_self">Head</a></li>
   <li><a href="layout_html4.php"  target="_self">Layout</a></li>
   <li><a href="layout_technique_html4.php"  target="_self">Layout Technique</a></li>
   <li><a href="computer_codes_html4.php"  target="_self">ComputerCodes</a></li>
   <li><a href="entities_html4.php"  target="_self">Entities</a></li>
   <li><a href="symbols_html4.php"  target="_self">Symbols</a></li>
   <li><a href="charsets_html4.php"  target="_self">Charsets</a></li>
   <li><a href="url_encode_html4.php"  target="_self">URL Encodes</a></li>
<li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;">HTML ATTRIBUTES</h4></li><br>
<li><a href="global_attributes_html4.php"  target="_self">Global Atributes</a></li>
<li><a href="event_attributes_html4.php"  target="_self">Event Attributes</a></li>
<li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;">HTML APIs</h4></li><br>
<li><a href="drag_n_drop_html4.php"  target="_self">Drag and Drop</a></li>
<li><a href="geolocation_html4.php"  target="_self">Geolocation</a></li>
<li><a href="web_storage_html4.php"  target="_self">Web Storage</a></li>
<li><a href="web_worker_html4.php"  target="_self">Web Worker</a></li>
<li><a href="ss_events_html4.php"  target="_self">SS Events</a></li>
<li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;">HTML GRAPHICS</h4></li><br>
<li><a href="svg_html4.php"  target="_self">SVG</a></li>
<li><a href="canvas_html4.php"  target="_self">Canvas</a></li>
<li style="box-shadow:1px 1px white;background-color:white;background-image:none!important;padding:0px;border: 3px solid #a54eee;"><h4 style="text-align:center;font-family: 'Roboto', sans-serif;height:30px;line-height:55px;color:#a54eee;background-color:white;">HTML MEDIA</h4></li><br>
<li><a href="audio_html4.php"  target="_self">Audio</a></li>
<li><a href="video_html4.php"  target="_self">Video</a></li>
<li><a href="youtube_html4.php"  target="_self">Youtube</a></li>
<li><a href="plugins_html4.php"  target="_self">Plugins</a></li>
<li><a href="tag_list_html4.php"  target="_self">Tag List</a></li>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
      ...
      <a href="" style="border:none;color:white;"><h1 id="tag1">HTML TUTORIAL</h1></a>
 <a href="home_html4.php"  target="_self">HTML Home</a>
   <a href="intro_html4.php"  target="_self">Introduction</a>
   <a href="installation_html4.php"  target="_self">Installation</a>
   <a href="text_editors_html4.php"  target="_self">Text Editors</a>
   <a href="basic_webpage_html4.php"  target="_self">Basic Webpage</a>
   <a href="attributes_html4.php"  target="_self">Attributes</a>
   <a href="heading_html4.php"  target="_self">Heading</a>
   <a href="styles_html4.php"  target="_self">Styles</a>
   <a href="formatting_html4.php"  target="_self">Formatting</a>
   <a href="paragraphs_html4.php"  target="_self">Paragraphs</a>
   <a href="quotation_html4.php"  target="_self">Quotation</a>
   <a href="comment_html4.php"  target="_self">Comment</a>
   <a href="color_html4.php"  target="_self">Color</a>
   <a href="links_html4.php"  target="_self">Links</a>
   <a href="images_html4.php"  target="_self">Images</a>
   <a href="tables_html4.php"  target="_self">Tables</a>
   <a href="lists_html4.php"  target="_self">List</a>
   <a href="block_html4.php"  target="_self" style="color:white;">Block</a>
   <a href="class_html4.php"  target="_self">Class</a>
   <a href="id_html4.php"  target="_self">Id</a>
   <a href="iframes_html4.php"  target="_self">Iframes</a>
   <a href="semantics_html4.php"  target="_self">Semantics</a>
   <a href="anchor_html4.php"  target="_self">Anchor</a>
   <a href="responsive_html4.php"  target="_self">Responsive</a>
   <a href="forms_html4.php"  target="_self">Forms</a>
   <a href="from_attributes_html4.php"  target="_self">Form Attributes</a>
   <a href="head_html4.php"  target="_self">Head</a>
   <a href="layout_html4.php"  target="_self">Layout</a>
   <a href="layout_technique_html4.php"  target="_self">Layout Technique</a>
   <a href="computer_codes_html4.php"  target="_self">ComputerCodes</a>
   <a href="entities_html4.php"  target="_self">Entities</a>
   <a href="symbols_html4.php"  target="_self">Symbols</a>
   <a href="charsets_html4.php"  target="_self">Charsets</a>
   <a href="url_encode_html4.php"  target="_self">URL Encodes</a>
<a href="" style="border:none;color:white;"><h1 id="tag1">HTML ATTRIBUTES</h1></a>
<a href="global_attributes_html4.php"  target="_self">Global Atributes</a>
<a href="event_attributes_html4.php"  target="_self">Event Attributes</a>

<a href="" style="border:none;color:white;"><h1 id="tag1">HTML APIs</h1></a>
<a href="drag_n_drop_html4.php"  target="_self">Drag and Drop</a>
<a href="geolocation_html4.php"  target="_self">Geolocation</a>
<a href="web_storage_html4.php"  target="_self">Web Storage</a>
<a href="web_worker_html4.php"  target="_self">Web Worker</a>
<a href="ss_events_html4.php"  target="_self">SS Events</a>
<a href="" style="border:none;color:white;"><h1 id="tag1">HTML GRAPHICS</h1></a>
<a href="svg_html4.php"  target="_self">SVG</a>
<a href="canvas_html4.php"  target="_self">Canvas</a>
<a href="" style="border:none;color:white;"><h1 id="tag1">HTML MEDIA</h1></a>
<a href="audio_html4.php"  target="_self">Audio</a>
<a href="video_html4.php"  target="_self">Video</a>
<a href="youtube_html4.php"  target="_self">Youtube</a>
<a href="plugins_html4.php"  target="_self">Plugins</a>
<a href="tag_list_html4.php"  target="_self">Tag List</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Block - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/images_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/images_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<p style="text-align:justify;">Every HTML Elements in displayed in the web page with a display value.The two values of display property are:<b>block</b> and <b>inline</b>.First of all we are going to talk about the block elements and after that we will learn about the inline elements.</p>


<h4 class="text-left mt-4" style="color:#a54eee;">Block Elements</h4>
<p style="text-align:justify;">A block-level element always starts on a new line and takes up the full width available (stretches out to the left and right as far as it can).Below I have provided a simple example to help you grab the concept of block elements.</p>
...
<body>
<div style="border:1px solid red;">This is a Block Element</div>
</body>
</html></textarea>
...
<h4 class="text-left mt-4" style="color: #a54eee;">A Complete List of Block Elements
</h4><dl style="text-align:justify;">
 <dt><a  title="The HTML <address> element indicates that the enclosed HTML provides contact information for a person or people, or for an organization."><code>&lt;address&gt;</code></a></dt>
 <dd>Contact information.</dd>
 <dt><a  title="The HTML <article> element represents a self-contained composition in a document, page, application, or site, which is intended to be independently distributable or reusable"><code>&lt;article&gt;</code></a></dt>
 <dd>Article content.</dd>
 <dt><a title="The HTML <aside> element represents a portion of a document whose content is only indirectly related to the document's main content."><code>&lt;aside&gt;</code></a></dt>
 <dd>Aside content.</dd>
 <dt><a  title="The HTML <blockquote> Element (or HTML Block Quotation Element) indicates that the enclosed text is an extended quotation. Usually, this is rendered visually by indentation (see Notes for how to change it). A URL for the source of the quotation may be given using the cite attribute, while a text representation of the source can be given using the <cite> element."><code>&lt;blockquote&gt;</code></a></dt>
 <dd>Long ("block") quotation.</dd>
 <dt><a  title="The HTML Details Element (<details>) creates a disclosure widget in which information is visible only when the widget is toggled into an &quot;open&quot; state."><code>&lt;details&gt;</code></a></dt>
 <dd>Disclosure widget.</dd>
 <dt><a  title="The HTML <dialog> element represents a dialog box or other interactive component, such as an inspector or window."><code>&lt;dialog&gt;</code></a></dt>
 <dd>Dialog box.</dd>
 <dt><a  title="The&nbsp;HTML <dd> element provides the details about or the definition of the preceding term (<dt>) in a description list (<dl>)."><code>&lt;dd&gt;</code></a></dt>
 <dd>Describes a term in a description list.</dd>
 <dt><a  title="The HTML Content Division element (<div>) is the generic container for flow content. It has no effect on the content or layout until styled using CSS."><code>&lt;div&gt;</code></a></dt>
 <dd>Document division.</dd>
 <dt><a  title="The HTML <dl> element represents a description list. The element encloses a list of groups of terms (specified using the <dt> element) and descriptions (provided by <dd> elements). Common uses for this element are to implement a glossary or to display metadata (a list of key-value pairs)."><code>&lt;dl&gt;</code></a></dt>
 <dd>Description list.</dd>
 <dt><a  title="The HTML <dt> element specifies a term in a description or definition list, and as such must be used inside a <dl> element."><code>&lt;dt&gt;</code></a></dt>
 <dd>Description list term.</dd>
 <dt><a title="The HTML <fieldset> element is used to group several controls as well as labels (<label>) within a web form."><code>&lt;fieldset&gt;</code></a></dt>
 <dd>Field set label.</dd>
 <dt><a title="The HTML <figcaption> or Figure Caption element represents a caption or legend describing the rest of the contents of its parent <figure> element."><code>&lt;figcaption&gt;</code></a></dt>
 <dd>Figure caption.</dd>
 <dt><a title="The HTML <figure> (Figure With Optional Caption) element represents self-contained content, potentially with an optional caption, which is specified using the (<figcaption>) element."><code>&lt;figure&gt;</code></a></dt>
 <dd>Groups media content with a caption (see <a href="/en-US/docs/Web/HTML/Element/figcaption" title="The HTML <figcaption> or Figure Caption element represents a caption or legend describing the rest of the contents of its parent <figure> element."><code>&lt;figcaption&gt;</code></a>).</dd>
 <dt><a  title="The HTML <footer> element represents a footer for its nearest sectioning content or sectioning root element. A footer typically contains information about the author of the section, copyright data or links to related documents."><code>&lt;footer&gt;</code></a></dt>
 <dd>Section or page footer.</dd>
 <dt><a title="The HTML <form> element represents a document section that contains interactive controls for submitting information to a web server."><code>&lt;form&gt;</code></a></dt>
 <dd>Input form.</dd>
 <dt><a  title="REDIRECT Heading elements [en-US]"><code>&lt;h1&gt;</code></a>, <a href="/en-US/docs/Web/HTML/Element/h2" title="REDIRECT Heading elements [en-US]"><code>&lt;h2&gt;</code></a>, <a href="/en-US/docs/Web/HTML/Element/h3" title="REDIRECT Heading elements [en-US]"><code>&lt;h3&gt;</code></a>, <a href="/en-US/docs/Web/HTML/Element/h4" title="REDIRECT Heading elements [en-US]"><code>&lt;h4&gt;</code></a>, <a href="/en-US/docs/Web/HTML/Element/h5" title="REDIRECT Heading elements [en-US]"><code>&lt;h5&gt;</code></a>, <a  title="REDIRECT Heading elements [en-US]"><code>&lt;h6&gt;</code></a></dt>
 <dd>Heading levels 1-6.</dd>
 <dt><a  title="The HTML <header> element represents introductory content, typically a group of introductory or navigational aids. It may contain some heading elements but also a logo, a search form, an author name, and other elements."><code>&lt;header&gt;</code></a></dt>
 <dd>Section or page header.</dd>
 <dt><a  title="The HTML <hgroup> element represents a multi-level heading for a section of a document. It groups a set of <h1>–<h6> elements."><code>&lt;hgroup&gt;</code></a></dt>
 <dd>Groups header information.</dd>
 <dt><a  title="The HTML <hr> element represents a thematic break between paragraph-level elements: for example, a change of scene in a story, or a shift of topic within a section."><code>&lt;hr&gt;</code></a></dt>
 <dd>Horizontal rule (dividing line).</dd>
 <dt><a  title="The HTML <li> element is used to represent an item in a list."><code>&lt;li&gt;</code></a></dt>
 <dd>List item.</dd>
 <dt><a  title="The HTML <main> element represents the dominant content of the <body> of a document. The main content area consists of content that is directly related to or expands upon the central topic of a document, or the central functionality of an application."><code>&lt;main&gt;</code></a></dt>
 <dd>Contains the central content unique to this document.</dd>
 <dt><a  title="The HTML <nav> element represents a section of a page whose purpose is to provide navigation links, either within the current document or to other documents. Common examples of navigation sections are menus, tables of contents, and indexes."><code>&lt;nav&gt;</code></a></dt>
 <dd>Contains navigation links.</dd>
 <dt><a  title="The HTML <ol> element represents an ordered list of items, typically rendered as a numbered list."><code>&lt;ol&gt;</code></a></dt>
 <dd>Ordered list.</dd>
 <dt><a  title="The HTML <p> element represents a paragraph."><code>&lt;p&gt;</code></a></dt>
 <dd>Paragraph.</dd>
 <dt><a  title="The HTML <pre> element represents preformatted text which is to be presented exactly as written in the HTML file."><code>&lt;pre&gt;</code></a></dt>
 <dd>Preformatted text.</dd>
 <dt><a  title="The HTML <section> element represents a standalone section — which doesn't have a more specific semantic element to represent it — contained within an HTML document."><code>&lt;section&gt;</code></a></dt>
 <dd>Section of a web page.</dd>
 <dt><a  title="The HTML <table> element represents tabular data — that is, information presented in a two-dimensional table comprised of rows and columns of cells containing data."><code>&lt;table&gt;</code></a></dt>
 <dd>Table.</dd>
 <dt><a  title="The HTML <ul> element represents an unordered list of items, typically rendered as a bulleted list."><code>&lt;ul&gt;</code></a></dt>
 <dd>Unordered list.</dd>
</dl>


<p style="text-align:justify;" class="mt-4">Now we are going to talk about the inline elements of HTML.</p>

<h4 class="text-left mt-4" style="color:#a54eee;">Inline Elements</h4>
<p style="text-align:justify;">An inline element does not start on a new line and it only takes up as much width as necessary.</p>
...
<body>
<p>This is an <span style="border:1px solid green;">&lt;span&gt; element</span> inside the paragraph.</p>
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<h4 class="text-left mt-4" style="color:#a54eee;">List of <i>Inline</i> Elements</h4>
<ul style="text-align:justify;font-size:19.5px;">
...
<div id="id01" class="modal text-center ml-auto mr-auto" style="box-shadow:none;border:none;outline: none;z-index:99;">
  <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal"><h1>&times;</h1></span><br>
...
<br><br>
<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;border-radius:50px;" class="btn btn-danger text-left pl-5 pr-5">Subscribe for Updates</button>
<br><br>
    ...
    <div class="modal-content" style="border-radius:10px!important;background-image: linear-gradient(to right,#a54eee,#4537d1);color:white;">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true" style="color:white;" class="times">&times;</span>
        </button>
      </div>
  ...
  <ul class="list-unstyled list-inline text-center" style="color:white;" id="social">
    ...
    <li class="list-inline-item">
      <a class="btn-floating btn-li mx-1">
        <i class="fa fa-linkedin" onclick="window.open('https://www.linkedin.com/in/satyam-kumar-verman-b77272190/')"> </i>
      </a>
    </li>
    <!--<li class="list-inline-item">
...
function next(){
  window.open("class_html4.php","_self");
}
function prev(){
  window.open("lists_html4.php","_self");
}
