        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Paragraphs in HTML - <p> Tag in HTML - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="paragraphs_html4.php"  target="_self">Paragraphs</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="paragraphs_html4.php"  target="_self" style="color:white;">Paragraphs</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Paragraphs - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/paragraphs_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/paragraphs_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<h4 class="text-left mt-4" style="color:#a54eee;">HTML Display</h4>
<p style="text-align:justify;">You cannot be sure how HTML will be displayed.

Large or small screens, and resized windows will create different results. </p>
<p style="text-align: justify;">You might be wondering that how we use this paragraph tag.Using this paragraph tag is very easy.It's a container tag i.e. it needs to be closed where there is another type of tag called empty tag which doesn't need to be closed such as <b>li</b> tag which is a list tag.</p>

<p style="text-align:justify;">Suppose you are writing a a single line in HTMl and another line but you hqave put more whitespaces in the second line.Can you guess what will output.The output will be the same because the browser automatically removes the extra spaces in the paragraph tag.</p>
...
<body> 
<p>I am a paragraph with less white spaces.</p>
<p>I am a paragraph 

with more               white spaces.</p>
</body>
</html></textarea>
...
<h3 class="text-left mt-4" style="color:#a54eee;">HTML Horizontal Rules</h3>
<p style="text-align:justify;">The <code>&lt;hr&gt;</code> tag defines a thematic break in an HTML page, and is most often displayed as a horizontal rule.

The <code>&lt;hr&gt;</code> element is used to separate content (or define a change) in an HTML page:</p>
<div class="text-left mt-2">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<body> 
<p>I am above the hr.</p>
<hr />
<p>I am below the hr.</p> 
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<h4 class="text-left mt-4" style="color:#a54eee;">HTML Line Breaks</h4>
<p style="text-align:justify;">In this section we are going to use line breaks i.e. breaking the line or a paragraphh using the <code>&lt;br&gt;</code> tag.</p>
<div class="text-left mt-2">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<body> 
<!--With Line Break-->
<p>My name is Line break I am going to break from here <br /> and after breaking I will smile :)</p>
<!--Without Line Break-->
<p>My name is Line break I am going to break from here and after breaking I will smile :)</p>
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<h4 class="text-left mt-4" style="color:#a54eee;">HTML POEM PROBLEM</h4>
<p style="text-align:justify;">We want to print the below as poem.</p>
<div class="text-left mt-2">
  <form action="https://www.jdoodle.com/api/redirect-to-post/python3-programming-online" method="post" target="_blank">
...
<h4 style="text-align:justify;color:#a54eee;" class="mt-4">Output of the above code</h4>
<output>
  <p>Johny Johny
Yes Papa,
Eating sugar?
...
<p style="text-align:justify;" class="mt-4">The above output is actually not that what we wanted we want that all the lines will look like the lines of a Poem and to solve this problem we have a tag called <code>&lt;pre&gt;</code>.</p>
...
function next(){
  window.open("quotation_html4.php","_self");
}
function prev(){
  window.open("formatting_html4.php","_self");
}
