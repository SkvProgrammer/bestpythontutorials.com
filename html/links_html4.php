...
<html lang="en-Us">
    <head>
        <title>Links/Hyperlinks - HTML</title>
        <meta charset="utf-8">
        ...
        <script src="../codemirror/mode/python/python.js"></script>
         <script src="../codemirror/mode/python/python.js"></script>
          ...
          <script src="../codemirror/mode/sql/sql.js"></script>
           ...
           <meta name="description" content="Links in HTML - Link Pages using Hyperlinks - <a> - anchor tag in html - BestPythonTutorials.com" />
...
<a class="btnxc" onclick=""><i class="fa fa-chevron-up"></i></a>
  ...
  <div class="menu mt-1" style="height:100%;overflow:auto;">
   ...
   <li style="background-image:linear-gradient(#4537d1,#4537d1);border-top:1px solid white;border-bottom:1px solid white;"><a href="links_html4.php"  target="_self">Links</a></li>
...
<div id="myNav" class="overlay">
 ...
 <a href="home_html4.php"  target="_self">HTML Home</a>
   ...
   <a href="links_html4.php"  target="_self" style="color:white;">Links</a>
...
<!--search ends--><h3 class="text-left" style="color: #a54eee;">Links - HTML</h3>
<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//bestpythontutorials.com/html/links_html4.php" style="background-color:#3377ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-facebook-f"></i> Share </a>
<a href="https://twitter.com/intent/tweet?text=http%3A//bestpythontutorials.com/html/links_html4.php" style="background-color:#1ac6ff;color:white;border-radius:10px;padding:1px;font-size:15px;" id="facebookshare" class="mr-2 pl-2 pr-2"> <i class="fa fa-twitter"></i> Tweet </a>
...
<!--content goes here-->
<div id="main">
<p style="text-align:justify;" class="mt-4">In this chapter we are going to learn about the links in HTML.First of all all links are hyperlinks i.e. when you click on it it brings you in a new page.It gives us option whether I want to open the page on the same or in a new tab.</p>

<div class="container-fluid mt-5" style="background-color:#ffffcc;padding:20px;">
<p style="text-align:justify;" class="mt-4"><b>Note:</b>A link does not have to be text. A link can be an image 
  or any other HTML element!</p>
</div>

<h4 class="text-left mt-4" style="color:#a54eee;">SYNTAX</h4>
<div class="container p-2 text-left" style="border:1px solid lightgrey;background-color:#f2f2f2;">
  &lt;a href="<i>url</i>"&gt;Link Name/Image/HTML Element&lt;a&gt;
</div>

<h4 class="text-left mt-4" style="color:#a54eee;">Types of Links</h4>
<p style="text-align:justify;">By default in a browser there are four types of links that are:</p>
<ul style="text-align:justify;">
  <li>
    An unvisited link is underlined and #4537d1
    </li><li>A visited link is underlined and #a54eee
    </li><li>An active link is underlined and red
</li>
</ul>



<h4 style="color:#a54eee;" class="text-left mt-4">HTML Links - The target Attribute</h4>

<p style="text-align:justify;">By default, the linked page will be displayed in the current browser window. To change this, you must specify another target for the link.
</p>
<p style="text-align:justify;">
The <code>target</code> attribute specifies where to open the linked document.
</p>
<p style="text-align:justify;">
The <code>target</code> attribute can have one of the following values:
</p>
...
<h4 class="text-left mt-4" style="color:#a54eee;">A Basic Link</h4>
...
<body>
 <a href="http://www.bestpythontutorials.com/" target="_blank">Visit BPT</a>  
</body>
</html></textarea>
...
<h4 class="text-left mt-4" style="color:#a54eee;">Types of URLs</h4>
<p style="text-align:justify;">Generally we have two types of URLs - Absolute URLs and Relative URLs.Below I have provided a simple example by which you can easily grab this concept.</p>
...
<body>
 ...
 <p><a href="https://www.bestpythontutorials.com/">BPT</a></p>  
 <p>Relative URL</p> 
  <p><a href="./links_html4.php">Links in HTML</a></p>  
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
<h4 class="text-left mt-4" style="color:#a54eee;">mailto: links</h4>
<p style="text-align:justify;">The anchor tag can also be used to send emails using the <code>mailto:</code> attribute.Let's do an example for it.</p>
...
<body>
 <p><a href="mailto:satyamvarman2004@gmail.com">Send Mail</a></p> 
</body>
</html></textarea>
              <!--<button type="submit" style="background-color:white;border:none;outline:none;box-shadow:none;" class="mt-3">
              <a type="submit" class="pl-4 pr-4" style="border:2px solid #3399ff;border-radius:4px;color:#1aa3ff;">Run it    <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
...
function prev(){
  window.open("color_html4.php","_self");
}
